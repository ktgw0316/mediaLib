...
#pragma ident	"@(#)mlib_v_GraphicsDrawCircle_AB.c	9.3	07/11/05 SMI"
...
#define	PROC_OPTI8(p01, p00, p02, p11, p10, p12, p21, p20,               \
	...
	{                                                                \
	    ...
	    vis_st_u8(PCALC8(v02, i2), (p02));                           \
	    vis_st_u8(PCALC8(v12, i2), (p12));                           \
	    vis_st_u8(PCALC8(v10, i0), (p10));                           \
	    vis_st_u8(PCALC8(v11, i1), (p11));                           \
	    vis_st_u8(PCALC8(v21, i1), (p21));                           \
	    vis_st_u8(PCALC8(v20, i0), (p20));                           \
	    vis_st_u8(PCALC8(v22, i2), (p22));                           \
	    vis_st_u8(PCALC8(v32, i2), (p32));                           \
