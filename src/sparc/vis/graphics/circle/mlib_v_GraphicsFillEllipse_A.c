...
#pragma ident	"@(#)mlib_v_GraphicsFillEllipse_A.c	9.3	07/11/05 SMI"
...
#pragma weak mlib_GraphicsFillEllipse_A_32 = __mlib_GraphicsFillEllipse_A_32
#pragma weak mlib_GraphicsFillEllipse_A_8 = __mlib_GraphicsFillEllipse_A_8

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_GraphicsFillEllipse_A_32) mlib_GraphicsFillEllipse_A_32
    __attribute__((weak, alias("__mlib_GraphicsFillEllipse_A_32")));
__typeof__(__mlib_GraphicsFillEllipse_A_8) mlib_GraphicsFillEllipse_A_8
    __attribute__((weak, alias("__mlib_GraphicsFillEllipse_A_8")));
...
#define	PPROC8_2(p0, p1, i0, i1)                                 \
	{                                                        \
	    ...
	    v0 = vis_ld_u8(p0);                                  \
	    v1 = vis_ld_u8(p1);                                  \
	    vis_st_u8(vis_write_lo(v0, PCALC8(v0, i0)), (p0));   \
	    vis_st_u8(vis_write_lo(v1, PCALC8(v1, i1)), (p1));   \
	}
...
#define	PPROC8_3(p0, p1, p2, i0, i1, i2)                         \
	{                                                        \
	    ...
	    vis_st_u8(vis_write_lo(v0, PCALC8(v0, i0)), (p0));   \
	    vis_st_u8(vis_write_lo(v1, PCALC8(v1, i1)), (p1));   \
	    vis_st_u8(vis_write_lo(v2, PCALC8(v2, i2)), (p2));   \
	}

/* *********************************************************** */

#define	PPROC8_4(p00, p01, p10, p11, i0, i1)                        \
	{                                                           \
	    mlib_d64 v00, v01, v10, v11;                            \
	                                                            \
	    v00 = vis_ld_u8(p00);                                   \
	    v01 = vis_ld_u8(p01);                                   \
	    v10 = vis_ld_u8(p10);                                   \
...
#define	PPROC32_2(p0, p1, i0, i1)                               \
	{                                                       \
	    ...
	    v0 = *(mlib_f32 *)(p0);                             \
	    v1 = *(mlib_f32 *)(p1);                             \
	    *(mlib_f32 *)(p0) = PCALC32(v0, i0);                \
	    *(mlib_f32 *)(p1) = PCALC32(v1, i1);                \
	}
...
#define	PPROC32_3(p0, p1, p2, i0, i1, i2)                       \
	{                                                       \
	    ...
	    *(mlib_f32 *)(p0) = PCALC32(v0, i0);                \
	    *(mlib_f32 *)(p1) = PCALC32(v1, i1);                \
	    *(mlib_f32 *)(p2) = PCALC32(v2, i2);                \
	}

/* *********************************************************** */

#define	PPROC32_4(p00, p01, p10, p11, i0, i1)                   \
	{                                                       \
	    mlib_f32 v00, v01, v10, v11;                        \
	                                                        \
	    v00 = *(mlib_f32 *)(p00);                           \
	    v01 = *(mlib_f32 *)(p01);                           \
	    v10 = *(mlib_f32 *)(p10);                           \
...
#define	SIMPLE_PUT_NOCLIP_X_2(bits)                               \
	PPROC##bits##_4(line0 + cx, line0 + cx + 1, line0 - cx,   \
	    line0 - cx - 1, 0, 1) if (cy)                         \
	{                                                         \
	PPROC##bits##_4(line1 + cx, line1 + cx + 1, line1 - cx,   \
	    line1 - cx - 1, 0, 1)}
...
#define	SIMPLE_PUT_NOCLIP_Y_2(bits)                             \
	PPROC##bits##_4(line0 + cx, line0 + cx - stride,        \
	    line1 + cx, line1 + cx + stride, 0, 1) if (cx)      \
	{                                                       \
	PPROC##bits##_4(line0 - cx, line0 - cx - stride,        \
	    line1 - cx, line1 - cx + stride, 0, 1)}
...
mlib_status
__mlib_GraphicsFillEllipse_A_8(
    mlib_image *buffer,
    mlib_s16 x,
    mlib_s16 y,
    mlib_s32 a,
    ...
    mlib_s32 c)
{
	...
	if (a == b)
		return (__mlib_GraphicsFillCircle_A_8(buffer, x, y, a, c));
...
mlib_status
__mlib_GraphicsFillEllipse_A_32(
    mlib_image *buffer,
    mlib_s16 x,
    mlib_s16 y,
    mlib_s32 a,
    ...
    mlib_s32 c)
{
	...
	if (a == b)
		return (__mlib_GraphicsFillCircle_A_32(buffer, x, y, a, c));
