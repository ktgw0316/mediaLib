...
#pragma ident	"@(#)mlib_v_VectorAddS32.c	9.4	07/11/05 SMI"

/*
 * FUNCTIONS
 *      mlib_VectorAddS_S32 - addition of signed 32-bit format vector
 *                            to a scalar
 *
 * SYNOPSIS
 *      mlib_status mlib_VectorAddS_S32_[Sat|Mod](mlib_s32       * xz,
 *                                                const mlib_s32 * c,
 *                                                mlib_s32       n);
...
/*
 * FUNCTIONS
 *      mlib_VectorAddS_S32C - addition of signed 32-bit format complex vector
 *                             to a scalar
 *
 * SYNOPSIS
 *      mlib_status mlib_VectorAddS_S32C_[Sat|Mod](mlib_s32       *xz,
 *                                                 const mlib_s32 *c,
 *                                                 mlib_s32       n);
...
__typeof__(__mlib_VectorAddS_S32_Mod) mlib_VectorAddS_S32_Mod
	__attribute__((weak, alias("__mlib_VectorAddS_S32_Mod")));
__typeof__(__mlib_VectorAddS_S32_Sat) mlib_VectorAddS_S32_Sat
	__attribute__((weak, alias("__mlib_VectorAddS_S32_Sat")));
__typeof__(__mlib_VectorAddS_S32C_Mod) mlib_VectorAddS_S32C_Mod
	__attribute__((weak, alias("__mlib_VectorAddS_S32C_Mod")));
__typeof__(__mlib_VectorAddS_S32C_Sat) mlib_VectorAddS_S32C_Sat
	__attribute__((weak, alias("__mlib_VectorAddS_S32C_Sat")));
__typeof__(__mlib_VectorAddS_S32C_S32C_Mod) mlib_VectorAddS_S32C_S32C_Mod
	__attribute__((weak, alias("__mlib_VectorAddS_S32C_S32C_Mod")));
__typeof__(__mlib_VectorAddS_S32C_S32C_Sat) mlib_VectorAddS_S32C_S32C_Sat
	__attribute__((weak, alias("__mlib_VectorAddS_S32C_S32C_Sat")));
__typeof__(__mlib_VectorAddS_S32_S32_Mod) mlib_VectorAddS_S32_S32_Mod
	__attribute__((weak, alias("__mlib_VectorAddS_S32_S32_Mod")));
__typeof__(__mlib_VectorAddS_S32_S32_Sat) mlib_VectorAddS_S32_S32_Sat
...
#pragma pipeloop(0)
	for (i = 0; i < n; i++) {
		...
		FLOAT2INT_CLAMP(pz[2 * i], sum_r);
		FLOAT2INT_CLAMP(pz[2 * i + 1], sum_i);
	}
