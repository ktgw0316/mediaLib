...
#pragma ident	"@(#)mlib_v_SignalFFT_3.c	9.5	07/11/05 SMI"
 ...
 *  parameter set to NULL ( see also: mlib_v_fftDispatcher_3 macro in header )
    ...
    mlib_s32 order)
{
	...
	if (order <= 4)
		...
		return mlib_v_fftDispatcher_3(dstc, NULL, (void *)srcc, NULL,
    ...
    mlib_s32 order)
{
	...
	if (order <= 4)
		...
		return mlib_v_fftDispatcher_3(dstr, dsti, (void *)srcr,
    ...
    mlib_s32 order)
{
	...
	if (order <= 4)
		...
		return mlib_v_fftDispatcher_3(dstc, NULL, (void *)srcr, NULL,
    ...
    mlib_s32 order)
{
	...
	if (order <= 4)
		...
		return mlib_v_fftDispatcher_3(dstr, NULL, (void *)srcc, NULL,
