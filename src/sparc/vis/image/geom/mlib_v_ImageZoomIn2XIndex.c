...
#pragma ident	"@(#)mlib_v_ImageZoomIn2XIndex.c	9.2	07/11/05 SMI"
...
#define	MLIB_ZOOMIN2XINDEXDEFPARAM_NN(MLIB_TYPE)                          \
...
#define	MLIB_ZOOMIN2XINDEXCALLPARAM_NN(MLIB_TYPE)                        \
	...
	dst_stride, src_stride, src_w_beg, src_h_beg

/* *********************************************************** */

#define	MLIB_ZOOMIN2XINDEXDEFPARAM(MLIB_TYPE)                      \
	MLIB_ZOOMIN2XINDEXDEFPARAM_NN(MLIB_TYPE), void *colormap
...
#define	MLIB_ZOOMIN2XINDEXDEFEDGE_CE(MLIB_TYPE)                     \
	MLIB_TYPE *pdst, mlib_s32 src_width, mlib_s32 src_height,   \
	mlib_s32 dst_stride, MLIB_TYPE * pdst_near,                 \
	mlib_s32 src_width_near, mlib_s32 src_height_near,          \
	const void *colormap

/* *********************************************************** */

#define	MLIB_ZOOMIN2XINDEXCALLEDGE_CE(MLIB_TYPE)                        \
	(MLIB_TYPE *) pdst, src_width, src_height, dst_stride,          \
	(MLIB_TYPE *) pdst_near, src_width_near, src_height_near,       \
	colormap
...
#define	MLIB_ZOOMIN2XINDEXDEFEDGE_NN(MLIB_TYPE)                     \
	...
	MLIB_TYPE * pdst_near, const MLIB_TYPE *psrc_near,          \
	mlib_s32 src_width_near, mlib_s32 src_height_near,          \
	mlib_s32 src_w_beg_near, mlib_s32 src_h_beg_near

/* *********************************************************** */

#define	MLIB_ZOOMIN2XINDEXCALLEDGE_NN(MLIB_TYPE)                        \
	(MLIB_TYPE *) pdst, src_width, src_height, dst_stride,          \
	src_stride, (MLIB_TYPE *) pdst_near,                            \
...
#define	MLIB_ZOOMIN2XINDEXDEFEDGE_BL(MLIB_TYPE)                   \
	MLIB_ZOOMIN2XINDEXDEFEDGE_NN(MLIB_TYPE), void *colormap
...
#define	MLIB_ZOOMIN2XINDEXDEFEDGE_BC(MLIB_TYPE)                         \
	MLIB_ZOOMIN2XINDEXDEFEDGE_CE(MLIB_TYPE), mlib_s32 src_stride,   \
	const MLIB_TYPE *psrc_beg, mlib_s32 src_width_beg,              \
	mlib_s32 src_height_beg, mlib_s32 src_w_beg_near,               \
	mlib_s32 src_h_beg_near

/* *********************************************************** */

#define	MLIB_ZOOMIN2XINDEXCALLEDGE_BC(MLIB_TYPE)                     \
	MLIB_ZOOMIN2XINDEXCALLEDGE_CE(MLIB_TYPE), src_stride,        \
