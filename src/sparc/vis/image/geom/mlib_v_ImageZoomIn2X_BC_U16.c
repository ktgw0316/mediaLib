...
#pragma ident	"@(#)mlib_v_ImageZoomIn2X_BC_U16.c	9.2	07/11/05 SMI"
...
/* *********************************************************** */
    ...
    FUNC_ZOOM_BC(BC, U16, 1, 0, 0)
    FUNC_ZOOM_BC(BC, U16, 1, 0, 1)
...
#define	READ_LO(x)	vis_fors(vis_read_lo(x), fzeros)
    ...
    FUNC_ZOOM_BC(BC, U16, 1, 1, 0)
    FUNC_ZOOM_BC(BC, U16, 1, 1, 1)
    FUNC_ZOOM_BC(BC, U16, 2, 0, 0)
    FUNC_ZOOM_BC(BC, U16, 2, 0, 1)
    FUNC_ZOOM_BC(BC, U16, 2, 1, 0)
    FUNC_ZOOM_BC(BC, U16, 2, 1, 1)
    FUNC_ZOOM_BC(BC, U16, 3, 0, 0)
    FUNC_ZOOM_BC(BC, U16, 3, 0, 1)
    FUNC_ZOOM_BC(BC, U16, 3, 1, 0)
    FUNC_ZOOM_BC(BC, U16, 3, 1, 1)
    FUNC_ZOOM_BC(BC, U16, 4, 0, 0)
    FUNC_ZOOM_BC(BC, U16, 4, 0, 1)
    FUNC_ZOOM_BC(BC, U16, 4, 1, 0)
    FUNC_ZOOM_BC(BC, U16, 4, 1, 1)
