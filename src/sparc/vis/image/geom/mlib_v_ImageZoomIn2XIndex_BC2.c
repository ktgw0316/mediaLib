...
#pragma ident	"@(#)mlib_v_ImageZoomIn2XIndex_BC2.c	9.3	07/11/05 SMI"
...
#define	IMAGE_COL_U8_BC_ODD2(ind, st, shift)                    \
	...
	fa1 = lut[psrc[ind + shift]];                           \
	fa2 = lut[psrc[ind + 2 * shift]];                       \
	da0 = vis_fmul8x16al(fa, fone_five);                    \
	da_1 = vis_fmul8x16au(fa_1, fone_five);                 \
	st = vis_fpsub16(da0, da_1);                            \
	da1 = vis_fmul8x16al(fa1, fone_five);                   \
	st = vis_fpadd16(st, da1);                              \
	da2 = vis_fmul8x16au(fa2, fone_five);                   \
...
#define	IMAGE_COL_U8_BC_EVEN1(ind, st, shift)                   \
	...
	fa1 = lut[psrc[ind + shift]];                           \
	fa2 = lut[psrc[ind + 2 * shift]];                       \
	da0 = vis_fmul8x16au(fa, ffifty_nteen);                 \
	da_1 = vis_fmul8x16au(fa_1, fnine_three);               \
	st = vis_fpsub16(da0, da_1);                            \
	da1 = vis_fmul8x16al(fa1, ffifty_nteen);                \
	st = vis_fpadd16(st, da1);                              \
...
#define	IMAGE_COL_U8_BC_EVEN2(ind, st, shift)                   \
	...
	fa1 = lut[psrc[ind + shift]];                           \
	fa2 = lut[psrc[ind + 2 * shift]];                       \
	da0 = vis_fmul8x16al(fa, ffifty_nteen);                 \
	da_1 = vis_fmul8x16al(fa_1, fnine_three);               \
	st = vis_fpsub16(da0, da_1);                            \
	da1 = vis_fmul8x16au(fa1, ffifty_nteen);                \
	st = vis_fpadd16(st, da1);                              \
...
#define	IMAGE_ROW_U8_BC_EVEN1(ind)                              \
	...
	da1 = vis_fmul8x16(ffifty, col1);                       \
	da1 = vis_fpsub16(da1, da0);                            \
	da_1 = vis_fmul8x16(fnteen, col2);                      \
...
#define	IMAGE_ROW_U8_BC_EVEN2(ind)                              \
	...
	da1 = vis_fmul8x16(fnteen, col1);                       \
	da1 = vis_fpsub16(da1, da0);                            \
	da_1 = vis_fmul8x16(ffifty, col2);                      \
	da1 = vis_fpadd16(da1, da_1);                           \
...
#define	IMAGE_COL_S16_BC_ODD2(ind, st, shift)                   \
	...
	fa1 = lut[psrc[ind + shift]];                           \
	fa2 = lut[psrc[ind + 2 * shift]];                       \
	da_1 = vis_fmul8x16(fone_by_16, fa_1);                  \
	da0 = vis_fmul8x16(ffive_by_16, fa);                    \
	st = vis_fpsub16(da0, da_1);                            \
	da1 = vis_fmul8x16(ffive_by_16, fa1);                   \
	st = vis_fpadd16(st, da1);                              \
	da2 = vis_fmul8x16(fone_by_16, fa2);                    \
	st = vis_fpsub16(st, da2)
...
#define	IMAGE_COL_S16_BC_EVEN1(ind, st, shift)                  \
	...
	fa1 = lut[psrc[ind + shift]];                           \
	fa2 = lut[psrc[ind + 2 * shift]];                       \
	da_1 = vis_fmul8x16(fnine_by_128, fa_1);                \
	da0 = vis_fmul8x16(ffifty_by_128, fa);                  \
	st = vis_fpsub16(da0, da_1);                            \
	da1 = vis_fmul8x16(fnteen_by_128, fa1);                 \
	st = vis_fpadd16(st, da1);                              \
	da2 = vis_fmul8x16(fthree_by_128, fa2);                 \
	st = vis_fpsub16(st, da2)
...
#define	IMAGE_COL_S16_BC_EVEN2(ind, st, shift)                  \
	...
	fa1 = lut[psrc[ind + shift]];                           \
	fa2 = lut[psrc[ind + 2 * shift]];                       \
	da_1 = vis_fmul8x16(fthree_by_128, fa_1);               \
	da0 = vis_fmul8x16(fnteen_by_128, fa);                  \
	st = vis_fpsub16(da0, da_1);                            \
	da1 = vis_fmul8x16(ffifty_by_128, fa1);                 \
	st = vis_fpadd16(st, da1);                              \
	da2 = vis_fmul8x16(fnine_by_128, fa2);                  \
	st = vis_fpsub16(st, da2)
...
#define	IMAGE_ROW_S16_BC_ODD2(ind)                              \
	da0 = vis_fmul8x16(ffive_by_8, col1);                   \
	da1 = vis_fmul8x16(ffive_by_8, col2);                   \
	da0 = vis_fpadd16(da0, da1);                            \
	da_1 = vis_fmul8x16(fone_by_8, col0);                   \
	da0 = vis_fpsub16(da0, da_1);                           \
	da2 = vis_fmul8x16(fone_by_8, col3);                    \
...
#define	IMAGE_ROW_S16_BC_EVEN1(ind)                             \
	da0 = vis_fmul8x16(ffifty_by_64, col1);                 \
	da1 = vis_fmul8x16(fnteen_by_64, col2);                 \
	da0 = vis_fpadd16(da0, da1);                            \
	da_1 = vis_fmul8x16(fnine_by_64, col0);                 \
	da0 = vis_fpsub16(da0, da_1);                           \
	da2 = vis_fmul8x16(fthree_by_64, col3);                 \
	da0 = vis_fpsub16(da0, da2);                            \
	da1 = vis_fmuld8ulx16(four, vis_read_lo(da0));          \
	da0 = vis_fmuld8ulx16(four, vis_read_hi(da0));          \
	dst_buf1[ind] = vis_fpackfix_pair(da0, da1)
...
#define	IMAGE_ROW_S16_BC_EVEN2(ind)                             \
	da0 = vis_fmul8x16(fnteen_by_64, col1);                 \
	da1 = vis_fmul8x16(ffifty_by_64, col2);                 \
	da0 = vis_fpadd16(da0, da1);                            \
	da_1 = vis_fmul8x16(fthree_by_64, col0);                \
	da0 = vis_fpsub16(da0, da_1);                           \
	da2 = vis_fmul8x16(fnine_by_64, col3);                  \
	da0 = vis_fpsub16(da0, da2);                            \
	da1 = vis_fmuld8ulx16(four, vis_read_lo(da0));          \
	da0 = vis_fmuld8ulx16(four, vis_read_hi(da0));          \
	dst_buf1[ind] = vis_fpackfix_pair(da0, da1)
...
/* 57*4 */                                                      \
	mlib_f32 ffifty = vis_to_float(0xE4E4E4E4),             \
/* 19*4 */                                                      \
	    fnteen = vis_to_float(0x4C4C4C4C),                  \
/* 9*4 */                                                       \
	    fnine = vis_to_float(0x24242424),                   \
/* 3*4 */                                                       \
	    fthree = vis_to_float(0x0C0C0C0C)

/* *********************************************************** */

#define	DEFINE_KOEFF_COL_EVEN_U8()                              \
/* 57*128, 19*128 */                                            \
	mlib_f32 ffifty_nteen = vis_to_float(0x1C800980),       \
/* 9*128, 3*128 */                                              \
	    fnine_three = vis_to_float(0x04800180)

/* *********************************************************** */

#define	DEFINE_KOEFF_ROW_ODD_U8()                               \
/* 1*32 = 1/8*256 */                                            \
	mlib_f32 fone = vis_to_float(0x20202020),               \
/* 5*32 */                                                      \
	    ffive = vis_to_float(0xA0A0A0A0)
...
/* 1*256*2, 5*256*2 */                                          \
	    fone_five = vis_to_float(0x02000A00)

/* *********************************************************** */

#define	DEFINE_KOEFF_ROW_EVEN_S16()                             \
/* 57*4 */                                                      \
	mlib_f32 ffifty_by_64 = vis_to_float(0xE4E4E4E4),       \
/* 19*4 */                                                      \
	    fnteen_by_64 = vis_to_float(0x4C4C4C4C),            \
/* 9*4 */                                                       \
	    fnine_by_64 = vis_to_float(0x24242424),             \
/* 3*4 */                                                       \
	    fthree_by_64 = vis_to_float(0x0C0C0C0C),            \
...
/* 57*2 */                                                      \
	mlib_f32 ffifty_by_128 = vis_to_float(0x72727272),      \
/* 19*2 */                                                      \
	    fnteen_by_128 = vis_to_float(0x26262626),           \
/* 9*2 */                                                       \
...
/* 1*32 */                                                      \
	mlib_f32 fone_by_8 = vis_to_float(0x20202020),          \
/* 5*32 */                                                      \
	    ffive_by_8 = vis_to_float(0xA0A0A0A0),              \
	    four = vis_to_float(0x40004)
...
/* 1*16 */                                                      \
	    fone_by_16 = vis_to_float(0x10101010),              \
/* 5*16 */                                                      \
	    ffive_by_16 = vis_to_float(0x50505050)
...
#define	COLUMN_BICUBIC(j, src_type, NAME_COL, NAME_ROW)                 \
	{                                                               \
	    mlib_s32 dh = (src_h_beg) & 1, dw =                         \
		(src_w_beg + j) & 1, wx =                               \
		(j + (src_w_beg & 1)) >> 1, jj = wx + 2 * src_stride;   \
	    DEFINE_KOEFF_ROW_##NAME_ROW##_##src_type();                 \
	    DEFINE_KOEFF_COL_##NAME_COL##_##src_type();                 \
	    WRITE_GSR_##src_type(NAME_COL);                             \
	    if (dw == 0) {                                              \
...
#define	DO_ROW_U8_BC_EVEN(ind)                                  \
	...
	da1 = vis_fmul8x16(ffifty, col1_);                      \
	da1 = vis_fpsub16(da1, da0);                            \
	da_1 = vis_fmul8x16(fnteen, col2_);                     \
	da1 = vis_fpadd16(da1, da_1);                           \
	da2 = vis_fmul8x16(fthree, col3_);                      \
	da1 = vis_fpsub16(da1, da2);                            \
	dst_buf2[ind] = vis_fpack16(da1);                       \
	da0 = vis_fmul8x16(fthree, col0_);                      \
	da1 = vis_fmul8x16(fnteen, col1_);                      \
	da1 = vis_fpsub16(da1, da0);                            \
	da_1 = vis_fmul8x16(ffifty, col2_);                     \
	da1 = vis_fpadd16(da1, da_1);                           \
...
mlib_status
mlib_v_ImageZoomIn2XIndex_U8_U8_BC2_FL0(
...
mlib_status
mlib_v_ImageZoomIn2XIndex_U8_U8_BC2_FL1(
    MLIB_ZOOMIN2XINDEXDEFPARAM(mlib_u8),
    mlib_s32 chan)
{
	DEFINE_IDENTIFICATORS_U8();
...
mlib_status
mlib_v_ImageZoomIn2XIndex_U8_U8_BC2_FL2(
    MLIB_ZOOMIN2XINDEXDEFPARAM(mlib_u8),
    mlib_s32 chan)
{
	DEFINE_IDENTIFICATORS_U8();
...
mlib_status
mlib_v_ImageZoomIn2XIndex_U8_U8_BC2_FL3(
    MLIB_ZOOMIN2XINDEXDEFPARAM(mlib_u8),
    mlib_s32 chan)
{
	DEFINE_IDENTIFICATORS_U8();
...
mlib_status
mlib_v_ImageZoomIn2XIndex_U8_S16_BC2_FL0(
...
mlib_status
mlib_v_ImageZoomIn2XIndex_U8_S16_BC2_FL1(
    MLIB_ZOOMIN2XINDEXDEFPARAM(mlib_s16),
    mlib_s32 chan)
{
	DEFINE_IDENTIFICATORS_U8();
...
mlib_status
mlib_v_ImageZoomIn2XIndex_U8_S16_BC2_FL2(
    MLIB_ZOOMIN2XINDEXDEFPARAM(mlib_s16),
    mlib_s32 chan)
{
	DEFINE_IDENTIFICATORS_U8();
...
mlib_status
mlib_v_ImageZoomIn2XIndex_U8_S16_BC2_FL3(
    MLIB_ZOOMIN2XINDEXDEFPARAM(mlib_s16),
    mlib_s32 chan)
{
	DEFINE_IDENTIFICATORS_U8();
...
#define	DO_ROW_S16_BC_ODD(ind)                                  \
	...
	da0 = vis_fmul8x16(ffive_by_8, col1_);                  \
	da1 = vis_fmul8x16(ffive_by_8, col2_);                  \
	da0 = vis_fpadd16(da0, da1);                            \
	da_1 = vis_fmul8x16(fone_by_8, col0_);                  \
	da0 = vis_fpsub16(da0, da_1);                           \
	da2 = vis_fmul8x16(fone_by_8, col3_);                   \
	da0 = vis_fpsub16(da0, da2);                            \
	da1 = vis_fmuld8ulx16(four, vis_read_lo(da0));          \
	da0 = vis_fmuld8ulx16(four, vis_read_hi(da0));          \
...
#define	DO_ROW_S16_BC_EVEN(ind)                                 \
	...
	da0 = vis_fmuld8ulx16(four, vis_read_hi(da0));          \
	dst_buf1[ind + 1] = vis_fpackfix_pair(da0, da1);        \
	da0 = vis_fmul8x16(ffifty_by_64, col1_);                \
	da1 = vis_fmul8x16(fnteen_by_64, col2_);                \
	da0 = vis_fpadd16(da0, da1);                            \
	da_1 = vis_fmul8x16(fnine_by_64, col0_);                \
	da0 = vis_fpsub16(da0, da_1);                           \
	da2 = vis_fmul8x16(fthree_by_64, col3_);                \
	da0 = vis_fpsub16(da0, da2);                            \
	da1 = vis_fmuld8ulx16(four, vis_read_lo(da0));          \
	da0 = vis_fmuld8ulx16(four, vis_read_hi(da0));          \
	dst_buf2[ind] = vis_fpackfix_pair(da0, da1);            \
	da0 = vis_fmul8x16(fnteen_by_64, col1_);                \
	da1 = vis_fmul8x16(ffifty_by_64, col2_);                \
	da0 = vis_fpadd16(da0, da1);                            \
	da_1 = vis_fmul8x16(fthree_by_64, col0_);               \
	da0 = vis_fpsub16(da0, da_1);                           \
	da2 = vis_fmul8x16(fnine_by_64, col3_);                 \
	da0 = vis_fpsub16(da0, da2);                            \
	da1 = vis_fmuld8ulx16(four, vis_read_lo(da0));          \
	da0 = vis_fmuld8ulx16(four, vis_read_hi(da0));          \
	dst_buf2[ind + 1] = vis_fpackfix_pair(da0, da1)
...
mlib_status
mlib_v_ImageZoomIn2XIndex_S16_U8_BC2_FL0(
    MLIB_ZOOMIN2XINDEXDEFPARAM(mlib_u8),
    mlib_s32 chan)
{
...
mlib_status
mlib_v_ImageZoomIn2XIndex_S16_U8_BC2_FL1(
    MLIB_ZOOMIN2XINDEXDEFPARAM(mlib_u8),
    mlib_s32 chan)
{
	DEFINE_IDENTIFICATORS_S16();
...
mlib_status
mlib_v_ImageZoomIn2XIndex_S16_U8_BC2_FL2(
    MLIB_ZOOMIN2XINDEXDEFPARAM(mlib_u8),
    mlib_s32 chan)
{
	DEFINE_IDENTIFICATORS_S16();
...
mlib_status
mlib_v_ImageZoomIn2XIndex_S16_U8_BC2_FL3(
    MLIB_ZOOMIN2XINDEXDEFPARAM(mlib_u8),
    mlib_s32 chan)
{
	DEFINE_IDENTIFICATORS_S16();
...
mlib_status
mlib_v_ImageZoomIn2XIndex_S16_S16_BC2_FL0(
    MLIB_ZOOMIN2XINDEXDEFPARAM(mlib_s16),
    mlib_s32 chan)
{
	DEFINE_IDENTIFICATORS_S16();
...
mlib_status
mlib_v_ImageZoomIn2XIndex_S16_S16_BC2_FL1(
    MLIB_ZOOMIN2XINDEXDEFPARAM(mlib_s16),
    mlib_s32 chan)
{
	DEFINE_IDENTIFICATORS_S16();
...
mlib_status
mlib_v_ImageZoomIn2XIndex_S16_S16_BC2_FL2(
    MLIB_ZOOMIN2XINDEXDEFPARAM(mlib_s16),
    mlib_s32 chan)
{
	DEFINE_IDENTIFICATORS_S16();
...
mlib_status
mlib_v_ImageZoomIn2XIndex_S16_S16_BC2_FL3(
    MLIB_ZOOMIN2XINDEXDEFPARAM(mlib_s16),
    mlib_s32 chan)
{
	DEFINE_IDENTIFICATORS_S16();
...
#define	MLIB_IMAGEZOOMIN2XINDEX_BC(dst_format, dst_type, SHIFT)            \
	...
	case MLIB_BYTE:                                                    \
	    res =                                                          \
		mlib_v_ImageZoomIn2XIndex_U8_##dst_type##_BC2_FL##SHIFT    \
		(MLIB_ZOOMIN2XINDEXCALLPARAM(dst_format), nchannels);      \
	    break;                                                         \
	case MLIB_SHORT:                                                   \
	    res =                                                          \
		mlib_v_ImageZoomIn2XIndex_S16_##dst_type##_BC2_FL##SHIFT   \
		(MLIB_ZOOMIN2XINDEXCALLPARAM(dst_format), nchannels);      \
	    break;                                                         \
	}                                                                  \
	                                                                   \
...
mlib_status
mlib_v_ImageZoomIn2XIndex_U8_BC2_FL0(
    MLIB_ZOOMIN2XINDEXDEFPARAM(mlib_u8))
{
...
mlib_status
mlib_v_ImageZoomIn2XIndex_U8_BC2_FL1(
    MLIB_ZOOMIN2XINDEXDEFPARAM(mlib_u8))
{
	MLIB_IMAGEZOOMIN2XINDEX_BC(mlib_u8,
	    U8,
...
mlib_status
mlib_v_ImageZoomIn2XIndex_U8_BC2_FL2(
    MLIB_ZOOMIN2XINDEXDEFPARAM(mlib_u8))
{
	MLIB_IMAGEZOOMIN2XINDEX_BC(mlib_u8,
	    U8,
...
mlib_status
mlib_v_ImageZoomIn2XIndex_U8_BC2_FL3(
    MLIB_ZOOMIN2XINDEXDEFPARAM(mlib_u8))
{
	MLIB_IMAGEZOOMIN2XINDEX_BC(mlib_u8,
	    U8,
...
mlib_status
mlib_v_ImageZoomIn2XIndex_S16_BC2_FL0(
    MLIB_ZOOMIN2XINDEXDEFPARAM(mlib_s16))
{
...
mlib_status
mlib_v_ImageZoomIn2XIndex_S16_BC2_FL1(
    MLIB_ZOOMIN2XINDEXDEFPARAM(mlib_s16))
{
	MLIB_IMAGEZOOMIN2XINDEX_BC(mlib_s16,
	    S16,
...
mlib_status
mlib_v_ImageZoomIn2XIndex_S16_BC2_FL2(
    MLIB_ZOOMIN2XINDEXDEFPARAM(mlib_s16))
{
	MLIB_IMAGEZOOMIN2XINDEX_BC(mlib_s16,
	    S16,
...
mlib_status
mlib_v_ImageZoomIn2XIndex_S16_BC2_FL3(
    MLIB_ZOOMIN2XINDEXDEFPARAM(mlib_s16))
{
	MLIB_IMAGEZOOMIN2XINDEX_BC(mlib_s16,
	    S16,
