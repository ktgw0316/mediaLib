...
#pragma ident	"@(#)mlib_v_ImageAffine_BC_U16.c	9.2	07/11/05 SMI"
...
#define	LOAD_BC_S16_1CH_1PIXEL(mlib_filters_s16,                         \
	mlib_filters_s16_4)                                              \
	...
	yPtr =                                                           \
	    ((mlib_d64 *)((mlib_u8 *)mlib_filters_s16_4 +                \
	    filterposy * 4));                                            \
	yFilter0 = yPtr[0];                                              \
	yFilter1 = yPtr[1];                                              \
	yFilter2 = yPtr[2];                                              \
	...
	xFilter =                                                        \
	    *((mlib_d64 *)((mlib_u8 *)mlib_filters_s16 + filterposx));   \
	X += dX;                                                         \
	Y += dY
...
#define	RESULT_1BC_S16_1PIXEL()                                    \
	...
	d1 =                                                       \
	vis_write_lo(d1, vis_fpadd32s(vis_read_hi(d0),             \
	    vis_read_lo(d0)));                                     \
...
#define	FADD_1BC_S16()                                                  \
	...
	d0 =                                                            \
	vis_freg_pair(vis_fpadd32s(vis_read_hi(d0), vis_read_lo(d0)),   \
	    vis_fpadd32s(vis_read_hi(d1), vis_read_lo(d1)));            \
	d1 =                                                            \
	vis_freg_pair(vis_fpadd32s(vis_read_hi(d2), vis_read_lo(d2)),   \
    ...
    mlib_affine_param *param)
{
	...
	for (j = yStart; j <= yFinish; j++) {
		...
		for (i = 0; i < align; i++) {
			NEXT_PIXEL_1BC_S16();
			LOAD_BC_S16_1CH_1PIXEL(mlib_filters_table,
...
#pragma pipeloop(0)
			for (; i <= cols - 14; i += 4) {
				*(mlib_d64 *)dstPixelPtr = res;
				FADD_1BC_S16();
				BC_S16_1CH(0, mlib_filters_table,
				    mlib_filters_table_4);
				BC_S16_1CH(1, mlib_filters_table,
				    mlib_filters_table_4);
				BC_S16_1CH(2, mlib_filters_table,
				    mlib_filters_table_4);
				BC_S16_1CH(3, mlib_filters_table,
				    mlib_filters_table_4);
				dstPixelPtr += 4;
			}
...
#define	LOAD_BC_S16_2CH_1PIXEL(mlib_filters_s16,                         \
	mlib_filters_s16_4)                                              \
	dpSrc = vis_alignaddr(sPtr, 0);                                  \
	data0 = dpSrc[0];                                                \
	data1 = dpSrc[1];                                                \
    ...
    mlib_affine_param *param)
{
	...
	for (j = yStart; j <= yFinish; j++) {
		...
		if (i <= cols - 6) {
			...
			NEXT_PIXEL_2BC_S16();
			LOAD_BC_S16_2CH_1PIXEL(mlib_filters_table,
			    mlib_filters_table_4);
...
#pragma pipeloop(0)
			for (; i <= cols - 8; i += 2) {
				vis_alignaddr((void *)(8 -
				    (mlib_addr)dstPixelPtr), 0);
				res = vis_faligndata(res, res);
				vis_pst_16(res, dp++, mask);
				vis_pst_16(res, dp, ~mask);
				FADD_2BC_S16();
				BC_S16_2CH(0, mlib_filters_table,
				    mlib_filters_table_4);
				BC_S16_2CH(1, mlib_filters_table,
				    mlib_filters_table_4);
			}
...
#define	LOAD_BC_S16_3CH_1PIXEL(mlib_filters_s16_3,              \
	mlib_filters_s16_4)                                     \
	dpSrc = vis_alignaddr(sPtr, 0);                         \
	data0 = dpSrc[0];                                       \
	data1 = dpSrc[1];                                       \
	...
	filterposx = (X >> FILTER_SHIFT) & FILTER_MASK;         \
	xPtr =                                                  \
	    ((mlib_d64 *)((mlib_u8 *)mlib_filters_s16_3 +       \
	    filterposx * 3));                                   \
	xFilter0 = xPtr[0];                                     \
	xFilter1 = xPtr[1];                                     \
	xFilter2 = xPtr[2];                                     \
    ...
    mlib_affine_param *param)
{
	...
	for (j = yStart; j <= yFinish; j++) {
		...
		if (i <= cols - 4) {
			...
			NEXT_PIXEL_3BC_S16();
			LOAD_BC_S16_3CH_1PIXEL(mlib_filters_table_3,
			    mlib_filters_table_4);
...
#pragma pipeloop(0)
			for (; i < cols - 4; i++) {
				...
				FADD_3BC_S16();
				BC_S16_3CH(mlib_filters_table_3,
				    mlib_filters_table_4);
			}
