...
#pragma ident	"@(#)mlib_v_ImageBlend_ONE_ZERO.c	9.2	07/11/05 SMI"

/*
 * FUNCTION
 *      mlib_ImageBlend_ONE_ZERO - blend two images with
 *      ZERO source blend factor and ONE destination blend factor
 *
 * SYNOPSIS
 *
 *      mlib_status mlib_ImageBlend_ONE_ZERO(mlib_image       *dst,
...
#pragma weak mlib_ImageBlend_ONE_ZERO = __mlib_ImageBlend_ONE_ZERO

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageBlend_ONE_ZERO) mlib_ImageBlend_ONE_ZERO
    __attribute__((weak, alias("__mlib_ImageBlend_ONE_ZERO")));
...
__mlib_ImageBlend_ONE_ZERO(
    ...
    mlib_s32 cmask)
{
	return (__mlib_ImageBlend_ZERO_ONE(dst, src2, src1, cmask));
}
