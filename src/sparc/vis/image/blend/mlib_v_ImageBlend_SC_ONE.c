...
#pragma ident	"@(#)mlib_v_ImageBlend_SC_ONE.c	9.2	07/11/05 SMI"
...
#define	IMAGE_SC_ONE                                                \
	sum1 = vis_fpadd16(vis_fexpand(vis_read_hi(pix1)), d256);   \
	res1 = vis_fmul8x16(vis_read_hi(pix2), sum1);               \
	sum2 = vis_fpadd16(vis_fexpand(vis_read_lo(pix1)), d256);   \
    ...
    mlib_s32 cmask)
{
	...
	BLEND_VALIDATE dst_width *= channels;
