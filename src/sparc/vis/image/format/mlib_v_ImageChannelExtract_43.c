...
#define	EXTRACT_U8_43R_old                                      \
	                                                        \
/*                                                              \
 * shift right                                                  \
 */                                                             \
	dd2 = vis_faligndata(sd3, dd2);                         \
/*                                                              \
 * r7--------------                                             \
 */                                                             \
...
#define	LOAD_EXTRACT_S16_43R_NF                                 \
	vis_alignaddr((void *)soff, 0);                         \
	s0 = s4;                                                \
	s1 = vis_ld_d64_nf(sp + 1);                             \
	s2 = vis_ld_d64_nf(sp + 2);                             \
...
#define	EXTRACT_U8_43L_old                                      \
	                                                        \
/*                                                              \
 * shift left                                                   \
 */                                                             \
	dd0 = vis_faligndata(dd0, sd0);                         \
/*                                                              \
 * --------------r0                                             \
 */                                                             \
	sd0 = vis_faligndata(sd0, sd0);                         \
...
#define	LOAD_EXTRACT_U8_43L                                     \
	...
	sd0 = vis_faligndata(s0, s1);                           \
/*                                                              \
 * the intermediate is ABGR aligned                             \
 */                                                             \
	sd1 = vis_faligndata(s1, s2);                           \
	sd2 = vis_faligndata(s2, s3);                           \
	sd3 = vis_faligndata(s3, s4);                           \
...
#define	LOAD_EXTRACT_S16_43L_NF                                 \
	vis_alignaddr((void *)soff, 0);                         \
	s0 = s4;                                                \
	s1 = vis_ld_d64_nf(sp + 1);                             \
	s2 = vis_ld_d64_nf(sp + 2);                             \
