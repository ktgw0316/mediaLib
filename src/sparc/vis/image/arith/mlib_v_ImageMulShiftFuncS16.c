...
/*
 * Internal functions for ImageMulShift (types S16 and U16).
 *
...
#define	MLIB_V_IMAGEMUL_S16(sd1, sd2, dd)                             \
	rdhh = vis_fmuld8sux16(vis_read_hi(sd1), vis_read_hi(sd2));   \
	rdhl = vis_fmuld8ulx16(vis_read_hi(sd1), vis_read_hi(sd2));   \
	rdh = vis_fpadd32(rdhh, rdhl);                                \
	rdh = vis_fpadd32(rdh, rdh);                                  \
	rdlh = vis_fmuld8sux16(vis_read_lo(sd1), vis_read_lo(sd2));   \
	rdll = vis_fmuld8ulx16(vis_read_lo(sd1), vis_read_lo(sd2));   \
	rdl = vis_fpadd32(rdlh, rdll);                                \
	rdl = vis_fpadd32(rdl, rdl);                                  \
	dd = vis_fpackfix_pair(rdh, rdl)
...
/* generate edge mask for the start point */
			...
			if (emask != 0xf) {
				sd10 = (*spp1++);
				sd20 = (*spp2++);
				MLIB_V_IMAGEMUL_S16(sd10, sd20, dd);
				vis_pst_16(dd, dpp++, emask);
				i += 4;
			}
#pragma pipeloop(0)
...
/* generate edge mask for the start point */
			...
			sd10 = vis_ld_d64_nf(spp1); spp1++;
			sd20 = vis_ld_d64_nf(spp2); spp2++;
			MLIB_V_IMAGEMUL_S16(sd10, sd20, dd0);

			if (emask != 0xf) {
				sd10 = vis_ld_d64_nf(spp1); spp1++;
				sd20 = vis_ld_d64_nf(spp2); spp2++;
				MLIB_V_IMAGEMUL_S16(sd10, sd20, dd1);
				dd = vis_faligndata(dd0, dd1);
				vis_pst_16(dd, dpp++, emask);
				dd0 = dd1;
				i += 4;
...
#pragma pipeloop(0)
			...
			if (i < width) {
				...
				sd20 = vis_faligndata(sd20,
					vis_ld_d64_nf(spp2 + 1));
				MLIB_V_IMAGEMUL_S16(sd11, sd20, dd);
				vis_pst_16(dd, dpp, emask);
			}
...
#if 0
/*
 * This macro realizes more accurate u16 multiplication
 * rather then uncommented  - but slower one.
 *
 *
...
/* initialize GSR scale factor */
	vis_write_gsr(((16 - (shift - 1)) & 0xf) << 3);
...
#define	MLIB_V_IMAGEMULSHIFTONE_U16(ud1, ud2, dd)                         \
	...
	rdh = vis_fpsub32(rdh, sd1ad);                                    \
	rdh_0 = (mlib_d64)(((mlib_s32 *)(&rdh))[0]);                      \
	rdh_0 -= (mlib_d64)((mlib_s32 *)(&sd2ad))[0];                     \
	rdh_0 *= dscale;                                                  \
	rdh_0 += sat_offset;                                              \
	rdh_1 = (mlib_d64)(((mlib_s32 *)(&rdh))[1]);                      \
	rdh_1 -= (mlib_d64)((mlib_s32 *)(&sd2ad))[1];                     \
	rdh_1 *= dscale;                                                  \
	rdh_1 += sat_offset;                                              \
	rdh = vis_to_double((mlib_s32)(rdh_0), (mlib_s32)(rdh_1));        \
	rdlh = vis_fmuld8sux16(vis_read_lo(sd1), vis_read_lo(sd2));       \
	...
	rdl = vis_fpsub32(rdl, sd1ad);                                    \
	rdl_0 = (mlib_d64)(((mlib_s32 *)(&rdl))[0]);                      \
	rdl_0 -= (mlib_d64)((mlib_s32 *)(&sd2ad))[0];                     \
	rdl_0 *= dscale;                                                  \
	rdl_0 += sat_offset;                                              \
	rdl_1 = (mlib_d64)(((mlib_s32 *)(&rdl))[1]);                      \
	rdl_1 -= (mlib_d64)((mlib_s32 *)(&sd2ad))[1];                     \
	rdl_1 *= dscale;                                                  \
	rdl_1 += sat_offset;                                              \
	rdl = vis_to_double((mlib_s32)(rdl_0), (mlib_s32)(rdl_1));        \
	dd = vis_fpackfix_pair(rdh, rdl);                                 \
