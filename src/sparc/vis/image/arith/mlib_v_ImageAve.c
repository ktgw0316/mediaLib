...
#pragma ident	"@(#)mlib_v_ImageAve.c	9.3	07/11/05 SMI"
    ...
    const mlib_image *src2)
{
	...
	if (dtype == MLIB_BYTE)
		return (mlib_v_ImageAve_U8(dst, src1, src2));
	else if (dtype == MLIB_SHORT)
		return (mlib_v_ImageAve_S16(dst, src1, src2));
	else if (dtype == MLIB_USHORT)
		return (mlib_v_ImageAve_U16(dst, src1, src2));
	else if (dtype == MLIB_INT)
		return (mlib_v_ImageAve_S32(dst, src1, src2));
	else
		return (MLIB_FAILURE);
}
