...
#pragma ident	"@(#)mlib_v_ImageAddFunc.c	9.2	07/11/05 SMI"

/*
 * Internal function.
 *
 *   mlib_status mlib_v_ImageAdd_U8(mlib_image       *dst,
 *                                  const mlib_image *src1,
 *                                  const mlib_image *src2);
 *
 *   mlib_status mlib_v_ImageAdd_S16(mlib_image       *dst,
 *                                   const mlib_image *src1,
 *                                   const mlib_image *src2);
 *
 *   mlib_status mlib_v_ImageAdd_U16(mlib_image       *dst,
 *                                   const mlib_image *src1,
 *                                   const mlib_image *src2);
 *
 *   mlib_status mlib_v_ImageAdd_S32(mlib_image       *dst,
 *                                   const mlib_image *src1,
 *                                   const mlib_image *src2);
 *
 * ARGUMENT
...
#define	MLIB_V_ADDIMAGE_U8(sd1, sd2, dd)                        \
...
#define	MLIB_V_ADDIMAGE_S16(sd1, sd2, dd)	dd = vis_fpadd16(sd1, sd2)
...
#define	MLIB_V_ADDIMAGE_U16(sd1, sd2, dpp)                      \
	{                                                       \
	    tmp = vis_fpadd16(sd1, sd2);                        \
...
#define	MLIB_V_ADDIMAGE_U16_emask(sd1, sd2, dpp, emask)         \
	{                                                       \
	    tmp = vis_fpadd16(sd1, sd2);                        \
	    sd1 = vis_fxor(ones, sd1);                          \
	    sd2 = vis_fxnor(ones, sd2);                         \
...
#pragma pipeloop(0)
			...
			if (i < amount) {
				...
				sd20 = vis_faligndata(sd20,
					vis_ld_d64_nf(spp2 + 1));
				MLIB_V_ADDIMAGE_U16_emask(sd11, sd20, dpp,
				    emask);
			}
...
#define	MLIB_V_ADDIMAGE_S32(sd1, sd2, dd)	dd = vis_fpadd32(sd1, sd2)
...
/* generate edge mask for the start point */
			...
			if (emask != 3) {
				sd10 = (*spp1++);
				sd20 = (*spp2++);
				MLIB_V_ADDIMAGE_S32(sd10, sd20, dd);
...
/* generate edge mask for the start point */
			...
			sd10 = vis_ld_d64_nf(spp1); spp1++;
			sd20 = vis_ld_d64_nf(spp2); spp2++;
			MLIB_V_ADDIMAGE_S32(sd10, sd20, dd0);

			if (emask != 3) {
				sd10 = vis_ld_d64_nf(spp1); spp1++;
				sd20 = vis_ld_d64_nf(spp2); spp2++;
				MLIB_V_ADDIMAGE_S32(sd10, sd20, dd1);
				dd = vis_faligndata(dd0, dd1);
				vis_pst_32(dd, dpp++, emask);
				dd0 = dd1;
				i += 2;
...
#pragma pipeloop(0)
			...
			if (i < amount) {
				...
				sd20 = vis_faligndata(sd20,
					vis_ld_d64_nf(spp2 + 1));
				MLIB_V_ADDIMAGE_S32(sd11, sd20, dd);
				vis_pst_32(dd, dpp, emask);
			}
