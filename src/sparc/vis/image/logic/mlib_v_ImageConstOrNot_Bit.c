...
#pragma ident	"@(#)mlib_v_ImageConstOrNot_Bit.c	9.2	07/11/05 SMI"

/*
 * FUNCTION
 *      mlib_ImageConstOrNot_Bit - image logical operation with constant
 *                               (type of image - BIT)
 *
 * SYNOPSIS
...
#define	VIS_CONSTLOGIC(c, a)	vis_fornot(a, c)
...
#define	CONST_LOGIC_BITS                                        \
	mlib_status                                             \
	mlib_v_ImageConstOrNot_Bit(mlib_image *dst,             \
