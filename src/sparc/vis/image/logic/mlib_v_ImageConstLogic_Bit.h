...
/*
 * Macro definitions for MLIB_VIS version bit image logical functions.
 */
...
#if defined(MLIB_VIS)
#if MLIB_VIS >= 0x200
#error This include file can be used with MLIB_VIS 1.0 only
#endif /* MLIB_VIS >= 0x200 */
#endif /* defined(MLIB_VIS) */
