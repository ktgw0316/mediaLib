...
#pragma ident	"@(#)mlib_v_ImageNotOr_Bit.c	9.2	07/11/05 SMI"

/*
 * FUNCTION
 *      mlib_v_ImageNotOr_Bit     - notor two bit type images  (VIS version)
 *
 * SYNOPSIS
...
#define	LOGIC_BITS                                                       \
	mlib_status                                                      \
	mlib_v_ImageNotOr_Bit(mlib_image *dst, const mlib_image *src1,   \
	    const mlib_image *src2)
