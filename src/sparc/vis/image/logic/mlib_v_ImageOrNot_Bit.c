...
#pragma ident	"@(#)mlib_v_ImageOrNot_Bit.c	9.2	07/11/05 SMI"

/*
 * FUNCTION
 *      mlib_v_ImageOrNot_Bit     - ornot two bit type images  (VIS version)
 *
 * SYNOPSIS
...
#define	VIS_LOGIC(a1, a2)	vis_fornot(a1, a2)
...
#define	LOGIC_BITS                                                       \
	mlib_status                                                      \
	mlib_v_ImageOrNot_Bit(mlib_image *dst, const mlib_image *src1,   \
	    const mlib_image *src2)
