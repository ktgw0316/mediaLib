...
#pragma ident	"@(#)mlib_v_ImageConvClearEdge.c	9.2	07/11/05 SMI"
...
static void mlib_ImageConvClearEdge_U8_1(
    mlib_image *dst,
    mlib_s32 dx_l,
    mlib_s32 dx_r,
    mlib_s32 dy_t,
...
static void mlib_ImageConvClearEdge_U8_2(
    mlib_image *dst,
    mlib_s32 dx_l,
    mlib_s32 dx_r,
    mlib_s32 dy_t,
...
static void mlib_ImageConvClearEdge_U8_3(
    mlib_image *dst,
    mlib_s32 dx_l,
    mlib_s32 dx_r,
    mlib_s32 dy_t,
...
static void mlib_ImageConvClearEdge_U8_4(
    mlib_image *dst,
    mlib_s32 dx_l,
    mlib_s32 dx_r,
    mlib_s32 dy_t,
...
static void mlib_ImageConvClearEdge_S16_1(
    mlib_image *dst,
    mlib_s32 dx_l,
    mlib_s32 dx_r,
    mlib_s32 dy_t,
...
static void mlib_ImageConvClearEdge_S16_2(
    mlib_image *dst,
    mlib_s32 dx_l,
    mlib_s32 dx_r,
    mlib_s32 dy_t,
...
static void mlib_ImageConvClearEdge_S16_3(
    mlib_image *dst,
    mlib_s32 dx_l,
    mlib_s32 dx_r,
    mlib_s32 dy_t,
...
static void mlib_ImageConvClearEdge_S16_4(
    mlib_image *dst,
    mlib_s32 dx_l,
    mlib_s32 dx_r,
    mlib_s32 dy_t,
...
static void mlib_ImageConvClearEdge_S32_1(
    mlib_image *dst,
    mlib_s32 dx_l,
    mlib_s32 dx_r,
    mlib_s32 dy_t,
...
static void mlib_ImageConvClearEdge_S32_2(
    mlib_image *dst,
    mlib_s32 dx_l,
    mlib_s32 dx_r,
    mlib_s32 dy_t,
...
static void mlib_ImageConvClearEdge_S32_3(
    mlib_image *dst,
    mlib_s32 dx_l,
    mlib_s32 dx_r,
    mlib_s32 dy_t,
...
static void mlib_ImageConvClearEdge_S32_4(
    mlib_image *dst,
    mlib_s32 dx_l,
    mlib_s32 dx_r,
    mlib_s32 dy_t,
...
#define	VERT_EDGES(chan, type, mask)                                      \
	...
	for (l = chan - 1; l >= 0; l--) {                                 \
	    ...
	    for (j = 0; j < dx_r; j++) {                                  \
		for (i = dy_t; i < (dst_height - dy_b); i++) {            \
		    pdst[i * dst_stride + l + (dst_width - 1 - j) *       \
			chan] = color_i;                                  \
		}                                                         \
	    }                                                             \
	}                                                                 \
    ...
    mlib_s32 cmask)
{
	...
	case MLIB_BYTE:
		...
		case 1:
			mlib_ImageConvClearEdge_U8_1(dst, dx_l, dx_r, dy_t,
			    dy_b, color);
			break;

		case 2:
			mlib_ImageConvClearEdge_U8_2(dst, dx_l, dx_r, dy_t,
			    dy_b, color, cmask);
			break;

		case 3:
			mlib_ImageConvClearEdge_U8_3(dst, dx_l, dx_r, dy_t,
			    dy_b, color, cmask);
			break;

		case 4:
			mlib_ImageConvClearEdge_U8_4(dst, dx_l, dx_r, dy_t,
			    dy_b, color, cmask);
			break;
	...
	case MLIB_USHORT:
		...
		case 1:
			mlib_ImageConvClearEdge_S16_1(dst, dx_l, dx_r, dy_t,
			    dy_b, color);
			break;

		case 2:
			mlib_ImageConvClearEdge_S16_2(dst, dx_l, dx_r, dy_t,
			    dy_b, color, cmask);
			break;

		case 3:
			mlib_ImageConvClearEdge_S16_3(dst, dx_l, dx_r, dy_t,
			    dy_b, color, cmask);
			break;

		case 4:
			mlib_ImageConvClearEdge_S16_4(dst, dx_l, dx_r, dy_t,
			    dy_b, color, cmask);
			break;
	...
	case MLIB_INT:
		...
		case 1:
			mlib_ImageConvClearEdge_S32_1(dst, dx_l, dx_r, dy_t,
			    dy_b, color);
			break;

		case 2:
			mlib_ImageConvClearEdge_S32_2(dst, dx_l, dx_r, dy_t,
			    dy_b, color, cmask);
			break;

		case 3:
			mlib_ImageConvClearEdge_S32_3(dst, dx_l, dx_r, dy_t,
			    dy_b, color, cmask);
			break;

		case 4:
			mlib_ImageConvClearEdge_S32_4(dst, dx_l, dx_r, dy_t,
			    dy_b, color, cmask);
			break;
    ...
    mlib_s32 cmask)
{
	...
	for (i = 0; i < dy_t; i++) {
		pdst_row = pdst + i * dst_stride;
		pdst_row_end = pdst_row + 2 * dst_width_t - 1;
		dpdst = (mlib_d64 *)vis_alignaddr(pdst_row, 0);
    ...
    mlib_s32 cmask)
{
	...
	for (i = 0; i < dy_t; i++) {
		pdst_row = pdst + i * dst_stride;
		pdst_row_end = pdst_row + 3 * dst_width_t - 1;
		...
		if (j < (3 * dst_width_t - 8)) {
			vis_pst_8(dcolor00, dpdst++, mask0);

			if (j < (3 * dst_width_t - 16)) {
    ...
    mlib_s32 cmask)
{
	...
	for (i = 0; i < dy_t; i++) {
		pdst_row = pdst + i * dst_stride;
		pdst_row_end = pdst_row + 4 * dst_width_t - 1;
		dpdst = (mlib_d64 *)((mlib_addr)pdst_row & ~7);
		offset = pdst_row - (mlib_u8 *)dpdst;
		mask1 = (tmask >> offset);
		vis_alignaddr((void *)(-(mlib_addr)pdst_row), 8);
