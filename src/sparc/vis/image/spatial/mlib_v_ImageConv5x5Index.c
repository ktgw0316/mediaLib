...
#pragma ident	"@(#)mlib_v_ImageConv5x5Index.c	9.2	07/11/05 SMI"
...
static mlib_status mlib_v_conv5x5Index_8_8nw(
    const mlib_image *src,
    mlib_image *dst,
    const mlib_s32 *kern,
    mlib_s32 scale,
...
static mlib_status mlib_v_conv5x5Index_8_16nw(
    const mlib_image *src,
    mlib_image *dst,
    const mlib_s32 *kern,
    mlib_s32 scale,
...
static mlib_status mlib_v_conv5x5Index_8_8ext(
    const mlib_image *src,
    mlib_image *dst,
    const mlib_s32 *kern,
    mlib_s32 scale,
...
static mlib_status mlib_v_conv5x5Index_8_16ext(
    const mlib_image *src,
    mlib_image *dst,
    const mlib_s32 *kern,
    mlib_s32 scale,
