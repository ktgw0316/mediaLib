...
#pragma ident	"@(#)mlib_v_ImageConv2x2Index.c	9.2	07/11/05 SMI"
...
static mlib_status mlib_v_conv2x2Index_8_8nw_(
    const mlib_image *src,
    mlib_image *dst,
    const mlib_s32 *kern,
    mlib_s32 scale,
...
static mlib_status mlib_v_conv2x2Index_8_16nw(
    const mlib_image *src,
    mlib_image *dst,
    const mlib_s32 *kern,
    mlib_s32 scale,
...
static mlib_status mlib_v_conv2x2Index_8_8ext(
    const mlib_image *src,
    mlib_image *dst,
    const mlib_s32 *kern,
    mlib_s32 scale,
...
static mlib_status mlib_v_conv2x2Index_8_16ext(
    const mlib_image *src,
    mlib_image *dst,
    const mlib_s32 *kern,
    mlib_s32 scale,
...
static mlib_status mlib_v_conv2x2Index_8_8nw(
    const mlib_image *src,
    mlib_image *dst,
    const mlib_s32 *kern,
    mlib_s32 scale,
...
static mlib_status mlib_v_conv2x2Index_8_16nw__(
    const mlib_image *src,
    mlib_image *dst,
    const mlib_s32 *kern,
    mlib_s32 scale,
    ...
    const void *colormap)
{
	...
	case MLIB_BYTE:
		...
		case MLIB_BYTE:
			...
			case MLIB_EDGE_DST_FILL_ZERO:
				stat =
				    mlib_v_conv2x2Index_8_8nw(src, dst, kernel,
				    scale, colormap);
			...
			case MLIB_EDGE_SRC_EXTEND:
				stat =
				    mlib_v_conv2x2Index_8_8ext(src, dst, kernel,
				    scale, colormap);
				break;
	...
	case MLIB_SHORT:	/* convert wid from pixels to bytes */
		...
		case MLIB_BYTE:
			...
			case MLIB_EDGE_DST_FILL_ZERO:
				stat =
				    mlib_v_conv2x2Index_8_16nw(src, dst, kernel,
				    scale, colormap);
			...
			case MLIB_EDGE_SRC_EXTEND:
				stat =
				    mlib_v_conv2x2Index_8_16ext(src, dst,
