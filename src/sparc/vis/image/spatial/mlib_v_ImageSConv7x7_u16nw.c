...
#pragma ident	"@(#)mlib_v_ImageSConv7x7_u16nw.c	9.3	07/11/05 SMI"
 ...
 *
 * SYNOPSIS
 *      mlib_status mlib_sconv7x7nw_s16(mlib_image       *dst,
...
static mlib_status mlib_v_sconv7x7_u16nw_1(
    mlib_image *dst,
    const mlib_image *src,
    const mlib_s32 *hkernel,
    const mlib_s32 *vkernel,
...
static mlib_status mlib_v_sconv7x7_u16nw_2(
    mlib_image *dst,
    const mlib_image *src,
    const mlib_s32 *hkernel,
    const mlib_s32 *vkernel,
...
static mlib_status mlib_v_sconv7x7_u16nw_3(
    mlib_image *dst,
    const mlib_image *src,
    const mlib_s32 *hkernel,
    const mlib_s32 *vkernel,
...
static mlib_status mlib_v_sconv7x7_u16nw_4(
    mlib_image *dst,
    const mlib_image *src,
    const mlib_s32 *hkernel,
    const mlib_s32 *vkernel,
...
static mlib_status mlib_v_sconv7x7_u16nw_mask(
    mlib_image *dst,
    const mlib_image *src,
    const mlib_s32 *hkernel,
    const mlib_s32 *vkernel,
    ...
    mlib_s32 cmask)
{
	...
	if ((nchannel == chan) || ((nchannel == 4) && (chan == 3))) {
		...
		case 1:
			res =
			    mlib_v_sconv7x7_u16nw_1(dst, src, hkernel, vkernel,
			    scalef_expon);
			break;
		case 2:
			res =
			    mlib_v_sconv7x7_u16nw_2(dst, src, hkernel, vkernel,
			    scalef_expon);
			break;
		case 3:
			res =
			    mlib_v_sconv7x7_u16nw_3(dst, src, hkernel, vkernel,
			    scalef_expon);
			break;
		case 4:
			res =
			    mlib_v_sconv7x7_u16nw_4(dst, src, hkernel, vkernel,
			    scalef_expon, cmask);
			break;
		default:
			res = MLIB_FAILURE;
		...
		res =
		    mlib_v_sconv7x7_u16nw_mask(dst, src, hkernel, vkernel,
		    scalef_expon, cmask);
	}
