...
#pragma pipeloop(0)
		...
		if (xsize & 7) {
			s00 = s01;
			s10 = s11;
			if ((xsize & 7) > (8 - NCHAN)) s01 = buff0[i + 1];
			if ((xsize & 7) > (8 - NCHAN)) s11 = buff1[i + 1];
			s0 = vis_faligndata(s00, s01);
			s1 = vis_faligndata(s10, s11);
