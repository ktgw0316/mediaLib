...
#pragma ident	"@(#)mlib_v_ImageSConv7x7_16ext.c	9.3	07/11/05 SMI"

/*
 * FUNCTION
 *      mlib_sconv7x7ext_s16 - separable convolve of an image with a 7x7 kernel
 *                               edge = MLIB_EDGE_SRC_EXTEND
 *
 * SYNOPSIS
 *      mlib_status mlib_sconv7x7ext_s16(mlib_image       *dst,
...
static mlib_status mlib_v_sconv7x7_16ext_1(
    mlib_image *dst,
    const mlib_image *src,
    mlib_s32 dx_l,
    mlib_s32 dx_r,
...
static mlib_status mlib_v_sconv7x7_16ext_2(
    mlib_image *dst,
    const mlib_image *src,
    mlib_s32 dx_l,
    mlib_s32 dx_r,
...
static mlib_status mlib_v_sconv7x7_16ext_3(
    mlib_image *dst,
    const mlib_image *src,
    mlib_s32 dx_l,
    mlib_s32 dx_r,
...
static mlib_status mlib_v_sconv7x7_16ext_4(
    mlib_image *dst,
    const mlib_image *src,
    mlib_s32 dx_l,
    mlib_s32 dx_r,
...
static mlib_status mlib_v_sconv7x7_16ext_mask(
    mlib_image *dst,
    const mlib_image *src,
    mlib_s32 dx_l,
    mlib_s32 dx_r,
...
/* data */
	...
	mlib_f32 f_scale = vis_to_float(0x40004000);
    ...
    mlib_s32 cmask)
{
	...
	if ((nchannel == chan) || ((nchannel == 4) && (chan == 3))) {
		...
		case 1:
			res =
			    mlib_v_sconv7x7_16ext_1(dst, src, dx_l, dx_r, dy_t,
			    dy_b, hkernel, vkernel, scalef_expon);
			break;
		case 2:
			res =
			    mlib_v_sconv7x7_16ext_2(dst, src, dx_l, dx_r, dy_t,
			    dy_b, hkernel, vkernel, scalef_expon);
			break;
		case 3:
			res =
			    mlib_v_sconv7x7_16ext_3(dst, src, dx_l, dx_r, dy_t,
			    dy_b, hkernel, vkernel, scalef_expon);
			break;
		case 4:
			res =
			    mlib_v_sconv7x7_16ext_4(dst, src, dx_l, dx_r, dy_t,
		...
		res =
		    mlib_v_sconv7x7_16ext_mask(dst, src, dx_l, dx_r, dy_t, dy_b,
