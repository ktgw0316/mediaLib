...
#pragma ident	"@(#)mlib_v_VideoColorJFIFYCC2ARGB444.c	9.2	07/11/05 SMI"
 ...
 *
 * SYNOPSIS
 *      mlib_status mlib_VideoColorJFIFYCC2ARGB444(mlib_u32      *argb,
 *                                                 const mlib_u8 *y,
 *                                                 const mlib_u8 *cb,
 *                                                 const mlib_u8 *cr,
 *                                                 mlib_s32      n)
...
#pragma pipeloop(0)
	for (i = 0; i < (n / 4); i++) {
		...
		MLIB_MERGE4_U8(alp, df0, df1, df2, dd0, dd1);
