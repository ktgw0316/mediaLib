...
#pragma ident	"@(#)mlib_v_VideoColorYUV2ABGR420_X3.c	9.2	07/11/05 SMI"
 ...
 *      abgr_stride     Stride in bytes between adjacent rows
 *                      in output image
...
/* Second scan line. */
			...
			rgb0[1] = rgb1[1] = rgb2[1] = val1;
			rgb0[0] = rgb1[0] = rgb2[0] =
				vis_faligndata(val2, val1);
			rgb0[2] = rgb1[2] = rgb2[2] =
				vis_faligndata(val1, val2);

			val1 = vis_fpmerge(vis_read_lo(x_green_hi),
				vis_read_lo(blue_red_hi));
			val2 = vis_faligndata(val1, val1);
			rgb0[4] = rgb1[4] = rgb2[4] = val1;
			rgb0[3] = rgb1[3] = rgb2[3] =
				vis_faligndata(val2, val1);
			rgb0[5] = rgb1[5] = rgb2[5] =
				vis_faligndata(val1, val2);

			val1 = vis_fpmerge(vis_read_hi(x_green_lo),
				vis_read_hi(blue_red_lo));
			val2 = vis_faligndata(val1, val1);
			rgb0[7] = rgb1[7] = rgb2[7] = val1;
			rgb0[6] = rgb1[6] = rgb2[6] =
				vis_faligndata(val2, val1);
			rgb0[8] = rgb1[8] = rgb2[8] =
				vis_faligndata(val1, val2);

			val1 = vis_fpmerge(vis_read_lo(x_green_lo),
				vis_read_lo(blue_red_lo));
			val2 = vis_faligndata(val1, val1);
			rgb0[10] = rgb1[10] = rgb2[10] = val1;
			rgb0[9] = rgb1[9] = rgb2[9] =
				vis_faligndata(val2, val1);
			rgb0[11] = rgb1[11] = rgb2[11] =
				vis_faligndata(val1, val2);
			...
			val1 = vis_fpmerge(vis_read_hi(x_green_hi),
				vis_read_hi(blue_red_hi));
			val2 = vis_faligndata(val1, val1);
			rgb3[1] = rgb4[1] = rgb5[1] = val1;
			rgb3[0] = rgb4[0] = rgb5[0] =
				vis_faligndata(val2, val1);
			rgb3[2] = rgb4[2] = rgb5[2] =
				vis_faligndata(val1, val2);

			val1 = vis_fpmerge(vis_read_lo(x_green_hi),
				vis_read_lo(blue_red_hi));
			val2 = vis_faligndata(val1, val1);
			rgb3[4] = rgb4[4] = rgb5[4] = val1;
			rgb3[3] = rgb4[3] = rgb5[3] =
				vis_faligndata(val2, val1);
			rgb3[5] = rgb4[5] = rgb5[5] =
				vis_faligndata(val1, val2);
...
/* V*(-0.8132); */
			...
			val1 = vis_fpmerge(vis_read_hi(x_green_lo),
				vis_read_hi(blue_red_lo));
			val2 = vis_faligndata(val1, val1);
			rgb3[7] = rgb4[7] = rgb5[7] = val1;
			rgb3[6] = rgb4[6] = rgb5[6] =
				vis_faligndata(val2, val1);
			rgb3[8] = rgb4[8] = rgb5[8] =
				vis_faligndata(val1, val2);
			...
			val1 = vis_fpmerge(vis_read_lo(x_green_lo),
				vis_read_lo(blue_red_lo));
			val2 = vis_faligndata(val1, val1);
			rgb3[10] = rgb4[10] = rgb5[10] = val1;
			rgb3[9] = rgb4[9] = rgb5[9] =
				vis_faligndata(val2, val1);
			rgb3[11] = rgb4[11] = rgb5[11] =
				vis_faligndata(val1, val2);
