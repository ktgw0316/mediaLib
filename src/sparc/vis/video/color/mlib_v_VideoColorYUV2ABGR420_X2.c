...
/* Second scan line. */
			...
			rgb0[0] = rgb1[0] = vis_faligndata(val2, val1);
			rgb0[1] = rgb1[1] = vis_faligndata(val1, val2);

			val1 = vis_fpmerge(vis_read_lo(x_green_hi),
				vis_read_lo(blue_red_hi));
			val2 = vis_faligndata(val1, val1);
			rgb0[2] = rgb1[2] = vis_faligndata(val2, val1);
			rgb0[3] = rgb1[3] = vis_faligndata(val1, val2);

			val1 = vis_fpmerge(vis_read_hi(x_green_lo),
				vis_read_hi(blue_red_lo));
			val2 = vis_faligndata(val1, val1);
			rgb0[4] = rgb1[4] = vis_faligndata(val2, val1);
			rgb0[5] = rgb1[5] = vis_faligndata(val1, val2);

			val1 = vis_fpmerge(vis_read_lo(x_green_lo),
				vis_read_lo(blue_red_lo));
			val2 = vis_faligndata(val1, val1);
			rgb0[6] = rgb1[6] = vis_faligndata(val2, val1);
			rgb0[7] = rgb1[7] = vis_faligndata(val1, val2);
			...
			val1 = vis_fpmerge(vis_read_hi(x_green_hi),
				vis_read_hi(blue_red_hi));
			val2 = vis_faligndata(val1, val1);
			rgb2[0] = rgb3[0] = vis_faligndata(val2, val1);
			rgb2[1] = rgb3[1] = vis_faligndata(val1, val2);

			val1 = vis_fpmerge(vis_read_lo(x_green_hi),
				vis_read_lo(blue_red_hi));
			val2 = vis_faligndata(val1, val1);
			rgb2[2] = rgb3[2] = vis_faligndata(val2, val1);
			rgb2[3] = rgb3[3] = vis_faligndata(val1, val2);
...
/* V*(-0.8132); */
			...
			val1 = vis_fpmerge(vis_read_hi(x_green_lo),
				vis_read_hi(blue_red_lo));
			val2 = vis_faligndata(val1, val1);
			rgb2[4] = rgb3[4] = vis_faligndata(val2, val1);
			rgb2[5] = rgb3[5] = vis_faligndata(val1, val2);

			v_8132_lo = vis_fmul8x16al(vis_read_lo(v2), k34);
			val1 = vis_fpmerge(vis_read_lo(x_green_lo),
				vis_read_lo(blue_red_lo));
			val2 = vis_faligndata(val1, val1);
			rgb2[6] = rgb3[6] = vis_faligndata(val2, val1);
			rgb2[7] = rgb3[7] = vis_faligndata(val1, val2);
