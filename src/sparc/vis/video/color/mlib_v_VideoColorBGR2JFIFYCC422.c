...
#pragma ident	"@(#)mlib_v_VideoColorBGR2JFIFYCC422.c	9.2	07/11/05 SMI"

/*
 * FUNCTION
 *      mlib_VideoColorBGR2JFIFYCC422 - color conversion with
...
__mlib_VideoColorBGR2JFIFYCC422(
	...
	mlib_s32 n)
{
	mlib_d64 *sp = (mlib_d64 *)rgb, *py = (mlib_d64 *)y;
