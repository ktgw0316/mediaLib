...
#pragma ident	"@(#)mlib_v_VideoColorYUV2ARGB422.c	9.3	07/11/05 SMI"

/*
 * FUNCTION
 *      mlib_VideoColorYUV2ARGB422 - color conversion from YUV422 to ARGB
 *
 * SYNOPSIS
 *
 *      mlib_status mlib_VideoColorYUV2ARGB422(mlib_u8       *argb,
 *                                             const mlib_u8 *y,
 *                                             const mlib_u8 *u,
 *                                             const mlib_u8 *v,
 *                                             mlib_s32      width,
...
#pragma weak mlib_VideoColorYUV2ARGB422 = __mlib_VideoColorYUV2ARGB422

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_VideoColorYUV2ARGB422) mlib_VideoColorYUV2ARGB422
	__attribute__((weak, alias("__mlib_VideoColorYUV2ARGB422")));
...
static mlib_status mlib_v_VideoColorYUV2ARGB422_all_align(
	mlib_u8 *argb,
	const mlib_u8 *y,
	const mlib_u8 *u,
	const mlib_u8 *v,
...
static mlib_status mlib_v_VideoColorYUV2ARGB422_nonalign(
	mlib_u8 *argb,
	const mlib_u8 *y,
	const mlib_u8 *u,
	const mlib_u8 *v,
	...
	mlib_s32 uv_stride)
{
	...
	if ((((mlib_addr)argb & 7) == 0) && (((mlib_addr)u & 3) == 0) &&
		...
		((argb_stride & 7) == 0)) || (height == 1))) {

		return mlib_v_VideoColorYUV2ARGB422_all_align(argb, y, u, v,
			width, height, argb_stride, y_stride, uv_stride);
	} else {
		return mlib_v_VideoColorYUV2ARGB422_nonalign(argb, y, u, v,
			width, height, argb_stride, y_stride, uv_stride);
	}
}
...
static mlib_status
mlib_v_VideoColorYUV2ARGB422_all_align(
	mlib_u8 *argb,
	const mlib_u8 *y,
	const mlib_u8 *u,
	const mlib_u8 *v,
...
static mlib_status
mlib_v_VideoColorYUV2ARGB422_nonalign(
	mlib_u8 *argb,
	const mlib_u8 *y,
	const mlib_u8 *u,
	const mlib_u8 *v,
