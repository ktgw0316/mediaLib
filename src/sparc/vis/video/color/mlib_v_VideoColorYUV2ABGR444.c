...
#pragma ident	"@(#)mlib_v_VideoColorYUV2ABGR444.c	9.3	07/11/05 SMI"
...
static mlib_status mlib_v_VideoColorYUV2ABGR444_all_align(
	mlib_u8 *abgr,
	const mlib_u8 *y,
	const mlib_u8 *u,
	const mlib_u8 *v,
...
static mlib_status mlib_v_VideoColorYUV2ABGR444_nonalign(
	mlib_u8 *abgr,
	const mlib_u8 *y,
	const mlib_u8 *u,
	const mlib_u8 *v,
	...
	mlib_s32 yuv_stride)
{
	...
	if (yuv_stride == width && abgr_stride == 4 * width) {

		width *= height;
		height = 1;
	}

	if ((((mlib_addr)abgr & 7) == 0) && (((mlib_addr)u & 7) == 0) &&
		(((mlib_addr)v & 7) == 0) && (((mlib_addr)y & 7) == 0) &&
		((((abgr_stride & 7) == 0) && ((yuv_stride & 7) == 0)) ||
		(height == 1))) {

		return mlib_v_VideoColorYUV2ABGR444_all_align(abgr, y, u, v,
			width, height, abgr_stride, yuv_stride);
	} else {
		return mlib_v_VideoColorYUV2ABGR444_nonalign(abgr, y, u, v,
			width, height, abgr_stride, yuv_stride);
	}
}
...
static mlib_status
mlib_v_VideoColorYUV2ABGR444_all_align(
	mlib_u8 *abgr,
	const mlib_u8 *y,
	const mlib_u8 *u,
	const mlib_u8 *v,
...
static mlib_status
mlib_v_VideoColorYUV2ABGR444_nonalign(
	mlib_u8 *abgr,
	const mlib_u8 *y,
	const mlib_u8 *u,
	const mlib_u8 *v,
