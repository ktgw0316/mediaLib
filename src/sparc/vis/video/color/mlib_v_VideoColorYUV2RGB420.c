 ...
 *                                            const const mlib_u8 *u,
 *                                            const const mlib_u8 *v,
 *                                            mlib_s32            width,
 *                                            mlib_s32            height,
 *                                            mlib_s32            rgb_stride,
 *                                            mlib_s32            y_stride,
...
/* loop variables */
	...
	mlib_d64 red1, green1, blue1;
	mlib_d64 red2, green2, blue2;
...
#pragma pipeloop(0)
		for (i = 0; i <= width - 8; i += 8) {
			...
			STORE_PIXEL1(21, 22, 23);
			STORE_PIXEL1(18, 19, 20);
			STORE_PIXEL1(15, 16, 17);
			STORE_PIXEL1(12, 13, 14);
			STORE_PIXEL1(9, 10, 11);
			STORE_PIXEL1(6, 7, 8);
			STORE_PIXEL1(3, 4, 5);

			vis_st_u8_i(blue1, dp1, 2);
			vis_st_u8_i(green1, dp1, 1);
			vis_st_u8_i(red1, dp1, 0);
			...
			vis_st_u8_i(blue2, dp2, 2);
			vis_st_u8_i(green2, dp2, 1);
			vis_st_u8_i(red2, dp2, 0);
