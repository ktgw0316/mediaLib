...
#pragma pipeloop(0)
	for (i = 0; i < n; i++) {
		...
		CHANNELWEIGHT_U8_2p(vis_read_hi(r0b1), vis_read_lo(b0g0),
			vis_read_hi(b0g0), vis_read_lo(g1r1),
			vis_read_hi(g1r1), vis_read_lo(r0b1), k11, k12, k13,
			z0, z1);
		...
		CHANNELWEIGHT_U8_2p(vis_read_hi(r0b1), vis_read_lo(b0g0),
			vis_read_hi(b0g0), vis_read_lo(g1r1),
			vis_read_hi(g1r1), vis_read_lo(r0b1), k21, k22, k23,
			z0, z1);
		...
		CHANNELWEIGHT_U8_2p(vis_read_hi(r0b1), vis_read_lo(b0g0),
			vis_read_hi(b0g0), vis_read_lo(g1r1),
			vis_read_hi(g1r1), vis_read_lo(r0b1), k31, k32, k33,
			z0, z1);
		...
		_b0g0 = vis_fpmerge(vis_read_hi(sea), vis_read_lo(seb));
		_r0b1 = vis_fpmerge(vis_read_lo(sea), vis_read_hi(sec));
		_g1r1 = vis_fpmerge(vis_read_hi(seb), vis_read_lo(sec));
