	...
	mlib_s32 stride)
{
	...
	vis_write_gsr64(((mlib_s64)0x018923ab << 32) | (5 << 3));
 ...
 */
	...
	outPtr[0] = vis_freg_pair(vis_fpack16(p00), vis_fpack16(p40));
	outPtr[str] = vis_freg_pair(vis_fpack16(p10), vis_fpack16(p50));
	outPtr[str * 2] = vis_freg_pair(vis_fpack16(p20), vis_fpack16(p60));
	outPtr[str * 3] = vis_freg_pair(vis_fpack16(p30), vis_fpack16(p70));
	outPtr[str * 4] = vis_freg_pair(vis_fpack16(p01), vis_fpack16(p41));
	outPtr[str * 5] = vis_freg_pair(vis_fpack16(p11), vis_fpack16(p51));
	outPtr[str * 6] = vis_freg_pair(vis_fpack16(p21), vis_fpack16(p61));
	outPtr[str * 7] = vis_freg_pair(vis_fpack16(p31), vis_fpack16(p71));
