 ...
 *      addition to mlib_s32 byte 127. Hence 'dx' becomes positive.
 *   2. Logical XOR dy ^ 0x7f7f7f7f7f7f7f7f. This is equivalent to
 *      addition to mlib_s32 byte 127. Hence 'dy' also becomes positive.
 *   3. Expand from 8 -> 16 bits representation via "vis_fmul8x16al"
 *      (multiplication by 256).
 *   4. 16-bit arithmetic plus.
 *   5. Arithmetic subtraction (127 + 127 = 254)-dz.16
 ...
 *   3. 16-bit arithmetic plus dx + dy --> dh.
 *      Every high byte in each mlib_s16 is with garbage.
...
/* start and destination point of a line in source */
	mlib_u8 *px, *py, *pz;
