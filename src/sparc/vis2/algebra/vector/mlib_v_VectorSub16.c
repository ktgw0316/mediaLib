...
#pragma ident	"@(#)mlib_v_VectorSub16.c	9.4	07/11/05 SMI"

/*
 * FUNCTIONS
 *      mlib_VectorSub_S16 - subtraction of signed 16-bit format vectors
 *
 * SYNOPSIS
...
/*
 * FUNCTIONS
 *      mlib_VectorSub_S16C - subtraction of signed 16-bit
...
#define	SUB_S16_S32                                             \
	...
	dzh = vis_fpsub32(dxh, dyh);                            \
	dzl = vis_fpsub32(dxl, dyl);
