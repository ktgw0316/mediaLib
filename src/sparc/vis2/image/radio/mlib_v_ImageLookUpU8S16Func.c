...
#pragma ident	"@(#)mlib_v_ImageLookUpU8S16Func.c	9.2	07/11/05 SMI"
...
static void mlib_v_ImageLookUp_U8_S16_124_SrcOff0_D1(
    const mlib_u8 *src,
    mlib_s16 *dst,
    mlib_s32 xsize,
...
static void mlib_v_ImageLookUp_U8_S16_124_SrcOff1_D1(
    const mlib_u8 *src,
    mlib_s16 *dst,
    mlib_s32 xsize,
    const mlib_s16 *table0,
...
static void mlib_v_ImageLookUp_U8_S16_124_SrcOff2_D1(
    const mlib_u8 *src,
    mlib_s16 *dst,
    mlib_s32 xsize,
    const mlib_s16 *table0,
...
static void mlib_v_ImageLookUp_U8_S16_124_SrcOff3_D1(
    const mlib_u8 *src,
    mlib_s16 *dst,
    mlib_s32 xsize,
    const mlib_s16 *table0,
...
static void mlib_v_ImageLookUp_U8_S16_3_SrcOff0_D1(
    const mlib_u8 *src,
    mlib_s16 *dst,
    mlib_s32 xsize,
    const mlib_s16 *table0,
...
static void mlib_v_ImageLookUp_U8_S16_3_SrcOff1_D1(
    const mlib_u8 *src,
    mlib_s16 *dst,
    mlib_s32 xsize,
    const mlib_s16 *table0,
...
static void mlib_v_ImageLookUp_U8_S16_3_SrcOff2_D1(
    const mlib_u8 *src,
    mlib_s16 *dst,
    mlib_s32 xsize,
    const mlib_s16 *table0,
...
static void mlib_v_ImageLookUp_U8_S16_3_SrcOff3_D1(
    const mlib_u8 *src,
    mlib_s16 *dst,
    mlib_s32 xsize,
    const mlib_s16 *table0,
...
void
mlib_v_ImageLookUp_U8_S16_124_SrcOff0_D1(
    const mlib_u8 *src,
    mlib_s16 *dst,
    mlib_s32 xsize,
    const mlib_s16 *table0,
...
void
mlib_v_ImageLookUp_U8_S16_124_SrcOff1_D1(
    const mlib_u8 *src,
    mlib_s16 *dst,
    mlib_s32 xsize,
    const mlib_s16 *table0,
...
void
mlib_v_ImageLookUp_U8_S16_124_SrcOff2_D1(
    const mlib_u8 *src,
    mlib_s16 *dst,
    mlib_s32 xsize,
    const mlib_s16 *table0,
...
void
mlib_v_ImageLookUp_U8_S16_124_SrcOff3_D1(
    const mlib_u8 *src,
    mlib_s16 *dst,
    mlib_s32 xsize,
    const mlib_s16 *table0,
...
/* row loop */
	for (j = 0; j < ysize; j++) {
		...
		if (size > 0) {
			...
			if (off == 0) {
				mlib_v_ImageLookUp_U8_S16_124_SrcOff0_D1(sp, dp,
				    size, tab, tab, tab, tab);
			} else if (off == 1) {
				mlib_v_ImageLookUp_U8_S16_124_SrcOff1_D1(sp, dp,
				    size, tab, tab, tab, tab);
			} else if (off == 2) {
				mlib_v_ImageLookUp_U8_S16_124_SrcOff2_D1(sp, dp,
				    size, tab, tab, tab, tab);
			} else {
				mlib_v_ImageLookUp_U8_S16_124_SrcOff3_D1(sp, dp,
				    size, tab, tab, tab, tab);
			}
		}
...
void
mlib_v_ImageLookUp_U8_S16_3_SrcOff0_D1(
    const mlib_u8 *src,
    mlib_s16 *dst,
    mlib_s32 xsize,
    const mlib_s16 *table0,
...
#pragma pipeloop(0)
		for (i = 0; i <= xsize - 24; i += 12, sa += 3, dp += 3) {
			...
			acc0a = vis_faligndata(t3, acc0a);
			acc0a = vis_faligndata(t2, acc0a);
			acc0 = vis_faligndata(t1, acc0);
			acc0 = vis_faligndata(t0, acc0);
			acc1a = vis_faligndata(t7, acc1a);
			acc1a = vis_faligndata(t6, acc1a);
			acc1 = vis_faligndata(t5, acc1);
			acc1 = vis_faligndata(t4, acc1);
			acc2a = vis_faligndata(t11, acc2a);
			acc2a = vis_faligndata(t10, acc2a);
			acc2 = vis_faligndata(t9, acc2);
			acc2 = vis_faligndata(t8, acc2);
			s0 = sa[0];
			s1 = sa[1];
			s2 = sa[2];
			dp[0] = vis_bshuffle(acc0, acc0a);
			dp[1] = vis_bshuffle(acc1, acc1a);
			dp[2] = vis_bshuffle(acc2, acc2a);
		}
...
void
mlib_v_ImageLookUp_U8_S16_3_SrcOff1_D1(
    const mlib_u8 *src,
    mlib_s16 *dst,
    mlib_s32 xsize,
    const mlib_s16 *table0,
...
void
mlib_v_ImageLookUp_U8_S16_3_SrcOff2_D1(
    const mlib_u8 *src,
    mlib_s16 *dst,
    mlib_s32 xsize,
    const mlib_s16 *table0,
...
void
mlib_v_ImageLookUp_U8_S16_3_SrcOff3_D1(
    const mlib_u8 *src,
    mlib_s16 *dst,
    mlib_s32 xsize,
    const mlib_s16 *table0,
...
/* row loop */
	for (j = 0; j < ysize; j++) {
		...
		if (size > 0) {
			...
			if (off == 0) {
				mlib_v_ImageLookUp_U8_S16_3_SrcOff0_D1(sp, dp,
				    size, tab0, tab1, tab2);
			} else if (off == 1) {
				mlib_v_ImageLookUp_U8_S16_3_SrcOff1_D1(sp, dp,
				    size, tab0, tab1, tab2);
			} else if (off == 2) {
				mlib_v_ImageLookUp_U8_S16_3_SrcOff2_D1(sp, dp,
				    size, tab0, tab1, tab2);
			} else {
				mlib_v_ImageLookUp_U8_S16_3_SrcOff3_D1(sp, dp,
				    size, tab0, tab1, tab2);
			}
		}
