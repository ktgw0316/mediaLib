...
#pragma ident	"@(#)mlib_v_ImageLookUpSIU16S16Func.c	9.2	07/11/05 SMI"
...
static void mlib_v_ImageLookUpSI_U16_S16_2_DstA8D1(
    const mlib_u16 *src,
    mlib_s16 *dst,
    mlib_s32 xsize,
    const mlib_s16 **table);

static void mlib_v_ImageLookUpSI_U16_S16_2_D1(
    const mlib_u16 *src,
    mlib_s16 *dst,
    mlib_s32 xsize,
    const mlib_s16 **table);

static void mlib_v_ImageLookUpSI_U16_S16_3_D1(
    const mlib_u16 *src,
    mlib_s16 *dst,
    mlib_s32 xsize,
    const mlib_s16 **table);

static void mlib_v_ImageLookUpSI_U16_S16_4_DstOff0_D1(
    const mlib_u16 *src,
    mlib_s16 *dst,
    mlib_s32 xsize,
    const mlib_s16 **table);

static void mlib_v_ImageLookUpSI_U16_S16_4_DstOff1_D1(
    const mlib_u16 *src,
    mlib_s16 *dst,
    mlib_s32 xsize,
    const mlib_s16 **table);

static void mlib_v_ImageLookUpSI_U16_S16_4_DstOff2_D1(
    const mlib_u16 *src,
    mlib_s16 *dst,
    mlib_s32 xsize,
    const mlib_s16 **table);

static void mlib_v_ImageLookUpSI_U16_S16_4_DstOff3_D1(
    const mlib_u16 *src,
    mlib_s16 *dst,
    mlib_s32 xsize,
    const mlib_s16 **table);
...
void
mlib_v_ImageLookUpSI_U16_S16_2_DstA8D1(
    const mlib_u16 *src,
    mlib_s16 *dst,
    mlib_s32 xsize,
    const mlib_s16 **table)
...
void
mlib_v_ImageLookUpSI_U16_S16_2(
    const mlib_u16 *src,
    mlib_s32 slb,
    mlib_s16 *dst,
    mlib_s32 dlb,
...
/* row loop */
	for (j = 0; j < ysize; j++) {
		...
		if (size > 0) {
			...
			if (((mlib_addr)dp & 7) == 0) {
				mlib_v_ImageLookUpSI_U16_S16_2_DstA8D1(sp, dp,
				    size, table);
			} else {
				mlib_v_ImageLookUpSI_U16_S16_2_D1(sp, dp, size,
				    table);
			}
		}
...
void
mlib_v_ImageLookUpSI_U16_S16_3_D1(
    const mlib_u16 *src,
    mlib_s16 *dst,
    mlib_s32 xsize,
    const mlib_s16 **table)
...
void
mlib_v_ImageLookUpSI_U16_S16_3(
    const mlib_u16 *src,
    mlib_s32 slb,
    mlib_s16 *dst,
    mlib_s32 dlb,
...
void
mlib_v_ImageLookUpSI_U16_S16_4_DstOff0_D1(
    const mlib_u16 *src,
    mlib_s16 *dst,
    mlib_s32 xsize,
    const mlib_s16 **table)
...
void
mlib_v_ImageLookUpSI_U16_S16_4_DstOff1_D1(
    const mlib_u16 *src,
    mlib_s16 *dst,
    mlib_s32 xsize,
    const mlib_s16 **table)
...
void
mlib_v_ImageLookUpSI_U16_S16_4_DstOff2_D1(
    const mlib_u16 *src,
    mlib_s16 *dst,
    mlib_s32 xsize,
    const mlib_s16 **table)
...
void
mlib_v_ImageLookUpSI_U16_S16_4(
    const mlib_u16 *src,
    mlib_s32 slb,
    mlib_s16 *dst,
    mlib_s32 dlb,
...
/* row loop */
	for (j = 0; j < ysize; j++) {
		...
		if (size > 0) {
			...
			if (off == 0) {
				mlib_v_ImageLookUpSI_U16_S16_4_DstOff0_D1(sp,
				    dp, size, table);
			} else if (off == 1) {
				s0 = *sp;
				(*dp++) = tab0[s0];
				size--;
				mlib_v_ImageLookUpSI_U16_S16_4_DstOff1_D1(sp,
				    dp, size, table);
			} else if (off == 2) {
				s0 = *sp;
				(*dp++) = tab0[s0];
				(*dp++) = tab1[s0];
				size--;
				mlib_v_ImageLookUpSI_U16_S16_4_DstOff2_D1(sp,
				    dp, size, table);
			} else if (off == 3) {
				s0 = *sp;
				(*dp++) = tab0[s0];
				...
				(*dp++) = tab2[s0];
				size--;
				mlib_v_ImageLookUpSI_U16_S16_4_DstOff3_D1(sp,
				    dp, size, table);
			}
		}
