...
#pragma ident	"@(#)mlib_v_ImageLookUpS32U8Func.c	9.2	07/11/05 SMI"
...
static void mlib_v_ImageLookUp_S32_U8_124_D1(
    const mlib_s32 *src,
    mlib_u8 *dst,
    mlib_s32 xsize,
...
static void mlib_v_ImageLookUp_S32_U8_3_D1(
    const mlib_s32 *src,
    mlib_u8 *dst,
    mlib_s32 xsize,
    const mlib_u8 *table0,
...
void
mlib_v_ImageLookUp_S32_U8_124_D1(
    const mlib_s32 *src,
    mlib_u8 *dst,
    mlib_s32 xsize,
    const mlib_u8 *table0,
    ...
    const mlib_u8 **table)
{
	mlib_s32 *sl;
	mlib_u8 *dl;
	const mlib_u8 *tab = &table[0][HALF_U64];
	mlib_s32 j, i;
...
/* row loop */
	for (j = 0; j < ysize; j++) {
		...
		if (size > 0) {
			mlib_v_ImageLookUp_S32_U8_124_D1(sp, dp, size, tab, tab,
			    tab, tab);
		}
...
/* row loop */
	for (j = 0; j < ysize; j++) {
		...
		if (size > 0) {
			mlib_v_ImageLookUp_S32_U8_124_D1(sp, dp, size, tab0,
			    tab1, tab0, tab1);
		}
...
void
mlib_v_ImageLookUp_S32_U8_3_D1(
    const mlib_s32 *src,
    mlib_u8 *dst,
    mlib_s32 xsize,
    const mlib_u8 *table0,
...
/* row loop */
	for (j = 0; j < ysize; j++) {
		...
		if (size > 0) {
			mlib_v_ImageLookUp_S32_U8_3_D1(sp, dp, size, tab0, tab1,
			    tab2);
		}
