...
#pragma ident	"@(#)mlib_v_ImageFilteredSubsam_S16.c	9.2	07/11/05 SMI"
 ...
 *      whether the symmetric kernel has a mlib_d64 center (even parity) or
...
#include <mlib_v_ImageFilteredSubsample_16.h>
