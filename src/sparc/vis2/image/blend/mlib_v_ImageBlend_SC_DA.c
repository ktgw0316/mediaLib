...
#pragma ident	"@(#)mlib_v_ImageBlend_SC_DA.c	9.2	07/11/05 SMI"

/*
 * FUNCTION
 *      mlib_ImageBlend_SC_DA - blend two images with
 *      DA source blend factor and SC destination blend factor
 *
 * SYNOPSIS
 *      mlib_status mlib_ImageBlend_SC_DA(mlib_image       *dst,
...
#pragma weak mlib_ImageBlend_SC_DA = __mlib_ImageBlend_SC_DA

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageBlend_SC_DA) mlib_ImageBlend_SC_DA
    __attribute__((weak, alias("__mlib_ImageBlend_SC_DA")));
