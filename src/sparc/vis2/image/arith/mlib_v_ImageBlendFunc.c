...
/* last 8-pixel column */
		...
		if ((mlib_addr)dp <= (mlib_addr)dend) {
			...
			vis_write_bmask(mask1, 0x01234567);
			sd10 = vis_bshuffle(s10, vis_ld_d64_nf(sp1 + 1));

			vis_write_bmask(mask2, 0x01234567);
			sd20 = vis_bshuffle(s20, vis_ld_d64_nf(sp2 + 1));
...
/* prepare the destination address */
		...
		mask1 = ((mlib_addr)(sa1 + (off >> 1)) & 7) * 0x11111111;
		mask2 = ((mlib_addr)(sa2 + (off >> 1)) & 7) * 0x11111111;
