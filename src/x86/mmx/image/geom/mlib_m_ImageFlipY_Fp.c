...
#pragma ident	"@(#)mlib_m_ImageFlipY_Fp.c	9.4	07/11/05 SMI"

/*
 * FUNCTION
 *      mlib_ImageFlipY_Fp - flip image on Y axis
 *
 * SYNOPSIS
...
#pragma weak mlib_ImageFlipY_Fp = __mlib_ImageFlipY_Fp

#elif defined(__GNUC__)  /* defined(__SUNPRO_C) */

__typeof__(__mlib_ImageFlipY_Fp) mlib_ImageFlipY_Fp
    __attribute__((weak, alias("__mlib_ImageFlipY_Fp")));
...
/* *************************************************************** */
    ...
    mlib_image *dst,
    const mlib_image *src);
    void mlib_ImageFlipY_D64_1(
    mlib_image *dst,
    const mlib_image *src);
    void mlib_ImageFlipY_D64_2(
    mlib_image *dst,
    const mlib_image *src);
