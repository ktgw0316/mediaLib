...
#pragma ident	"@(#)mlib_m_ImageFlipMainDiag.c	9.4	07/11/05 SMI"
...
/* *********************************************************** */
    ...
    void mlib_m_ImageFlipMainDiag_U8_1(
    mlib_image *dst,
    const mlib_image *src);
    void mlib_c_ImageFlipMainDiag_U8_2(
    mlib_image *dst,
    const mlib_image *src);
    void mlib_c_ImageFlipMainDiag_S16_1(
    mlib_image *dst,
    const mlib_image *src);
...
/*  handle MLIB_BYTE data type of image  */
	case MLIB_BYTE:
		switch (mlib_ImageGetChannels(src)) {
		case 1:
			mlib_m_ImageFlipMainDiag_U8_1(dst, src);
			break;
		case 2:
			mlib_c_ImageFlipMainDiag_U8_2(dst, src);
			break;
		case 3:
...
/*  handle MLIB_SHORT data type of image  */
	...
	case MLIB_USHORT:
		switch (mlib_ImageGetChannels(src)) {
		case 1:
			mlib_c_ImageFlipMainDiag_S16_1(dst, src);
			break;
		case 2:
			mlib_ImageFlipMainDiag_S32_1(dst, src);
			break;
		case 3:
			...
			break;
		case 4:
			mlib_ImageFlipMainDiag_D64_1(dst, src);
			break;
		default:
			return (MLIB_FAILURE);
		}
...
/*  handle MLIB_INT data type of image  */
	case MLIB_INT:
		...
		case 2:
			...
			break;
		case 3:
			mlib_ImageFlipMainDiag_S32_3(dst, src);
			break;
		case 4:
			mlib_ImageFlipMainDiag_D64_2(dst, src);
			break;
		default:
			return (MLIB_FAILURE);
		}
...
#define	ALOAD_4X4_1S16                                                  \
	{                                                               \
	    mlib_u16 *psq2 = (void *)((mlib_u8 *)pssq + 2 * sstride);   \
	                                                                \
	    wi0 = *(__m64 *) (pssq);                                    \
	    wi1 = *(__m64 *) ((mlib_u8 *)pssq + sstride);               \
	    wi2 = *(__m64 *) (psq2);                                    \
...
#define	TRANSP_2X8_4U8                                          \
	wo0 = _mm_unpacklo_pi32(wi0, wi1);                      \
	wo1 = _mm_unpacklo_pi32(wi2, wi3);                      \
	wo2 = _mm_unpacklo_pi32(wi4, wi5);                      \
	wo3 = _mm_unpacklo_pi32(wi6, wi7);                      \
	wo4 = _mm_unpackhi_pi32(wi0, wi1);                      \
	wo5 = _mm_unpackhi_pi32(wi2, wi3);                      \
	wo6 = _mm_unpackhi_pi32(wi4, wi5);                      \
	wo7 = _mm_unpackhi_pi32(wi6, wi7)
...
void
mlib_m_ImageFlipMainDiag_S16_1(
    mlib_image *dst,
    const mlib_image *src)
{
...
void
mlib_c_ImageFlipMainDiag_S16_1(
    mlib_image *dst,
    const mlib_image *src)
{
	PREPAREVARS(mlib_u16, 1)
