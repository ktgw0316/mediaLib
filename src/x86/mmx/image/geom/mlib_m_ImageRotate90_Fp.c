...
#pragma ident	"@(#)mlib_m_ImageRotate90_Fp.c	9.4	07/11/05 SMI"

/*
 * FUNCTION
 *      mlib_ImageRotate90_Fp - flip image on main diag
 *
 * SYNOPSIS
 *      mlib_status mlib_ImageRotate90_Fp(mlib_image *dst,
...
#pragma weak mlib_ImageRotate90_Fp = __mlib_ImageRotate90_Fp

#elif defined(__GNUC__)  /* defined(__SUNPRO_C) */

__typeof__(__mlib_ImageRotate90_Fp) mlib_ImageRotate90_Fp
    __attribute__((weak, alias("__mlib_ImageRotate90_Fp")));
...
/* *************************************************************** */
    ...
    mlib_image *dst,
    const mlib_image *src);
    void mlib_ImageRotate90_S32_2(
    mlib_image *dst,
    const mlib_image *src);
    void mlib_ImageRotate90_S32_3(
    mlib_image *dst,
    const mlib_image *src);
    void mlib_ImageRotate90_S32_4(
    mlib_image *dst,
    const mlib_image *src);
...
/*  handle MLIB_DOUBLE data type of image  */
	case MLIB_DOUBLE:
		...
		case 2:
			...
			break;
		case 3:
			mlib_ImageRotate90_D64_3(dst, src);
			break;
		case 4:
			mlib_ImageRotate90_D64_4(dst, src);
			break;
		default:
			return (MLIB_FAILURE);
		}
