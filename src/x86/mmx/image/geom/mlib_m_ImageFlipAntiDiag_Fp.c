...
#pragma ident	"@(#)mlib_m_ImageFlipAntiDiag_Fp.c	9.4	07/11/05 SMI"
...
/* *************************************************************** */
    ...
    mlib_image *dst,
    const mlib_image *src);
    void mlib_ImageFlipAntiDiag_S32_2(
    mlib_image *dst,
    const mlib_image *src);
    void mlib_ImageFlipAntiDiag_S32_3(
    mlib_image *dst,
    const mlib_image *src);
    void mlib_ImageFlipAntiDiag_S32_4(
    mlib_image *dst,
    const mlib_image *src);

    void mlib_ImageFlipAntiDiag_D64_1(
    mlib_image *dst,
    const mlib_image *src);
    void mlib_ImageFlipAntiDiag_D64_2(
    mlib_image *dst,
    const mlib_image *src);
    void mlib_ImageFlipAntiDiag_D64_3(
    mlib_image *dst,
    const mlib_image *src);
    void mlib_ImageFlipAntiDiag_D64_4(
    mlib_image *dst,
    const mlib_image *src);
...
/*  handle MLIB_FLOAT data type of image  */
	case MLIB_FLOAT:
		...
		case 1:
			...
			break;
		case 2:
			mlib_ImageFlipAntiDiag_D64_1(dst, src);
			break;
		case 3:
			mlib_ImageFlipAntiDiag_S32_3(dst, src);
			break;
		case 4:
			mlib_ImageFlipAntiDiag_D64_2(dst, src);
			break;
		default:
			return (MLIB_FAILURE);
		}
...
/*  handle MLIB_DOUBLE data type of image  */
	case MLIB_DOUBLE:
		...
		case 2:
			...
			break;
		case 3:
			mlib_ImageFlipAntiDiag_D64_3(dst, src);
			break;
		case 4:
			mlib_ImageFlipAntiDiag_D64_4(dst, src);
			break;
		default:
			return (MLIB_FAILURE);
		}
