...
#pragma ident	"@(#)mlib_m_ImageAffineTable_s16nw.c	9.4	07/11/05 SMI"
...
void mlib_m_ImageAffineTableLine_s16nw_4_4_1(
    PARAMS_INT);
void mlib_m_ImageAffineTableLine_s16nw_4_2_1(
    PARAMS_INT);
void mlib_m_ImageAffineTableLine_s16nw_3_4_1(
    PARAMS_INT);
void mlib_m_ImageAffineTableLine_s16nw_3_2_1(
    PARAMS_INT);
void mlib_m_ImageAffineTableLine_s16nw_2_4_1(
    PARAMS_INT);
void mlib_m_ImageAffineTableLine_s16nw_2_2_1(
    PARAMS_INT);

void mlib_m_ImageAffineTableLine_s16nw_4_4_2(
    PARAMS_INT);
void mlib_m_ImageAffineTableLine_s16nw_4_2_2(
    PARAMS_INT);
void mlib_m_ImageAffineTableLine_s16nw_3_4_2(
    PARAMS_INT);
void mlib_m_ImageAffineTableLine_s16nw_3_2_2(
    PARAMS_INT);
void mlib_m_ImageAffineTableLine_s16nw_2_4_2(
    PARAMS_INT);
void mlib_m_ImageAffineTableLine_s16nw_2_2_2(
    PARAMS_INT);

void mlib_m_ImageAffineTableLine_s16nw_4_4_3(
    PARAMS_INT);
void mlib_m_ImageAffineTableLine_s16nw_4_3_3(
    PARAMS_INT);
void mlib_m_ImageAffineTableLine_s16nw_4_2_3(
    PARAMS_INT);
void mlib_m_ImageAffineTableLine_s16nw_3_4_3(
    PARAMS_INT);
void mlib_m_ImageAffineTableLine_s16nw_3_3_3(
    PARAMS_INT);
void mlib_m_ImageAffineTableLine_s16nw_3_2_3(
    PARAMS_INT);
void mlib_m_ImageAffineTableLine_s16nw_2_4_3(
    PARAMS_INT);
void mlib_m_ImageAffineTableLine_s16nw_2_3_3(
    PARAMS_INT);
void mlib_m_ImageAffineTableLine_s16nw_2_2_3(
    PARAMS_INT);

void mlib_m_ImageAffineTableLine_s16nw_4_4_4(
    PARAMS_INT);
void mlib_m_ImageAffineTableLine_s16nw_4_3_4(
    PARAMS_INT);
void mlib_m_ImageAffineTableLine_s16nw_4_2_4(
    PARAMS_INT);
void mlib_m_ImageAffineTableLine_s16nw_3_4_4(
    PARAMS_INT);
void mlib_m_ImageAffineTableLine_s16nw_3_3_4(
    PARAMS_INT);
void mlib_m_ImageAffineTableLine_s16nw_3_2_4(
    PARAMS_INT);
void mlib_m_ImageAffineTableLine_s16nw_2_4_4(
    PARAMS_INT);
void mlib_m_ImageAffineTableLine_s16nw_2_3_4(
    PARAMS_INT);
void mlib_m_ImageAffineTableLine_s16nw_2_2_4(
    PARAMS_INT);
...
mlib_status
mlib_m_ImageAffineTable_s16nw_1(
    PARAMS_NW)
{
...
/* offset in current kernel line */
		...
		for (i = 0; i < size; i += 4) {
			*dp =
			    _mm_packs_pi32(_mm_srai_pi32(_mm_unpacklo_pi16
			    (_m_zero, ddst[0]), shift),
			    _mm_srai_pi32(_mm_unpackhi_pi16(_m_zero, ddst[0]),
			    shift));
			dp++;
			ddst++;
		}
...
mlib_status
mlib_m_ImageAffineTable_s16nw_2(
    PARAMS_NW)
{
	DECLAREVAR __m64 buff_local[BUFF_SIZE], *buff = buff_local, *buff_acc;
	mlib_s32 shift;
...
mlib_status
mlib_m_ImageAffineTable_s16nw_3(
    PARAMS_NW)
{
	DECLAREVAR __m64 buff_local[BUFF_SIZE], *buff = buff_local, *buff_acc;
	mlib_s32 shift;
...
mlib_status
mlib_m_ImageAffineTable_s16nw_4(
    PARAMS_NW)
{
	DECLAREVAR __m64 buff_local[BUFF_SIZE], *buff = buff_local, *buff_acc;
	mlib_s32 shift;
...
/* offset in current kernel line */
			for (off = 0; off < m; off += kw) {
				...
				if (kh == 4) {
				    if (kw == 4)
					mlib_m_ImageAffineTableLine_s16nw_4_4_4
					    (CALL_PARAMS_INT);
				    else if (kw == 3)
					mlib_m_ImageAffineTableLine_s16nw_4_3_4
					    (CALL_PARAMS_INT);
				    else if (kw == 2)
					mlib_m_ImageAffineTableLine_s16nw_4_2_4
					    (CALL_PARAMS_INT);
				} else if (kh == 3) {
				    if (kw == 4)
					mlib_m_ImageAffineTableLine_s16nw_3_4_4
					    (CALL_PARAMS_INT);
				    else if (kw == 3)
					mlib_m_ImageAffineTableLine_s16nw_3_3_4
					    (CALL_PARAMS_INT);
				    else if (kw == 2)
					mlib_m_ImageAffineTableLine_s16nw_3_2_4
					    (CALL_PARAMS_INT);
				} else {	/* if (kh == 2) */

				    if (kw == 4)
					mlib_m_ImageAffineTableLine_s16nw_2_4_4
					    (CALL_PARAMS_INT);
				    else if (kw == 3)
					mlib_m_ImageAffineTableLine_s16nw_2_3_4
					    (CALL_PARAMS_INT);
				    else if (kw == 2)
					mlib_m_ImageAffineTableLine_s16nw_2_2_4
					    (CALL_PARAMS_INT);
				}
    ...
    PARAMS_NW)
{
	...
	switch (ws->nchan) {
	case 1:
		res = mlib_m_ImageAffineTable_s16nw_1(CALL_PARAMS);
		break;
	case 2:
		res = mlib_m_ImageAffineTable_s16nw_2(CALL_PARAMS);
		break;
	case 3:
		res = mlib_m_ImageAffineTable_s16nw_3(CALL_PARAMS);
		break;
	case 4:
		res = mlib_m_ImageAffineTable_s16nw_4(CALL_PARAMS);
		break;
	default:
		res = MLIB_FAILURE;
		break;
