...
#ifndef _MLIB_M_IMAGEFILTERS_H
#define	_MLIB_M_IMAGEFILTERS_H

#pragma ident	"@(#)mlib_m_ImageFilters.h	9.2	07/11/05 SMI"
...
/*
 *    These tables are used by MMX version
...
extern const mlib_s16 mlib_filters_u8_bl[],
    ...
    mlib_filters_s16_bc2_3[], mlib_filters_s16_bc_4[], mlib_filters_s16_bc2_4[];

#ifdef __cplusplus
}
#endif

#endif /* _MLIB_M_IMAGEFILTERS_H */
