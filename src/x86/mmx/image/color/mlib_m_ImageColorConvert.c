...
#pragma ident	"@(#)mlib_m_ImageColorConvert.c	9.4	07/11/05 SMI"
...
/* *********************************************************** */
    ...
    mlib_status mlib_m_ImageColorConvert1_U8(
    const mlib_u8 *src,
    mlib_s32 slb,
    mlib_u8 *dst,
    mlib_s32 dlb,
    ...
    mlib_status mlib_m_ImageColorConvert1_S16(
    const mlib_s16 *src,
    mlib_s32 slb,
    mlib_s16 *dst,
    mlib_s32 dlb,
    ...
    mlib_status mlib_m_ImageColorConvert2_U8(
    const mlib_u8 *src,
    mlib_s32 slb,
    mlib_u8 *dst,
    mlib_s32 dlb,
    ...
    mlib_status mlib_m_ImageColorConvert2_S16(
    const mlib_s16 *src,
    mlib_s32 slb,
    mlib_s16 *dst,
    mlib_s32 dlb,
    ...
    mlib_status mlib_m_ImageColorConvert2_U16(
    const mlib_u16 *src,
    mlib_s32 slb,
    mlib_u16 *dst,
    mlib_s32 dlb,
    ...
    const mlib_d64 *fmat)
{
	...
	if (dtype == MLIB_BYTE) {
		mlib_m_ImageColor1_Mat_U8(fmat, &scale);

		if (scale > 7)
			return (MLIB_FAILURE);

		return mlib_m_ImageColorConvert1_U8(sa, slb,
		    da, dlb, xsize, ysize, fmat, scale);
	} else if (dtype == MLIB_SHORT) {
		mlib_m_ImageColor1_Mat_S16(fmat, &scale);

		if (scale > 15)
			return (MLIB_FAILURE);

		return mlib_m_ImageColorConvert1_S16(sa, slb / 2,
		    da, dlb / 2, xsize, ysize, fmat, scale);
	} else if (dtype == MLIB_USHORT) {

		offset0[0] =
		    32768. * fmat[0] + 32768. * fmat[1] + 32768. * fmat[2] -
		    32768.;
		offset0[1] =
		    32768. * fmat[3] + 32768. * fmat[4] + 32768. * fmat[5] -
		    32768.;
		offset0[2] =
		    32768. * fmat[6] + 32768. * fmat[7] + 32768. * fmat[8] -
		    32768.;

		mlib_m_ImageColor2_Mat_S16(fmat, offset0, &scale);

		if (scale > 15)
			return (MLIB_FAILURE);

		return mlib_m_ImageColorConvert2_U16(sa, slb / 2,
		    da, dlb / 2, xsize, ysize, fmat, offset0, scale);
	} else if (dtype == MLIB_INT) {
		return mlib_m_ImageColorConvert1_S32(sa, slb / 4,
    ...
    const mlib_d64 *offset)
{
	...
	if (dtype == MLIB_BYTE) {
		mlib_m_ImageColor2_Mat_U8(fmat, offset, &scale);

		if (scale > 7)
			return (MLIB_FAILURE);

		return mlib_m_ImageColorConvert2_U8(sa, slb,
		    da, dlb, xsize, ysize, fmat, offset, scale);
	} else if (dtype == MLIB_SHORT) {
		mlib_m_ImageColor2_Mat_S16(fmat, offset, &scale);

		if (scale > 15)
			return (MLIB_FAILURE);

		return mlib_m_ImageColorConvert2_S16(sa, slb / 2,
		    da, dlb / 2, xsize, ysize, fmat, offset, scale);
	} else if (dtype == MLIB_USHORT) {

		offset0[0] =
		    offset[0] + 32768. * fmat[0] + 32768. * fmat[1] +
		    32768. * fmat[2] - 32768.;
		offset0[1] =
		    offset[1] + 32768. * fmat[3] + 32768. * fmat[4] +
		    32768. * fmat[5] - 32768.;
		offset0[2] =
		    offset[2] + 32768. * fmat[6] + 32768. * fmat[7] +
		    32768. * fmat[8] - 32768.;
		...
		return mlib_m_ImageColorConvert2_S32(sa, slb / 4,
