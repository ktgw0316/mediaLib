...
#pragma ident	"@(#)mlib_m_ImageSConv3x3_u16nw_3.c	9.2	07/11/05 SMI"
...
#define	PREP_V()                                                \
	...
	s1 = _mm_xor_si64(s1, mask8000);                        \
	s2 = _mm_xor_si64(s2, mask8000);                        \
	v2 = _mm_mulhi_pi16(s0, vker0);                         \
	v2 = _mm_add_pi16(v2, _mm_mulhi_pi16(s1, vker1));       \
	v2 = _mm_add_pi16(v2, _mm_mulhi_pi16(s2, vker2))
    ...
    mlib_s32 scalef_expon)
{
	...
	__m64 s0, s1, s2, v0, v1, v2, aa, bb, rr, rh, rl;
