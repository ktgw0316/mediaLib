...
#pragma ident	"@(#)mlib_m_ImageSConv7x7_8nw_2.c	9.2	07/11/05 SMI"
...
#define	PREP_7x7(xx, i)                                         \
	...
	sum6 = _mm_add_pi16(sum6, _mm_mulhi_pi16(d1, hker2));   \
	aa = ALGN(d1, d2, 32);                                  \
	sum6 = _mm_add_pi16(sum6, _mm_mulhi_pi16(aa, hker3));   \
	sum6 = _mm_add_pi16(sum6, _mm_mulhi_pi16(d2, hker4));   \
	aa = ALGN(d2, d3, 32);                                  \
	sum6 = _mm_add_pi16(sum6, _mm_mulhi_pi16(aa, hker5));   \
	sum6 = _mm_add_pi16(sum6, _mm_mulhi_pi16(d3, hker6));   \
	buff6[i] = sum6
    ...
    mlib_s32 scalef_expon)
{
	...
	__m64 s0, d0, d1, d2, d3, aa, res_hi, res_lo;
