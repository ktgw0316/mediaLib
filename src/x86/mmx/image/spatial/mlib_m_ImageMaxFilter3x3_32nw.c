...
#pragma ident	"@(#)mlib_m_ImageMaxFilter3x3_32nw.c	9.2	07/11/05 SMI"
...
#define	C_COMP(a, b)                                            \
	_mm_add_pi32(a, _mm_and_si64(_mm_sub_pi32(b, a),        \
	    _mm_cmpgt_pi32(b, a)))
