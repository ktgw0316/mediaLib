...
#pragma ident	"@(#)mlib_m_ImageSConv5x5_8nw_2.c	9.2	07/11/05 SMI"
...
#define	PREP_5x5(xx, i)                                         \
	...
	sum4 = _mm_add_pi16(sum4, _mm_mulhi_pi16(d1, hker2));   \
	bb = ALGN(d1, d2, 32);                                  \
	sum4 = _mm_add_pi16(sum4, _mm_mulhi_pi16(bb, hker3));   \
	sum4 = _mm_add_pi16(sum4, _mm_mulhi_pi16(d2, hker4));   \
	buff4[i] = sum4
