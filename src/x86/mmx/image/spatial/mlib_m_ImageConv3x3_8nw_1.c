...
#pragma ident	"@(#)mlib_m_ImageConv3x3_8nw_1.c	9.2	07/11/05 SMI"
...
#define	UNPACK_SRC(dd, xx)                                      \
	dd = _mm_unpack##xx##_pi8(s0, _m_zero);                 \
	dd = _mm_slli_pi16(d1, 7)

/* *********************************************************** */
mlib_status
mlib_m_conv3x3_8nw_1(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kern,
    mlib_s32 scalef_expon)
{
	...
	__m64 s0, d0, d1, prev0, prev1, sum0, sum1, sum2, aa, bb, res_hi,
	    res_lo;
	mlib_s32 shift;
	mlib_s32 *sp;
