...
#pragma ident	"@(#)mlib_m_ImageConv3x3_u16nw_4.c	9.2	07/11/05 SMI"
    ...
    mlib_s32 scalef_expon)
{
	...
	__m64 d0, d1, d2, rr, tmpa, tmpb, ker_off, mask8000;
