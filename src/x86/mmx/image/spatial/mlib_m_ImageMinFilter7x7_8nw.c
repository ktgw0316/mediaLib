...
#pragma ident	"@(#)mlib_m_ImageMinFilter7x7_8nw.c	9.2	07/11/05 SMI"
...
#define	C_COMP(a, b)                                                   \
	_mm_add_pi8(a, _mm_and_si64(_mm_sub_pi8(b, a),                 \
	    _mm_cmpgt_pi8(_mm_xor_si64(b, mask8080), _mm_xor_si64(a,   \
	    mask8080))))
...
#define	C_COMP(a, b)                                                   \
	_mm_add_pi8(a, _mm_and_si64(_mm_sub_pi8(b, a),                 \
	    _mm_cmpgt_pi8(_mm_xor_si64(a, mask8080), _mm_xor_si64(b,   \
	    mask8080))))
