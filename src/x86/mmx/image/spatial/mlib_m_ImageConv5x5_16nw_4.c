...
#pragma ident	"@(#)mlib_m_ImageConv5x5_16nw_4.c	9.3	07/11/05 SMI"
 ...
 *
 * SYNOPSIS
 *  mlib_status mlib_m_conv5x5_16nw(mlib_image       *dst,
    ...
    mlib_s32 scalef_expon)
{
	...
	__m64 ker[5][5];
	__m64 d0, d1, d2, d3, d4, bb, cc, rr, tmpa, tmpb;
