...
#pragma ident	"@(#)mlib_m_ImageConv3x3_8nw_4.c	9.2	07/11/05 SMI"
...
#define	PREP_3x3()                                              \
	...
	sum0 = _mm_add_pi16(sum0, _mm_mulhi_pi16(d1, ker2));    \
	sum1 = _mm_add_pi16(sum1, _mm_mulhi_pi16(d1, ker5));    \
	sum0 = _mm_add_pi16(sum0, _mm_mulhi_pi16(d2, ker3));    \
	sum1 = _mm_add_pi16(sum1, _mm_mulhi_pi16(d2, ker6));    \
	buff1[i] = sum0;                                        \
	buff2[i] = sum1
...
#define	CONV_3x3(xx, i)                                         \
	...
	sum0 = _mm_add_pi16(sum0, _mm_mulhi_pi16(d1, ker2));    \
	sum1 = _mm_add_pi16(sum1, _mm_mulhi_pi16(d1, ker5));    \
	sum2 = _mm_add_pi16(sum2, _mm_mulhi_pi16(d1, ker8));    \
	sum0 = _mm_add_pi16(sum0, _mm_mulhi_pi16(d2, ker3));    \
	sum1 = _mm_add_pi16(sum1, _mm_mulhi_pi16(d2, ker6));    \
	sum2 = _mm_add_pi16(sum2, _mm_mulhi_pi16(d2, ker9));    \
    ...
    mlib_s32 scalef_expon)
{
	...
	__m64 s0, d0, d1, d2, prev0, prev1, sum0, sum1, sum2, res_hi, res_lo;
	__m64 zero = _m_zero;
	mlib_s32 shift;
	mlib_s32 *sp;
