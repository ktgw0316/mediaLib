...
#pragma ident	"@(#)mlib_m_ImageConv5x5_u16nw_4.c	9.2	07/11/05 SMI"
...
#define	PREP_5x5()                                              \
	...
	d3 = d4;                                                \
	d4 = (*sp++);                                           \
	d4 = _mm_xor_si64(d4, mask8000);                        \
	mmx_mul_16x16(sum0, d0, ker[0][0]);                     \
	mmx_mul_16x16(sum1, d0, ker[1][0]);                     \
	mmx_mul_16x16(sum2, d0, ker[2][0]);                     \
	mmx_mul_16x16(sum3, d0, ker[3][0]);                     \
	mmx_madd_16x16(sum0, d1, ker[0][1]);                    \
	mmx_madd_16x16(sum1, d1, ker[1][1]);                    \
	mmx_madd_16x16(sum2, d1, ker[2][1]);                    \
	mmx_madd_16x16(sum3, d1, ker[3][1]);                    \
	mmx_madd_16x16(sum0, d2, ker[0][2]);                    \
	mmx_madd_16x16(sum1, d2, ker[1][2]);                    \
	mmx_madd_16x16(sum2, d2, ker[2][2]);                    \
	mmx_madd_16x16(sum3, d2, ker[3][2]);                    \
	mmx_madd_16x16(sum0, d3, ker[0][3]);                    \
	mmx_madd_16x16(sum1, d3, ker[1][3]);                    \
	mmx_madd_16x16(sum2, d3, ker[2][3]);                    \
	mmx_madd_16x16(sum3, d3, ker[3][3]);                    \
	mmx_madd_16x16(sum0, d4, ker[0][4]);                    \
	mmx_madd_16x16(sum1, d4, ker[1][4]);                    \
	mmx_madd_16x16(sum2, d4, ker[2][4]);                    \
	mmx_madd_16x16(sum3, d4, ker[3][4]);                    \
	buff0[2 * i] = sum0h;                                   \
	buff1[2 * i] = sum1h;                                   \
	buff2[2 * i] = sum2h;                                   \
	buff3[2 * i] = sum3h;                                   \
...
#define	CONV_5x5(xx, i)                                         \
	...
	mmx_madd_16x16(sum2, d1, ker[2][1]);                    \
	mmx_madd_16x16(sum3, d1, ker[3][1]);                    \
	mmx_madd_16x16(sum4, d1, ker[4][1]);                    \
	bb = _mm_add_pi32(d2, _m_zero);                         \
/*                                                              \
 * to prevent compiler bug                                      \
 */                                                             \
 ...
 */                                                             \
	...
	mmx_madd_16x16(sum2, d4, ker[2][4]);                    \
	mmx_madd_16x16(sum3, d4, ker[3][4]);                    \
	mmx_madd_16x16(sum4, d4, ker[4][4]);                    \
	prev0h = buff0[2 * i];                                  \
	prev1h = buff1[2 * i];                                  \
	prev2h = buff2[2 * i];                                  \
	prev3h = buff3[2 * i];                                  \
    ...
    mlib_s32 scalef_expon)
{
	...
	__m64 ker[5][5];
	__m64 d0, d1, d2, d3, d4, bb, cc, rr, tmpa, tmpb, ker_off, mask8000;
