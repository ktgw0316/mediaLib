...
#pragma ident	"@(#)mlib_m_ImageSConv7x7_16nw_2.c	9.2	07/11/05 SMI"
...
#define	CONV_7x7()                                              \
	...
	bb = ALGN(v1, v2, 32);                                  \
	rr = _mm_add_pi16(rr, _mm_mulhi_pi16(bb, hker3));       \
	rr = _mm_add_pi16(rr, _mm_mulhi_pi16(v2, hker4));       \
	cc = ALGN(v2, v3, 32);                                  \
	rr = _mm_add_pi16(rr, _mm_mulhi_pi16(cc, hker5));       \
	rr = _mm_add_pi16(rr, _mm_mulhi_pi16(v3, hker6));       \
    ...
    mlib_s32 scalef_expon)
{
	...
	__m64 s0, s1, s2, s3, s4, s5, s6, v0, v1, v2, v3, rr, rh, rl;
	__m64 aa, bb, cc, zero, _rnd;
