...
#pragma ident	"@(#)mlib_m_ImageConv3x3.c	9.4	07/11/05 SMI"
...
/* *********************************************************** */
    ...
    mlib_status mlib_m_conv3x3_8nw_1(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);

    mlib_status mlib_m_conv3x3_8nw_2(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);

    mlib_status mlib_m_conv3x3_8nw_3(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);

    mlib_status mlib_m_conv3x3_8nw_4(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);
...
/* *********************************************************** */
    ...
    mlib_status mlib_m_conv3x3_16nw_1(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);

    mlib_status mlib_m_conv3x3_16nw_2(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);

    mlib_status mlib_m_conv3x3_16nw_3(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);
...
/* *********************************************************** */
    ...
    mlib_status mlib_m_conv3x3_u16nw_1(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);

    mlib_status mlib_m_conv3x3_u16nw_2(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);

    mlib_status mlib_m_conv3x3_u16nw_3(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);

    mlib_status mlib_m_conv3x3_u16nw_4(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);
    ...
    mlib_s32 cmask)
{
	...
	switch (nchan) {
	case 1:
		return (mlib_m_conv3x3_8nw_1(dst, src, kernel, scalef_expon));
	case 2:
		return (mlib_m_conv3x3_8nw_2(dst, src, kernel, scalef_expon));
	case 3:
		return (mlib_m_conv3x3_8nw_3(dst, src, kernel, scalef_expon));
	case 4:
		return (mlib_m_conv3x3_8nw_4(dst, src, kernel, scalef_expon));
	}
    ...
    mlib_s32 cmask)
{
	...
	switch (nchan) {
	case 1:
		return (mlib_m_conv3x3_16nw_1(dst, src, kernel, scalef_expon));
	case 2:
		return (mlib_m_conv3x3_16nw_2(dst, src, kernel, scalef_expon));
	case 3:
		return (mlib_m_conv3x3_16nw_3(dst, src, kernel, scalef_expon));
	case 4:
		return (mlib_m_conv3x3_16nw_4(dst, src, kernel, scalef_expon));
	}
    ...
    mlib_s32 cmask)
{
	...
	switch (nchan) {
	case 1:
		return (mlib_m_conv3x3_u16nw_1(dst, src, kernel, scalef_expon));
	case 2:
		return (mlib_m_conv3x3_u16nw_2(dst, src, kernel, scalef_expon));
	case 3:
		return (mlib_m_conv3x3_u16nw_3(dst, src, kernel, scalef_expon));
	case 4:
		return (mlib_m_conv3x3_u16nw_4(dst, src, kernel, scalef_expon));
	}
		...
		if (mlib_ImageGetWidth(src_i) >= ksize &&
			...
			case MLIB_BYTE:
				if (scale < 16 || scale > 31)
					return (MLIB_FAILURE);
				mlib_m_conv3x3nw_u8(dst_i, src_i,
			...
			case MLIB_SHORT:
				if (scale < 17 || scale > 32)
					return (MLIB_FAILURE);
				mlib_m_conv3x3nw_s16(dst_i, src_i,
				    (void *)kernel, scale, cmask);
				break;
			...
			case MLIB_USHORT:
				if (scale < 17 || scale > 32)
					return (MLIB_FAILURE);
				mlib_m_conv3x3nw_u16(dst_i, src_i,
				    (void *)kernel, scale, cmask);
				break;
...
/* adjust src_e image */
		...
		case MLIB_BYTE:
			...
			if (mlib_ImageConvVersion(3, 3, scale, type) == 0)
				mlib_c_conv3x3ext_u8(dst_e, src_e, dx_l, dx_r,
				    dy_t, dy_b, (void *)kernel, scale, cmask);
			else
				mlib_i_conv3x3ext_u8(dst_e, src_e, dx_l, dx_r,
				    dy_t, dy_b, (void *)kernel, scale, cmask);
			break;
		case MLIB_SHORT:
			if (scale < 17 || scale > 32)
