...
#pragma ident	"@(#)mlib_m_ImageSConv7x7_u16nw_1.c	9.2	07/11/05 SMI"
...
#define	CONV_7x7()                                              \
	...
	aa = ALGN(v0, v1, 32);                                  \
	rr = _mm_add_pi16(rr, _mm_mulhi_pi16(aa, hker2));       \
	aa = ALGN(v0, v1, 48);                                  \
	rr = _mm_add_pi16(rr, _mm_mulhi_pi16(aa, hker3));       \
	rr = _mm_add_pi16(rr, _mm_mulhi_pi16(v1, hker4));       \
	aa = ALGN(v1, v2, 16);                                  \
	rr = _mm_add_pi16(rr, _mm_mulhi_pi16(aa, hker5));       \
	aa = ALGN(v1, v2, 32);                                  \
	rr = _mm_add_pi16(rr, _mm_mulhi_pi16(aa, hker6));       \
    ...
    mlib_s32 scalef_expon)
{
	...
	__m64 s0, s1, s2, s3, s4, s5, s6, v0, v1, v2, rr, rh, rl;
	__m64 aa, zero, _rnd, ker_off, mask8000;
