...
#pragma ident	"@(#)mlib_m_ImageMedianFilter5x5Func.c	9.2	07/11/05 SMI"
 ...
 */                                                                       \
	...
	{                                                                 \
		...
		fs->size;                                                 \
	    mlib_u8 *dp, *sp;                                             \
	    __m64 mask80, mask, d1, d2, d3, d4, d5, d6, d7, d8, d9, dA;   \
		...
		d8 = *(__m64 *) buff3;                                    \
		d9 = *(__m64 *) buff4;                                    \
		MMX_SORT5(d1, d2, d3, d4, d5, img_type);                  \
		dA = d3;                                                  \
		MMX_SORT5(d6, d7, d8, d9, dA, img_type);                  \
		*(__m64 *) buff5 = d3;                                    \
		*(__m64 *) dp = d8;                                       \
		sp += 8;                                                  \
		dp += 8;                                                  \
    ...
    mlib_filter_state * fs)
{
	...
	mlib_f32 *dl, *sl;
	mlib_f32 mask, d1, d2, d3, d4, d5, d6, d7, d8, d9;
	mlib_f32 *buff1, *buff2, *buff3, *buff4, *buff5;
    ...
    mlib_filter_state * fs)
{
	mlib_s32 nchan = fs->nchan, cmask = fs->cmask, size = fs->size;
	mlib_d64 *dl, *sl;
	mlib_d64 mask, d1, d2, d3, d4, d5, d6, d7, d8, d9;
	mlib_d64 *buff1, *buff2, *buff3, *buff4, *buff5;
	mlib_s32 off0 = -2 * nchan, off1 = -nchan, off2 = 0;
	mlib_s32 off3 = nchan, off4 = 2 * nchan, i, k;
