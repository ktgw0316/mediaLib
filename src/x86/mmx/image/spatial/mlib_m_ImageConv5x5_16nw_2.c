...
#pragma ident	"@(#)mlib_m_ImageConv5x5_16nw_2.c	9.2	07/11/05 SMI"
...
#define	PREP_5x5()                                              \
	...
	mmx_madd_16x16(sum0, d1, ker[0][2]);                    \
	mmx_madd_16x16(sum1, d1, ker[1][2]);                    \
	mmx_madd_16x16(sum2, d1, ker[2][2]);                    \
	mmx_madd_16x16(sum3, d1, ker[3][2]);                    \
	bb = ALGN(d1, d2, 32);                                  \
	mmx_madd_16x16(sum0, bb, ker[0][3]);                    \
	mmx_madd_16x16(sum1, bb, ker[1][3]);                    \
	mmx_madd_16x16(sum2, bb, ker[2][3]);                    \
	mmx_madd_16x16(sum3, bb, ker[3][3]);                    \
	mmx_madd_16x16(sum0, d2, ker[0][4]);                    \
	mmx_madd_16x16(sum1, d2, ker[1][4]);                    \
	mmx_madd_16x16(sum2, d2, ker[2][4]);                    \
	mmx_madd_16x16(sum3, d2, ker[3][4]);                    \
	buff0[2 * i] = sum0h;                                   \
	buff1[2 * i] = sum1h;                                   \
	buff2[2 * i] = sum2h;                                   \
	buff3[2 * i] = sum3h;                                   \
...
#define	CONV_5x5(xx, i)                                         \
	...
	mmx_madd_16x16(sum2, d1, ker[2][2]);                    \
	mmx_madd_16x16(sum3, d1, ker[3][2]);                    \
	mmx_madd_16x16(sum4, d1, ker[4][2]);                    \
	bb = ALGN(d1, d2, 32);                                  \
	mmx_madd_16x16(sum0, bb, ker[0][3]);                    \
	mmx_madd_16x16(sum1, bb, ker[1][3]);                    \
	mmx_madd_16x16(sum2, bb, ker[2][3]);                    \
	mmx_madd_16x16(sum3, bb, ker[3][3]);                    \
	mmx_madd_16x16(sum4, bb, ker[4][3]);                    \
	mmx_madd_16x16(sum0, d2, ker[0][4]);                    \
	mmx_madd_16x16(sum1, d2, ker[1][4]);                    \
	mmx_madd_16x16(sum2, d2, ker[2][4]);                    \
	mmx_madd_16x16(sum3, d2, ker[3][4]);                    \
	mmx_madd_16x16(sum4, d2, ker[4][4]);                    \
	prev0h = buff0[2 * i];                                  \
	prev1h = buff1[2 * i];                                  \
	prev2h = buff2[2 * i];                                  \
	prev3h = buff3[2 * i];                                  \
    ...
    mlib_s32 scalef_expon)
{
	...
	__m64 ker[5][5];
	__m64 d0, d1, d2, aa, bb, rr, tmpa, tmpb;
