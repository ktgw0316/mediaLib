...
#pragma ident	"@(#)mlib_m_ImageMedianFilter7x7.c	9.5	07/11/05 SMI"
...
#define	FUNC_MEDIAN_ROW(MEDMASK, img_type)                             \
	...
	{                                                              \
	    ...
	    mlib_##img_type *buff1, *buff2, *buff3, *buff4, *buff5,    \
		*buff6, *buff7;                                        \
	    mlib_s32 d1, d2, d3, d4, d5, d6, d7, mask;                 \
	    mlib_s32 v1, v2, v3, v4, v5, v6;                           \
	    mlib_s32 i, k;                                             \
	                                                               \
 ...
 */                                                                    \
	...
	{                                                              \
		...
		fs->size;                                              \
	    mlib_u8 *dp, *sp;                                          \
	    __m64 d1, d2, d3, d4, d5, d6, d7, mask80, mask;            \
	    __m64 v1, v2, v3, v4, v5, v6;                              \
	    mlib_u8 *buff1, *buff2, *buff3, *buff4, *buff5, *buff6,    \
		*buff7;                                                \
		...
		v5 = *(__m64 *) buff5;                                 \
		v6 = *(__m64 *) buff6;                                 \
		MMX_SORT7(d1, d2, d3, d4, d5, d6, d7, img_type);       \
		*(__m64 *) buff7 = d4;                                 \
		MMX_SORT7(v1, v2, v3, v4, v5, v6, d4, img_type);       \
		*(__m64 *) dp = v4;                                    \
		sp += 8;                                               \
		dp += 8;                                               \
		buff1 += 8;                                            \
		...
		sorttype_##img_type d1, d2, d3, d4, d5, d6, d7,        \
		    mask;                                              \
		...
		SORT7(d1, d2, d3, d4, d5, d6, d7, SORT2_##img_type);   \
		*(mlib_##img_type *) buff7 = d4;                       \
		SORT7(v1, v2, v3, v4, v5, v6, d4, SORT2_##img_type);   \
...
static mlib_median_fun_type median_row_7x7_funs[] = {
	NULL, NULL, NULL,
	mlib_m_median_row_7x7rsep_u8,
	NULL, NULL, NULL,
	mlib_m_median_row_7x7rsep_s16,
	NULL, NULL, NULL,
	mlib_m_median_row_7x7rsep_u16,
	NULL, NULL, NULL,
	mlib_m_median_row_7x7rsep_s32,
	NULL, NULL, NULL,
	mlib_median_row_7x7rsep_f32,
	NULL, NULL, NULL,
	mlib_median_row_7x7rsep_d64
