...
#pragma ident	"@(#)mlib_m_ImageMin.c	9.7	07/11/05 SMI"
...
#define	MLIB_M_IMAGE_MIN_U8_MASK(cmask64, s1, s2)                 \
	{                                                         \
	    cmask64 = _mm_cmpeq_pi8(_mm_subs_pu8(sd2, sd1),	  \
			    _m_zero);   			  \
	}

/* *********************************************************** */

#define	MLIB_M_IMAGE_MIN_S16_MASK(cmask64, s1, s2)              \
	{                                                       \
	    cmask64 = _mm_cmpgt_pi16(sd1, sd2);                 \
	}

/* *********************************************************** */

#define	MLIB_M_IMAGE_MIN_U16_MASK(cmask64, s1, s2)                  \
	{                                                           \
	    cmask64 = _mm_cmpeq_pi16(_mm_subs_pu16(sd2, sd1),	    \
			    _m_zero);   			    \
	}

/* *********************************************************** */

#define	MLIB_M_IMAGE_MIN_S32_MASK(cmask64, s1, s2)              \
	{                                                       \
	    cmask64 = _mm_cmpgt_pi32(sd1, sd2);                 \
	}

/* *********************************************************** */

    static void mlib_m_ImageMin_U8(
    mlib_u8 *da1,
    mlib_u8 *sa1,
    mlib_u8 *sa2,
    mlib_s32 dlb1,
...
/* *********************************************************** */
    ...
    static void mlib_m_ImageMin_S16(
    mlib_s16 *da1,
    mlib_s16 *sa1,
    mlib_s16 *sa2,
    mlib_s32 dlb1,
...
/* *********************************************************** */
    ...
    static void mlib_m_ImageMin_U16(
    mlib_u16 *da1,
    mlib_u16 *sa1,
    mlib_u16 *sa2,
    mlib_s32 dlb1,
...
/* *********************************************************** */
    ...
    static void mlib_m_ImageMin_S32(
    mlib_s32 *da1,
    mlib_s32 *sa1,
    mlib_s32 *sa2,
    mlib_s32 dlb1,
    ...
    const mlib_image *src2)
{
	...
	if (dtype == MLIB_BYTE) {
		...
		mlib_m_ImageMin_U8((mlib_u8 *)da1, sa1, sa2, dlb1, slb1, slb2,
		    dw, dh);
		return (MLIB_SUCCESS);
		...
		mlib_m_ImageMin_S16((mlib_s16 *)da1, sa1, sa2, dlb1, slb1, slb2,
		    dw, dh);
		return (MLIB_SUCCESS);
		...
		mlib_m_ImageMin_U16((mlib_u16 *)da1, sa1, sa2, dlb1, slb1, slb2,
		    dw, dh);
		return (MLIB_SUCCESS);
		...
		mlib_m_ImageMin_S32((mlib_s32 *)da1, sa1, sa2, dlb1, slb1, slb2,
		    dw, dh);
		return (MLIB_SUCCESS);
	}
...
/* row loop */
	for (; dh > 0; dh--) {
		...
		if (emask != 0xff) {
			...
			MLIB_M_IMAGE_MIN_U8_MASK(cmask64, sd1, sd2)
...
/* row loop */
	for (; dh > 0; dh--) {
		...
		if (emask != 0xf) {
			...
			MLIB_M_IMAGE_MIN_S16_MASK(cmask64, sd1, sd2)
			    cmask64 = _mm_and_si64(cmask64, emask64);
...
/* row loop */
	for (; dh > 0; dh--) {
		...
		if (emask != 0xf) {
			...
			sd2 = (*sa2++);
			emask64 = mask_pst_16[emask & 0xF];
			MLIB_M_IMAGE_MIN_U16_MASK(cmask64, sd1, sd2)
			    cmask64 = _mm_and_si64(cmask64, emask64);
			mmx_pst_16m64(sd1, da1, emask64);
			mmx_pst_16m64(sd2, da1, cmask64);
			n1 += 4;
...
/* row loop */
	for (; dh > 0; dh--) {
		...
		if (emask != 0x3) {
			...
			MLIB_M_IMAGE_MIN_S32_MASK(cmask64, sd1, sd2)
			    cmask64 = _mm_and_si64(cmask64, emask64);
