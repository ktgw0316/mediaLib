...
#pragma ident	"@(#)mlib_m_ImageAndNot.c	9.6	07/11/05 SMI"

/*
 * FUNCTION
 *      mlib_ImageAndNot  - AndNot two images
 *
 * SYNOPSIS
 ...
 *
 * DESCRIPTION
 *      AndNot two images for each band:
 *         dst = src1 & (~src2)
 */
...
#define	MLIB_M_IMAGE_LOGIC(d, s1, s2)	d = _mm_and_si64(s1, _mm_not_si64(s2));
