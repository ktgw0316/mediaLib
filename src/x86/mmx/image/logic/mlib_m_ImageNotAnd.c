...
#pragma ident	"@(#)mlib_m_ImageNotAnd.c	9.6	07/11/05 SMI"

/*
 * FUNCTION
 *      mlib_ImageNotAnd  - NotAnd two images
 *
 * SYNOPSIS
 ...
 *
 * DESCRIPTION
 *      NotAnd two images for each band:
 *        dst = ~(src1 & src2)
 */
...
#define	MLIB_M_IMAGE_LOGIC(d, s1, s2)	d = _mm_not_si64(_mm_and_si64(s1, s2));
