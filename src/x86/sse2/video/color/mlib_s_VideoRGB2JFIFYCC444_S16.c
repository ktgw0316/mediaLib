...
#pragma ident	"@(#)mlib_s_VideoRGB2JFIFYCC444_S16.c	9.4	07/11/05 SMI"
...
/* *********************************************************** */
#define	SeparateRGB48_S16			\
{								\
	x_t0 = _mm_unpacklo_epi16(x_rgb0, _mm_srli_si128(x_rgb1, 8));	\
	x_t1 = _mm_unpacklo_epi16(_mm_srli_si128(x_rgb0, 8), x_rgb2);	\
	x_t2 = _mm_unpacklo_epi16(x_rgb1, _mm_srli_si128(x_rgb2, 8));	\
								\
	...
	x_t5 = _mm_unpacklo_epi16(x_t1, _mm_srli_si128(x_t2, 8));	\
								\
	x_r = _mm_unpacklo_epi16(x_t3, _mm_srli_si128(x_t4, 8));	\
	x_g = _mm_unpacklo_epi16(_mm_srli_si128(x_t3, 8), x_t5);	\
	x_b = _mm_unpacklo_epi16(x_t4, _mm_srli_si128(x_t5, 8));	\
}

#define	SeparateRGB24_S16			\
{								\
	x_t0 = _mm_unpacklo_epi16(x_rgb0, x_zero);			\
	x_t1 = _mm_unpacklo_epi16(_mm_srli_si128(x_rgb0, 8), x_zero);	\
	x_t2 = _mm_unpacklo_epi16(x_rgb1, x_zero);			\
								\
	x_t3 = _mm_unpacklo_epi16(x_t0, _mm_srli_si128(x_t1, 8));	\
	x_t4 = _mm_unpacklo_epi16(_mm_srli_si128(x_t0, 8), x_t2);	\
	x_t5 = _mm_unpacklo_epi16(x_t1, _mm_srli_si128(x_t2, 8));	\
...
/* *********************************************************** */
mlib_status
mlib_VideoColorRGB2JFIFYCC444_S16_aligned(
	mlib_s16 *y,
	mlib_s16 *cb,
	mlib_s16 *cr,
	const mlib_s16 *rgb,
...
mlib_status
mlib_VideoColorRGB2JFIFYCC444_S16_naligned(
	mlib_s16 *y,
	mlib_s16 *cb,
	mlib_s16 *cr,
	const mlib_s16 *rgb,
	...
	mlib_s32 n)
{
	...
	if (0 == (0xf & ((mlib_addr)y | (mlib_addr)cb |
	    ...
	    return mlib_VideoColorRGB2JFIFYCC444_S16_aligned(
		y, cb, cr, rgb, n);
	} else {
	    return mlib_VideoColorRGB2JFIFYCC444_S16_naligned(
		y, cb, cr, rgb, n);
	}
}
	...
	mlib_s32 n)
{
	...
	__m128i *px_y, *px_cb, *px_cr, *px_rgb;
...
#pragma pipeloop(0)
	...
	for (i = 0; i <= (n - 8); i += 8) {
		...
		x_rgb0 = _mm_slli_epi16(x_rgb0, 3);
		x_rgb1 = _mm_load_si128(px_rgb++);
		x_rgb1 = _mm_slli_epi16(x_rgb1, 3);
		x_rgb2 = _mm_load_si128(px_rgb++);
		x_rgb2 = _mm_slli_epi16(x_rgb2, 3);
		SeparateRGB48_S16;
