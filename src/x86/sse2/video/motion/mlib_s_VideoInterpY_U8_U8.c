...
#pragma ident	"@(#)mlib_s_VideoInterpY_U8_U8.c	9.2	07/11/05 SMI"
	...
	mlib_s32 field_stride)
{
	...
	dl = dd = (void *)curr_block;
	mlib_u8 *sd1 = sd + frame_stride;
	mlib_u8 *sl1 = sd1;
#ifdef __SUNPRO_C
#pragma pipeloop(0)
#endif
