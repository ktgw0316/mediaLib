...
#pragma ident	"@(#)mlib_s_VideoInterpXY_U8_U8.c	9.2	07/11/05 SMI"
...
#define	MLIB_S_VIDEOINTERP8(height)                            \
	for (y = 0; y < height; y++) {                               \
		...
		txmm1 = _mm_loadu_si128((__m128i *)(sd + 1));	     \
		txmm2 = _mm_loadu_si128((__m128i *)sd2);	     \
		txmm3 = _mm_loadu_si128((__m128i *)(sd2 + 1));	     \
		txmm4 = _mm_avg_epu8(txmm0, txmm1);		     \
		txmm5 = _mm_avg_epu8(txmm3, txmm2);		     \
		txmm6 = _mm_avg_epu8(txmm4, txmm5);		     \
