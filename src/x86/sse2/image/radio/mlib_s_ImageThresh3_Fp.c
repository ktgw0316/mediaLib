...
#pragma ident   "@(#)mlib_s_ImageThresh3_Fp.c	9.2	07/11/05 SMI"
...
static void mlib_s_ImageThresh3_F321(
    const mlib_f32 *psrc,
    mlib_s32 src_stride,
    mlib_f32 *pdst,
    mlib_s32 dst_stride,
...
static void mlib_s_ImageThresh3_F322(
    const mlib_f32 *psrc,
    mlib_s32 src_stride,
    mlib_f32 *pdst,
    mlib_s32 dst_stride,
...
static void mlib_s_ImageThresh3_F323(
    const mlib_f32 *psrc,
    mlib_s32 src_stride,
    mlib_f32 *pdst,
    mlib_s32 dst_stride,
...
static void mlib_s_ImageThresh3_F324(
    const mlib_f32 *psrc,
    mlib_s32 src_stride,
    mlib_f32 *pdst,
    mlib_s32 dst_stride,
...
static void mlib_s_ImageThresh3_D641(
    const mlib_d64 *psrc,
    mlib_s32 src_stride,
    mlib_d64 *pdst,
    mlib_s32 dst_stride,
...
static void mlib_s_ImageThresh3_D642(
    const mlib_d64 *psrc,
    mlib_s32 src_stride,
    mlib_d64 *pdst,
    mlib_s32 dst_stride,
...
static void mlib_s_ImageThresh3_D643(
    const mlib_d64 *psrc,
    mlib_s32 src_stride,
    mlib_d64 *pdst,
    mlib_s32 dst_stride,
...
static void mlib_s_ImageThresh3_D644(
    const mlib_d64 *psrc,
    mlib_s32 src_stride,
    mlib_d64 *pdst,
    mlib_s32 dst_stride,
...
#define	DO_THRESH_F32(s0, th, gh)                             \
	((s0) > (th)) ? (gh) : (s0)

#define	THRESH0_F32(s0)	DO_THRESH_F32(s0, thresh0, ghigh0)
#define	THRESH1_F32(s0)	DO_THRESH_F32(s0, thresh1, ghigh1)
#define	THRESH2_F32(s0)	DO_THRESH_F32(s0, thresh2, ghigh2)
#define	THRESH3_F32(s0)	DO_THRESH_F32(s0, thresh3, ghigh3)

/* *********************************************************** */
#define	DO_FAST_THRESH_F32(dst, src, th_SSE2, gh_SSE2)        \
	_s_32x4 = _mm_loadu_ps(src);                              \
	mask_gt_th = _mm_cmpgt_ps(_s_32x4, th_SSE2);              \
	dd = _mm_or_ps(                                           \
		_mm_andnot_ps(mask_gt_th, _s_32x4),                   \
...
#define	GROSS_LOOPS_F32                                       \
	for (j = 0; j < w3; j += 4) {                             \
	    DO_FAST_THRESH_F32(dataPtr, sourcePtr, _s_th, _s_gh); \
	}
/* *********************************************************** */

void
mlib_s_ImageThresh3_F321(
    const DTYPE *psrc,
    mlib_s32 src_stride,
    DTYPE *pdst,
    mlib_s32 dst_stride,
...
#define	DO_THRESH_D64(s0, th, gh)                             \
	((s0) > (th)) ? (gh) : (s0)

#define	THRESH0_D64(s0)	DO_THRESH_D64(s0, thresh0, ghigh0)
#define	THRESH1_D64(s0)	DO_THRESH_D64(s0, thresh1, ghigh1)
#define	THRESH2_D64(s0)	DO_THRESH_D64(s0, thresh2, ghigh2)
#define	THRESH3_D64(s0)	DO_THRESH_D64(s0, thresh3, ghigh3)

/* *********************************************************** */
#define	DO_FAST_THRESH_D64(dst, src, th_SSE2, gh_SSE2)        \
	_s_64x2 = _mm_loadu_pd(src);                              \
	mask_gt_th = _mm_cmpgt_pd(_s_64x2, th_SSE2);              \
	dd = _mm_or_pd(                                           \
		_mm_andnot_pd(mask_gt_th, _s_64x2),                   \
...
#define	GROSS_LOOPS_D64                                       \
	for (j = 0; j < w1; j += 2) {                             \
	    DO_FAST_THRESH_D64(dataPtr, sourcePtr, _s_th, _s_gh); \
	}
/* *********************************************************** */


void
mlib_s_ImageThresh3_D641(
    const DTYPE *psrc,
    mlib_s32 src_stride,
    DTYPE *pdst,
    mlib_s32 dst_stride,
    ...
    const mlib_d64 *ghigh)
{
	...
	if (dtype == MLIB_FLOAT) {
		...
		switch (nchan) {
		case 1:
			mlib_s_ImageThresh3_F321(psrc, sstride,
			    pdst, dstride, width, height, thresh, ghigh);
			break;
		case 2:
			mlib_s_ImageThresh3_F322(psrc, sstride,
			    pdst, dstride, width, height, thresh, ghigh);
			break;
		case 3:
			mlib_s_ImageThresh3_F323(psrc, sstride,
			    pdst, dstride, width, height, thresh, ghigh);
			break;
		case 4:
			mlib_s_ImageThresh3_F324(psrc, sstride,
			    pdst, dstride, width, height, thresh, ghigh);
			break;
		}
		...
		switch (nchan) {
		case 1:
			mlib_s_ImageThresh3_D641(psrc, sstride,
			    pdst, dstride, width, height, thresh, ghigh);
			break;
		case 2:
			mlib_s_ImageThresh3_D642(psrc, sstride,
			    pdst, dstride, width, height, thresh, ghigh);
			break;
		case 3:
			mlib_s_ImageThresh3_D643(psrc, sstride,
			    pdst, dstride, width, height, thresh, ghigh);
			break;
		case 4:
			mlib_s_ImageThresh3_D644(psrc, sstride,
			    pdst, dstride, width, height, thresh, ghigh);
			break;
		}
