...
#pragma ident   "@(#)mlib_s_ImageLookUp_32.c	9.3	07/11/05 SMI"
...
#define	MLIB_S_IMAGE_LOOKUP_S32_2INDEX(               \
			w0, w1, w2, w3, sp)                       \
{                                                     \
	w0 = ((STYPE *)(sp))[0];                          \
	w1 = ((STYPE *)(sp))[1];                          \
...
#define	MLIB_S_IMAGE_LOOKUP_S32_U8_1E(                \
			dp, sp, t0, t1, t2, t3, n)                \
	{                                                 \
		for (k = 0; k < n - 3; k += 4) {              \
			((mlib_u8 *)dp)[k] =                      \
...
/* src1 address */
	__m128i *sp1, *sl1, sd1, sd2, sd3, sd4;
...
#define	MLIB_S_IMAGE_LOOKUP_S32_U8_3L(dp, sp, t0, t1, t2)   \
	{                                                       \
	    mlib_s32 c0, c1, c2, c3, c4, c5, c6, c7;            \
		mlib_s32 c8, c9, c10, c11, c12, c13, c14, c15;      \
                                                            \
...
#define	MLIB_S_IMAGE_LOOKUP_S32_U8_3E(                   \
			dp, sp, t0, t1, t2, n)                       \
	{                                                    \
		for (k = 0; k < n - 2; k += 3) {                 \
			((mlib_u8 *)dp)[k] =                         \
...
#define	MLIB_S_IMAGE_LOOKUP_SI_S32_U8_2L(                   \
			dp, sp, t0, t1, t2, t3)                         \
	{                                                       \
	    mlib_s32 c0, c1, c2, c3, c4, c5, c6, c7;            \
                                                            \
...
#define	MLIB_S_IMAGE_LOOKUP_SI_S32_U8_2E(                 \
			dp, sp, t0, t1, n)                            \
	{                                                     \
...
#endif
		for (n1 = dw; n1 > 15; n1 -= 16) {
			FN_NAME(SI_S32_U8_2L)(
				dp1, sp1, tab0, tab1, tab0, tab1);
		}

		if (n1 > 0) {
			FN_NAME(SI_S32_U8_2E)(
...
#define	MLIB_S_IMAGE_LOOKUP_SI_S32_U8_3L(dp, sp, t0, t1, t2)\
	{                                                       \
	    mlib_s32 c0, c1, c2, c3, c4, c5, c6, c7;            \
		mlib_s32 c8, c9, c10, c11, c12, c13, c14, c15;      \
                                                            \
...
#define	MLIB_S_IMAGE_LOOKUP_SI_S32_U8_3E(                      \
			dp, sp, t0, t1, t2, n)                            \
{                                                             \
...
/* loop variables */
	...
	mlib_s32 e8, e9, e10, e11, e12, e13, e14, e15;
...
#endif
		for (n1 = dw; n1 > 47; n1 -= 48) {
			FN_NAME(SI_S32_U8_3L)(
				dp1, sp1, tab0, tab1, tab2);
		}

		if (n1 > 0) {
			FN_NAME(SI_S32_U8_3E)(
				dp1, sp1, tab0, tab1, tab2, n1);
		}
...
#define	MLIB_S_IMAGE_LOOKUP_SI_S32_U8_4L(                 \
			dp, sp, t0, t1, t2, t3)                       \
	{                                                     \
...
#define	MLIB_S_IMAGE_LOOKUP_SI_S32_U8_4E(                 \
			dp, sp, t0, t1, t2, t3, n)                   \
	{                                                    \
...
#endif
		for (n1 = dw; n1 > 15; n1 -= 16) {
			FN_NAME(SI_S32_U8_4L)(
				dp1, sp1, tab0, tab1, tab2, tab3);
		}

		if (n1 > 0) {
			FN_NAME(SI_S32_U8_4E)(
				dp1, sp1, tab0, tab1, tab2, tab3, n1);
		}
...
#define	MLIB_S_IMAGE_LOOKUP_S32_S16_1L(                     \
			dp, sp, t0, t1, t2, t3)                         \
	{                                                       \
	    mlib_s32 c0, c1, c2, c3, c4, c5, c6, c7;            \
                                                            \
...
#define	MLIB_S_IMAGE_LOOKUP_S32_S16_1E(              \
			dp, sp, t0, t1, t2, t3, n)               \
	{                                                \
		for (k = 0; k < n - 3; k += 4) {             \
			((mlib_s16 *)dp)[k] =                    \
...
#define	MLIB_S_IMAGE_LOOKUP_S32_S16_3L(dp, sp,              \
			t0, t1, t2)                                     \
	{                                                       \
	    mlib_s32 c0, c1, c2, c3, c4, c5, c6, c7;            \
                                                            \
...
#define	MLIB_S_IMAGE_LOOKUP_S32_S16_3E(                  \
			dp, sp, t0, t1, t2, n)                       \
	{                                                    \
		for (k = 0; k < n - 2; k += 3) {                 \
			((mlib_s16 *)dp)[k] =                        \
...
#define	MLIB_S_IMAGE_LOOKUP_SI_S32_S16_2L(dp, sp, t0,       \
	t1, t2, t3)                                             \
	{                                                       \
	    mlib_s32 c0, c1, c2, c3;                            \
		mlib_u32 e0, e1, e2, e3;                            \
...
#define	MLIB_S_IMAGE_LOOKUP_SI_S32_S16_2E(                  \
			dp, sp, t0, t1, n)                              \
	{                                                       \
		for (k = 0, j = 0; k < n; k += 2, j++) {            \
			((mlib_s16 *)dp)[k] =                           \
...
void
mlib_s_ImageLookUpSI_S32_S16_2(
    const mlib_s32 *src,
    mlib_s32 slb,
    mlib_s16 *dst,
    mlib_s32 dlb,
...
#endif
		for (n1 = dw; n1 > 7; n1 -= 8) {
			FN_NAME(SI_S32_S16_2L)(
				dp1, sp1, tab0, tab1, tab0, tab1);
		}

		if (n1 > 0) {
			FN_NAME(SI_S32_S16_2E)(
				dp1, sp1, tab0, tab1, n1);
		}
...
#define	MLIB_S_IMAGE_LOOKUP_SI_S32_S16_4L(             \
			dp, sp, t0, t1, t2, t3)                    \
	{                                                  \
	    mlib_s32 c0, c1, c2, c3;                       \
                                                       \
...
#define	MLIB_S_IMAGE_LOOKUP_SI_S32_S16_4E(             \
			dp, sp, t0, t1, t2, t3, n)                 \
	{                                                  \
		for (k = 0, j = 0; k < n; k += 4, j++) {       \
			((mlib_s16 *)dp)[k] =                      \
...
void
mlib_s_ImageLookUpSI_S32_S16_4(
    const mlib_s32 *src,
    mlib_s32 slb,
    mlib_s16 *dst,
    mlib_s32 dlb,
...
#endif
		for (n1 = dw; n1 > 15; n1 -= 16) {
			FN_NAME(SI_S32_S16_4L)(
				dp1, sp1, tab0, tab1, tab2, tab3);
		}

		if (n1 > 0) {
			FN_NAME(SI_S32_S16_4E)(
				dp1, sp1, tab0, tab1, tab2, tab3, n1);
		}
...
#define	MLIB_S_IMAGE_LOOKUP_SI_S32_S16_3L(dp, sp,           \
			t0, t1, t2)                                     \
	{                                                       \
	    mlib_s32 c0, c1, c2, c3, c4, c5, c6, c7;            \
                                                            \
...
#define	MLIB_S_IMAGE_LOOKUP_SI_S32_S16_3E(                  \
			dp, sp, t0, t1, t2, n)                          \
{                                                           \
		for (k = 0, j = 0; k < n; k += 3, j++) {            \
			((mlib_s16 *)dp)[k] =                           \
...
void
mlib_s_ImageLookUpSI_S32_S16_3(
    const mlib_s32 *src,
    mlib_s32 slb,
    mlib_s16 *dst,
    mlib_s32 dlb,
...
#endif
		for (n1 = dw; n1 > 23; n1 -= 24) {
			FN_NAME(SI_S32_S16_3L)(
				dp1, sp1, tab0, tab1, tab2);
		}

		if (n1 > 0) {
			FN_NAME(SI_S32_S16_3E)(
				dp1, sp1, tab0, tab1, tab2, n1);
		}
...
#define	MLIB_S_IMAGE_LOOKUP_S32_S32_1L(dp, sp, t0, t1, \
	t2, t3)                                            \
	{                                                  \
	    mlib_s32 c0, c1, c2, c3;                       \
                                                       \
...
#define	MLIB_S_IMAGE_LOOKUP_S32_S32_1E(                \
			dp, sp, t0, t1, t2, t3, n)                 \
	{                                                  \
		if (n > 0) {                                   \
			((mlib_s32 *)dp)[0] =                      \
...
#define	MLIB_S_IMAGE_LOOKUP_S32_S32_3L(dp, sp,      \
			t0, t1, t2)                             \
	{                                               \
	    mlib_s32 c0, c1, c2, c3;                    \
                                                    \
...
#define	MLIB_S_IMAGE_LOOKUP_S32_S32_3E(             \
			dp, sp, t0, t1, t2, n)                  \
	{                                               \
		for (k = 0; k < n - 2; k += 3) {            \
			((mlib_s32 *)dp)[k] =                   \
...
#define	MLIB_S_IMAGE_LOOKUP_SI_S32_S32_2L(                  \
			dp, sp, t0, t1, t2, t3)                         \
	{                                                       \
	    mlib_s32 c0, c1, c2, c3;                            \
                                                            \
...
#define	MLIB_S_IMAGE_LOOKUP_SI_S32_S32_2E(                 \
			dp, sp, t0, t1, n)                             \
	{                                                      \
		for (k = 0, j = 0; k < n; k += 2, j++) {           \
			((mlib_s32 *)dp)[k] =                          \
...
void
mlib_s_ImageLookUpSI_S32_S32_2(
    const mlib_s32 *src,
    mlib_s32 slb,
    mlib_s32 *dst,
    mlib_s32 dlb,
...
#endif
		for (n1 = dw; n1 > 7; n1 -= 8) {
			FN_NAME(SI_S32_S32_2L)(
				dp1, sp1, tab0, tab1, tab0, tab1);
		}

		if (n1 > 0) {
			FN_NAME(SI_S32_S32_2E)(
				dp1, sp1, tab0, tab1, n1);
		}
...
#define	MLIB_S_IMAGE_LOOKUP_SI_S32_S32_4L(            \
			dp, sp, t0, t1, t2, t3)                  \
	{                                                 \
	    mlib_s32 c0, c1, c2, c3;                      \
                                                      \
...
#define	MLIB_S_IMAGE_LOOKUP_SI_S32_S32_4E(            \
			dp, sp, t0, t1, t2, t3, n)                \
	{                                                 \
		for (k = 0, j = 0; k < n; k += 4, j++) {      \
			((mlib_s32 *)dp)[k] =                     \
...
void
mlib_s_ImageLookUpSI_S32_S32_4(
    const mlib_s32 *src,
    mlib_s32 slb,
    mlib_s32 *dst,
    mlib_s32 dlb,
...
#endif
		for (n1 = dw; n1 > 15; n1 -= 16) {
			FN_NAME(SI_S32_S32_4L)(
				dp1, sp1, tab0, tab1, tab2, tab3);
		}

		if (n1 > 0) {
			FN_NAME(SI_S32_S32_4E)(
				dp1, sp1, tab0, tab1, tab2, tab3, n1);
		}
...
#define	MLIB_S_IMAGE_LOOKUP_SI_S32_S32_3L(                  \
			dp, sp, t0, t1, t2)                             \
	{                                                       \
	    mlib_s32 c0, c1, c2, c3;                            \
                                                            \
...
#define	MLIB_S_IMAGE_LOOKUP_SI_S32_S32_3E(                  \
			dp, sp, t0, t1, t2, n)                          \
{                                                           \
		for (k = 0, j = 0; k < n; k += 3, j++) {            \
			((mlib_s32 *)dp)[k] =                           \
...
void
mlib_s_ImageLookUpSI_S32_S32_3(
    const mlib_s32 *src,
    mlib_s32 slb,
    mlib_s32 *dst,
    mlib_s32 dlb,
...
#endif
	    for (n1 = dw; n1 > 11; n1 -= 12) {
			FN_NAME(SI_S32_S32_3L)(
				dp1, sp1, tab0, tab1, tab2);
	    }

	    if (n1 > 0) {
			FN_NAME(SI_S32_S32_3E)(
				dp1, sp1, tab0, tab1, tab2, n1);
		}
