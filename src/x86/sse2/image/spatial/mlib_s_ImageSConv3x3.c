...
#pragma ident   "@(#)mlib_s_ImageSConv3x3.c	9.4	07/11/05 SMI"
...
/* *********************************************************** */
    ...
    mlib_status mlib_s_sconv3x3_8nw_1(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *hkernel,
    mlib_s32 *vkernel,
    ...
    mlib_status mlib_s_sconv3x3_8nw_2(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *hkernel,
    mlib_s32 *vkernel,
    ...
    mlib_status mlib_s_sconv3x3_8nw_3(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *hkernel,
    mlib_s32 *vkernel,
    ...
    mlib_status mlib_s_sconv3x3_8nw_4(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *hkernel,
    mlib_s32 *vkernel,
...
/* *********************************************************** */
    mlib_status mlib_s_sconv3x3_16nw_1(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *hkernel,
    mlib_s32 *vkernel,
    ...
    mlib_status mlib_s_sconv3x3_16nw_2(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *hkernel,
    mlib_s32 *vkernel,
    ...
    mlib_status mlib_s_sconv3x3_16nw_3(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *hkernel,
    mlib_s32 *vkernel,
    ...
    mlib_status mlib_s_sconv3x3_16nw_4(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *hkernel,
    mlib_s32 *vkernel,
...
/* *********************************************************** */
    mlib_status mlib_s_sconv3x3_u16nw_1(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *hkernel,
    mlib_s32 *vkernel,
    ...
    mlib_status mlib_s_sconv3x3_u16nw_2(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *hkernel,
    mlib_s32 *vkernel,
    ...
    mlib_status mlib_s_sconv3x3_u16nw_3(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *hkernel,
    mlib_s32 *vkernel,
    ...
    mlib_status mlib_s_sconv3x3_u16nw_4(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *hkernel,
    mlib_s32 *vkernel,
...
/* *********************************************************** */
    ...
    mlib_status mlib_s_sconv3x3_8ext_1(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_status mlib_s_sconv3x3_8ext_2(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_status mlib_s_sconv3x3_8ext_3(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_status mlib_s_sconv3x3_8ext_4(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
...
/* *********************************************************** */
    mlib_status mlib_s_sconv3x3_16ext_1(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_status mlib_s_sconv3x3_16ext_2(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_status mlib_s_sconv3x3_16ext_3(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_status mlib_s_sconv3x3_16ext_4(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
...
/* *********************************************************** */
    mlib_status mlib_s_sconv3x3_u16ext_1(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_status mlib_s_sconv3x3_u16ext_2(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_status mlib_s_sconv3x3_u16ext_3(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_status mlib_s_sconv3x3_u16ext_4(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_s32 cmask)
{
	...
	switch (nchan) {
	case 1:
		return mlib_s_sconv3x3_8nw_1(dst, src, hkernel, vkernel,
		    scalef_expon);
	case 2:
		return mlib_s_sconv3x3_8nw_2(dst, src, hkernel, vkernel,
		    scalef_expon);
	case 3:
		return mlib_s_sconv3x3_8nw_3(dst, src, hkernel, vkernel,
		    scalef_expon);
	case 4:
		return mlib_s_sconv3x3_8nw_4(dst, src, hkernel, vkernel,
		    scalef_expon);
	}
	...
	mlib_s32 cmask)
{
	...
	if (nchan == 1)
		cmask = 1;
	if ((cmask & amask) != amask || scalef_expon < 29) {
		return mlib_sconv3x3ext_u8(dst, src, dx_l,
	...
	switch (nchan) {
	case 1:
		return mlib_s_sconv3x3_8ext_1(dst, src, dx_l,
			dx_r, dy_t, dy_b, hkernel, vkernel,
			scalef_expon, cmask);
	case 2:
		return mlib_s_sconv3x3_8ext_2(dst, src, dx_l,
			dx_r, dy_t, dy_b, hkernel, vkernel,
			scalef_expon, cmask);
	case 3:
		return mlib_s_sconv3x3_8ext_3(dst, src, dx_l,
			dx_r, dy_t, dy_b, hkernel, vkernel,
			scalef_expon, cmask);
	case 4:
		return mlib_s_sconv3x3_8ext_4(dst, src, dx_l,
			dx_r, dy_t, dy_b, hkernel, vkernel,
			scalef_expon, cmask);
	}
    ...
    mlib_s32 cmask)
{
	...
	switch (nchan) {
	case 1:
		return mlib_s_sconv3x3_16nw_1(dst, src, hkernel, vkernel,
		    scalef_expon);
	case 2:
		return mlib_s_sconv3x3_16nw_2(dst, src, hkernel, vkernel,
		    scalef_expon);
	case 3:
		return mlib_s_sconv3x3_16nw_3(dst, src, hkernel, vkernel,
		    scalef_expon);
	case 4:
		return mlib_s_sconv3x3_16nw_4(dst, src, hkernel, vkernel,
		    scalef_expon);
	}
	...
	mlib_s32 cmask)
{
	...
	if (nchan == 1)
		cmask = 1;
	if ((cmask & amask) != amask) {
		return mlib_sconv3x3ext_s16(dst, src, dx_l,
			dx_r, dy_t, dy_b, (void *)hkernel,
			(void *)vkernel, scalef_expon, cmask);
	}
	...
	switch (nchan) {
	case 1:
		return mlib_s_sconv3x3_16ext_1(dst, src, dx_l,
			dx_r, dy_t, dy_b, hkernel, vkernel,
			scalef_expon, cmask);
	case 2:
		return mlib_s_sconv3x3_16ext_2(dst, src, dx_l,
			dx_r, dy_t, dy_b, hkernel, vkernel,
			scalef_expon, cmask);
	case 3:
		return mlib_s_sconv3x3_16ext_3(dst, src, dx_l,
			dx_r, dy_t, dy_b, hkernel, vkernel,
			scalef_expon, cmask);
	case 4:
		return mlib_s_sconv3x3_16ext_4(dst, src, dx_l,
			dx_r, dy_t, dy_b, hkernel, vkernel,
			scalef_expon, cmask);
	}
    ...
    mlib_s32 cmask)
{
	...
	switch (nchan) {
	case 1:
		return mlib_s_sconv3x3_u16nw_1(dst, src, hkernel, vkernel,
		    scalef_expon);
	case 2:
		return mlib_s_sconv3x3_u16nw_2(dst, src, hkernel, vkernel,
		    scalef_expon);
	case 3:
		return mlib_s_sconv3x3_u16nw_3(dst, src, hkernel, vkernel,
		    scalef_expon);
	case 4:
		return mlib_s_sconv3x3_u16nw_4(dst, src, hkernel, vkernel,
		    scalef_expon);
	}
	...
	mlib_s32 cmask)
{
	...
	if (nchan == 1)
		cmask = 1;
	if ((cmask & amask) != amask) {
		return mlib_sconv3x3ext_u16(dst, src, dx_l,
			dx_r, dy_t, dy_b, (void *)hkernel,
			(void *)vkernel, scalef_expon, cmask);
	}
	...
	switch (nchan) {
	case 1:
		return mlib_s_sconv3x3_u16ext_1(dst, src, dx_l,
			dx_r, dy_t, dy_b, hkernel, vkernel,
			scalef_expon, cmask);
	case 2:
		return mlib_s_sconv3x3_u16ext_2(dst, src, dx_l,
			dx_r, dy_t, dy_b, hkernel, vkernel,
			scalef_expon, cmask);
	case 3:
		return mlib_s_sconv3x3_u16ext_3(dst, src, dx_l,
			dx_r, dy_t, dy_b, hkernel, vkernel,
			scalef_expon, cmask);
	case 4:
		return mlib_s_sconv3x3_u16ext_4(dst, src, dx_l,
			dx_r, dy_t, dy_b, hkernel, vkernel,
			scalef_expon, cmask);
	}
		...
		if (mlib_ImageGetWidth(src_i) >= ksize &&
			...
			case MLIB_BYTE:
				...
				if (scale < 24 || scale > 31)
					return (MLIB_FAILURE);
				mlib_s_sconv3x3nw_u8(dst_i, src_i,
			...
			case MLIB_SHORT:
				...
				if (scale < 26 || scale > 33)
					return (MLIB_FAILURE);
				mlib_s_sconv3x3nw_s16(dst_i, src_i,
				    (void *)hkernel, (void *)vkernel, scale,
				    cmask);
				break;
			...
			case MLIB_USHORT:
				...
				if (scale < 26 || scale > 33)
					return (MLIB_FAILURE);
				mlib_s_sconv3x3nw_u16(dst_i, src_i,
				    (void *)hkernel, (void *)vkernel, scale,
				    cmask);
				break;
...
/* adjust src_e image */
		...
		case MLIB_BYTE:
			...
			if (scale < 24 || scale > 31)
				return (MLIB_FAILURE);
			mlib_s_sconv3x3ext_u8(dst_e, src_e, dx_l, dx_r, dy_t,
		...
		case MLIB_SHORT:
			...
			if (scale < 26 || scale > 33)
				return (MLIB_FAILURE);
			mlib_s_sconv3x3ext_s16(dst_e, src_e, dx_l, dx_r, dy_t,
			    dy_b, (void *)hkernel, (void *)vkernel, scale,
			    cmask);
			break;
		case MLIB_USHORT:
			...
			if (scale < 26 || scale > 33)
				return (MLIB_FAILURE);
			mlib_s_sconv3x3ext_u16(dst_e, src_e, dx_l, dx_r, dy_t,
			    dy_b, (void *)hkernel, (void *)vkernel, scale,
			    cmask);
			break;
		case MLIB_INT:
