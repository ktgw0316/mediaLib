...
#pragma ident   "@(#)mlib_s_ImageDilate4_D64.c	9.2	07/11/05 SMI"
 ...
 *
 * SYNOPSIS
 *      mlib_status mlib_ImageDilate4_D64(void       *dst,
 *                                        const void *src,
 *                                        mlib_s32   dlb,
 *                                        mlib_s32   slb,
 *                                        mlib_s32   wid,
 *                                        mlib_s32   hgt)
 *      OR
 *      mlib_status mlib_ImageErode4_D64(void       *dst,
 *                                       const void *src,
 *                                       mlib_s32   dlb,
 *                                       mlib_s32   slb,
 *                                       mlib_s32   wid,
    ...
    mlib_s32 hgt)
{
	...
	__m128d *dp0, *dp1;
	__m128d a1, b0, b1, b2, c0, c1, c2, d1, vv, h0, h1, r0, r1, t0, t1;
	__m128d mask;
	mlib_s32 i, j, tail;
 ...
 */
		...
		for (i = 0; i <= wid - 16; i += 16) {
			a1 = _mm_loadu_pd((mlib_d64 *)(sp0 + SSIZE));
			b0 = _mm_loadu_pd((mlib_d64 *)(sp1));
			b1 = _mm_loadu_pd((mlib_d64 *)(sp1 + SSIZE));
			b2 = _mm_loadu_pd((mlib_d64 *)(sp1 + 2 * SSIZE));
		...
		if (tail) {
			...
			t0 =
			    _mm_or_pd(_mm_and_pd(mask, r0),
			    _mm_andnot_pd(mask, t0));
			t1 =
			    _mm_or_pd(_mm_and_pd(mask, r1),
			    _mm_andnot_pd(mask, t1));
