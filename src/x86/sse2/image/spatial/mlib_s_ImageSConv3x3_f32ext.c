...
#pragma ident   "@(#)mlib_s_ImageSConv3x3_f32ext.c	9.3	07/11/05 SMI"
...
#define	PREP_3x3(NCHAN, l)                                   \
	...
	_mm_store_ps((mlib_f32 *)(buff0 + l), sum2);         \
	sbuff++
