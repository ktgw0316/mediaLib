...
#pragma ident   "@(#)mlib_s_ImageConv4x4_d64ext.c	9.3	07/11/05 SMI"
...
#define	GET_KERN()                                                    \
	...
	ker10 = _mm_set1_pd((mlib_d64)kern[9]);             \
	ker11 = _mm_set1_pd((mlib_d64)kern[10]);            \
	ker12 = _mm_set1_pd((mlib_d64)kern[11]);            \
	ker13 = _mm_set1_pd((mlib_d64)kern[12]);            \
	ker14 = _mm_set1_pd((mlib_d64)kern[13]);            \
	ker15 = _mm_set1_pd((mlib_d64)kern[14]);            \
	ker16 = _mm_set1_pd((mlib_d64)kern[15]);            \
...
#define	PREP_4x4(NCHAN, l)                                  \
	...
	sum1 = _mm_mul_pd(d0, ker5);                        \
	sum2 = _mm_mul_pd(d0, ker9);                        \
	aa = _mm_loadu_pd((void *)(sbuff + NCHAN));         \
	sum0 = _mm_add_pd(sum0, _mm_mul_pd(aa, ker2));      \
	sum1 = _mm_add_pd(sum1, _mm_mul_pd(aa, ker6));      \
	sum2 = _mm_add_pd(sum2, _mm_mul_pd(aa, ker10));     \
	bb = _mm_loadu_pd((void *)(sbuff + 2 * NCHAN));     \
	sum0 = _mm_add_pd(sum0, _mm_mul_pd(bb, ker3));      \
	sum1 = _mm_add_pd(sum1, _mm_mul_pd(bb, ker7));      \
	sum2 = _mm_add_pd(sum2, _mm_mul_pd(bb, ker11));     \
	cc = _mm_loadu_pd((void *)(sbuff + 3 * NCHAN));     \
	sum0 = _mm_add_pd(sum0, _mm_mul_pd(cc, ker4));      \
	sum1 = _mm_add_pd(sum1, _mm_mul_pd(cc, ker8));      \
	sum2 = _mm_add_pd(sum2, _mm_mul_pd(cc, ker12));     \
...
#define	CONV_4x4(NCHAN, l)                                  \
	...
	sum1 = _mm_mul_pd(d0, ker5);                        \
	sum2 = _mm_mul_pd(d0, ker9);                        \
	sum3 = _mm_mul_pd(d0, ker13);                       \
	aa = _mm_loadu_pd((void *)(sbuff + NCHAN));         \
	sum0 = _mm_add_pd(sum0, _mm_mul_pd(aa, ker2));      \
	sum1 = _mm_add_pd(sum1, _mm_mul_pd(aa, ker6));      \
	sum2 = _mm_add_pd(sum2, _mm_mul_pd(aa, ker10));     \
	sum3 = _mm_add_pd(sum3, _mm_mul_pd(aa, ker14));     \
	bb = _mm_loadu_pd((void *)(sbuff + 2 * NCHAN));     \
	sum0 = _mm_add_pd(sum0, _mm_mul_pd(bb, ker3));      \
	sum1 = _mm_add_pd(sum1, _mm_mul_pd(bb, ker7));      \
	sum2 = _mm_add_pd(sum2, _mm_mul_pd(bb, ker11));     \
	sum3 = _mm_add_pd(sum3, _mm_mul_pd(bb, ker15));     \
	cc = _mm_loadu_pd((void *)(sbuff + 3 * NCHAN));     \
	sum0 = _mm_add_pd(sum0, _mm_mul_pd(cc, ker4));      \
	sum1 = _mm_add_pd(sum1, _mm_mul_pd(cc, ker8));      \
	sum2 = _mm_add_pd(sum2, _mm_mul_pd(cc, ker12));     \
	sum3 = _mm_add_pd(sum3, _mm_mul_pd(cc, ker16));     \
...
#define	FUNC_CONV4x4_d64ext(NCHAN)                             \
	...
	{                                                      \
	    ...
	    __m128d s0, d0, prev0, prev1, prev2,               \
...
FUNC_CONV4x4_d64ext(1)
FUNC_CONV4x4_d64ext(2)
FUNC_CONV4x4_d64ext(3)
FUNC_CONV4x4_d64ext(4)
