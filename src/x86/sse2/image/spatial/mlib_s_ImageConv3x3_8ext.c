...
#pragma ident   "@(#)mlib_s_ImageConv3x3_8ext.c	9.3	07/11/05 SMI"
...
#define	PREP_3x3(NCHAN)                                          \
	...
	_mm_store_si128(buff1 + j, sum0);                        \
	_mm_store_si128(buff2 + j, sum1);                        \
...
#define	FUNC_CONV3x3_8ext(NCHAN)                             \
	mlib_status                                            \
	mlib_s_conv3x3_8ext_##NCHAN(                           \
	...
	{                                                      \
	    ...
	    __m128i s0, d0, d1, dt, prev0, prev1,              \
