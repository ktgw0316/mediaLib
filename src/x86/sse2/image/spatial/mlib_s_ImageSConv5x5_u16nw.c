...
#pragma ident	"@(#)mlib_s_ImageSConv5x5_u16nw.c	9.5	07/11/05 SMI"
...
#define	FUNC_CONV5x5_u16nw(NCHAN)                                          \
	mlib_status                                                        \
	mlib_s_sconv5x5_u16nw_##NCHAN(mlib_image *dst,                     \
	...
	{                                                                  \
		...
		sum4;                                                      \
	    __m128i aa, bb, cc, dd, res, rl, rh, mask, rnd;                \
...
FUNC_CONV5x5_u16nw(1)
FUNC_CONV5x5_u16nw(2)
FUNC_CONV5x5_u16nw(3)
FUNC_CONV5x5_u16nw(4)
