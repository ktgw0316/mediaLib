...
#pragma ident   "@(#)mlib_s_ImageMedianFilter5x5.c	9.4	07/11/05 SMI"
...
#define	SSE2_MEDIAN_5x5rect(itype)                            \
	{                                                       \
	    sse2_##itype d10, d11, d12, d13, d14, d15, d16, d17;\
	    sse2_##itype d18, d19, d20, d21, d22, d23, d24, d25;\
	                                                        \
	    d1 = SSE2_LOAD_##itype((pp0 - 2 * bchan));          \
	    d2 = SSE2_LOAD_##itype((pp0 - bchan));              \
	    d3 = SSE2_LOAD_##itype((pp0));                      \
	    d4 = SSE2_LOAD_##itype((pp0 + bchan));              \
	    d5 = SSE2_LOAD_##itype((pp0 + 2 * bchan));          \
	    d6 = SSE2_LOAD_##itype((pp1 - 2 * bchan));          \
	    d7 = SSE2_LOAD_##itype((pp1 - bchan));              \
	    d8 = SSE2_LOAD_##itype((pp1));                      \
	    d9 = SSE2_LOAD_##itype((pp1 + bchan));              \
	    d10 = SSE2_LOAD_##itype((pp1 + 2 * bchan));         \
	    d11 = SSE2_LOAD_##itype((pp2 - 2 * bchan));         \
	    d12 = SSE2_LOAD_##itype((pp2 - bchan));             \
	    d13 = SSE2_LOAD_##itype((pp2));                     \
	    d14 = SSE2_LOAD_##itype((pp2 + bchan));             \
	    d15 = SSE2_LOAD_##itype((pp2 + 2 * bchan));         \
	    d16 = SSE2_LOAD_##itype((pp3 - 2 * bchan));         \
	    d17 = SSE2_LOAD_##itype((pp3 - bchan));             \
	    d18 = SSE2_LOAD_##itype((pp3));                     \
	    d19 = SSE2_LOAD_##itype((pp3 + bchan));             \
	    d20 = SSE2_LOAD_##itype((pp3 + 2 * bchan));         \
	    d21 = SSE2_LOAD_##itype((pp4 - 2 * bchan));         \
	    d22 = SSE2_LOAD_##itype((pp4 - bchan));             \
	    d23 = SSE2_LOAD_##itype((pp4));                     \
	    d24 = SSE2_LOAD_##itype((pp4 + bchan));             \
	    d25 = SSE2_LOAD_##itype((pp4 + 2 * bchan));         \
	    SSE2_SORT25(itype);                                 \
	    d5 = d13;                                           \
	}
...
#define	SSE2_MEDIAN_5x5plus(itype)                            \
	d1 = SSE2_LOAD_##itype((pp0));                          \
	d2 = SSE2_LOAD_##itype((pp1));                          \
	d3 = SSE2_LOAD_##itype((pp2 - 2 * bchan));              \
	d4 = SSE2_LOAD_##itype((pp2 - bchan));                  \
	d5 = SSE2_LOAD_##itype((pp2));                          \
	d6 = SSE2_LOAD_##itype((pp2 + bchan));                  \
	d7 = SSE2_LOAD_##itype((pp2 + 2 * bchan));              \
	d8 = SSE2_LOAD_##itype((pp3));                          \
	d9 = SSE2_LOAD_##itype((pp4));                          \
	SSE2_SORT9(d1, d2, d3, d4, d5, d6, d7, d8, d9, itype)

/* *********************************************************** */

#define	SSE2_MEDIAN_5x5xmsk(itype)                            \
	d1 = SSE2_LOAD_##itype((pp0 - 2 * bchan));              \
	d2 = SSE2_LOAD_##itype((pp0 + 2 * bchan));              \
	d3 = SSE2_LOAD_##itype((pp1 - bchan));                  \
	d4 = SSE2_LOAD_##itype((pp1 + bchan));                  \
	d5 = SSE2_LOAD_##itype((pp2));                          \
	d6 = SSE2_LOAD_##itype((pp3 - bchan));                  \
	d7 = SSE2_LOAD_##itype((pp3 + bchan));                  \
	d8 = SSE2_LOAD_##itype((pp4 - 2 * bchan));              \
	d9 = SSE2_LOAD_##itype((pp4 + 2 * bchan));              \
	SSE2_SORT9(d1, d2, d3, d4, d5, d6, d7, d8, d9, itype)
...
#define	_SSE2_MEDIAN_INITROW_5x5RSEP(img_type)                   \
	void                                                    \
	mlib_s_median_initrow_5x5rsep_##img_type(mlib_u8 *dl,   \
	    void **psl, mlib_filter_state * fs);
...
#define	_SSE2_MEDIAN_ROW_5x5RSEP(img_type)                       \
	void                                                    \
	mlib_s_median_row_5x5rsep_##img_type(mlib_u8 *dl,       \
	    void **psl, mlib_filter_state * fs);
...
static mlib_median_fun_type median_row_5x5_funs[] = {
	mlib_s_median_row_5x5rect_u8,
	mlib_s_median_row_5x5plus_u8,
	mlib_s_median_row_5x5xmsk_u8,
	mlib_s_median_row_5x5rsep_u8,
	mlib_s_median_row_5x5rect_s16,
	mlib_s_median_row_5x5plus_s16,
	mlib_s_median_row_5x5xmsk_s16,
	mlib_s_median_row_5x5rsep_s16,
	mlib_s_median_row_5x5rect_u16,
	mlib_s_median_row_5x5plus_u16,
	mlib_s_median_row_5x5xmsk_u16,
	mlib_s_median_row_5x5rsep_u16,
	mlib_s_median_row_5x5rect_s32,
	mlib_s_median_row_5x5plus_s32,
	mlib_s_median_row_5x5xmsk_s32,
	mlib_s_median_row_5x5rsep_s32,
	mlib_s_median_row_5x5rect_f32,
	mlib_s_median_row_5x5plus_f32,
	mlib_s_median_row_5x5xmsk_f32,
	mlib_s_median_row_5x5rsep_f32,
	mlib_s_median_row_5x5rect_d64,
	mlib_s_median_row_5x5plus_d64,
	mlib_s_median_row_5x5xmsk_d64,
	mlib_s_median_row_5x5rsep_d64
};
...
static mlib_median_fun_type median_init_5x5_funs[] = {
	mlib_s_median_initrow_5x5rsep_u8,
	mlib_s_median_initrow_5x5rsep_s16,
	mlib_s_median_initrow_5x5rsep_u16,
	mlib_s_median_initrow_5x5rsep_s32,
	mlib_s_median_initrow_5x5rsep_f32,
	mlib_s_median_initrow_5x5rsep_d64
};
