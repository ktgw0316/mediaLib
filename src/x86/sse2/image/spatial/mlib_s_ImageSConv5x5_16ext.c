...
#pragma ident   "@(#)mlib_s_ImageSConv5x5_16ext.c	9.3	07/11/05 SMI"
...
#define	FUNC_SCONV5x5_16ext(NCHAN)                             \
	mlib_status mlib_s_sconv5x5_16ext_##NCHAN(             \
...
FUNC_SCONV5x5_16ext(1)
FUNC_SCONV5x5_16ext(2)
...
#undef FUNC_SCONV5x5_16ext
#define	FUNC_SCONV5x5_16ext(NCHAN)                             \
	mlib_status                                            \
	mlib_s_sconv5x5_16ext_##NCHAN(                          \
		mlib_image *dst, const mlib_image *src,            \
		mlib_s32 dx_l, mlib_s32 dx_r, mlib_s32 dy_t,       \
		mlib_s32 dy_b, const mlib_s32 *hkernel,            \
		const mlib_s32 *vkernel, mlib_s32 scalef_expon,    \
...
FUNC_SCONV5x5_16ext(3)
FUNC_SCONV5x5_16ext(4)
