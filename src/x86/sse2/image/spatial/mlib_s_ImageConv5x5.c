...
#pragma ident   "@(#)mlib_s_ImageConv5x5.c	9.4	07/11/05 SMI"
...
/* *********************************************************** */
    ...
    mlib_status mlib_s_conv5x5_8nw_1(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);

    mlib_status mlib_s_conv5x5_8nw_2(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);

    mlib_status mlib_s_conv5x5_8nw_3(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);

    mlib_status mlib_s_conv5x5_8nw_4(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);
...
/* *********************************************************** */
    mlib_status mlib_s_conv5x5_16nw_1(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);

    mlib_status mlib_s_conv5x5_16nw_2(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);

    mlib_status mlib_s_conv5x5_16nw_3(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);

    mlib_status mlib_s_conv5x5_16nw_4(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);
...
/* *********************************************************** */
    mlib_status mlib_s_conv5x5_u16nw_1(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);

    mlib_status mlib_s_conv5x5_u16nw_2(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);

    mlib_status mlib_s_conv5x5_u16nw_3(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);

    mlib_status mlib_s_conv5x5_u16nw_4(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);
...
/* *********************************************************** */
    ...
    mlib_status mlib_s_conv5x5_8ext_1(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_status mlib_s_conv5x5_8ext_2(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_status mlib_s_conv5x5_8ext_3(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_status mlib_s_conv5x5_8ext_4(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
...
/* *********************************************************** */
    ...
    mlib_status mlib_s_conv5x5_16ext_1(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_status mlib_s_conv5x5_16ext_2(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_status mlib_s_conv5x5_16ext_3(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_status mlib_s_conv5x5_16ext_4(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
...
/* *********************************************************** */
    ...
    mlib_status mlib_s_conv5x5_u16ext_1(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_status mlib_s_conv5x5_u16ext_2(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_status mlib_s_conv5x5_u16ext_3(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_status mlib_s_conv5x5_u16ext_4(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_s32 cmask)
{
	...
	switch (nchan) {
	case 1:
		return (mlib_s_conv5x5_8nw_1(dst, src, kernel, scalef_expon));
	case 2:
		return (mlib_s_conv5x5_8nw_2(dst, src, kernel, scalef_expon));
	case 3:
		return (mlib_s_conv5x5_8nw_3(dst, src, kernel, scalef_expon));
	case 4:
		return (mlib_s_conv5x5_8nw_4(dst, src, kernel, scalef_expon));
	}
	...
	mlib_s32 cmask)
{
	...
	chk_flag = mlib_ImageConvVersion(5, 5, scale, MLIB_BYTE);

	if (nchan == 1)
		cmask = 1;
	if ((cmask & amask) != amask || scale < 25 || chk_flag != 3) {
		if (chk_flag == 0)
			return (mlib_c_conv5x5ext_u8(dst, src, dx_l, dx_r,
			    dy_t, dy_b, (void *)kernel, scale, cmask));
		return (mlib_i_conv5x5ext_u8(dst, src, dx_l, dx_r,
		    dy_t, dy_b, (void *)kernel, scale, cmask));
	}

	switch (nchan) {
	case 1:
		return (mlib_s_conv5x5_8ext_1(dst, src,
			dx_l, dx_r, dy_t, dy_b, (void *)kernel, scale, cmask));
	case 2:
		return (mlib_s_conv5x5_8ext_2(dst, src,
			dx_l, dx_r, dy_t, dy_b, (void *)kernel, scale, cmask));
	case 3:
		return (mlib_s_conv5x5_8ext_3(dst, src,
			dx_l, dx_r, dy_t, dy_b, (void *)kernel, scale, cmask));
	case 4:
		return (mlib_s_conv5x5_8ext_4(dst, src,
			dx_l, dx_r, dy_t, dy_b, (void *)kernel, scale, cmask));
	}
    ...
    mlib_s32 cmask)
{
	...
	switch (nchan) {
	case 1:
		return (mlib_s_conv5x5_16nw_1(dst, src, kernel, scalef_expon));
	case 2:
		return (mlib_s_conv5x5_16nw_2(dst, src, kernel, scalef_expon));
	case 3:
		return (mlib_s_conv5x5_16nw_3(dst, src, kernel, scalef_expon));
	case 4:
		return (mlib_s_conv5x5_16nw_4(dst, src, kernel, scalef_expon));
	}
	...
	mlib_s32 cmask)
{
	...
	if ((cmask & amask) != amask || scale < 25 || chk_flag != 3) {
		if (chk_flag == 0)
			return (mlib_conv5x5ext_s16(dst, src, dx_l, dx_r,
			    dy_t, dy_b, (void *)kernel, scale, cmask));
		return (mlib_i_conv5x5ext_s16(dst, src, dx_l, dx_r,
		    dy_t, dy_b, (void *)kernel, scale, cmask));
	}

	switch (nchan) {
	case 1:
		return (mlib_s_conv5x5_16ext_1(dst, src,
			dx_l, dx_r, dy_t, dy_b, (void *)kernel, scale, cmask));
	case 2:
		return (mlib_s_conv5x5_16ext_2(dst, src,
			dx_l, dx_r, dy_t, dy_b, (void *)kernel, scale, cmask));
	case 3:
		return (mlib_s_conv5x5_16ext_3(dst, src,
			dx_l, dx_r, dy_t, dy_b, (void *)kernel, scale, cmask));
	case 4:
		return (mlib_s_conv5x5_16ext_4(dst, src,
			dx_l, dx_r, dy_t, dy_b, (void *)kernel, scale, cmask));
	}
    ...
    mlib_s32 cmask)
{
	...
	switch (nchan) {
	case 1:
		return (mlib_s_conv5x5_u16nw_1(dst, src, kernel, scalef_expon));
	case 2:
		return (mlib_s_conv5x5_u16nw_2(dst, src, kernel, scalef_expon));
	case 3:
		return (mlib_s_conv5x5_u16nw_3(dst, src, kernel, scalef_expon));
	case 4:
		return (mlib_s_conv5x5_u16nw_4(dst, src, kernel, scalef_expon));
	}
		...
		if (mlib_ImageGetWidth(src_i) >= ksize &&
			...
			case MLIB_BYTE:
				...
				if (scale < 16 || scale > 31)
					return (MLIB_FAILURE);
				mlib_s_conv5x5nw_u8(dst_i, src_i,
			...
			case MLIB_SHORT:
				...
				if (scale < 17 || scale > 32)
					return (MLIB_FAILURE);
				mlib_s_conv5x5nw_s16(dst_i, src_i,
				    (void *)kernel, scale, cmask);
				break;
			...
			case MLIB_USHORT:
				...
				if (scale < 17 || scale > 32)
					return (MLIB_FAILURE);
				mlib_s_conv5x5nw_u16(dst_i, src_i,
				    (void *)kernel, scale, cmask);
				break;
...
/* adjust src_e image */
		...
		case MLIB_BYTE:
			...
			if (scale < 16 || scale > 31)
				return (MLIB_FAILURE);
			mlib_s_conv5x5ext_u8(dst_e, src_e, dx_l, dx_r,
			    dy_t, dy_b, (void *)kernel, scale, cmask);
		...
		case MLIB_SHORT:
			...
			if (scale < 17 || scale > 32)
				return (MLIB_FAILURE);
			mlib_s_conv5x5ext_s16(dst_e, src_e, dx_l, dx_r,
			    dy_t, dy_b, (void *)kernel, scale, cmask);
		...
		case MLIB_USHORT:
			...
			if (scale < 17 || scale > 32)
				return (MLIB_FAILURE);
			mlib_s_conv5x5ext_u16(dst_e, src_e, dx_l, dx_r,
			    dy_t, dy_b, (void *)kernel, scale, cmask);
