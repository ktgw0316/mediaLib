...
#pragma ident   "@(#)mlib_s_ImageConv3x3.c	9.4	07/11/05 SMI"
...
/* *********************************************************** */
    ...
    mlib_status mlib_s_conv3x3_8nw_1(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);

    mlib_status mlib_s_conv3x3_8nw_2(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);

    mlib_status mlib_s_conv3x3_8nw_3(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);

    mlib_status mlib_s_conv3x3_8nw_4(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);
...
/* *********************************************************** */
    ...
    mlib_status mlib_s_conv3x3_16nw_1(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);

    mlib_status mlib_s_conv3x3_16nw_2(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);

    mlib_status mlib_s_conv3x3_16nw_3(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);

    mlib_status mlib_s_conv3x3_16nw_4(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);
...
/* *********************************************************** */
    ...
    mlib_status mlib_s_conv3x3_u16nw_1(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);

    mlib_status mlib_s_conv3x3_u16nw_2(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);

    mlib_status mlib_s_conv3x3_u16nw_3(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);

    mlib_status mlib_s_conv3x3_u16nw_4(
    mlib_image *dst,
    mlib_image *src,
    mlib_s32 *kernel,
    mlib_s32 scalef_expon);
...
/* *********************************************************** */
    ...
    mlib_status mlib_s_conv3x3_8ext_1(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_status mlib_s_conv3x3_8ext_2(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_status mlib_s_conv3x3_8ext_3(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_status mlib_s_conv3x3_8ext_4(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
...
/* *********************************************************** */
    ...
    mlib_status mlib_s_conv3x3_16ext_1(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_status mlib_s_conv3x3_16ext_2(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_status mlib_s_conv3x3_16ext_3(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_status mlib_s_conv3x3_16ext_4(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
...
/* *********************************************************** */
    ...
    mlib_status mlib_s_conv3x3_u16ext_1(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_status mlib_s_conv3x3_u16ext_2(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_status mlib_s_conv3x3_u16ext_3(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_status mlib_s_conv3x3_u16ext_4(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
    ...
    mlib_s32 cmask)
{
	...
	chk_flag = mlib_ImageConvVersion(3, 3, scalef_expon, MLIB_BYTE);

	if (nchan == 1)
		cmask = 1;
	if ((cmask & amask) != amask || scalef_expon < 25 || chk_flag != 3) {
		if (chk_flag == 0)
			return mlib_c_conv3x3nw_u8(dst, src, kernel,
			    scalef_expon, cmask);
		return mlib_i_conv3x3nw_u8(dst, src, kernel, scalef_expon,
		    cmask);
	}

	switch (nchan) {
	case 1:
		return (mlib_s_conv3x3_8nw_1(dst, src, kernel, scalef_expon));
	case 2:
		return (mlib_s_conv3x3_8nw_2(dst, src, kernel, scalef_expon));
	case 3:
		return (mlib_s_conv3x3_8nw_3(dst, src, kernel, scalef_expon));
	case 4:
		return (mlib_s_conv3x3_8nw_4(dst, src, kernel, scalef_expon));
	}
	...
	mlib_s32 cmask)
{
	...
	chk_flag = mlib_ImageConvVersion(3, 3, scale, MLIB_BYTE);

	if (nchan == 1)
		cmask = 1;
	if ((cmask & amask) != amask || scale < 25 || chk_flag != 3) {
		if (chk_flag == 0)
			return (mlib_c_conv3x3ext_u8(dst, src, dx_l, dx_r,
			    dy_t, dy_b, (void *)kernel, scale, cmask));
		return (mlib_i_conv3x3ext_u8(dst, src, dx_l, dx_r,
		    dy_t, dy_b, (void *)kernel, scale, cmask));
	}

	switch (nchan) {
	case 1:
		return (mlib_s_conv3x3_8ext_1(dst, src,
			dx_l, dx_r, dy_t, dy_b, (void *)kernel, scale, cmask));
	case 2:
		return (mlib_s_conv3x3_8ext_2(dst, src,
			dx_l, dx_r, dy_t, dy_b, (void *)kernel, scale, cmask));
	case 3:
		return (mlib_s_conv3x3_8ext_3(dst, src,
			dx_l, dx_r, dy_t, dy_b, (void *)kernel, scale, cmask));
	case 4:
		return (mlib_s_conv3x3_8ext_4(dst, src,
			dx_l, dx_r, dy_t, dy_b, (void *)kernel, scale, cmask));
	}
    ...
    mlib_s32 cmask)
{
	...
	chk_flag = mlib_ImageConvVersion(3, 3, scalef_expon, MLIB_SHORT);

	if (nchan == 1)
		cmask = 1;
	if ((cmask & amask) != amask || chk_flag != 3) {
		if (chk_flag == 0)
			return mlib_conv3x3nw_s16(dst, src, kernel,
			    scalef_expon, cmask);
		return mlib_i_conv3x3nw_s16(dst, src, kernel, scalef_expon,
		    cmask);
	}

	switch (nchan) {
	case 1:
		return (mlib_s_conv3x3_16nw_1(dst, src, kernel, scalef_expon));
	case 2:
		return (mlib_s_conv3x3_16nw_2(dst, src, kernel, scalef_expon));
	case 3:
		return (mlib_s_conv3x3_16nw_3(dst, src, kernel, scalef_expon));
	case 4:
		return (mlib_s_conv3x3_16nw_4(dst, src, kernel, scalef_expon));
	}
...
/* *********************************************************** */
    ...
    mlib_status mlib_s_conv3x3ext_s16(
	mlib_image *dst,
	const mlib_image *src,
	mlib_s32 dx_l,
	mlib_s32 dx_r,
	...
	mlib_s32 cmask)
{
	...
	chk_flag = mlib_ImageConvVersion(3, 3, scale, MLIB_SHORT);

	if (nchan == 1)
		cmask = 1;
	if ((cmask & amask) != amask || scale < 25 || chk_flag != 3) {
		if (chk_flag == 0)
			return (mlib_conv3x3ext_s16(dst, src, dx_l, dx_r,
			    dy_t, dy_b, (void *)kernel, scale, cmask));
		return (mlib_i_conv3x3ext_s16(dst, src, dx_l, dx_r,
		    dy_t, dy_b, (void *)kernel, scale, cmask));
	}

	switch (nchan) {
	case 1:
		return (mlib_s_conv3x3_16ext_1(dst, src,
			dx_l, dx_r, dy_t, dy_b, (void *)kernel, scale, cmask));
	case 2:
		return (mlib_s_conv3x3_16ext_2(dst, src,
			dx_l, dx_r, dy_t, dy_b, (void *)kernel, scale, cmask));
	case 3:
		return (mlib_s_conv3x3_16ext_3(dst, src,
			dx_l, dx_r, dy_t, dy_b, (void *)kernel, scale, cmask));
	case 4:
		return (mlib_s_conv3x3_16ext_4(dst, src,
			dx_l, dx_r, dy_t, dy_b, (void *)kernel, scale, cmask));
	}
	...
	mlib_s32 cmask)
{
	...
	if ((cmask & amask) != amask || scale < 25 || chk_flag != 3) {
		if (chk_flag == 0)
			return (mlib_conv3x3ext_u16(dst, src, dx_l, dx_r,
			    dy_t, dy_b, (void *)kernel, scale, cmask));
		return (mlib_i_conv3x3ext_u16(dst, src, dx_l, dx_r,
		    dy_t, dy_b, (void *)kernel, scale, cmask));
	}

	switch (nchan) {
	case 1:
		return (mlib_s_conv3x3_u16ext_1(dst, src,
			dx_l, dx_r, dy_t, dy_b, (void *)kernel, scale, cmask));
	case 2:
		return (mlib_s_conv3x3_u16ext_2(dst, src,
			dx_l, dx_r, dy_t, dy_b, (void *)kernel, scale, cmask));
	case 3:
		return (mlib_s_conv3x3_u16ext_3(dst, src,
			dx_l, dx_r, dy_t, dy_b, (void *)kernel, scale, cmask));
	case 4:
		return (mlib_s_conv3x3_u16ext_4(dst, src,
			dx_l, dx_r, dy_t, dy_b, (void *)kernel, scale, cmask));
	}
