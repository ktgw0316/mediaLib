...
#pragma ident	"@(#)mlib_s_ImageFilteredSubsample.c	9.4	07/11/05 SMI"
...
#define	ARGS                                                        \
	mlib_image *dst, const mlib_image *src, mlib_s32 scaleX,    \
	    mlib_s32 scaleY, mlib_s32 transX, mlib_s32 transY,      \
	    const mlib_d64 *hKernel, const mlib_d64 *vKernel,       \
	    mlib_s32 hSize, mlib_s32 vSize, mlib_s32 hParity,       \
	    mlib_s32 vParity, mlib_edge edge
...
#define	ARGS_SSE2                                                   \
	mlib_image *dst, const mlib_image *src, mlib_s32 scaleX,    \
	    mlib_s32 scaleY, mlib_s32 transX, mlib_s32 transY,      \
	    const mlib_d64 *hKernel, const mlib_d64 *vKernel,       \
	    mlib_s32 iscale, mlib_s32 hSize, mlib_s32 vSize,        \
	    mlib_s32 hParity, mlib_s32 vParity, mlib_edge edge
...
/* *********************************************************** */
    ...
    mlib_status mlib_s_ImageFilteredSubsample_8nw_1(
    ARGS_SSE2);
...
/* SSE2 version */
	if (type == MLIB_BYTE) {
		...
		if (iscale < 0)
			iscale = 0;
		if (iscale < 7)
			return (mlib_s_ImageFilteredSubsample_8nw_1(
			    PARAMS_SSE2));
	}
