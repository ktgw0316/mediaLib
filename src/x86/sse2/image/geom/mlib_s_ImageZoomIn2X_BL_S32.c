...
#pragma ident	"@(#)mlib_s_ImageZoomIn2X_BL_S32.c	9.3	07/11/05 SMI"
...
#define	MLIB_S_ZOOM_FL_S32_P3(x_d0, x_d1, x_dt0, x_dt1) {           \
	__m128i x_dp0_0, x_dp0_1;                                   \
...
#define	MLIB_S_ZOOM_FL_S32_PACK                                     \
	switch (channels) {                                         \
	case 1: {                                                   \
	...
	case 3: {                                                   \
		__m128i x_mask3 = _mm_set_epi32(                    \
		    0, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF);         \
		__m128i x_mask2 = _mm_set_epi32(                    \
		    0, 0, 0xFFFFFFFF, 0xFFFFFFFF);                  \
		__m128i x_mask1 = _mm_set_epi32(                    \
		    0xFFFFFFFF, 0, 0, 0);                           \
		MLIB_S_ZOOM_FL_S32_P3(x_d0_3, x_d1_3, x_dd0, x_dd1) \
		MLIB_S_ZOOM_FL_S32_P3(                              \
		    x_d0s_3, x_d1s_3, x_dd2, x_dd3)                 \
		break;                                              \
	}                                                           \
	}                                                           \
...
#define	MLIB_S_ZOOM_S32_FL0                                     \
	...
	x_sd0 = _mm_srai_epi32(x_sd0, 1);                       \
	x_sd0s = _mm_srai_epi32(x_sd0s, 1);                     \
	x_sd1 = _mm_srai_epi32(x_sd1, 1);                       \
	x_sd1s = _mm_srai_epi32(x_sd1s, 1);                     \
	...
	x_sd00s = _mm_add_epi32(x_sd0, x_sd0s);                 \
	x_sd11s = _mm_add_epi32(x_sd1, x_sd1s);                 \
	x_sd01 = _mm_add_epi32(x_sd0, x_sd1);                   \
	x_sd0s1s = _mm_add_epi32(x_sd0s, x_sd1s);               \
	                                                        \
	x_sd00s = _mm_srai_epi32(x_sd00s, 1);                   \
	x_sd11s = _mm_srai_epi32(x_sd11s, 1);                   \
	x_d0_0 = _mm_add_epi32(x_sd00s, x_sd11s);               \
	x_sd01 = _mm_srai_epi32(x_sd01, 1);                     \
	x_d0_1 = _mm_add_epi32(x_sd00s, x_sd01);                \
	x_d0_0 = _mm_srai_epi32(x_d0_0, 1);                     \
	x_d0_2 = _mm_add_epi32(x_sd0, x_d0_0);                  \
	x_d0_2 = _mm_srai_epi32(x_d0_2, 1);                     \
	x_d0_1 = _mm_srai_epi32(x_d0_1, 1);                     \
	x_d0_3 = _mm_add_epi32(x_d0_2, x_d0_1);                 \
	                                                        \
	x_d1_1 = _mm_add_epi32(x_sd01, x_sd11s);                \
	x_d1_2 = _mm_add_epi32(x_d0_0, x_sd1);                  \
	x_d1_2 = _mm_srai_epi32(x_d1_2, 1);                     \
	x_d1_1 = _mm_srai_epi32(x_d1_1, 1);                     \
	x_d1_3 = _mm_add_epi32(x_d1_2, x_d1_1);                 \
	                                                        \
	x_sd0s1s = _mm_srai_epi32(x_sd0s1s, 1);                 \
	x_d0s_1 = _mm_add_epi32(x_sd0s1s, x_sd00s);             \
	x_d0s_2 = _mm_add_epi32(x_d0_0, x_sd0s);                \
	x_d0s_1 = _mm_srai_epi32(x_d0s_1, 1);                   \
	x_d0s_2 = _mm_srai_epi32(x_d0s_2, 1);                   \
	x_d0s_3 = _mm_add_epi32(x_d0s_1, x_d0s_2);              \
	                                                        \
	x_d1s_1 = _mm_add_epi32(x_sd0s1s, x_sd11s);             \
	x_d1s_2 = _mm_add_epi32(x_d0_0, x_sd1s);                \
	x_d1s_1 = _mm_srai_epi32(x_d1s_1, 1);                   \
	x_d1s_2 = _mm_srai_epi32(x_d1s_2, 1);                   \
	x_d1s_3 = _mm_add_epi32(x_d1s_1, x_d1s_2);              \
	MLIB_S_ZOOM_FL_S32_PACK;                                \
	MLIB_S_ZOOM_FL_STORE(4, 3)

/* *********************************************************** */

#define	MLIB_S_ZOOM_S32_FL1                                     \
	__m128i x_sd0, x_sd0s, x_sd1, x_sd1s;                   \
	...
	x_sd01 = _mm_add_epi32(x_sd0, x_sd1);                   \
	x_sd01 = _mm_srai_epi32(x_sd01, 1);                     \
	x_d0_3 = _mm_add_epi32(x_sd01, x_sd0);                  \
	x_d1_3 = _mm_add_epi32(x_sd01, x_sd1);                  \
	x_sd0s1s = _mm_add_epi32(x_sd0s, x_sd1s);               \
	x_sd0s1s = _mm_srai_epi32(x_sd0s1s, 1);                 \
	x_d0s_0 = _mm_add_epi32(x_sd0s1s, x_sd0s);              \
	x_d0s_1 = _mm_srai_epi32(x_d0s_0, 1);                   \
	x_d0s_2 = _mm_srai_epi32(x_d0_3, 1);                    \
	x_d0s_3 = _mm_add_epi32(x_d0s_1, x_d0s_2);              \
	x_d1s_0 = _mm_add_epi32(x_sd0s1s, x_sd1s);              \
	x_d1s_1 = _mm_srai_epi32(x_d1s_0, 1);                   \
	x_d1s_2 = _mm_srai_epi32(x_d1_3, 1);                    \
	x_d1s_3 = _mm_add_epi32(x_d1s_1, x_d1s_2);              \
	MLIB_S_ZOOM_FL_S32_PACK;                                \
	MLIB_S_ZOOM_FL_STORE(4, 3)
...
#define	MLIB_S_ZOOM_S32_FL2                                     \
	...
	x_sd00s = _mm_srai_epi32(x_sd00s, 1);                   \
	x_sd11s = _mm_srai_epi32(x_sd11s, 1);                   \
	x_d0_3 = _mm_add_epi32(x_sd00s, x_sd0);                 \
	x_d0s_3 = _mm_add_epi32(x_sd00s, x_sd0s);               \
	x_d0s_0 = _mm_add_epi32(x_sd00s, x_sd11s);              \
	x_d0s_1 = _mm_add_epi32(x_sd0, x_sd1);                  \
	x_d0s_0 = _mm_srai_epi32(x_d0s_0, 1);                   \
	x_d0s_1 = _mm_srai_epi32(x_d0s_1, 1);                   \
	x_d1_3 = _mm_add_epi32(x_d0s_0, x_d0s_1);               \
	x_d1s_0 = _mm_add_epi32(x_sd0s, x_sd1s);                \
	x_d1s_1 = _mm_srai_epi32(x_d1s_0, 1);                   \
	x_d1s_3 = _mm_add_epi32(x_d0s_0, x_d1s_1);              \
	MLIB_S_ZOOM_FL_S32_PACK;                                \
	MLIB_S_ZOOM_FL_STORE(4, 3)

/* *********************************************************** */

#define	MLIB_S_ZOOM_S32_FL3                                     \
	__m128i x_sd0, x_sd0s, x_sd1, x_sd1s;                   \
	__m128i x_dd0, x_dd1, x_dd2, x_dd3;                     \
	...
	x_sd1 = _mm_srai_epi32(x_sd1, 1);                       \
	x_sd1s = _mm_srai_epi32(x_sd1s, 1);                     \
	x_d1_3 = _mm_add_epi32(x_sd0, x_sd1);                   \
	x_d0s_3 = _mm_add_epi32(x_sd0, x_sd0s);                 \
	x_d1s_0 = _mm_add_epi32(x_sd1, x_sd1s);                 \
	x_d1s_1 = _mm_srai_epi32(x_d1s_0, 1);                   \
	x_d1s_2 = _mm_srai_epi32(x_d0s_3, 1);                   \
	x_d1s_3 = _mm_add_epi32(x_d1s_1, x_d1s_2);              \
	MLIB_S_ZOOM_FL_S32_PACK;                                \
	MLIB_S_ZOOM_FL_STORE(4, 3)
