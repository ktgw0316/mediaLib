...
#pragma ident   "@(#)mlib_s_ImageRotate270.c	9.6	07/11/05 SMI"
...
void mlib_s_ImageRotate270_U8_1(
    mlib_image *dst,
    const mlib_image *src);
...
void mlib_s_ImageRotate270_S16_1(
    mlib_image *dst,
    const mlib_image *src);
...
void mlib_s_ImageRotate270_S32_1(
    mlib_image *dst,
    const mlib_image *src);

void mlib_s_ImageRotate270_S32_3(
    mlib_image *dst,
    const mlib_image *src);

void mlib_s_ImageRotate270_D64_1(
    mlib_image *dst,
    const mlib_image *src);

void mlib_s_ImageRotate270_D64_2(
    mlib_image *dst,
    const mlib_image *src);

void mlib_s_ImageRotate270_D64_3(
    mlib_image *dst,
    const mlib_image *src);

void mlib_s_ImageRotate270_D64_4(
    mlib_image *dst,
    const mlib_image *src);
...
/*  handle MLIB_BYTE data type of image  */
	case MLIB_BYTE:
		switch (mlib_ImageGetChannels(src)) {
		case 1:
			mlib_s_ImageRotate270_U8_1(dst, src);
			break;
		case 2:
			mlib_s_ImageRotate270_S16_1(dst, src);
			break;
		case 3:
			mlib_c_ImageRotate270_U8_3(dst, src);
			break;
		case 4:
			mlib_s_ImageRotate270_S32_1(dst, src);
			break;
		default:
			return (MLIB_FAILURE);
		}
...
/*  handle MLIB_SHORT data type of image  */
	...
	case MLIB_USHORT:
		...
		case 3:
			...
			break;
		case 4:
			mlib_s_ImageRotate270_D64_1(dst, src);
			break;
		default:
			return (MLIB_FAILURE);
		}
...
/*  handle MLIB_INT data type of image  */
	case MLIB_INT:
		...
		case 2:
			...
			break;
		case 3:
			mlib_s_ImageRotate270_S32_3(dst, src);
			break;
		case 4:
			mlib_s_ImageRotate270_D64_2(dst, src);
			break;
		default:
			return (MLIB_FAILURE);
		}
...
#define	LOAD_16X16_1U8                                             \
	{                                                          \
	    ...
	    mlib_u8 *psq8 = psq6 + 2 * sstride;                    \
	    mlib_u8 *psq10 = psq8 + 2 * sstride;                   \
	    mlib_u8 *psq12 = psq10 + 2 * sstride;                  \
	    mlib_u8 *psq14 = psq12 + 2 * sstride;                  \
                                                                   \
	    wi0 = _mm_loadu_si128((__m128i *)(pssq));              \
...
void
mlib_s_ImageRotate270_D64_1(
    mlib_image *dst,
    const mlib_image *src)
{
	PREPAREVARS(mlib_d64, 1)
	if (sw < 2 || sh < 2) {
		STRIP_1(dststart, sdata, sw, sh, mlib_d64);
	} else {
...
void
mlib_s_ImageRotate270_D64_2(
    mlib_image *dst,
    const mlib_image *src)
{
	PREPAREVARS(mlib_d64, 2)
	    STRIP_SSE2_FP_2(dststart, sdata, sw, sh);
    ...
    const mlib_image *src)
{
	...
	if (numhorzsq <= 0 || numvertsq <= 0) {
		STRIP_3(dststart, sdata, sw, sh, mlib_d64);
		return;
	}
...
void
mlib_s_ImageRotate270_D64_4(
    mlib_image *dst,
    const mlib_image *src)
{
	PREPAREVARS(mlib_d64, 4)
	    STRIP_SSE2_FP_4(dststart, sdata, sw, sh);
}
    ...
    const mlib_image *src)
{
	...
	if (!((sstride | dstride) & 3)) {
		...
		if (numhorzsq <= 0 || numvertsq <= 0) {
			STRIP_3(dststart, sdata, sw, sh, mlib_u32);
			return;
		}
		for (ysq = 1; ysq <= numhorzsq; ++ysq) {
			mlib_s32 xsq;
