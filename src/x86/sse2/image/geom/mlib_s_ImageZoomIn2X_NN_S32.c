...
#pragma ident	"@(#)mlib_s_ImageZoomIn2X_NN_S32.c	9.2	07/11/05 SMI"
...
#define	MLIB_S_CPX_1(i0, i1, ld, st)                       \
	x_sd0 = _mm_##ld##_si128((void *)(psrc + i1));	   \
	x_st0 = _mm_unpacklo_epi32(x_sd0, x_sd0);          \
	x_st1 = _mm_unpackhi_epi32(x_sd0, x_sd0);          \
	_mm_##st##_si128((void *)(pdst + i0), x_st0);      \
	_mm_##st##_si128((void *)(pdst + i0 + 4), x_st1)

#define	CPY_1(i0, i1)	CPY(i0, i1, 0)
#define	CP4_1(i0, i1)	CP4(i0, i1, 0)

#define	MLIB_S_CP4_1(i0, i1, ld, st)                                   \
	x_sd0 = _mm_##ld##_si128((void *)(psrc + i1));	               \
	x_st0 = _mm_unpacklo_epi32(x_sd0, x_sd0);                      \
	x_st1 = _mm_unpackhi_epi32(x_sd0, x_sd0);                      \
	_mm_##st##_si128((void *)(pdst + i0), x_st0);                  \
	_mm_##st##_si128((void *)(pdst + i0 + 4), x_st1);              \
	_mm_##st##_si128((void *)(pdst + i0 + dst_stride), x_st0);     \
	_mm_##st##_si128((void *)(pdst + i0 + 4 + dst_stride), x_st1)
...
#define	MLIB_S_CPX_2(i0, i1, ld, st)                       \
	x_sd0 = _mm_##ld##_si128((void *)(psrc + i1));	   \
...
#define	MLIB_S_CP4_2(i0, i1, ld, st)                                   \
	x_sd0 = _mm_##ld##_si128((void *)(psrc + i1));	               \
	x_st0 = _mm_unpacklo_epi64(x_sd0, x_sd0);                      \
	x_st1 = _mm_unpackhi_epi64(x_sd0, x_sd0);                      \
	_mm_##st##_si128((void *)(pdst + i0), x_st0);                  \
...
#define	MLIB_S_CPX_3(i0, i1, ld, st)                            \
	__m128i x_sd1, x_sd2, x_st2, x_st3, x_st4, x_st5;       \
	const __m128i mask0 = _mm_set_epi32(                    \
	    0x00000000, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF);    \
	const __m128i mask1 = _mm_set_epi32(                    \
	    0x00000000, 0x00000000, 0xFFFFFFFF, 0x00000000);    \
	const __m128i mask2 = _mm_set_epi32(                    \
	    0x00000000, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000000);    \
	x_sd0 = _mm_##ld##_si128((void *)(psrc + i1));	        \
	x_sd1 = _mm_##ld##_si128((void *)(psrc + i1 + 4));      \
	x_sd2 = _mm_##ld##_si128((void *)(psrc + i1 + 8));      \
	x_st0 = _mm_or_si128(_mm_and_si128(x_sd0, mask0),       \
	    _mm_slli_si128(x_sd0, 12));                         \
	x_st1 = _mm_or_si128(_mm_srli_si128(x_sd0, 4),          \
	    _mm_slli_si128(x_sd1, 12));                         \
	x_st2 = _mm_and_si128(x_sd1, mask1);                    \
	x_st3 = _mm_or_si128(_mm_slli_si128(x_st2, 8),          \
	    _mm_srli_si128(x_st2, 4));                          \
	x_st4 = _mm_and_si128(_mm_srli_si128(x_st1, 4), mask2); \
	x_st5 = _mm_or_si128(x_st3, x_st4);                     \
	_mm_##st##_si128((void *)(pdst + i0), x_st0);           \
	_mm_##st##_si128((void *)(pdst + i0 + 4), x_st1);       \
	_mm_##st##_si128((void *)(pdst + i0 + 8), x_st5);       \
	const __m128i mask3 = _mm_set_epi32(                    \
	    0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000000);    \
	const __m128i mask4 = _mm_set_epi32(                    \
	    0x00000000, 0xFFFFFFFF, 0x00000000, 0x00000000);    \
	x_st0 = _mm_or_si128(_mm_and_si128(x_sd2, mask3),       \
	    _mm_srli_si128(x_sd2, 12));                         \
	x_st1 = _mm_or_si128(_mm_slli_si128(x_sd2, 4),          \
	    _mm_srli_si128(x_sd1, 12));                         \
	x_st2 = _mm_and_si128(x_sd1, mask4);                    \
	x_st3 = _mm_or_si128(_mm_slli_si128(x_st2, 4),          \
	    _mm_srli_si128(x_st2, 8));                          \
	x_st4 = _mm_and_si128(_mm_slli_si128(x_st1, 4), mask2); \
	x_st5 = _mm_or_si128(x_st3, x_st4);                     \
	_mm_##st##_si128((void *)(pdst + i0 + 12), x_st5);      \
	_mm_##st##_si128((void *)(pdst + i0 + 16), x_st1);      \
	_mm_##st##_si128((void *)(pdst + i0 + 20), x_st0)

#define	CPY_3(i0, i1)	CPY(i0, i1, 0); CPY(i0, i1, 1); CPY(i0, i1, 2);

#define	CP4_3(i0, i1)	CP4(i0, i1, 0); CP4(i0, i1, 1); CP4(i0, i1, 2)

#define	MLIB_S_CP4_3(i0, i1, ld, st)                                    \
	__m128i x_sd1, x_sd2, x_st2, x_st3, x_st4, x_st5;               \
	const __m128i mask0 = _mm_set_epi32(                            \
	    0x00000000, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF);            \
	const __m128i mask1 = _mm_set_epi32(                            \
	...
	_mm_##st##_si128((void *)(pdst + i0 + dst_stride), x_st0);      \
	_mm_##st##_si128((void *)(pdst + i0 + 4 + dst_stride), x_st1);  \
	_mm_##st##_si128((void *)(pdst + i0 + 8 + dst_stride), x_st5);  \
	const __m128i mask3 = _mm_set_epi32(                            \
	    0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0x00000000);            \
	const __m128i mask4 = _mm_set_epi32(                            \
	    0x00000000, 0xFFFFFFFF, 0x00000000, 0x00000000);            \
	...
	_mm_##st##_si128((void *)(pdst + i0 + 16), x_st1);              \
	_mm_##st##_si128((void *)(pdst + i0 + 20), x_st0);              \
	_mm_##st##_si128((void *)(pdst + i0 + 12 + dst_stride), x_st5); \
	_mm_##st##_si128((void *)(pdst + i0 + 16 + dst_stride), x_st1); \
	_mm_##st##_si128((void *)(pdst + i0 + 20 + dst_stride), x_st0)
...
#define	MLIB_S_CPX_4(i0, i1, ld, st)                      \
	x_sd0 = _mm_##ld##_si128((void *)(psrc + i1));	  \
	_mm_##st##_si128((void *)(pdst + i0), x_sd0);     \
	_mm_##st##_si128((void *)(pdst + i0 + 4), x_sd0)
...
#define	MLIB_S_CP4_4(i0, i1, ld, st)                                  \
	x_sd0 = _mm_##ld##_si128((void *)(psrc + i1));	              \
	_mm_##st##_si128((void *)(pdst + i0), x_sd0);                 \
	_mm_##st##_si128((void *)(pdst + i0 + 4), x_sd0);             \
	_mm_##st##_si128((void *)(pdst + i0 + dst_stride), x_sd0);    \
	_mm_##st##_si128((void *)(pdst + i0 + 4 + dst_stride), x_sd0)

/* *********************************************************** */

#define	MLIB_S_FUNC_ZOOM_NN(NAME, STYPE, N, N2)                           \
	static void                                                       \
 ...
 */                                                                       \
		...
		if ((0 == ((mlib_addr)(psrc) & 15)) &&                    \
		    (0 == ((mlib_addr)(pdst) & 15))) {                    \
			for (j = 0; j < ((src_width / 2) - (mc - 1));     \
			    j += mc) {                                    \
			    MLIB_S_CPX_##N(j * N2, j * N, load, store);   \
			}                                                 \
		} else {                                                  \
			for (j = 0; j < ((src_width / 2) - (mc - 1));     \
			    j += mc) {                                    \
			    MLIB_S_CPX_##N(j * N2, j * N, loadu, storeu); \
			}                                                 \
		}                                                         \
		for (; j < (src_width / 2); j++) {                        \
		    CPX_##N(j * N2, j * N);                               \
		...
		if ((0 == ((mlib_addr)(psrc) & 15)) &&                    \
			...
			for (j = 0; j < (src_width / 2) - (mc - 1);       \
			    j += mc) {                                    \
			    MLIB_S_CP4_##N(j * N2, j * N, load, store);   \
			}                                                 \
		} else {                                                  \
			for (j = 0; j < (src_width / 2) - (mc - 1);       \
			    j += mc) {                                    \
			    MLIB_S_CP4_##N(j * N2, j * N, loadu, storeu); \
			}                                                 \
		}                                                         \
		for (; j < (src_width / 2); j++) {                        \
		    CP4_##N(j * N2, j * N);                               \
