...
#pragma ident	"@(#)mlib_s_ImageZoomIn2X.c	9.5	07/11/05 SMI"
...
/* handle MLIB_BYTE data type of image */
		case MLIB_BYTE:
			...
			case MLIB_BILINEAR:
				switch (flag) {
				case 0:
					mlib_s_ImageZoomIn2X_U8_BL_FL0
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u8));
					break;
				case 1:
					mlib_s_ImageZoomIn2X_U8_BL_FL1
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u8));
					break;
				case 2:
					mlib_s_ImageZoomIn2X_U8_BL_FL2
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u8));
					break;
				case 3:
					mlib_s_ImageZoomIn2X_U8_BL_FL3
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u8));
					break;
				}
			...
			case MLIB_BICUBIC:
				switch (flag) {
				case 0:
					mlib_s_ImageZoomIn2X_U8_BC_FL0
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u8));
					break;
				case 1:
					mlib_s_ImageZoomIn2X_U8_BC_FL1
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u8));
					break;
				case 2:
					mlib_s_ImageZoomIn2X_U8_BC_FL2
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u8));
					break;
				case 3:
					mlib_s_ImageZoomIn2X_U8_BC_FL3
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u8));
					break;
				}
			...
			case MLIB_BICUBIC2:
				switch (flag) {
				case 0:
					mlib_s_ImageZoomIn2X_U8_BC2_FL0
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u8));
					break;
				case 1:
					mlib_s_ImageZoomIn2X_U8_BC2_FL1
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u8));
					break;
				case 2:
					mlib_s_ImageZoomIn2X_U8_BC2_FL2
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u8));
					break;
				case 3:
					mlib_s_ImageZoomIn2X_U8_BC2_FL3
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u8));
					break;
				}
...
/* handle MLIB_SHORT data type of image */
		case MLIB_SHORT:
			...
			case MLIB_BILINEAR:
				switch (flag) {
				case 0:
					mlib_s_ImageZoomIn2X_S16_BL_FL0
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_s16));
					break;
				case 1:
					mlib_s_ImageZoomIn2X_S16_BL_FL1
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_s16));
					break;
				case 2:
					mlib_s_ImageZoomIn2X_S16_BL_FL2
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_s16));
					break;
				case 3:
					mlib_s_ImageZoomIn2X_S16_BL_FL3
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_s16));
					break;
				}
			...
			case MLIB_BICUBIC:
				switch (flag) {
				case 0:
					mlib_s_ImageZoomIn2X_S16_BC_FL0
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_s16));
					break;
				case 1:
					mlib_s_ImageZoomIn2X_S16_BC_FL1
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_s16));
					break;
				case 2:
					mlib_s_ImageZoomIn2X_S16_BC_FL2
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_s16));
					break;
				case 3:
					mlib_s_ImageZoomIn2X_S16_BC_FL3
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_s16));
					break;
				}
			...
			case MLIB_BICUBIC2:
				switch (flag) {
				case 0:
					mlib_s_ImageZoomIn2X_S16_BC2_FL0
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_s16));
					break;
				case 1:
					mlib_s_ImageZoomIn2X_S16_BC2_FL1
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_s16));
					break;
				case 2:
					mlib_s_ImageZoomIn2X_S16_BC2_FL2
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_s16));
					break;
				case 3:
					mlib_s_ImageZoomIn2X_S16_BC2_FL3
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_s16));
					break;
				}
...
/* handle MLIB_USHORT data type of image */
		case MLIB_USHORT:
			...
			case MLIB_BILINEAR:
				switch (flag) {
				case 0:
					mlib_s_ImageZoomIn2X_U16_BL_FL0
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u16));
					break;
				case 1:
					mlib_s_ImageZoomIn2X_U16_BL_FL1
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u16));
					break;
				case 2:
					mlib_s_ImageZoomIn2X_U16_BL_FL2
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u16));
					break;
				case 3:
					mlib_s_ImageZoomIn2X_U16_BL_FL3
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u16));
					break;
				}
			...
			case MLIB_BICUBIC:
				switch (flag) {
				case 0:
					mlib_s_ImageZoomIn2X_U16_BC_FL0
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u16));
					break;
				case 1:
					mlib_s_ImageZoomIn2X_U16_BC_FL1
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u16));
					break;
				case 2:
					mlib_s_ImageZoomIn2X_U16_BC_FL2
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u16));
					break;
				case 3:
					mlib_s_ImageZoomIn2X_U16_BC_FL3
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u16));
					break;
				}
			...
			case MLIB_BICUBIC2:
				switch (flag) {
				case 0:
					mlib_s_ImageZoomIn2X_U16_BC2_FL0
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u16));
					break;
				case 1:
					mlib_s_ImageZoomIn2X_U16_BC2_FL1
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u16));
					break;
				case 2:
					mlib_s_ImageZoomIn2X_U16_BC2_FL2
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u16));
					break;
				case 3:
					mlib_s_ImageZoomIn2X_U16_BC2_FL3
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u16));
					break;
				}
