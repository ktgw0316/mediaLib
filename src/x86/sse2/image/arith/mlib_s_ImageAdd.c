...
#pragma ident	"@(#)mlib_s_ImageAdd.c	9.5	07/11/05 SMI"
...
#define	FUNCTION_NAME	__mlib_ImageAdd

#define	ARITH_OPER_U8(d, s1, s2)	d = _mm_adds_epu8(s1, s2)
#define	ARITH_OPER_S16(d, s1, s2)	d = _mm_add_epi16(s1, s2)
#define	ARITH_OPER_U16(d, s1, s2)	d = _mm_adds_epu16(s1, s2)
#define	ARITH_OPER_S32(d, s1, s2)	d = _mm_add_epi32(s1, s2)
#define	ARITH_OPER_F32(d, s1, s2)	d = _mm_add_ps(s1, s2)
#define	ARITH_OPER_D64(d, s1, s2)	d = _mm_add_pd(s1, s2)
