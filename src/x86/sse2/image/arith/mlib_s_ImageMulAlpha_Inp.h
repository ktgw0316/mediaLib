...
#ifndef _MLIB_S_IMAGEMULALPHA_INP_H
#define	_MLIB_S_IMAGEMULALPHA_INP_H

#pragma ident	"@(#)mlib_s_ImageMulAlpha_Inp.h	9.3	07/11/05 SMI"
...
void
mlib_s_ImageMulAlpha_Inp_U16_4(
    mlib_u16 *sl,
	mlib_s32 stride,
    mlib_s32 width,
    mlib_s32 height,
...
void
mlib_s_ImageMulAlpha_Inp_U16_2(
    mlib_u16 *sl,
	mlib_s32 stride,
    mlib_s32 width,
    mlib_s32 height,
...
#endif /* _MLIB_S_IMAGEMULALPHA_INP_H */
