...
#pragma ident	"@(#)mlib_s_ImageMax_Fp.c	9.4	07/11/05 SMI"
 ...
 *
 * DESCRIPTION
 *	dst[x][y][c] = MAX(src1[x][y][c], src2[x][y][c])
 *	src1dst[x][y][c] = MAX(src1dst[x][y][c], src2[x][y][c])
 */
...
#define	mlib_ImageFunc_Fp	__mlib_ImageMax_Fp

#define	mlib_s_ImageFunc_Fp_f32	mlib_s_ImageMax_Fp_f32
#define	mlib_s_ImageFunc_Fp_d64	mlib_s_ImageMax_Fp_d64

#define	MM_INST_F32		_mm_max_ps
#define	MM_INST_D64		_mm_max_pd
...
__mlib_ImageMax_Fp_Inp(
	...
	const mlib_image *src2)
{
	return (__mlib_ImageMax_Fp(src1dst, src1dst, src2));
}
