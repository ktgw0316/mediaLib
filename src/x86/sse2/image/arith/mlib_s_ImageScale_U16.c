...
#pragma ident   "@(#)mlib_s_ImageScale_U16.c	9.2	07/11/05 SMI"

/*
 * FUNCTION
 *	mlib_s_ImageScale_u16_u8	- linear scaling
 *	mlib_s_ImageScale_u16_s16	- linear scaling
 *	mlib_s_ImageScale_u16_u16	- linear scaling
 *	mlib_s_ImageScale_u16_s32	- linear scaling
 *
 * SYNOPSIS
 *	mlib_status mlib_s_ImageScale_u16_u8(
 *				mlib_u8 *dst,
 *				mlib_s32 dlb,
 *				const mlib_u16 *src,
 *				mlib_s32 slb,
 ...
 *	mlib_status mlib_s_ImageScale_u16_s16(
 *				mlib_s16 *dst,
 *				mlib_s32 dlb,
 *				const mlib_u16 *src,
 *				mlib_s32 slb,
 ...
 *				const mlib_s32 *beta,
 *				const mlib_s32 shift);
 *  mlib_status mlib_s_ImageScale_u16_u16(
 *				mlib_u16 *dst,
 *				mlib_s32 dlb,
 *				const mlib_u16 *src,
 *				mlib_s32 slb,
 ...
 *				const mlib_s32 *beta,
 *				const mlib_s32 shift);
 *  mlib_status mlib_s_ImageScale_u16_s32(
 *				mlib_s32 *dst,
 *				mlib_s32 dlb,
 *				const mlib_u16 *src,
 *				mlib_s32 slb,
...
#define	MLIB_S_IMAGESCALE3_U16_U8(D_STORE, S_LOAD)           \
	{                                                       \
		__m128i dsts, dsts0, dsts1;                         \
		__m128i srcs;                                       \
		__m128i part0, part1;                               \
		srcs  = S_LOAD((void *)srcPtr);                     \
		srcs = _mm_xor_si128(srcs, mask8000);               \
		srcPtr++;                                           \
...
#define	OPER_U8(k)                                         \
	((sl[i + k] - 32768) * alpha[k] + beta[k]) >> shift
#define	OPER_S16(k)                                        \
	((sl[i + k] - 32768) * alpha[k] + beta[k]) >> shift
#define	OPER_U16(k)                                        \
	((sl[i + k] - 32768) * alpha[k] + beta[k]) >> shift
...
#define	MLIB_S_IMAGESCALE_U16_S16(D_STORE, S_LOAD)	        \
	{                                                       \
		__m128i dsts, dsts0, dsts1;                         \
		__m128i srcs;                                       \
		__m128i part0, part1;                               \
...
#define	MLIB_S_IMAGESCALE3_U16_S16(D_STORE, S_LOAD)           \
	{                                                       \
		__m128i dsts, dsts0, dsts1;                         \
		__m128i srcs;                                       \
		__m128i part0, part1;                               \
...
#define	MLIB_S_IMAGESCALE_U16_U16(D_STORE, S_LOAD)	        \
	{                                                       \
		__m128i dsts, dsts0, dsts1;                         \
		__m128i srcs;                                       \
		__m128i part0, part1;                               \
...
#define	MLIB_S_IMAGESCALE3_U16_U16(D_STORE, S_LOAD)           \
	{                                                       \
		__m128i dsts, dsts0, dsts1;                         \
		__m128i srcs;                                       \
		__m128i part0, part1;                               \
...
#define	MLIB_S_IMAGESCALE_U16_S32(D_STORE, S_LOAD)	        \
	{                                                       \
		__m128i dsts0, dsts1;                               \
		__m128i srcs;                                       \
		__m128i part0, part1;                               \
...
#define	MLIB_S_IMAGESCALE3_U16_S32(D_STORE, S_LOAD)           \
	{                                                       \
		__m128i dsts0, dsts1;                               \
		__m128i srcs;                                       \
		__m128i part0, part1;                               \
