...
#pragma ident	"@(#)mlib_s_ImageConstMul_Fp.c	9.4	07/11/05 SMI"

/*
 * FUNCTION
 *	mlib_ImageConstMul_Fp 		- multiply an image with a constant
 *	mlib_ImageConstMul_Fp_Inp	- multiply an image with a constant
 *
 * SYNOPSIS
...
#define	mlib_ImageConstFunc_Fp		__mlib_ImageConstMul_Fp

#define	mlib_s_ImageConstFunc_Fp_f32	mlib_s_ImageConstMul_Fp_f32
#define	mlib_s_ImageConstFunc_Fp_d64	mlib_s_ImageConstMul_Fp_d64
