...
#pragma ident	"@(#)mlib_s_ImageAndNot_Bit.c	9.2	07/11/05 SMI"

/*
 * FUNCTION
 *      mlib_ImageAndNot_Bit     - andnot two bit type images  (C version)
 *
 * SYNOPSIS
 ...
 *
 * DESCRIPTION
 *     AndNot two images for each channel:     dst = src1 & (~src2)
 */
...
#define	LOGIC_BITS                                                      \
	mlib_status                                                     \
	mlib_ImageAndNot_Bit(mlib_image *dst, const mlib_image *src1,   \
	    const mlib_image *src2)
