...
#pragma ident	"@(#)mlib_s_ImageConstOr_Bit.c	9.2	07/11/05 SMI"

/*
 * FUNCTION
 *      mlib_ImageConstOr_Bit - image logical operation with constant
 *                              (type of image - BIT)
 *
 * SYNOPSIS
...
#define	CONST_LOGIC_BITS                                                \
	mlib_status                                                     \
	mlib_ImageConstOr_Bit(mlib_image *dst, const mlib_image *src,   \
	    const mlib_s32 *c)
