...
#pragma ident	"@(#)mlib_s_ImageNotAnd_Bit.c	9.2	07/11/05 SMI"

/*
 * FUNCTION
 *      mlib_ImageNotAnd_Bit     - notand two bit type images  (C version)
 *
 * SYNOPSIS
...
#define	LOGIC_BITS                                                      \
	mlib_status                                                     \
	mlib_ImageNotAnd_Bit(mlib_image *dst, const mlib_image *src1,   \
	    const mlib_image *src2)
