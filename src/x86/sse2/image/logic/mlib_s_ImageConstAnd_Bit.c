...
#pragma ident	"@(#)mlib_s_ImageConstAnd_Bit.c	9.2	07/11/05 SMI"
...
#define	CONSTLOGIC_SSE2(c, a)	_mm_and_si128(c, a)

/* *********************************************************** */

#define	CONST_LOGIC_BITS                                                 \
	mlib_status                                                      \
	mlib_ImageConstAnd_Bit(mlib_image *dst, const mlib_image *src,   \
	    const mlib_s32 *c)
