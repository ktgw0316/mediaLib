...
#pragma ident	"@(#)mlib_s_ImageConstXor_Bit.c	9.2	07/11/05 SMI"

/*
 * FUNCTION
 *      mlib_ImageConstXor_Bit - image logical operation with constant
 *                               (type of image - BIT)
 *
 * SYNOPSIS
...
#define	CONSTLOGIC_SSE2(c, a)	_mm_xor_si128(c, a)

/* *********************************************************** */

#define	CONST_LOGIC_BITS                                                 \
	mlib_status                                                      \
	mlib_ImageConstXor_Bit(mlib_image *dst, const mlib_image *src,   \
	    const mlib_s32 *c)
