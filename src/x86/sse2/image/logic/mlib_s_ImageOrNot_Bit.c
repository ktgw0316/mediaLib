...
#pragma ident	"@(#)mlib_s_ImageOrNot_Bit.c	9.2	07/11/05 SMI"

/*
 * FUNCTION
 *      mlib_ImageOrNor_Bit     - ornot two bit type images  (C version)
 *
 * SYNOPSIS
 ...
 *
 * DESCRIPTION
 *     OrNot two images for each band:   dst = src1 | (~src2)
 */

/* *********************************************************** */

#define	OPERATION(a1, a2)	(a1) | (~(a2))
#define	OPERATION_SSE2(a1, a2)	_mm_or_si128(a1, _mm_andnot_si128(a2, ones))

/* *********************************************************** */

#define	LOGIC_BITS                                                     \
	mlib_status                                                    \
	mlib_ImageOrNot_Bit(mlib_image *dst, const mlib_image *src1,   \
	    const mlib_image *src2)
