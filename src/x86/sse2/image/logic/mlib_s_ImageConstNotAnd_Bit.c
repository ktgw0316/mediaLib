...
#pragma ident	"@(#)mlib_s_ImageConstNotAnd_Bit.c	9.2	07/11/05 SMI"

/*
 * FUNCTION
 *      mlib_ImageConstNotAnd_Bit - image logical operation with constant
 *                                  (type of image - BIT)
 *
 * SYNOPSIS
...
#define	CONST_LOGIC_BITS                                        \
	mlib_status                                             \
	mlib_ImageConstNotAnd_Bit(mlib_image *dst,              \
