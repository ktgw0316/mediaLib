...
#pragma ident	"@(#)mlib_s_ImageNotAnd.c	9.2	07/11/05 SMI"

/*
 * FUNCTION
 *      mlib_ImageNotAnd   - notAnd two images  (C version)
 *
 * SYNOPSIS
 *      mlib_status mlib_ImageNotAnd(mlib_image *dst,
 ...
 *
 * DESCRIPTION
 *      NotAnd two images for each band:  dst = ~(src1 & src2)
 */
...
#pragma weak mlib_ImageNotAnd = __mlib_ImageNotAnd

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageNotAnd) mlib_ImageNotAnd
    __attribute__((weak, alias("__mlib_ImageNotAnd")));
...
#define	OPERATION_SSE2(a1, a2)	_mm_andnot_si128(_mm_and_si128(a1, a2), ones)
