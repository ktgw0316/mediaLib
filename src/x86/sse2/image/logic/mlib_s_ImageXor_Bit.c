...
#pragma ident	"@(#)mlib_s_ImageXor_Bit.c	9.2	07/11/05 SMI"

/*
 * FUNCTION
 *      mlib_ImageXor_Bit     - xor two bit type images  (C version)
 *
 * SYNOPSIS
...
#define	OPERATION_SSE2(a1, a2)	_mm_xor_si128(a1, a2)

/* *********************************************************** */

#define	LOGIC_BITS                                                   \
	mlib_status                                                  \
	mlib_ImageXor_Bit(mlib_image *dst, const mlib_image *src1,   \
	    const mlib_image *src2)
