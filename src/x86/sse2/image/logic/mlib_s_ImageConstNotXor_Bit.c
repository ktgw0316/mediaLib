...
#pragma ident	"@(#)mlib_s_ImageConstNotXor_Bit.c	9.2	07/11/05 SMI"

/*
 * FUNCTION
 *      mlib_ImageConstNotXor_Bit - image logical operation with constant
 *                                  (type of image - BIT)
 *
 * SYNOPSIS
...
#define	CONST_LOGIC_BITS                                        \
	mlib_status                                             \
	mlib_ImageConstNotXor_Bit(mlib_image *dst,              \
