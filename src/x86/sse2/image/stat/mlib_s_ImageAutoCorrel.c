...
#pragma ident	"@(#)mlib_s_ImageAutoCorrel.c	9.2	07/11/05 SMI"
...
/* handle MLIB_BYTE data type of image */
	case MLIB_BYTE:
		...
		case 1:
			mlib_s_ImageCrossCorrel_U8_1(img1, img2, rez);
			break;
		case 2:
			mlib_s_ImageCrossCorrel_U8_2(img1, img2, rez);
			break;
		case 3:
			mlib_s_ImageCrossCorrel_U8_3(img1, img2, rez);
			break;
		case 4:
			mlib_s_ImageCrossCorrel_U8_4(img1, img2, rez);
			break;
		default:
			return (MLIB_FAILURE);
		}
...
/* handle MLIB_USHORT data type of image */
	case MLIB_USHORT:
		...
		switch (mlib_ImageGetChannels(img1)) {
		case 1:
			mlib_s_ImageCrossCorrel_U16_1(img1, img2, rez);
			break;
		case 2:
			mlib_s_ImageCrossCorrel_U16_2(img1, img2, rez);
			break;
		case 3:
			mlib_s_ImageCrossCorrel_U16_3(img1, img2, rez);
			break;
		case 4:
			mlib_s_ImageCrossCorrel_U16_4(img1, img2, rez);
			break;
		default:
			return (MLIB_FAILURE);
		}
...
/* handle MLIB_SHORT data type of image */
	case MLIB_SHORT:
		switch (mlib_ImageGetChannels(img1)) {
		case 1:
			mlib_s_ImageCrossCorrel_S16_1(img1, img2, rez);
			break;
		case 2:
			mlib_s_ImageCrossCorrel_S16_2(img1, img2, rez);
			break;
		case 3:
			mlib_s_ImageCrossCorrel_S16_3(img1, img2, rez);
			break;
		case 4:
			mlib_s_ImageCrossCorrel_S16_4(img1, img2, rez);
			break;
		default:
			return (MLIB_FAILURE);
		}
...
/* handle MLIB_INT data type of image */
	case MLIB_INT:
		switch (mlib_ImageGetChannels(img1)) {
		case 1:
			mlib_s_ImageCrossCorrel_S32_1(img1, img2, rez);
			break;
		case 2:
			mlib_s_ImageCrossCorrel_S32_2(img1, img2, rez);
			break;
		case 3:
			mlib_s_ImageCrossCorrel_S32_3(img1, img2, rez);
			break;
		case 4:
			mlib_s_ImageCrossCorrel_S32_4(img1, img2, rez);
			break;
		default:
			return (MLIB_FAILURE);
		}
