...
#pragma ident	"@(#)mlib_s_ImageBlend_SC_SAS.c	9.2	07/11/05 SMI"
...
{                                                         \
	...
	dalpha1 = _mm_mullo_epi16(ssrc1, ssrc2);              \
...
{                                                         \
	...
	for (k = i; k < dst_width; k++) {                     \
		...
		d_s2 = psrc1[4 * k + 2];                          \
                                                          \
		d_s0 = (psrc2[4 * k + 0] * (d_s0 + min)) >> 8;    \
		d_s1 = (psrc2[4 * k + 1] * (d_s1 + min)) >> 8;    \
		d_s2 = (psrc2[4 * k + 2] * (d_s2 + min)) >> 8;    \
                                                          \
		SAT_U8_U8C(pdst[4 * k + 0], d_s0);                \
		SAT_U8_U8C(pdst[4 * k + 1], d_s1);                \
		SAT_U8_U8C(pdst[4 * k + 2], d_s2);                \
		SAT_U8_U8C(pdst[4 * k + 3], (psrc2[4 * k + 3] *   \
			(psrc1[4 * k + 3] + 256) >> 8));              \
	}                                                     \
}
...
{                                                         \
	...
	for (k = i; k < dst_width; k++) {                     \
		...
		d_s2 = psrc1[4 * k + 3];                          \
                                                          \
		d_s0 = (psrc2[4 * k + 1] * (d_s0 + min)) >> 8;    \
		d_s1 = (psrc2[4 * k + 2] * (d_s1 + min)) >> 8;    \
		d_s2 = (psrc2[4 * k + 3] * (d_s2 + min)) >> 8;    \
                                                          \
		SAT_U8_U8C(pdst[4 * k + 0], (psrc2[4 * k + 0] *   \
			(psrc1[4 * k + 0] + 256) >> 8));              \
		SAT_U8_U8C(pdst[4 * k + 1], d_s0);                \
		SAT_U8_U8C(pdst[4 * k + 2], d_s1);                \
		SAT_U8_U8C(pdst[4 * k + 3], d_s2);                \
	}                                                     \
}
/* *********************************************************** */
