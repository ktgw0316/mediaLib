...
#pragma ident	"@(#)mlib_s_ImageBlend_OMSA_OMSA.c	9.2	07/11/05 SMI"

/*
 * FUNCTION
 *      mlib_ImageBlend_OMSA_OMSA - blend two images with
 *      OMSA source blend factor and OMSA destination blend factor
 *
 * SYNOPSIS
 *
 *      mlib_status mlib_ImageBlend_OMSA_OMSA(mlib_image       *dst,
...
#pragma weak mlib_ImageBlend_OMSA_OMSA = __mlib_ImageBlend_OMSA_OMSA

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageBlend_OMSA_OMSA) mlib_ImageBlend_OMSA_OMSA
    __attribute__((weak, alias("__mlib_ImageBlend_OMSA_OMSA")));
...
{                                                         \
	...
	dalpha3 = _mm_add_epi16(dalpha3, done_one);           \
                                                          \
	dalpha1 = _mm_mullo_epi16(dalpha3, ssrc2);            \
                                                          \
