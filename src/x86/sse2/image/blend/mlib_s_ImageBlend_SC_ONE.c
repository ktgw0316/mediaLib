...
#pragma ident	"@(#)mlib_s_ImageBlend_SC_ONE.c	9.2	07/11/05 SMI"
...
{                                                         \
	__m128i alpha1;                                       \
	alpha1 = _mm_slli_epi16(ssrc2, 8);                    \
	sdst = _mm_mullo_epi16(ssrc1, ssrc2);                 \
	sdst = _mm_adds_epu16(alpha1, sdst);                  \
...
{                                                         \
	for (k = i; k < dst_width; k++) {                     \
		SAT_U8_U8C(pdst[k], ((((mlib_s32)psrc1[k] + 256) *\
			(mlib_s32) psrc2[k]) >> 8));                 \
	}                                                     \
}
