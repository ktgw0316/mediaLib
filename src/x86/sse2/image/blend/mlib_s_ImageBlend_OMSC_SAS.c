...
#pragma ident	"@(#)mlib_s_ImageBlend_OMSC_SAS.c	9.2	07/11/05 SMI"
...
{                                                         \
	...
	dalpha2 = _mm_insert_epi16(dalpha2, 0x100, 4);        \
	                                                      \
	dalpha1 = _mm_mullo_epi16(dalpha2, ssrc2);            \
...
{                                                         \
	for (k = i; k < dst_width; k++) {                     \
		...
		d_s0 = psrc1[4 * k + 0] + ((psrc2[4 * k + 0] *    \
			(256 - psrc1[4 * k + 0])) >> 8);              \
		d_s1 = psrc1[4 * k + 1] + ((psrc2[4 * k + 1] *    \
			(min - psrc1[4 * k + 1])) >> 8);              \
		d_s2 = psrc1[4 * k + 2] + ((psrc2[4 * k + 2] *    \
			(min - psrc1[4 * k + 2])) >> 8);              \
		d_s3 = psrc1[4 * k + 3] + ((psrc2[4 * k + 3] *    \
			(min - psrc1[4 * k + 3])) >> 8);              \
                                                          \
