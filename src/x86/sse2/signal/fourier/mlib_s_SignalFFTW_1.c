...
#pragma ident	"@(#)mlib_s_SignalFFTW_1.c	9.5	07/11/05 SMI"

/*
 * FUNCTIONS
 *  NOTE: FFT below means F(ast)F(ourier)T(ransform)
 *      mlib_SignalFFTW_1_S16C_S16C_Mod  - windowed FFT of 16-bit format complex
 *                                         array into complex array
 *      mlib_SignalFFTW_1_S16_S16_Mod    - windowed FFT
 *                                         of 16-bit format 2 arrays
 *                                         as real and imag parts
 *                                         of complex into 2
 *                                         arrays as real and
 *                                         imag parts of complex
 *      mlib_SignalFFTW_1_S16C_S16_Mod   - windowed FFT of 16bit format 1 array
 *                                         as real part of( real-valued )
 *                                         complex into complex array
 *      mlib_SignalIFFTW_1_S16C_S16C     - inverse windowed FFT of 16-bit format
 *                                         complex array into complex array
 *      mlib_SignalIFFTW_1_S16_S16       - inverse windowed FFT of 16-bit format
 *                                         2 arrays as real and imag parts of
 *                                         complex into 2 arrays as real and
 *                                         imag parts of complex
 *      mlib_SignalIFFTW_1_S16_S16C      - inverse windowed FFT of 16bit format
 *                                         complex array into 1 array as real
 *                                         part of( real-valued ) complex
 *                                         NOTE: this is a semantic pair
 *                                           to mlib_SignalFFTW_1_S16C_S16_Mod
 *      mlib_SignalFFTW_1_S16C_Mod       - windowed FFT of 16-bit format complex
 *                                         array into complex array
 *                                         (input and output arrays
 *                                         are the same)
 *      mlib_SignalFFTW_1_S16_Mod        - windowed FFT
 *                                         of 16-bit format 2 arrays
 *                                         as real and imag parts
 *                                         of complex into
 *                                         2 arrays as real and imag parts of
 ...
 *                                         are the same)
 *      mlib_SignalIFFTW_1_S16C          - inverse windowed FFT
 *                                         of 16-bit format complex
 *                                         array into complex array
 *                                         (input and output arrays
 *                                         are the same)
 *      mlib_SignalIFFTW_1_S16           - inverse windowed FFT of 16-bit format
 *                                         2 arrays as real and imag parts of
 *                                         complex into 2 arrays as real and
 *                                         imag parts of complex
 *                                         (input and output array pairs
 ...
 * SYNOPSIS
 *
 *      mlib_status mlib_SignalFFTW_1_S16C_Mod(mlib_s16       *datac,
 *                                             const mlib_s16 *window,
 *                                             mlib_s32       order);
 *      mlib_status mlib_SignalFFTW_1_S16C_S16C_Mod(mlib_s16       *dstc,
 *                                                  const mlib_s16 *srcc,
 *                                                  const mlib_s16 *window,
 *                                                  mlib_s32       order);
 *      mlib_status mlib_SignalFFTW_1_S16C_S16_Mod(mlib_s16       *dstc,
 *                                                 const mlib_s16 *srcr,
 *                                                 const mlib_s16 *window,
 *                                                 mlib_s32       order);
 *      mlib_status mlib_SignalFFTW_1_S16_Mod(mlib_s16       *datar,
 *                                            mlib_s16       *datai,
 *                                            const mlib_s16 *window,
 *                                            mlib_s32       order);
 *      mlib_status mlib_SignalFFTW_1_S16_S16_Mod(mlib_s16       *dstr,
 *                                                const mlib_s16 *dsti,
 *                                                const mlib_s16 *srcr,
 *                                                const mlib_s16 *srci,
 *                                                const mlib_s16 *window,
 *                                                mlib_s32       order);
 *      mlib_status mlib_SignalIFFTW_1_S16(mlib_s16       *datar,
 *                                         mlib_s16       *datai,
 *                                         const mlib_s16 *window,
 *                                         mlib_s32       order);
 *      mlib_status mlib_SignalIFFTW_1_S16C(mlib_s16       *datac,
 *                                          const mlib_s16 *window,
 *                                          mlib_s32       order);
 ...
 *                                               const mlib_s16 *window,
 *                                               mlib_s32       order);
 *      mlib_status mlib_SignalIFFTW_1_S16_S16(mlib_s16       *dstr,
 *                                             const mlib_s16 *dsti,
 *                                             const mlib_s16 *srcr,
 *                                             const mlib_s16 *srci,
 *                                             const mlib_s16 *window,
 ...
 * Note1. Functions like mlib*FFTW_1_S16 and mlib*FFTW_1_S16C are trivially
 *  mapped into mlib*FFTW_1_S16_S16 and mlib*FFTW_1_S16C_S16C.
...
#pragma weak mlib_SignalFFTW_1_S16C_Mod = __mlib_SignalFFTW_1_S16C_Mod
#pragma weak mlib_SignalFFTW_1_S16C_S16C_Mod = \
	__mlib_SignalFFTW_1_S16C_S16C_Mod
#pragma weak mlib_SignalFFTW_1_S16C_S16_Mod = \
	__mlib_SignalFFTW_1_S16C_S16_Mod
#pragma weak mlib_SignalFFTW_1_S16_Mod = __mlib_SignalFFTW_1_S16_Mod
#pragma weak mlib_SignalFFTW_1_S16_S16_Mod = __mlib_SignalFFTW_1_S16_S16_Mod
#pragma weak mlib_SignalIFFTW_1_S16 = __mlib_SignalIFFTW_1_S16
#pragma weak mlib_SignalIFFTW_1_S16C = __mlib_SignalIFFTW_1_S16C
#pragma weak mlib_SignalIFFTW_1_S16C_S16C = __mlib_SignalIFFTW_1_S16C_S16C
#pragma weak mlib_SignalIFFTW_1_S16_S16 = __mlib_SignalIFFTW_1_S16_S16
#pragma weak mlib_SignalIFFTW_1_S16_S16C = __mlib_SignalIFFTW_1_S16_S16C

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_SignalFFTW_1_S16C_Mod) mlib_SignalFFTW_1_S16C_Mod
    __attribute__((weak, alias("__mlib_SignalFFTW_1_S16C_Mod")));
__typeof__(__mlib_SignalFFTW_1_S16C_S16C_Mod) mlib_SignalFFTW_1_S16C_S16C_Mod
    __attribute__((weak, alias("__mlib_SignalFFTW_1_S16C_S16C_Mod")));
__typeof__(__mlib_SignalFFTW_1_S16C_S16_Mod) mlib_SignalFFTW_1_S16C_S16_Mod
    __attribute__((weak, alias("__mlib_SignalFFTW_1_S16C_S16_Mod")));
__typeof__(__mlib_SignalFFTW_1_S16_Mod) mlib_SignalFFTW_1_S16_Mod
    __attribute__((weak, alias("__mlib_SignalFFTW_1_S16_Mod")));
__typeof__(__mlib_SignalFFTW_1_S16_S16_Mod) mlib_SignalFFTW_1_S16_S16_Mod
    __attribute__((weak, alias("__mlib_SignalFFTW_1_S16_S16_Mod")));
__typeof__(__mlib_SignalIFFTW_1_S16) mlib_SignalIFFTW_1_S16
    __attribute__((weak, alias("__mlib_SignalIFFTW_1_S16")));
__typeof__(__mlib_SignalIFFTW_1_S16C) mlib_SignalIFFTW_1_S16C
    __attribute__((weak, alias("__mlib_SignalIFFTW_1_S16C")));
__typeof__(__mlib_SignalIFFTW_1_S16C_S16C) mlib_SignalIFFTW_1_S16C_S16C
    __attribute__((weak, alias("__mlib_SignalIFFTW_1_S16C_S16C")));
__typeof__(__mlib_SignalIFFTW_1_S16_S16) mlib_SignalIFFTW_1_S16_S16
    __attribute__((weak, alias("__mlib_SignalIFFTW_1_S16_S16")));
__typeof__(__mlib_SignalIFFTW_1_S16_S16C) mlib_SignalIFFTW_1_S16_S16C
    __attribute__((weak, alias("__mlib_SignalIFFTW_1_S16_S16C")));
...
/* undefine the macros that are redefined in this file */
#undef	LOAD_ROT_INV
    ...
    mlib_s32 order)
{
	...
	case 3:
		...
		dsrc2 =
		    ...
		    FREG(add, hi, dst1, hi, dsrc0, sub, 00, AS_HL(sub, 00,
		    fzero, hi, dst3), lo, dsrc0));
		dsrc3 =
		...
		dsrc5 = SSE2_fpackfix_pair_r(dsrc5,
    ...
    mlib_s32 order)
{
	...
	case 1:
		...
		dsrc0 = MUL32F(_MM_READ32_hi(dwin), _MM_READ32_hi(dsrc0));
		dsrc1 = MUL32F(_MM_READ32_hi(dwin), _MM_READ32_hi(dsrc1));
		fdst0 = SSE2_fpackfix_r(
		    FREG(add, hi, dsrc0, lo, dsrc0, sub, hi, dsrc0, lo, dsrc0));
		fdst1 = SSE2_fpackfix_r(
		    FREG(add, hi, dsrc1, lo, dsrc1, sub, hi, dsrc1, lo, dsrc1));
		VIS_STF(dstr, fdst0);
		VIS_STF(dsti, fdst1);
		break;
    ...
    mlib_s32 order)
{
	...
	case 1:
		...
		VIS_LDD(dsrc, srcc);
		MUL32_WIN(dsrc0, dsrc1, dwin, dsrc);
		fdst0 = SSE2_fpackfix_r(FREG(add, hi, dsrc0, hi,
			dsrc1, sub, hi, dsrc0, hi, dsrc1));
		VIS_STF(dstr, fdst0);
		break;
    ...
    mlib_s32 order)
{
	...
	if (order <= 4)
		...
		return mlib_s_fftDispatcherW_1(dstc, NULL, (void *)srcc, NULL,
...
mlib_status
__mlib_SignalFFTW_1_S16_S16_Mod(
    mlib_s16 *dstr,
    mlib_s16 *dsti,
    const mlib_s16 *srcr,
    const mlib_s16 *srci,
    ...
    mlib_s32 order)
{
	...
	if (order <= 4)
		...
		return mlib_s_fftDispatcherW_1(dstr, dsti, (void *)srcr,
    ...
    mlib_s32 order)
{
	...
	if (order <= 4)
		...
		return mlib_s_fftDispatcherW_1(dstc, NULL, (void *)srcr, NULL,
...
mlib_status
__mlib_SignalIFFTW_1_S16C_S16C(
    mlib_s16 *dstc,
    const mlib_s16 *srcc,
    const mlib_s16 *window,
    mlib_s32 order)
    ...
    mlib_s32 order)
{
	...
	if (order <= 4)
		...
		return mlib_s_fftDispatcherW_1(dstr, NULL, (void *)srcc, NULL,
...
mlib_status
__mlib_SignalFFTW_1_S16C_Mod(
    mlib_s16 *datac,
    const mlib_s16 *window,
    mlib_s32 order)
{
	return (__mlib_SignalFFTW_1_S16C_S16C_Mod(datac, datac, window, order));
}

/* *********************************************************** */

mlib_status
__mlib_SignalFFTW_1_S16_Mod(
    mlib_s16 *datar,
    mlib_s16 *datai,
    const mlib_s16 *window,
    mlib_s32 order)
{
	return __mlib_SignalFFTW_1_S16_S16_Mod(datar, datai, datar, datai,
	    window, order);
}
...
mlib_status
__mlib_SignalIFFTW_1_S16C(
    mlib_s16 *datac,
    const mlib_s16 *window,
    mlib_s32 order)
{
	return (__mlib_SignalIFFTW_1_S16C_S16C(datac, datac, window, order));
}

/* *********************************************************** */

mlib_status
__mlib_SignalIFFTW_1_S16(
    mlib_s16 *datar,
    mlib_s16 *datai,
    const mlib_s16 *window,
    mlib_s32 order)
{
	return __mlib_SignalIFFTW_1_S16_S16(datar, datai, datar, datai, window,
	    order);
}
