...
#ifndef _MLIB_S_SIGNALFFTSETTINGS_H
#define	_MLIB_S_SIGNALFFTSETTINGS_H

#pragma ident	"@(#)mlib_s_SignalFFTSettings.h	9.2	07/11/05 SMI"
...
#endif /* _MLIB_S_SIGNALFFTSETTINGS_H */
