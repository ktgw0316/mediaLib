...
#pragma ident	"@(#)mlib_SignalMulHanning_Fp.c	9.2	07/10/09 SMI"

/*
 * FUNCTIONS
 *      mlib_SignalMulHanning_F32 - multiply source data on
 *          coefficients of the corresponding window
 *
 *      mlib_SignalMulHanning_F32S - multiply stereo source
 *          data on coefficients of the corresponding window
 *
 *      mlib_SignalMulHanning_F32_F32 - multiply source data on
 *          coefficients of the corresponding window with results
 *          in destination array
 *
 *      mlib_SignalMulHanning_F32S_F32S - multiply stereo source
 *          data on coefficients of the corresponding window with
 *          result in destination array
 *
 * SYNOPSIS
 *
 *      mlib_status mlib_SignalMulHanning_F32( mlib_f32 *data,
 *                                            mlib_s32  n);
 *      mlib_status mlib_SignalMulHanning_F32S( mlib_f32 *data,
 *                                             mlib_s32  n);
...
#pragma weak mlib_SignalMulHanning_F32 = __mlib_SignalMulHanning_F32
#pragma weak mlib_SignalMulHanning_F32S = __mlib_SignalMulHanning_F32S
#pragma weak mlib_SignalMulHanning_F32S_F32S = \
	__mlib_SignalMulHanning_F32S_F32S
#pragma weak mlib_SignalMulHanning_F32_F32 = __mlib_SignalMulHanning_F32_F32

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_SignalMulHanning_F32) mlib_SignalMulHanning_F32
    __attribute__((weak, alias("__mlib_SignalMulHanning_F32")));
__typeof__(__mlib_SignalMulHanning_F32S) mlib_SignalMulHanning_F32S
    __attribute__((weak, alias("__mlib_SignalMulHanning_F32S")));
__typeof__(__mlib_SignalMulHanning_F32S_F32S) mlib_SignalMulHanning_F32S_F32S
    __attribute__((weak, alias("__mlib_SignalMulHanning_F32S_F32S")));
__typeof__(__mlib_SignalMulHanning_F32_F32) mlib_SignalMulHanning_F32_F32
    __attribute__((weak, alias("__mlib_SignalMulHanning_F32_F32")));
...
mlib_status
__mlib_SignalMulHanning_F32_F32(
    mlib_f32 *dst,
    const mlib_f32 *src,
    mlib_s32 n)
{
	return mlib_SignalMulHanning_F32_F32_i(dst, src, n,
		0, n / 4);
}

mlib_status
__mlib_SignalMulHanning_F32(
    mlib_f32 *data,
    mlib_s32 n)
{
	return mlib_SignalMulHanning_F32_F32_i(data, data, n,
		0, n / 4);
}
...
#pragma pipeloop(0)
	...
	if ((n & 3) && i1 == n / 4) {
		...
		switch (n & 3) {
		case 3:
			dst[5] = src[5] * (.5 - cbase2);
			dst[4] = src[4] * (.5 - cbase2);
		case 2:
			dst[3] = src[3] * (.5 - cbase1);
			dst[2] = src[2] * (.5 - cbase1);
		case 1:
...
__mlib_SignalMulHanning_F32S_F32S(
    ...
    mlib_s32 n)
{
	return mlib_SignalMulHanning_F32S_F32S_i(dst, src, n,
		0, n / 4);
}

mlib_status
__mlib_SignalMulHanning_F32S(
    mlib_f32 *data,
    mlib_s32 n)
{
	return mlib_SignalMulHanning_F32S_F32S_i(data, data, n,
		0, n / 4);
}
