...
#ifndef _MLIB_SIGNALFFTUTIL_H
#define	_MLIB_SIGNALFFTUTIL_H

#pragma ident	"@(#)mlib_SignalFFTUtil.h	9.3	07/10/09 SMI"
...
#include <mlib_SignalFFTSettings.h>
