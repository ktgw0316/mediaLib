...
#pragma ident	"@(#)mlib_SignalADPCM4Bits.c	9.3	07/10/09 SMI"

/*
 * FUNCTIONS
 *   Function mlib_SignalADPCM4Bits2Linear() and mlib_SignalLinear2ADPCM4Bits()
 *   convert data between 16-bit linear PCM format and
 *   G.721 32kbps 4-bit ADPCM format.
 *
 *   mlib_SignalADPCM4Bits2Linear -  convert data to 16-bit PCM format
 *
 *   mlib_SignalLinear2ADPCM4Bits -  convert data to 4-bit ADPCM format
 *
 * SYNOPSIS
...
#pragma weak mlib_SignalADPCM4Bits2Linear = __mlib_SignalADPCM4Bits2Linear
#pragma weak mlib_SignalLinear2ADPCM4Bits = __mlib_SignalLinear2ADPCM4Bits

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_SignalADPCM4Bits2Linear) mlib_SignalADPCM4Bits2Linear
    __attribute__((weak, alias("__mlib_SignalADPCM4Bits2Linear")));
__typeof__(__mlib_SignalLinear2ADPCM4Bits) mlib_SignalLinear2ADPCM4Bits
    __attribute__((weak, alias("__mlib_SignalLinear2ADPCM4Bits")));
...
static mlib_s32 mlib_quan1(
    mlib_s32 val);
static mlib_s32 mlib_quan_size7(
    mlib_s32 val,
...
#ifdef __SUNPRO_C
#pragma inline(mlib_quan1, mlib_quan_size7, mlib_fmult, mlib_reconstruct)
...
mlib_status
__mlib_SignalADPCM4Bits2Linear(
    mlib_s16 *pcm,
    const mlib_u8 *adpcm,
    void *decode,
    mlib_s32 n)
...
/* quantized diff. */
		dq = mlib_reconstruct(adpcm_val & 0x8,
		    mlib_ADPCM4Bits_rsf[adpcm_val], y);
...
/* update state variables */
		mlib_update(y, mlib_ADPCM4Bits_sfm[adpcm_val] << 5,
		    mlib_ADPCM4Bits_st[adpcm_val], dq, sr, dqsez, state);
	}
...
mlib_status
__mlib_SignalLinear2ADPCM4Bits(
    mlib_u8 *adpcm,
    const mlib_s16 *pcm,
    void *encode,
    mlib_s32 n)
...
/* adpcm_val = ADPCM code */
		adpcm_val = mlib_quantize(d, y, mlib_ADPCM4Bits_quant, 7);
		dp[i] = adpcm_val;

/* quantized est diff */
		dq = mlib_reconstruct(adpcm_val & 8,
		    mlib_ADPCM4Bits_rsf[adpcm_val], y);
