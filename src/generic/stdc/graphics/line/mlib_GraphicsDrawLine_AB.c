...
#pragma ident	"@(#)mlib_GraphicsDrawLine_AB.c	9.3	07/10/09 SMI"

/*
 *  FUNCTION
 *    mlib_GraphicsDrawLine_AB_[8|32] - draw line between (x1, y1) and (x2, y2)
 *                                     with antialiasing
 *
 *  SYNOPSIS
 *    mlib_status mlib_GraphicsDrawLine_AB_[8|32]
 *                                      (mlib_image *buffer,
 *                                       mlib_s16   x1,
 *                                       mlib_s16   y1,
 *                                       mlib_s16   x2,
...
#pragma weak mlib_GraphicsDrawLine_AB_8 = __mlib_GraphicsDrawLine_AB_8
#pragma weak mlib_GraphicsDrawLine_AB_32 = __mlib_GraphicsDrawLine_AB_32

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_GraphicsDrawLine_AB_8) mlib_GraphicsDrawLine_AB_8
    __attribute__((weak, alias("__mlib_GraphicsDrawLine_AB_8")));
__typeof__(__mlib_GraphicsDrawLine_AB_32) mlib_GraphicsDrawLine_AB_32
    __attribute__((weak, alias("__mlib_GraphicsDrawLine_AB_32")));
    ...
    mlib_s32 a)
{
	...
	mlib_GraphicsSpamLineSet_AB_8(rtable, stride, coords,
	    coords + MLIB_GDS_NEXT, c, a, d_c, width - 1, height - 1);
