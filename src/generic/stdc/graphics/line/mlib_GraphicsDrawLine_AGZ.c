...
#pragma ident	"@(#)mlib_GraphicsDrawLine_AGZ.c	9.3	07/10/09 SMI"

/*
 *  FUNCTION
 *    mlib_GraphicsDrawLine_AGZ_[8|32] - draw line between (x1, y1) and (x2, y2)
 *      with antialiasing, Gouraud shading and Z buffering
 *
 *  SYNOPSIS
 *    mlib_status mlib_GraphicsDrawLine_AGZ_[8|32]
 *                                      (mlib_image *buffer,
 *                                       mlib_image *zbuffer,
 *                                       mlib_s16   x1,
 *                                       mlib_s16   y1,
...
#pragma weak mlib_GraphicsDrawLine_AGZ_8 = __mlib_GraphicsDrawLine_AGZ_8
#pragma weak mlib_GraphicsDrawLine_AGZ_32 = __mlib_GraphicsDrawLine_AGZ_32

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_GraphicsDrawLine_AGZ_8) mlib_GraphicsDrawLine_AGZ_8
	__attribute__((weak, alias("__mlib_GraphicsDrawLine_AGZ_8")));
__typeof__(__mlib_GraphicsDrawLine_AGZ_32) mlib_GraphicsDrawLine_AGZ_32
	__attribute__((weak, alias("__mlib_GraphicsDrawLine_AGZ_32")));
	...
	mlib_s32 c2)
{
	...
	mlib_GraphicsSpamLineSet_AGZ_8(rtable, zrtable, stride, zstride, coords,
		coords + MLIB_GDS_NEXT_GZ, width - 1, height - 1);
...
mlib_status
__mlib_GraphicsDrawLine_AGZ_32(
	mlib_image *buffer,
	mlib_image *zbuffer,
	mlib_s16 xx1,
	mlib_s16 yy1,
	...
	mlib_s32 c2)
{
	...
	mlib_GraphicsSpamLineSet_AGZ_32(rtable, zrtable, stride, zstride,
		coords, coords + MLIB_GDS_NEXT_GZ32, width - 1, height - 1);
