...
#pragma ident	"@(#)mlib_GraphicsDrawLine_X.c	9.2	07/10/09 SMI"

/*
 *  FUNCTION
 *    mlib_GraphicsDrawLine_X_[8|32] - draw line in XOR mode
 *
 *
 *  SYNOPSIS
 *    mlib_status mlib_GraphicsDrawLine_X_[8|32]
 *                                      (mlib_image *buffer,
 *                                       mlib_s16   x1,
 *                                       mlib_s16   y1,
 *                                       mlib_s16   x2,
...
#pragma weak mlib_GraphicsDrawLine_X_8 = __mlib_GraphicsDrawLine_X_8
#pragma weak mlib_GraphicsDrawLine_X_32 = __mlib_GraphicsDrawLine_X_32

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_GraphicsDrawLine_X_8) mlib_GraphicsDrawLine_X_8
	__attribute__((weak, alias("__mlib_GraphicsDrawLine_X_8")));
__typeof__(__mlib_GraphicsDrawLine_X_32) mlib_GraphicsDrawLine_X_32
	__attribute__((weak, alias("__mlib_GraphicsDrawLine_X_32")));
	...
	mlib_s32 c2)
{
	...
	mlib_GraphicsSpamLineSet_X_8(rtable, stride, coords,
	...
	mlib_s32 c2)
{
	...
	mlib_GraphicsClipLine(coords, width, height, x, y);
	mlib_GraphicsSpamLineSet_X_32(rtable, stride, coords,
		coords + MLIB_GDS_NEXT, c, d_c);
