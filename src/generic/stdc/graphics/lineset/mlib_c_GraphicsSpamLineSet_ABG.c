...
#pragma ident	"@(#)mlib_c_GraphicsSpamLineSet_ABG.c	9.2	07/10/09 SMI"
...
static void mlib_GraphicsSpamLineSet_ABG_8_InnX(
    mlib_u8 **rtable,
    mlib_s32 *coords,
    mlib_s32 height,
    mlib_s32 a);

static void mlib_GraphicsSpamLineSet_ABG_8_InnHor(
    mlib_u8 **rtable,
    mlib_s32 *coords,
    mlib_s32 stride,
    mlib_s32 height,
...
static void mlib_GraphicsSpamLineSet_ABG_8_InnY(
    mlib_u8 **rtable,
    mlib_s32 *coords,
    mlib_s32 stride,
    mlib_s32 width,
...
static void mlib_GraphicsSpamLineSet_ABG_8_InnVer(
    mlib_u8 **rtable,
    mlib_s32 *coords,
    mlib_s32 stride,
    mlib_s32 width,
...
static void mlib_GraphicsSpamLineSet_ABG_32_InnX(
    mlib_u8 **rtable,
    mlib_s32 *coords,
    mlib_s32 height,
    mlib_s32 a);

static void mlib_GraphicsSpamLineSet_ABG_32_InnHor(
    mlib_u8 **rtable,
    mlib_s32 *coords,
    mlib_s32 stride,
    mlib_s32 height,
...
static void mlib_GraphicsSpamLineSet_ABG_32_InnY(
    mlib_u8 **rtable,
    mlib_s32 *coords,
    mlib_s32 stride,
    mlib_s32 width,
...
static void mlib_GraphicsSpamLineSet_ABG_32_InnVer(
    mlib_u8 **rtable,
    mlib_s32 *coords,
    mlib_s32 width,
    mlib_s32 a);
...
void
mlib_GraphicsSpamLineSet_ABG_8_InnX(
    mlib_u8 **rtable,
    mlib_s32 *coords,
    mlib_s32 height,
    mlib_s32 a)
...
#pragma pipeloop(0)
	...
	for (j = 0; j <= n; j++, x++) {
		...
		data[x] = MLIB_BLENDING_8_PURE(bg, fg);
...
void
mlib_GraphicsSpamLineSet_ABG_8_InnHor(
    mlib_u8 **rtable,
    mlib_s32 *coords,
    mlib_s32 stride,
    mlib_s32 height,
...
#pragma pipeloop(0)
		...
		for (j = 0; j <= n; j++) {
			bg = data[x + j - stride];
			fg = bg + divt[(tc + j * dc) >> MLIB_SHIFT] - divt[bg];
			data[x + j - stride] = MLIB_BLENDING_8_PURE(bg, fg);
		}
...
#pragma pipeloop(0)
	...
	for (j = 0; j <= n; j++) {
		MLIB_BLENDING_8(data[x + j], (tc + j * dc) >> MLIB_SHIFT);
	}
...
void
mlib_GraphicsSpamLineSet_ABG_8_InnY(
    mlib_u8 **rtable,
    mlib_s32 *coords,
    mlib_s32 stride,
    mlib_s32 width,
...
void
mlib_GraphicsSpamLineSet_ABG_8_InnVer(
    mlib_u8 **rtable,
    mlib_s32 *coords,
    mlib_s32 stride,
    mlib_s32 width,
	...
	while (coords < coordsend) {
		...
		if (n >= 0) {
			if (y < 0) {
				if (dt)
					mlib_GraphicsSpamLineSet_ABG_8_InnX
					    (rtable, coords, height, a);
				else
					mlib_GraphicsSpamLineSet_ABG_8_InnHor
					    (rtable, coords, stride, height, a);
			} else {
				if (dt & (MLIB_ONE - 1))
					mlib_GraphicsSpamLineSet_ABG_8_InnY
					    (rtable, coords, stride, width, a);
				else
					mlib_GraphicsSpamLineSet_ABG_8_InnVer
					    (rtable, coords, stride, width, a);
			}
...
void
mlib_GraphicsSpamLineSet_ABG_32_InnX(
    mlib_u8 **rtable,
    mlib_s32 *coords,
    mlib_s32 height,
    mlib_s32 a)
...
void
mlib_GraphicsSpamLineSet_ABG_32_InnHor(
    mlib_u8 **rtable,
    mlib_s32 *coords,
    mlib_s32 stride,
    mlib_s32 height,
...
#ifdef _LITTLE_ENDIAN
		data[3] = 0xFF;
		MLIB_BLENDING_8(data[2], (tc2 >> MLIB_SHIFT));
		tc2 += dc2;
		MLIB_BLENDING_8(data[1], (tc1 >> MLIB_SHIFT));
		tc1 += dc1;
		MLIB_BLENDING_8(data[0], (tc >> MLIB_SHIFT));
		tc += dc;
		data[7] = 0xFF;
		MLIB_BLENDING_8(data[6], (tc2 >> MLIB_SHIFT));
		tc2 += dc2;
		MLIB_BLENDING_8(data[5], (tc1 >> MLIB_SHIFT));
		tc1 += dc1;
		MLIB_BLENDING_8(data[4], (tc >> MLIB_SHIFT));
		tc += dc;
#else /* _LITTLE_ENDIAN */

		data[0] = 0xFF;
		MLIB_BLENDING_8(data[1], (tc2 >> MLIB_SHIFT));
		tc2 += dc2;
		MLIB_BLENDING_8(data[2], (tc1 >> MLIB_SHIFT));
		tc1 += dc1;
		MLIB_BLENDING_8(data[3], (tc >> MLIB_SHIFT));
		tc += dc;
		data[4] = 0xFF;
		MLIB_BLENDING_8(data[5], (tc2 >> MLIB_SHIFT));
		tc2 += dc2;
		MLIB_BLENDING_8(data[6], (tc1 >> MLIB_SHIFT));
		tc1 += dc1;
		MLIB_BLENDING_8(data[7], (tc >> MLIB_SHIFT));
		tc += dc;
#endif /* _LITTLE_ENDIAN */
	}
...
void
mlib_GraphicsSpamLineSet_ABG_32_InnY(
    mlib_u8 **rtable,
    mlib_s32 *coords,
    mlib_s32 stride,
    mlib_s32 width,
...
void
mlib_GraphicsSpamLineSet_ABG_32_InnVer(
    mlib_u8 **rtable,
    mlib_s32 *coords,
    mlib_s32 width,
    mlib_s32 a)
