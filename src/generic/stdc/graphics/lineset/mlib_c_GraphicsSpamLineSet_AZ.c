...
#pragma ident	"@(#)mlib_c_GraphicsSpamLineSet_AZ.c	9.2	07/10/09 SMI"
...
static void mlib_GraphicsSpamLineSet_AZ_8_InnX(
	mlib_u8 **rtable,
	mlib_u8 **zrtable,
	mlib_s32 *coords,
	mlib_s32 c,
...
static void mlib_GraphicsSpamLineSet_AZ_8_InnHor(
	mlib_u8 **rtable,
	mlib_u8 **zrtable,
	mlib_s32 *coords,
	mlib_s32 c,
...
static void mlib_GraphicsSpamLineSet_AZ_8_InnY(
	mlib_u8 **rtable,
	mlib_u8 **zrtable,
	mlib_s32 *coords,
	mlib_s32 c,
...
static void mlib_GraphicsSpamLineSet_AZ_8_InnVer(
	mlib_u8 **rtable,
	mlib_u8 **zrtable,
	mlib_s32 *coords,
	mlib_s32 c,
...
void
mlib_GraphicsSpamLineSet_AZ_8_InnX(
	mlib_u8 **rtable,
	mlib_u8 **zrtable,
	mlib_s32 *coords,
	mlib_s32 c,
...
void
mlib_GraphicsSpamLineSet_AZ_8_InnHor(
	mlib_u8 **rtable,
	mlib_u8 **zrtable,
	mlib_s32 *coords,
	mlib_s32 c,
	mlib_s32 height)
{
	...
	mlib_s32 ualpha, alpha, dalpha, ubg, dbg;
...
#pragma pipeloop(0)
	...
	for (j = 0; j <= n; j++, x++) {
		...
		zdata1[xz] = stz;
		data[xz] = c;
		udata[ux] = ubg + alpha - divt[ubg];
		ddata[dx] = dbg + alpha - divt[dbg];
	}
}
...
void
mlib_GraphicsSpamLineSet_AZ_8_InnY(
	mlib_u8 **rtable,
	mlib_u8 **zrtable,
	mlib_s32 *coords,
	mlib_s32 c,
...
void
mlib_GraphicsSpamLineSet_AZ_8_InnVer(
	mlib_u8 **rtable,
	mlib_u8 **zrtable,
	mlib_s32 *coords,
	mlib_s32 c,
...
#define	MLIB_SIMPLE_ALIAS32(DATA, OFF, DIVT)                    \
	{                                                       \
	    ...
	    bg2 = _data[1];                                     \
	    bg3 = _data[0];                                     \
	    bg1 = bg1 + alpha2 - DIVT[bg1];                     \
	    bg2 = bg2 + alpha1 - DIVT[bg2];                     \
	    bg3 = bg3 + alpha0 - DIVT[bg3];                     \
	    _data[2] = bg1;                                     \
	    _data[1] = bg2;                                     \
	    _data[0] = bg3;                                     \
	}
