...
#pragma ident	"@(#)mlib_GraphicsClipLineSet_AB.c	9.2	07/10/09 SMI"
...
#pragma pipeloop(0)
		...
		for (i = 0; i < count - 3; i += 4) {
			...
			f_div2 = (ll2 <
			    MLIB_STEP_TABLE_LENGTH) ?
			    mlib_GraphicsStepTable_f32[ll2] : MLIB_ONE_FL / ll2;
			f_div3 = (ll3 <
			    MLIB_STEP_TABLE_LENGTH) ?
			    mlib_GraphicsStepTable_f32[ll3] : MLIB_ONE_FL / ll3;
		...
		SpamLineSet(rtable, stride, ps, pe, c, alpha, d_c, width - 1,
		    height - 1);
