...
void
mlib_GraphicsClipLineSet_BGZ_8(
	mlib_u8 **rtable,
	mlib_u8 **zrtable,
	mlib_s32 width,
	mlib_s32 height,
...
#pragma pipeloop(0)
		...
		SpamLineSet(rtable, zrtable, stride, zstride, ps, pe, alpha,
		width - 1, height - 1);
...
void
mlib_GraphicsClipLineSet_BGZ_32(
	mlib_u8 **rtable,
	mlib_u8 **zrtable,
	mlib_s32 width,
	mlib_s32 height,
