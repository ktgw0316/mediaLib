...
#pragma ident	"@(#)mlib_GraphicsDrawTriangle_BGZ.c	9.2	07/10/09 SMI"

/*
 *  FUNCTION
 *    mlib_GraphicsDrawTriangle_BGZ_[8|32] - draw triangle with vertices at
 *    (x1, y1), (x2, y2) and (x3, y3) with Gouraud Shading, Z-buffering
 *							and alpha blending
 *    mlib_GraphicsDrawTriangle[|Fan|Strip]Set_BGZ_[8|32]
 ...
 *  SYNOPSIS
 *
 *    mlib_status mlib_GraphicsDrawTriangle_BGZ_[8|32]
 *                                      (mlib_image *buffer,
 *                                       mlib_image *zbuffer,
 *                                       mlib_s16   x1,
 *                                       mlib_s16   y1,
...
#pragma weak mlib_GraphicsDrawTriangleFanSet_BGZ_32 = \
	__mlib_GraphicsDrawTriangleFanSet_BGZ_32
#pragma weak mlib_GraphicsDrawTriangleFanSet_BGZ_8 = \
	__mlib_GraphicsDrawTriangleFanSet_BGZ_8
#pragma weak mlib_GraphicsDrawTriangleSet_BGZ_32 = \
	__mlib_GraphicsDrawTriangleSet_BGZ_32
#pragma weak mlib_GraphicsDrawTriangleSet_BGZ_8 = \
	__mlib_GraphicsDrawTriangleSet_BGZ_8
#pragma weak mlib_GraphicsDrawTriangleStripSet_BGZ_32 = \
	__mlib_GraphicsDrawTriangleStripSet_BGZ_32
#pragma weak mlib_GraphicsDrawTriangleStripSet_BGZ_8 = \
	__mlib_GraphicsDrawTriangleStripSet_BGZ_8
#pragma weak mlib_GraphicsDrawTriangle_BGZ_32 = \
	__mlib_GraphicsDrawTriangle_BGZ_32
#pragma weak mlib_GraphicsDrawTriangle_BGZ_8 = \
	__mlib_GraphicsDrawTriangle_BGZ_8

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_GraphicsDrawTriangleFanSet_BGZ_32)
	mlib_GraphicsDrawTriangleFanSet_BGZ_32
	__attribute__((weak,
	alias("__mlib_GraphicsDrawTriangleFanSet_BGZ_32")));
__typeof__(__mlib_GraphicsDrawTriangleFanSet_BGZ_8)
	mlib_GraphicsDrawTriangleFanSet_BGZ_8
	__attribute__((weak, alias("__mlib_GraphicsDrawTriangleFanSet_BGZ_8")));
__typeof__(__mlib_GraphicsDrawTriangleSet_BGZ_32)
	mlib_GraphicsDrawTriangleSet_BGZ_32
	__attribute__((weak, alias("__mlib_GraphicsDrawTriangleSet_BGZ_32")));
__typeof__(__mlib_GraphicsDrawTriangleSet_BGZ_8)
	mlib_GraphicsDrawTriangleSet_BGZ_8
	__attribute__((weak, alias("__mlib_GraphicsDrawTriangleSet_BGZ_8")));
__typeof__(__mlib_GraphicsDrawTriangleStripSet_BGZ_32)
	mlib_GraphicsDrawTriangleStripSet_BGZ_32
	__attribute__((weak,
	alias("__mlib_GraphicsDrawTriangleStripSet_BGZ_32")));
__typeof__(__mlib_GraphicsDrawTriangleStripSet_BGZ_8)
	mlib_GraphicsDrawTriangleStripSet_BGZ_8
	__attribute__((weak,
	alias("__mlib_GraphicsDrawTriangleStripSet_BGZ_8")));
__typeof__(__mlib_GraphicsDrawTriangle_BGZ_32) mlib_GraphicsDrawTriangle_BGZ_32
	__attribute__((weak, alias("__mlib_GraphicsDrawTriangle_BGZ_32")));
__typeof__(__mlib_GraphicsDrawTriangle_BGZ_8) mlib_GraphicsDrawTriangle_BGZ_8
	__attribute__((weak, alias("__mlib_GraphicsDrawTriangle_BGZ_8")));
	...
	mlib_s32 a)
{
	...
	mlib_GraphicsSpamLineSet_BGZ_32(rtable, zrtable, stride, zstride,
		coords,	coords + 3 * MLIB_GDS_NEXT_GZ32, a);
...
#define	MLIB_GDT_COMPLECT_BGZ(N, SUF, DP0, DP1)                       \
	MLIB_GRAPHICS_DECL_VARZ;                                      \
...
__mlib_GraphicsDrawTriangleSet_BGZ_8(
	...
	mlib_s32 a)
{
	MLIB_GDT_COMPLECT_BGZ(8, TS, 3, 3);
}
...
__mlib_GraphicsDrawTriangleSet_BGZ_32(
	...
	mlib_s32 a)
{
	MLIB_GDT_COMPLECT_BGZ(32, TS, 3, 3);
}
...
__mlib_GraphicsDrawTriangleFanSet_BGZ_8(
	...
	mlib_s32 a)
{
	MLIB_GDT_COMPLECT_BGZ(8, TFS, 0, 1);
}
...
__mlib_GraphicsDrawTriangleFanSet_BGZ_32(
	...
	mlib_s32 a)
{
	MLIB_GDT_COMPLECT_BGZ(32, TFS, 0, 1);
}
...
__mlib_GraphicsDrawTriangleStripSet_BGZ_8(
	...
	mlib_s32 a)
{
	MLIB_GDT_COMPLECT_BGZ(8, TSS, 1, 1);
}
...
__mlib_GraphicsDrawTriangleStripSet_BGZ_32(
	...
	mlib_s32 a)
{
	MLIB_GDT_COMPLECT_BGZ(32, TSS, 1, 1);
}
