...
#pragma ident	"@(#)mlib_GraphicsDrawTriangle_BG.c	9.2	07/10/09 SMI"

/*
 *  FUNCTION
 *    mlib_GraphicsDrawTriangle_BG_[8|32] - draw triangle with vertices at
 *	(x1, y1), (x2, y2) and (x3, y3) with Gouraud Shading and alpha blending
 *    mlib_GraphicsDrawTriangle[|Fan|Strip]Set_BG_[8|32]
 ...
 *  SYNOPSIS
 *
 *    mlib_status mlib_GraphicsDrawTriangle_BG_[8|32]
 *                                      (mlib_image *buffer,
 *                                       mlib_s16   x1,
 *                                       mlib_s16   y1,
 *                                       mlib_s16   x2,
...
#pragma weak mlib_GraphicsDrawTriangleFanSet_BG_32 = \
	__mlib_GraphicsDrawTriangleFanSet_BG_32
#pragma weak mlib_GraphicsDrawTriangleFanSet_BG_8 = \
	__mlib_GraphicsDrawTriangleFanSet_BG_8
#pragma weak mlib_GraphicsDrawTriangleSet_BG_32 = \
	__mlib_GraphicsDrawTriangleSet_BG_32
#pragma weak mlib_GraphicsDrawTriangleSet_BG_8 = \
	__mlib_GraphicsDrawTriangleSet_BG_8
#pragma weak mlib_GraphicsDrawTriangleStripSet_BG_32 = \
	__mlib_GraphicsDrawTriangleStripSet_BG_32
#pragma weak mlib_GraphicsDrawTriangleStripSet_BG_8 = \
	__mlib_GraphicsDrawTriangleStripSet_BG_8
#pragma weak mlib_GraphicsDrawTriangle_BG_32 = \
	__mlib_GraphicsDrawTriangle_BG_32
#pragma weak mlib_GraphicsDrawTriangle_BG_8 = \
	__mlib_GraphicsDrawTriangle_BG_8

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_GraphicsDrawTriangleFanSet_BG_32)
    mlib_GraphicsDrawTriangleFanSet_BG_32
    __attribute__((weak, alias("__mlib_GraphicsDrawTriangleFanSet_BG_32")));
__typeof__(__mlib_GraphicsDrawTriangleFanSet_BG_8)
    mlib_GraphicsDrawTriangleFanSet_BG_8
    __attribute__((weak, alias("__mlib_GraphicsDrawTriangleFanSet_BG_8")));
__typeof__(__mlib_GraphicsDrawTriangleSet_BG_32)
    mlib_GraphicsDrawTriangleSet_BG_32
    __attribute__((weak, alias("__mlib_GraphicsDrawTriangleSet_BG_32")));
__typeof__(__mlib_GraphicsDrawTriangleSet_BG_8)
    mlib_GraphicsDrawTriangleSet_BG_8
    __attribute__((weak, alias("__mlib_GraphicsDrawTriangleSet_BG_8")));
__typeof__(__mlib_GraphicsDrawTriangleStripSet_BG_32)
    mlib_GraphicsDrawTriangleStripSet_BG_32
    __attribute__((weak, alias("__mlib_GraphicsDrawTriangleStripSet_BG_32")));
__typeof__(__mlib_GraphicsDrawTriangleStripSet_BG_8)
    mlib_GraphicsDrawTriangleStripSet_BG_8
    __attribute__((weak, alias("__mlib_GraphicsDrawTriangleStripSet_BG_8")));
__typeof__(__mlib_GraphicsDrawTriangle_BG_32) mlib_GraphicsDrawTriangle_BG_32
    __attribute__((weak, alias("__mlib_GraphicsDrawTriangle_BG_32")));
__typeof__(__mlib_GraphicsDrawTriangle_BG_8) mlib_GraphicsDrawTriangle_BG_8
    __attribute__((weak, alias("__mlib_GraphicsDrawTriangle_BG_8")));
...
#define	MLIB_GRAPHICS_TRIANGLE_INNER_BG(NEXT)                   \
    ...
    mlib_s32 a)
{
	...
	MLIB_GRAPHICS_TRIANGLE_INNER_BG(MLIB_GDS_NEXT_GZ);
    ...
    mlib_s32 a)
{
	...
	MLIB_GRAPHICS_TRIANGLE_INNER_BG(MLIB_GDS_NEXT_GZ32);
...
#define	MLIB_GDT_COMPLECT_BG(N, SUF, DP0, DP1)                         \
	MLIB_GRAPHICS_DECL_VAR;                                        \
	...
	mlib_GraphicsClipTriangleSet_BG_##N(rtable, width, height,     \
	    ...
	    DP1, mlib_GraphicsSpamLineSet_BG_##N);                     \
	return MLIB_SUCCESS
...
__mlib_GraphicsDrawTriangleSet_BG_32(
    ...
    mlib_s32 a)
{
	MLIB_GDT_COMPLECT_BG(32, TS, 3, 3);
}
...
__mlib_GraphicsDrawTriangleFanSet_BG_8(
    ...
    mlib_s32 a)
{
	MLIB_GDT_COMPLECT_BG(8, TFS, 0, 1);
}
...
__mlib_GraphicsDrawTriangleFanSet_BG_32(
    ...
    mlib_s32 a)
{
	MLIB_GDT_COMPLECT_BG(32, TFS, 0, 1);
}
...
__mlib_GraphicsDrawTriangleStripSet_BG_8(
    ...
    mlib_s32 a)
{
	MLIB_GDT_COMPLECT_BG(8, TSS, 1, 1);
}
...
__mlib_GraphicsDrawTriangleStripSet_BG_32(
    ...
    mlib_s32 a)
{
	MLIB_GDT_COMPLECT_BG(32, TSS, 1, 1);
}
