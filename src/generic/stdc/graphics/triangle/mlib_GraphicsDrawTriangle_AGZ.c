...
#pragma ident	"@(#)mlib_GraphicsDrawTriangle_AGZ.c	9.2	07/10/09 SMI"

/*
 *  FUNCTION
 *    mlib_GraphicsDrawTriangle_AGZ_[8|32] - draw triangle with vertices at
 *                        (x1, y1), (x2, y2) and (x3, y3) with antialiasing
 *                        Gouraud Shading and Z - buffering
 *    mlib_GraphicsDrawTriangle[|Fan|Strip]Set_AGZ_[8|32]
 ...
 *
 *  SYNOPSIS
 *    mlib_status mlib_GraphicsDrawTriangle_AGZ_[8|32]
 *                                      (mlib_image *buffer,
 *                                       mlib_image *zbuffer,
 *                                       mlib_s16 x1,
 *                                       mlib_s16 y1,
...
#pragma weak mlib_GraphicsDrawTriangleFanSet_AGZ_32 = \
	__mlib_GraphicsDrawTriangleFanSet_AGZ_32
#pragma weak mlib_GraphicsDrawTriangleFanSet_AGZ_8 = \
	__mlib_GraphicsDrawTriangleFanSet_AGZ_8
#pragma weak mlib_GraphicsDrawTriangleSet_AGZ_32 = \
	__mlib_GraphicsDrawTriangleSet_AGZ_32
#pragma weak mlib_GraphicsDrawTriangleSet_AGZ_8 = \
	__mlib_GraphicsDrawTriangleSet_AGZ_8
#pragma weak mlib_GraphicsDrawTriangleStripSet_AGZ_32 = \
	__mlib_GraphicsDrawTriangleStripSet_AGZ_32
#pragma weak mlib_GraphicsDrawTriangleStripSet_AGZ_8 = \
	__mlib_GraphicsDrawTriangleStripSet_AGZ_8
#pragma weak mlib_GraphicsDrawTriangle_AGZ_32 = \
	__mlib_GraphicsDrawTriangle_AGZ_32
#pragma weak mlib_GraphicsDrawTriangle_AGZ_8 = \
	__mlib_GraphicsDrawTriangle_AGZ_8

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_GraphicsDrawTriangleFanSet_AGZ_32)
	mlib_GraphicsDrawTriangleFanSet_AGZ_32
	__attribute__((weak,
	alias("__mlib_GraphicsDrawTriangleFanSet_AGZ_32")));
__typeof__(__mlib_GraphicsDrawTriangleFanSet_AGZ_8)
	mlib_GraphicsDrawTriangleFanSet_AGZ_8
	__attribute__((weak,
	alias("__mlib_GraphicsDrawTriangleFanSet_AGZ_8")));
__typeof__(__mlib_GraphicsDrawTriangleSet_AGZ_32)
	mlib_GraphicsDrawTriangleSet_AGZ_32
	__attribute__((weak, alias("__mlib_GraphicsDrawTriangleSet_AGZ_32")));
__typeof__(__mlib_GraphicsDrawTriangleSet_AGZ_8)
	mlib_GraphicsDrawTriangleSet_AGZ_8
	__attribute__((weak, alias("__mlib_GraphicsDrawTriangleSet_AGZ_8")));
__typeof__(__mlib_GraphicsDrawTriangleStripSet_AGZ_32)
	mlib_GraphicsDrawTriangleStripSet_AGZ_32
	__attribute__((weak,
	alias("__mlib_GraphicsDrawTriangleStripSet_AGZ_32")));
__typeof__(__mlib_GraphicsDrawTriangleStripSet_AGZ_8)
	mlib_GraphicsDrawTriangleStripSet_AGZ_8
	__attribute__((weak,
	alias("__mlib_GraphicsDrawTriangleStripSet_AGZ_8")));
__typeof__(__mlib_GraphicsDrawTriangle_AGZ_32) mlib_GraphicsDrawTriangle_AGZ_32
	__attribute__((weak, alias("__mlib_GraphicsDrawTriangle_AGZ_32")));
__typeof__(__mlib_GraphicsDrawTriangle_AGZ_8) mlib_GraphicsDrawTriangle_AGZ_8
	__attribute__((weak, alias("__mlib_GraphicsDrawTriangle_AGZ_8")));
	...
	mlib_s32 c3)
{
	...
	mlib_GraphicsClipLine_GZ_8(coords + 2 * MLIB_GDS_NEXT_GZ, width, height,
		x + 2, y + 2, z + 2, c + 2);
	mlib_GraphicsSpamLineSet_AGZ_8(rtable, zrtable, stride, zstride, coords,
	...
	mlib_s32 c3)
{
	...
	mlib_GraphicsSpamLineSet_AGZ_32(rtable, zrtable, stride, zstride,
		coords, coords + 3 * MLIB_GDS_NEXT_GZ32, width - 1, height - 1);
