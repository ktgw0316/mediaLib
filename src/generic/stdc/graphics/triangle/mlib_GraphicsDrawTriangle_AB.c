...
#pragma ident	"@(#)mlib_GraphicsDrawTriangle_AB.c	9.2	07/10/09 SMI"

/*
 *  FUNCTION
 *    mlib_GraphicsDrawTriangle_AB_[8|32] - draw triangle with vertices at
 *                      (x1, y1), (x2, y2) and (x3, y3) with antialiasing and
 *			alpha blending
 *    mlib_GraphicsDrawTriangle[|Fan|Strip]Set_AB_[8|32]
 ...
 *
 *  SYNOPSIS
 *    mlib_status mlib_GraphicsDrawTriangle_AB_[8|32]
 *                                      (mlib_image *buffer,
 *                                       mlib_s16   x1,
 *                                       mlib_s16   y1,
 *                                       mlib_s16   x2,
...
#pragma weak mlib_GraphicsDrawTriangleFanSet_AB_32 = \
	__mlib_GraphicsDrawTriangleFanSet_AB_32
#pragma weak mlib_GraphicsDrawTriangleFanSet_AB_8 = \
	__mlib_GraphicsDrawTriangleFanSet_AB_8
#pragma weak mlib_GraphicsDrawTriangleSet_AB_32 = \
	__mlib_GraphicsDrawTriangleSet_AB_32
#pragma weak mlib_GraphicsDrawTriangleSet_AB_8 = \
	__mlib_GraphicsDrawTriangleSet_AB_8
#pragma weak mlib_GraphicsDrawTriangleStripSet_AB_32 = \
	__mlib_GraphicsDrawTriangleStripSet_AB_32
#pragma weak mlib_GraphicsDrawTriangleStripSet_AB_8 = \
	__mlib_GraphicsDrawTriangleStripSet_AB_8
#pragma weak mlib_GraphicsDrawTriangle_AB_32 = \
	__mlib_GraphicsDrawTriangle_AB_32
#pragma weak mlib_GraphicsDrawTriangle_AB_8 = \
	__mlib_GraphicsDrawTriangle_AB_8

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_GraphicsDrawTriangleFanSet_AB_32)
    mlib_GraphicsDrawTriangleFanSet_AB_32
    __attribute__((weak, alias("__mlib_GraphicsDrawTriangleFanSet_AB_32")));
__typeof__(__mlib_GraphicsDrawTriangleFanSet_AB_8)
    mlib_GraphicsDrawTriangleFanSet_AB_8
    __attribute__((weak, alias("__mlib_GraphicsDrawTriangleFanSet_AB_8")));
__typeof__(__mlib_GraphicsDrawTriangleSet_AB_32)
    mlib_GraphicsDrawTriangleSet_AB_32
    __attribute__((weak, alias("__mlib_GraphicsDrawTriangleSet_AB_32")));
__typeof__(__mlib_GraphicsDrawTriangleSet_AB_8)
    mlib_GraphicsDrawTriangleSet_AB_8
    __attribute__((weak, alias("__mlib_GraphicsDrawTriangleSet_AB_8")));
__typeof__(__mlib_GraphicsDrawTriangleStripSet_AB_32)
    mlib_GraphicsDrawTriangleStripSet_AB_32
    __attribute__((weak, alias("__mlib_GraphicsDrawTriangleStripSet_AB_32")));
__typeof__(__mlib_GraphicsDrawTriangleStripSet_AB_8)
    mlib_GraphicsDrawTriangleStripSet_AB_8
    __attribute__((weak, alias("__mlib_GraphicsDrawTriangleStripSet_AB_8")));
__typeof__(__mlib_GraphicsDrawTriangle_AB_32) mlib_GraphicsDrawTriangle_AB_32
    __attribute__((weak, alias("__mlib_GraphicsDrawTriangle_AB_32")));
__typeof__(__mlib_GraphicsDrawTriangle_AB_8) mlib_GraphicsDrawTriangle_AB_8
    __attribute__((weak, alias("__mlib_GraphicsDrawTriangle_AB_8")));
    ...
    mlib_s32 a)
{
	...
	MLIB_GRAPHICS_DECL_VAR_B_8 MLIB_GRAPHICS_TRIANGLE_INNER;
	...
	mlib_GraphicsSpamLineSet_AB_8(rtable, stride, coords,
	    coords + 3 * MLIB_GDS_NEXT, c, a, d_c, width - 1, height - 1);
...
{
	MLIB_GRAPHICS_DECL_VAR;
	MLIB_GRAPHICS_DECL_VAR_B_32 MLIB_GRAPHICS_TRIANGLE_INNER;
	...
	mlib_GraphicsClipLine(coords + 2 * MLIB_GDS_NEXT, width, height, x + 2,
	    y + 2);
	mlib_GraphicsSpamLineSet_AB_32(rtable, stride, coords,
	    coords + 3 * MLIB_GDS_NEXT, c, a, d_c, width - 1, height - 1);
