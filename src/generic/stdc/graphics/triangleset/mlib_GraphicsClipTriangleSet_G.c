...
#pragma ident	"@(#)mlib_GraphicsClipTriangleSet_G.c	9.2	07/10/09 SMI"

/*
 *  FUNCTIONS
 *    mlib_GraphicsClipTriangleSet_G_8    - clipping function for Gouraud mode
 *    mlib_GraphicsClipTriangleSet_G_32   - clipping function for Gouraud mode
 *
 *  SYNOPSIS
 *    void  mlib_GraphicsClipTriangleSet_G_[8 | 32]
 *                                        (mlib_u8  **rtable,
 *                                         mlib_s32 width,
 *                                         mlib_s32 height,
 *                                         mlib_s32 stride,
...
void
mlib_GraphicsClipTriangleSet_G_8(
	mlib_u8 **rtable,
	mlib_s32 width,
	mlib_s32 height,
	mlib_s32 stride,
	...
	void (*SpamLineSet) ())
{
	...
	while (all > 0) {
		...
		mlib_GraphicsClipLineSet_G_8(rtable, width, height, stride, xl,
			yl, cl, nlines + (k >> 1), 2, 2, SpamLineSet);
...
void
mlib_GraphicsClipTriangleSet_G_32(
	mlib_u8 **rtable,
	mlib_s32 width,
	mlib_s32 height,
	mlib_s32 stride,
	...
	void (*SpamLineSet) ())
{
	...
	while (all > 0) {
		...
		mlib_GraphicsClipLineSet_G_32(rtable, width, height, stride, xl,
			yl, cl, nlines + (k >> 1), 2, 2, SpamLineSet);
