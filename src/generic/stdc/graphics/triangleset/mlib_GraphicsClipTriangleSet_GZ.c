...
#pragma ident	"@(#)mlib_GraphicsClipTriangleSet_GZ.c	9.2	07/10/09 SMI"

/*
 *  FUNCTIONS
 *    mlib_GraphicsClipTriangleSet_GZ_8  - clipping function for Gouraud shading
 *                                       Z - buffering modes
 *    mlib_GraphicsClipTriangleSet_GZ_32 - clipping function for Gouraud shading
 *                                       Z - buffering modes
 *  SYNOPSIS
 *    void  mlib_GraphicsClipTriangleSet_GZ_[8 | 32]
 *                                        (mlib_u8  **rtable,
 *                                         mlib_u8  **zrtable,
 *                                         mlib_s32 width,
 *                                         mlib_s32 height,
...
void
mlib_GraphicsClipTriangleSet_GZ_8(
	mlib_u8 **rtable,
	mlib_u8 **zrtable,
	mlib_s32 width,
	mlib_s32 height,
	...
	void (*SpamLineSet) ())
{
	...
	while (all > 0) {
		...
		mlib_GraphicsClipLineSet_GZ_8(rtable, zrtable, width, height,
			stride, zstride, xl, yl, zl, cl, nlines + (k >> 1), 2,
			2, SpamLineSet);
...
void
mlib_GraphicsClipTriangleSet_GZ_32(
	mlib_u8 **rtable,
	mlib_u8 **zrtable,
	mlib_s32 width,
	mlib_s32 height,
	...
	void (*SpamLineSet) ())
{
	...
	while (all > 0) {
		...
		mlib_GraphicsClipLineSet_GZ_32(rtable, zrtable, width, height,
			stride, zstride, xl, yl, zl, cl, nlines + (k >> 1), 2,
			2, SpamLineSet);
