...
#pragma ident	"@(#)mlib_GraphicsClipTriangleSet.c	9.2	07/10/09 SMI"
	...
	void (*SpamLineSet) ())
{
	...
	while (all > 0) {
		...
		mlib_GraphicsClipLineSet(rtable, width, height, stride, xl, yl,
			nlines + (k >> 1), 2, 2, c, SpamLineSet);
