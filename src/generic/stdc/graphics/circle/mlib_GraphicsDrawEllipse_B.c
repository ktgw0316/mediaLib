...
#pragma ident	"@(#)mlib_GraphicsDrawEllipse_B.c	9.2	07/10/09 SMI"

/*
 * FUNCTIONS
 *    mlib_GraphicsDrawEllipse_B_[8 | 32] - draw ellipse
 *
 * SYNOPSIS
 *    mlib_status mlib_GraphicsDrawEllipse_B_8 (mlib_image *buffer,
 *                                              mlib_s16   x,
 *                                              mlib_s16   y,
 *                                              mlib_s32   a,
 *                                              mlib_s32   b,
 ...
 *                                              mlib_s32   alp);
 *
 *    mlib_status mlib_GraphicsDrawEllipse_B_32(mlib_image *buffer,
 *                                              mlib_s16   x,
 *                                              mlib_s16   y,
 *                                              mlib_s32   a,
 *                                              mlib_s32   b,
 ...
 *    t       Angle of major axis in radians.
 *    c       Color used in the drawing.
 *    alp     Alpha value for the blending.
 *
 * DESCRIPTION
 *    Function draws an ellipse of center (x, y), major semiaxis a,
 *    minor semiaxis b, and the position angle t of the major axis
 *    measured clockwise from X axis, by alpha blending with color c,
 *    alpha value alp.
 *
...
#pragma weak mlib_GraphicsDrawEllipse_B_32 = __mlib_GraphicsDrawEllipse_B_32
#pragma weak mlib_GraphicsDrawEllipse_B_8 = __mlib_GraphicsDrawEllipse_B_8

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_GraphicsDrawEllipse_B_32) mlib_GraphicsDrawEllipse_B_32
    __attribute__((weak, alias("__mlib_GraphicsDrawEllipse_B_32")));
__typeof__(__mlib_GraphicsDrawEllipse_B_8) mlib_GraphicsDrawEllipse_B_8
    __attribute__((weak, alias("__mlib_GraphicsDrawEllipse_B_8")));
...
#define	SIMPLE_PUT_NOCLIP {                                    \
	...
	tmp2 = line1[cx];				       \
	tmp3 = line1[-cx];		      		       \
	BLEND2(line0 + cx, tmp0)	      		       \
	BLEND2(line0 - cx, tmp1)	      		       \
	BLEND2(line1 + cx, tmp2)	      		       \
	BLEND2(line1 - cx, tmp3)	      		       \
}
#endif

/* *********************************************************** */

#define	SIMPLE_PUT_NOCLIP_CX0                                  \
	BLEND(line0)				       	       \
	if (line1 != line0) {                                  \
	    BLEND(line1)				       \
	}
...
#define	SIMPLE_ELLIPSE_PHASE2_START_NOCLIP                            \
	cx1 = cx + 1;                                                 \
	cy1 = cy - 1;                                                 \
	_2cx = cx * 2;                                                \
	_2cy = cy * 2;                                                \
...
#define	BLEND2	MLIB_GRAPHICS_BLEND2_8

#define	LOAD_F(f, fp)	f = *(mlib_f32 *)((mlib_addr)(fp) &~ 3);

/* *********************************************************** */

mlib_status
__mlib_GraphicsDrawEllipse_B_8(
    mlib_image *buffer,
    mlib_s16 x,
    mlib_s16 y,
    mlib_s32 a,
    ...
    mlib_s32 alp)
{
	...
	if (a == 0 || b == 0) {
		...
		return __mlib_GraphicsDrawLine_B_8(buffer, x + x1, y + y1,
		    x + x2, y + y2, c, alp);
	}

	if (a == b)
		return (__mlib_GraphicsDrawCircle_B_8(buffer, x, y, a, c, alp));
...
#undef BLEND2
#define	BLEND2	MLIB_GRAPHICS_BLEND2_32_P

#undef LOAD_F
#define	LOAD_F(f, fp)	f = *(mlib_f32 *)(fp);

/* *********************************************************** */

mlib_status
__mlib_GraphicsDrawEllipse_B_32(
    mlib_image *buffer,
    mlib_s16 x,
    mlib_s16 y,
    mlib_s32 a,
    ...
    mlib_s32 alp)
{
	...
	if (a == 0 || b == 0) {
		...
		return __mlib_GraphicsDrawLine_B_32(buffer, x + x1, y + y1,
		    x + x2, y + y2, c, alp);
	}

	if (a == b)
		return (__mlib_GraphicsDrawCircle_B_32
		    (buffer, x, y, a, c, alp));
