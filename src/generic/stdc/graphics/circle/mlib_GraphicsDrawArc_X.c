...
#pragma ident	"@(#)mlib_GraphicsDrawArc_X.c	9.2	07/10/09 SMI"

/*
 * FUNCTIONS
 *      mlib_GraphicsDrawArc_X_[8 | 32] - draw arc
 *
 * SYNOPSIS
 *      mlib_status mlib_GraphicsDrawArc_X_8 (mlib_image *buffer,
 *                                            mlib_s16   x,
 *                                            mlib_s16   y,
 *                                            mlib_s32   r,
 *                                            mlib_f32   t1,
 ...
 *                                            mlib_s32   c2)
 *
 *      mlib_status mlib_GraphicsDrawArc_X_32(mlib_image *buffer,
 *                                            mlib_s16   x,
 *                                            mlib_s16   y,
 *                                            mlib_s32   r,
 *                                            mlib_f32   t1,
 ...
 *
 * DESCRIPTION
 *      Function draws circle arc in XOR mode with radius r in image pointed
...
#pragma weak mlib_GraphicsDrawArc_X_32 = __mlib_GraphicsDrawArc_X_32
#pragma weak mlib_GraphicsDrawArc_X_8 = __mlib_GraphicsDrawArc_X_8

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_GraphicsDrawArc_X_32) mlib_GraphicsDrawArc_X_32
    __attribute__((weak, alias("__mlib_GraphicsDrawArc_X_32")));
__typeof__(__mlib_GraphicsDrawArc_X_8) mlib_GraphicsDrawArc_X_8
    __attribute__((weak, alias("__mlib_GraphicsDrawArc_X_8")));
    ...
    mlib_s32 c2)
{
	...
	if (mlib_fabs(t1 - t2) >= PIx2)
		return (__mlib_GraphicsDrawCircle_X_8(buffer, x, y, r, c, 0));
	{
		mlib_f32 tt = t1;
    ...
    mlib_s32 c2)
{
	...
	if (mlib_fabs(t1 - t2) >= PIx2)
		return (__mlib_GraphicsDrawCircle_X_32(buffer, x, y, r, c, 0));
	{
		mlib_f32 tt = t1;
