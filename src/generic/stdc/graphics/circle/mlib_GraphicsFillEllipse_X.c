...
#pragma ident	"@(#)mlib_GraphicsFillEllipse_X.c	9.2	07/10/09 SMI"

/*
 * FUNCTIONS
 *      mlib_GraphicsFillEllipse_X_[8 | 32] - fill ellipse
 *
 * SYNOPSIS
 *      mlib_status mlib_GraphicsFillEllipse_X_8 (mlib_image *buffer,
 *                                                mlib_s16   x,
 *                                                mlib_s16   y,
 *                                                mlib_s32   a,
 *                                                mlib_s32   b,
 ...
 *                                                mlib_s32   c2);
 *
 *      mlib_status mlib_GraphicsFillEllipse_X_32(mlib_image *buffer,
 *                                                mlib_s16   x,
 *                                                mlib_s16   y,
 *                                                mlib_s32   a,
 *                                                mlib_s32   b,
 ...
 *      c1, c2  colors used in the filling
 * DESCRIPTION
 *      Function fills an ellipse in XOR mode at (x, y), major semiaxis a,
 *      minor semiaxis b, and the angle of the major semiaxis is t
...
#pragma weak mlib_GraphicsFillEllipse_X_32 = __mlib_GraphicsFillEllipse_X_32
#pragma weak mlib_GraphicsFillEllipse_X_8 = __mlib_GraphicsFillEllipse_X_8

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_GraphicsFillEllipse_X_32) mlib_GraphicsFillEllipse_X_32
    __attribute__((weak, alias("__mlib_GraphicsFillEllipse_X_32")));
__typeof__(__mlib_GraphicsFillEllipse_X_8) mlib_GraphicsFillEllipse_X_8
    __attribute__((weak, alias("__mlib_GraphicsFillEllipse_X_8")));
...
mlib_status
__mlib_GraphicsFillEllipse_X_8(
    mlib_image *buffer,
    mlib_s16 x,
    mlib_s16 y,
    mlib_s32 a,
    ...
    mlib_s32 c2)
{
	...
	if (a == b)
		return (__mlib_GraphicsFillCircle_X_8(buffer, x, y, a, c, 0));
...

	{
		...
		if (!doclip) {
			for (ibuf = 0; 2 * bufsize - ibuf >= 0; ++ibuf) {
				...
				MLIB_FILL_ROW_X_8(line, beg, end, color,
				    dcolor);
				line += stride;
			}
		} else {
...
mlib_status
__mlib_GraphicsFillEllipse_X_32(
    mlib_image *buffer,
    mlib_s16 x,
    mlib_s16 y,
    mlib_s32 a,
    ...
    mlib_s32 c2)
{
	...
	if (a == b)
		return (__mlib_GraphicsFillCircle_X_32(buffer, x, y, a, c, 0));
...

	{
		...
		if (!doclip) {
			for (ibuf = 0; 2 * bufsize - ibuf >= 0; ++ibuf) {
				...
				MLIB_FILL_ROW_X_32(line, beg, end, c, dcolor);
				line += stride;
			}
		} else {
			mlib_s32 yb = (bufsize - y > 0) ? bufsize - y : 0;
