...
#pragma ident	"@(#)mlib_GraphicsFillEllipse_B.c	9.2	07/10/09 SMI"

/*
 * FUNCTIONS
 *    mlib_GraphicsFillEllipse_B_[8 | 32] - draw filled ellipse
 *                                          with alpha blending
 *
 * SYNOPSIS
 *    mlib_status mlib_GraphicsFillEllipse_B_8 (mlib_image *buffer,
 *                                              mlib_s16   x,
 *                                              mlib_s16   y,
 *                                              mlib_s32   a,
 *                                              mlib_s32   b,
 ...
 *                                              mlib_s32   alp);
 *
 *    mlib_status mlib_GraphicsFillEllipse_B_32(mlib_image *buffer,
 *                                              mlib_s16   x,
 *                                              mlib_s16   y,
 *                                              mlib_s32   a,
 *                                              mlib_s32   b,
 ...
 *
 * DESCRIPTION
 *    Function fills an ellipse of center (x, y), major semiaxis a,
...
#pragma weak mlib_GraphicsFillEllipse_B_32 = __mlib_GraphicsFillEllipse_B_32
#pragma weak mlib_GraphicsFillEllipse_B_8 = __mlib_GraphicsFillEllipse_B_8

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_GraphicsFillEllipse_B_32) mlib_GraphicsFillEllipse_B_32
    __attribute__((weak, alias("__mlib_GraphicsFillEllipse_B_32")));
__typeof__(__mlib_GraphicsFillEllipse_B_8) mlib_GraphicsFillEllipse_B_8
    __attribute__((weak, alias("__mlib_GraphicsFillEllipse_B_8")));
...
mlib_status
__mlib_GraphicsFillEllipse_B_8(
    mlib_image *buffer,
    mlib_s16 x,
    mlib_s16 y,
    mlib_s32 a,
    ...
    mlib_s32 alp)
{
	...
	if (a == b)
		return (__mlib_GraphicsFillCircle_B_8(buffer, x, y, a, c, alp));
...

	{
		...
		if (!doclip) {
			for (ibuf = 0; 2 * bufsize - ibuf >= 0; ++ibuf) {
				...
				MLIB_FILL_ROW_B_8_START(line, beg, end, c,
						a_1, vca, va_1)
#ifdef __SUNPRO_C
...
mlib_status
__mlib_GraphicsFillEllipse_B_32(
    mlib_image *buffer,
    mlib_s16 x,
    mlib_s16 y,
    mlib_s32 a,
    ...
    mlib_s32 alp)
{
	...
	if (a == b)
		return (__mlib_GraphicsFillCircle_B_32(buffer, x, y, a,
							c, alp));
...

	{
		...
		if (!doclip) {
			for (ibuf = 0; 2 * bufsize - ibuf >= 0; ++ibuf) {
				...
				MLIB_FILL_ROW_B_32(line, beg, end, ca1, ca2,
						ca3, a_1, vca, va_1);
				line += stride;
			}
		} else {
