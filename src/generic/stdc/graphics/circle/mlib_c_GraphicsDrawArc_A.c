...
#pragma ident	"@(#)mlib_c_GraphicsDrawArc_A.c	9.3	07/10/09 SMI"
...
#define	PCALC32(ptr, i0, bi)                                    \
	{                                                       \
	    ...
	    mlib_s32 c0 = buf[bi].c[i0];                        \
	                                                        \
	    p[3] = cfalpha;                                     \
	    p[2] = PCOMP32(v2, c0, cf2);                        \
	    p[1] = PCOMP32(v1, c0, cf1);                        \
	    p[0] = PCOMP32(v0, c0, cf0);                        \
	}
...
#define	PCALC32(ptr, i0, bi)                                    \
	{                                                       \
	    ...
	    mlib_s32 c0 = buf[bi].c[i0];                        \
	                                                        \
	    p[0] = cfalpha;                                     \
	    p[1] = PCOMP32(v2, c0, cf2);                        \
	    p[2] = PCOMP32(v1, c0, cf1);                        \
	    p[3] = PCOMP32(v0, c0, cf0);                        \
	}
