...
#pragma ident	"@(#)mlib_GraphicsDrawPolygon_ABZ.c	9.2	07/10/09 SMI"

/*
 *  FUNCTION
 *    mlib_GraphicsDrawPolygon_ABZ_[8|32] - draw polygon
 *    enclose (x1, y1), (x2, y2) ... (xn, yn), (x1, y1) with antialiasing
 *    and blending
 *
 *  SYNOPSIS
 *    mlib_status mlib_GraphicsDrawPolygon_ABZ_[8|32]
 *                                      (mlib_image     *buffer,
 *                                       mlib_image     *zbuffer,
 *                                       const mlib_s16 *x,
 *                                       const mlib_s16 *y,
...
#pragma weak mlib_GraphicsDrawPolygon_ABZ_32 = \
	__mlib_GraphicsDrawPolygon_ABZ_32
#pragma weak mlib_GraphicsDrawPolygon_ABZ_8 = \
	__mlib_GraphicsDrawPolygon_ABZ_8

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_GraphicsDrawPolygon_ABZ_32) mlib_GraphicsDrawPolygon_ABZ_32
    __attribute__((weak, alias("__mlib_GraphicsDrawPolygon_ABZ_32")));
__typeof__(__mlib_GraphicsDrawPolygon_ABZ_8) mlib_GraphicsDrawPolygon_ABZ_8
    __attribute__((weak, alias("__mlib_GraphicsDrawPolygon_ABZ_8")));
...
#define	MLIB_GDP_COMPLECT_ABZ(N, NEXT)                                     \
	...
	mlib_GraphicsClipLineSet_BZ(rtable, zrtable, width, height,        \
	    stride, zstride, (void *)x, (void *)y, (void *)z, nlines, 1,   \
	    1, c, a, mlib_GraphicsSpamLineSet_ABZ_##N);                    \
	mlib_GraphicsClipLine_Z(coords, width, height, xx, yy, zz);        \
	mlib_GraphicsSpamLineSet_ABZ_##N(rtable, zrtable, stride,          \
	    zstride, coords, coords + NEXT, c, a, d_c, width - 1,          \
	    height - 1);                                                   \
	return MLIB_SUCCESS
...
__mlib_GraphicsDrawPolygon_ABZ_8(
    ...
    mlib_s32 a)
{
	MLIB_GDP_COMPLECT_ABZ(8, MLIB_GDS_NEXT_GZ);
}
...
__mlib_GraphicsDrawPolygon_ABZ_32(
    ...
    mlib_s32 a)
{
	MLIB_GDP_COMPLECT_ABZ(32, MLIB_GDS_NEXT_GZ);
}
