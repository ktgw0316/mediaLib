...
#pragma ident	"@(#)mlib_GraphicsDrawPolygon_A.c	9.2	07/10/09 SMI"

/*
 *  FUNCTION
 *    mlib_GraphicsDrawPolygon_A_[8|32] - draw Polygon connecting
 *    points (x1, y1), (x2, y2) ... (xn, yn), (x1, y1) with antialiasing
 *
 *  SYNOPSIS
 *    mlib_status mlib_GraphicsDrawPolygon_A_[8|32]
 *                                      (mlib_image     *buffer,
 *                                       const mlib_s16 *x,
 *                                       const mlib_s16 *y,
 *                                       mlib_s32       npoints,
...
#pragma weak mlib_GraphicsDrawPolygon_A_32 = __mlib_GraphicsDrawPolygon_A_32
#pragma weak mlib_GraphicsDrawPolygon_A_8 = __mlib_GraphicsDrawPolygon_A_8

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_GraphicsDrawPolygon_A_32) mlib_GraphicsDrawPolygon_A_32
	__attribute__((weak, alias("__mlib_GraphicsDrawPolygon_A_32")));
__typeof__(__mlib_GraphicsDrawPolygon_A_8) mlib_GraphicsDrawPolygon_A_8
	__attribute__((weak, alias("__mlib_GraphicsDrawPolygon_A_8")));
...
#define	MLIB_GDP_COMPLECT_A(N, NEXT)                                \
	...
	mlib_GraphicsSpamLineSet_A_##N(rtable, stride, coords,      \
		coords + NEXT, c, d_c, width - 1, height - 1);      \
	return MLIB_SUCCESS

/* *********************************************************** */

mlib_status
__mlib_GraphicsDrawPolygon_A_8(
	mlib_image *buffer,
	const mlib_s16 *x,
	const mlib_s16 *y,
	mlib_s32 npoints,
	mlib_s32 c)
{
	MLIB_GDP_COMPLECT_A(8, MLIB_GDS_NEXT);
}

/* *********************************************************** */

mlib_status
__mlib_GraphicsDrawPolygon_A_32(
	mlib_image *buffer,
	const mlib_s16 *x,
	const mlib_s16 *y,
	mlib_s32 npoints,
	mlib_s32 c)
{
	MLIB_GDP_COMPLECT_A(32, MLIB_GDS_NEXT);
}
