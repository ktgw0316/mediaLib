...
#pragma ident	"@(#)mlib_GraphicsFillPolygon_ABZ.c	9.2	07/10/09 SMI"

/*
 *  FUNCTION
 *    mlib_GraphicsFillPolygon_ABZ_[8|32] - draw filled polygon enclose
 *                                         (x1, y1, z1), (x2, y2, z2), ...,
 *					   (xn, yn, zn), (x1, y1, z1)
 ...
 *
 *  SYNOPSIS
 *    mlib_status mlib_GraphicsFillPolygon_ABZ_[8|32]
 *                                                   (mlib_image     *buffer,
 *                                                    mlib_image     *zbuffer,
 *                                                    const mlib_s16 *x,
 *                                                    const mlib_s16 *y,
...
#pragma weak mlib_GraphicsFillPolygon_ABZ_32 = \
	__mlib_GraphicsFillPolygon_ABZ_32
#pragma weak mlib_GraphicsFillPolygon_ABZ_8 = \
	__mlib_GraphicsFillPolygon_ABZ_8

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_GraphicsFillPolygon_ABZ_32) mlib_GraphicsFillPolygon_ABZ_32
    __attribute__((weak, alias("__mlib_GraphicsFillPolygon_ABZ_32")));
__typeof__(__mlib_GraphicsFillPolygon_ABZ_8) mlib_GraphicsFillPolygon_ABZ_8
    __attribute__((weak, alias("__mlib_GraphicsFillPolygon_ABZ_8")));
    ...
    mlib_s32 a)
{
	...
	status = __mlib_GraphicsDrawPolygon_ABZ_8(buffer, zbuffer, x, y, z,
	    npoints, c, a);

	if (status != MLIB_SUCCESS)
		return (status);
	return __mlib_GraphicsFillPolygon_BZ_8(buffer, zbuffer, x, y, z,
	    npoints, c, a);
}
    ...
    mlib_s32 a)
{
	...
	status = __mlib_GraphicsDrawPolygon_ABZ_32(buffer, zbuffer, x, y, z,
	    npoints, c, a);

	if (status != MLIB_SUCCESS)
		return (status);
	return __mlib_GraphicsFillPolygon_BZ_32(buffer, zbuffer, x, y, z,
	    npoints, c, a);
}
