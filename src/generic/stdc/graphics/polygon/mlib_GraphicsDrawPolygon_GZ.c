...
#pragma ident	"@(#)mlib_GraphicsDrawPolygon_GZ.c	9.2	07/10/09 SMI"

/*
 *  FUNCTION
 *    mlib_GraphicsDrawPolygon_GZ_[8|32] - draw Polygon enclose (x1, y1),
 *    (x2, y2) ... (xn, yn) with Gouraud shading and Z buffering
 *
 *  SYNOPSIS
 *    mlib_status mlib_GraphicsDrawPolygon_GZ_[8|32]
 *                                      (mlib_image     *buffer,
 *                                       mlib_image     *zbuffer,
 *                                       const mlib_s16 *x,
 *                                       const mlib_s16 *y,
...
#pragma weak mlib_GraphicsDrawPolygon_GZ_32 = \
	__mlib_GraphicsDrawPolygon_GZ_32
#pragma weak mlib_GraphicsDrawPolygon_GZ_8 = __mlib_GraphicsDrawPolygon_GZ_8

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_GraphicsDrawPolygon_GZ_32) mlib_GraphicsDrawPolygon_GZ_32
	__attribute__((weak, alias("__mlib_GraphicsDrawPolygon_GZ_32")));
__typeof__(__mlib_GraphicsDrawPolygon_GZ_8) mlib_GraphicsDrawPolygon_GZ_8
	__attribute__((weak, alias("__mlib_GraphicsDrawPolygon_GZ_8")));
...
#define	MLIB_GDP_COMPLECT_GZ(N, NEXT)                                  \
	...
	mlib_GraphicsClipLineSet_GZ_##N(rtable, zrtable, width,        \
		...
		(void *)z, (void *)c, nlines, 1, 1,                    \
		mlib_GraphicsSpamLineSet_GZ_##N);                      \
	mlib_GraphicsClipLine_GZ_##N(coords, width, height, xx, yy,    \
		zz, cc);                                               \
	mlib_GraphicsSpamLineSet_GZ_##N(rtable, zrtable, stride,       \
		zstride, coords, coords + NEXT);                       \
	return MLIB_SUCCESS

/* *********************************************************** */

mlib_status
__mlib_GraphicsDrawPolygon_GZ_8(
	mlib_image *buffer,
	mlib_image *zbuffer,
	const mlib_s16 *x,
	const mlib_s16 *y,
	...
	const mlib_s32 *c)
{
	MLIB_GDP_COMPLECT_GZ(8, MLIB_GDS_NEXT_GZ);
}
...
__mlib_GraphicsDrawPolygon_GZ_32(
	...
	const mlib_s32 *c)
{
	MLIB_GDP_COMPLECT_GZ(32, MLIB_GDS_NEXT_GZ32);
}
