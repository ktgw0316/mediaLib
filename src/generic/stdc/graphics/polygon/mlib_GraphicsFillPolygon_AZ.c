...
#pragma ident	"@(#)mlib_GraphicsFillPolygon_AZ.c	9.2	07/10/09 SMI"

/*
 *  FUNCTION
 *    mlib_GraphicsFillPolygon_AZ_[8|32] - draw filled polygon
 *    enclose (x1, y1), (x2, y2) ... (xn, yn), (x1, y1) with antialiasing
 *
 *  SYNOPSIS
 *    mlib_status mlib_GraphicsFillPolygon_AZ_[8|32]
 *                                      (mlib_image     *buffer,
 *                                       mlib_image     *zbuffer,
 *                                       const mlib_s16 *x,
 *                                       const mlib_s16 *y,
...
#pragma weak mlib_GraphicsFillPolygon_AZ_32 = \
	__mlib_GraphicsFillPolygon_AZ_32
#pragma weak mlib_GraphicsFillPolygon_AZ_8 = __mlib_GraphicsFillPolygon_AZ_8

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_GraphicsFillPolygon_AZ_32) mlib_GraphicsFillPolygon_AZ_32
	__attribute__((weak, alias("__mlib_GraphicsFillPolygon_AZ_32")));
__typeof__(__mlib_GraphicsFillPolygon_AZ_8) mlib_GraphicsFillPolygon_AZ_8
	__attribute__((weak, alias("__mlib_GraphicsFillPolygon_AZ_8")));
...
mlib_status
__mlib_GraphicsFillPolygon_AZ_8(
	mlib_image *buffer,
	mlib_image *zbuffer,
	const mlib_s16 *x,
	const mlib_s16 *y,
	...
	mlib_s32 c)
{
	...
	status = __mlib_GraphicsDrawPolygon_AZ_8(buffer, zbuffer, x, y, z,
		npoints, c);

	if (status != MLIB_SUCCESS)
		return (status);
	return __mlib_GraphicsFillPolygon_Z_8(buffer, zbuffer, x, y, z, npoints,
		c);
}
	...
	mlib_s32 c)
{
	...
	status = __mlib_GraphicsDrawPolygon_AZ_32(buffer, zbuffer, x, y, z,
		npoints, c);

	if (status != MLIB_SUCCESS)
		return (status);
	return __mlib_GraphicsFillPolygon_Z_32(buffer, zbuffer, x, y, z,
		npoints, c);
}
