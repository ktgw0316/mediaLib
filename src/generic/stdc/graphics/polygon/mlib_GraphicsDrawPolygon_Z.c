...
#pragma ident	"@(#)mlib_GraphicsDrawPolygon_Z.c	9.2	07/10/09 SMI"

/*
 *  FUNCTION
 *    mlib_GraphicsDrawPolygon_Z_[8|32] - draw Polygon enclose
 *                                        (x1, y1), (x2, y2)... (xn, yn)
 *                                        with Z buffering
 *
 *  SYNOPSIS
 *    mlib_status mlib_GraphicsDrawPolygon_Z_[8|32]
 *                                      (mlib_image     *buffer,
 *                                       mlib_image     *zbuffer,
 *                                       const mlib_s16 *x,
 *                                       const mlib_s16 *y,
...
#pragma weak mlib_GraphicsDrawPolygon_Z_32 = __mlib_GraphicsDrawPolygon_Z_32
#pragma weak mlib_GraphicsDrawPolygon_Z_8 = __mlib_GraphicsDrawPolygon_Z_8

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_GraphicsDrawPolygon_Z_32) mlib_GraphicsDrawPolygon_Z_32
	__attribute__((weak, alias("__mlib_GraphicsDrawPolygon_Z_32")));
__typeof__(__mlib_GraphicsDrawPolygon_Z_8) mlib_GraphicsDrawPolygon_Z_8
	__attribute__((weak, alias("__mlib_GraphicsDrawPolygon_Z_8")));
...
#define	MLIB_GDP_COMPLECT_Z(N, NEXT)                                  \
	...
	mlib_GraphicsClipLineSet_Z(rtable, zrtable, width, height,    \
		...
		nlines, 1, 1, c, mlib_GraphicsSpamLineSet_Z_##N);     \
	mlib_GraphicsClipLine_Z(coords, width, height, xx, yy, zz);   \
	mlib_GraphicsSpamLineSet_Z_##N(rtable, zrtable, stride,       \
		zstride, coords, coords + NEXT, c, d_c);              \
	return MLIB_SUCCESS

/* *********************************************************** */

mlib_status
__mlib_GraphicsDrawPolygon_Z_8(
	mlib_image *buffer,
	mlib_image *zbuffer,
	const mlib_s16 *x,
	const mlib_s16 *y,
...
mlib_status
__mlib_GraphicsDrawPolygon_Z_32(
	mlib_image *buffer,
	mlib_image *zbuffer,
	const mlib_s16 *x,
	const mlib_s16 *y,
