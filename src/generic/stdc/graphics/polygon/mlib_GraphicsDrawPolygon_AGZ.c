...
#pragma ident	"@(#)mlib_GraphicsDrawPolygon_AGZ.c	9.2	07/10/09 SMI"

/*
 *  FUNCTION
 *    mlib_GraphicsDrawPolygon_AGZ_[8|32] - draw polygon
 *    enclose (x1, y1), (x2, y2) ... (xn, yn), (x1, y1) with antialiasing
 *
 *  SYNOPSIS
 *    mlib_status mlib_GraphicsDrawPolygon_AGZ_[8|32]
 *                                      (mlib_image     *buffer,
 *                                       mlib_image     *zbuffer,
 *                                       const mlib_s16 *x,
 *                                       const mlib_s16 *y,
...
#pragma weak mlib_GraphicsDrawPolygon_AGZ_32 = \
	__mlib_GraphicsDrawPolygon_AGZ_32
#pragma weak mlib_GraphicsDrawPolygon_AGZ_8 = \
	__mlib_GraphicsDrawPolygon_AGZ_8

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_GraphicsDrawPolygon_AGZ_32) mlib_GraphicsDrawPolygon_AGZ_32
	__attribute__((weak, alias("__mlib_GraphicsDrawPolygon_AGZ_32")));
__typeof__(__mlib_GraphicsDrawPolygon_AGZ_8) mlib_GraphicsDrawPolygon_AGZ_8
	__attribute__((weak, alias("__mlib_GraphicsDrawPolygon_AGZ_8")));
...
#define	MLIB_GDP_COMPLECT_AGZ(N, NEXT)                                    \
	...
	mlib_GraphicsClipLine_GZ_##N(coords, width, height, xx, yy,       \
		zz, cc);                                                  \
	mlib_GraphicsSpamLineSet_AGZ_##N(rtable, zrtable, stride,         \
		zstride, coords, coords + NEXT, width - 1, height - 1);   \
	return MLIB_SUCCESS
...
__mlib_GraphicsDrawPolygon_AGZ_8(
	...
	const mlib_s32 *c)
{
	MLIB_GDP_COMPLECT_AGZ(8, MLIB_GDS_NEXT_GZ);
}
...
__mlib_GraphicsDrawPolygon_AGZ_32(
	...
	const mlib_s32 *c)
{
	MLIB_GDP_COMPLECT_AGZ(32, MLIB_GDS_NEXT_GZ32);
}
