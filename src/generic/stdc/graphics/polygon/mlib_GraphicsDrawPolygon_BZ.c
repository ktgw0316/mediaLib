...
#pragma ident	"@(#)mlib_GraphicsDrawPolygon_BZ.c	9.2	07/10/09 SMI"

/*
 *  FUNCTION
 *    mlib_GraphicsDrawPolygon_BZ_[8|32] - draw Polygon enclose
 *                                        (x1, y1), (x2, y2)... (xn, yn)
 *                                        with Z buffering
 *
 *  SYNOPSIS
 *    mlib_status mlib_GraphicsDrawPolygon_BZ_[8|32]
 *                                      (mlib_image     *buffer,
 *                                       mlib_image     *zbuffer,
 *                                       const mlib_s16 *x,
 *                                       const mlib_s16 *y,
...
#pragma weak mlib_GraphicsDrawPolygon_BZ_8 = __mlib_GraphicsDrawPolygon_BZ_8
#pragma weak mlib_GraphicsDrawPolygon_BZ_32 = __mlib_GraphicsDrawPolygon_BZ_32

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_GraphicsDrawPolygon_BZ_32) mlib_GraphicsDrawPolygon_BZ_32
	__attribute__((weak, alias("__mlib_GraphicsDrawPolygon_BZ_32")));
__typeof__(__mlib_GraphicsDrawPolygon_BZ_8) mlib_GraphicsDrawPolygon_BZ_8
	__attribute__((weak, alias("__mlib_GraphicsDrawPolygon_BZ_8")));
...
#define	MLIB_GDP_COMPLECT_Z(N, NEXT)                                  \
	...
	mlib_GraphicsClipLineSet_BZ(rtable, zrtable, width, height,   \
		...
		nlines, 1, 1, c, a, mlib_GraphicsSpamLineSet_BZ_##N); \
	mlib_GraphicsClipLine_Z(coords, width, height, xx, yy, zz);   \
	mlib_GraphicsSpamLineSet_BZ_##N(rtable, zrtable, stride,      \
		zstride, coords, coords + NEXT, c, a, d_c);           \
	return MLIB_SUCCESS

/* *********************************************************** */

mlib_status
__mlib_GraphicsDrawPolygon_BZ_8(
	mlib_image *buffer,
	mlib_image *zbuffer,
	const mlib_s16 *x,
	const mlib_s16 *y,
	...
	mlib_s32 a)
{
	MLIB_GDP_COMPLECT_Z(8, MLIB_GDS_NEXT_GZ);
}

/* *********************************************************** */

mlib_status
__mlib_GraphicsDrawPolygon_BZ_32(
	mlib_image *buffer,
	mlib_image *zbuffer,
	const mlib_s16 *x,
	const mlib_s16 *y,
	...
	mlib_s32 a)
{
	MLIB_GDP_COMPLECT_Z(32, MLIB_GDS_NEXT_GZ);
}
