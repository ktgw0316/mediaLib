...
#pragma ident	"@(#)mlib_GraphicsDrawPolygon.c	9.2	07/10/09 SMI"

/*
 *  FUNCTION
 *    mlib_GraphicsDrawPolygon_[8|32] - draw Polygon enclose (x1, y1), (x2, y2)
 *      ... (xn, yn)
 *
 *  SYNOPSIS
 *    mlib_status mlib_GraphicsDrawPolygon_[8|32]
 *                                      (mlib_image     *buffer,
 *                                       const mlib_s16 *x,
 *                                       const mlib_s16 *y,
 *                                       mlib_s32       npoints,
...
#pragma weak mlib_GraphicsDrawPolygon_32 = __mlib_GraphicsDrawPolygon_32
#pragma weak mlib_GraphicsDrawPolygon_8 = __mlib_GraphicsDrawPolygon_8

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_GraphicsDrawPolygon_32) mlib_GraphicsDrawPolygon_32
	__attribute__((weak, alias("__mlib_GraphicsDrawPolygon_32")));
__typeof__(__mlib_GraphicsDrawPolygon_8) mlib_GraphicsDrawPolygon_8
	__attribute__((weak, alias("__mlib_GraphicsDrawPolygon_8")));
...
#define	MLIB_GDP_COMPLECT(N, NEXT)                                  \
	...
	mlib_GraphicsSpamLineSet_##N(rtable, stride, coords,        \
		coords + NEXT, c, d_c);                             \
	return MLIB_SUCCESS
...
__mlib_GraphicsDrawPolygon_8(
	...
	mlib_s32 c)
{
	MLIB_GDP_COMPLECT(8, MLIB_GDS_NEXT);
}

/* *********************************************************** */

mlib_status
__mlib_GraphicsDrawPolygon_32(
	mlib_image *buffer,
	const mlib_s16 *x,
	const mlib_s16 *y,
	mlib_s32 npoints,
	mlib_s32 c)
{
	MLIB_GDP_COMPLECT(32, MLIB_GDS_NEXT);
}
