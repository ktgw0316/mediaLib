...
#pragma ident	"@(#)mlib_ImageBlend_SA_OMDC.c	9.2	07/10/09 SMI"

/*
 * FUNCTION
 *      mlib_ImageBlend_SA_OMDC - blend two images with
 *      OMDC source blend factor and SA destination blend factor
 *
 * SYNOPSIS
 *
 *      mlib_status mlib_ImageBlend_SA_OMDC(mlib_image       *dst,
...
#pragma weak mlib_ImageBlend_SA_OMDC = __mlib_ImageBlend_SA_OMDC

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageBlend_SA_OMDC) mlib_ImageBlend_SA_OMDC
    __attribute__((weak, alias("__mlib_ImageBlend_SA_OMDC")));
...
__mlib_ImageBlend_SA_OMDC(
    ...
    mlib_s32 cmask)
{
	return (__mlib_ImageBlend_OMSC_DA(dst, src2, src1, cmask));
}
