...
#pragma ident	"@(#)mlib_c_ImageBlend_ZERO_SA.c	9.2	07/10/09 SMI"
...
#pragma pipeloop(0)
			...
			for (j = 0; j < dst_width; j++) {
				...
				a = mlib_c_blend_Q8[help_alpha];
				pdst[0] =
				    (mlib_u8)(mlib_U82F32[help_alpha] * a);
				pdst[1] = (mlib_u8)(mlib_U82F32[psrc2[1]] * a);
				pdst[2] = (mlib_u8)(mlib_U82F32[psrc2[2]] * a);
				pdst[3] = (mlib_u8)(mlib_U82F32[psrc2[3]] * a);
				psrc2 += 4;
				pdst += 4;
			}
