...
#pragma ident	"@(#)mlib_ImageBlend_DA_DC.c	9.2	07/10/09 SMI"

/*
 * FUNCTION
 *      mlib_ImageBlend_DA_DC - blend two images with
 *      DC source blend factor and DA destination blend factor
 *
 * SYNOPSIS
 *
 *      mlib_status mlib_ImageBlend_DA_DC(mlib_image       *dst,
...
#pragma weak mlib_ImageBlend_DA_DC = __mlib_ImageBlend_DA_DC

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageBlend_DA_DC) mlib_ImageBlend_DA_DC
    __attribute__((weak, alias("__mlib_ImageBlend_DA_DC")));
...
mlib_status
__mlib_ImageBlend_DA_DC(
    mlib_image *dst,
    const mlib_image *src1,
    const mlib_image *src2,
    mlib_s32 cmask)
{
	return (__mlib_ImageBlend_SC_SA(dst, src2, src1, cmask));
}
