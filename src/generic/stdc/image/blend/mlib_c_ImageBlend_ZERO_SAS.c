...
#pragma ident	"@(#)mlib_c_ImageBlend_ZERO_SAS.c	9.3	07/10/09 SMI"
...
#pragma pipeloop(0)
			...
			for (i = 0; i < dst_width; i++) {
				...
				pdst[4 * i + 0] =
				    (mlib_u8)((min) * mlib_U82F32[psrc2[4 * i +
				    0]]);
				pdst[4 * i + 1] =
				    (mlib_u8)((min) * mlib_U82F32[psrc2[4 * i +
				    1]]);
				pdst[4 * i + 2] =
				    ...
				    2]]);
				pdst[4 * i + 3] =
				    (mlib_u8)mlib_U82F32[psrc2[4 * i + 3]];
			}
...
#pragma pipeloop(0)
			...
			for (i = 0; i < dst_width; i++) {
				...
				pdst[4 * i + 0] =
				    (mlib_u8)mlib_U82F32[psrc2[4 * i + 0]];
				pdst[4 * i + 1] =
				    (mlib_u8)((min) * mlib_U82F32[psrc2[4 * i +
				    1]]);
				pdst[4 * i + 2] =
