...
#pragma ident	"@(#)mlib_ImageBlend_SA_ONE.c	9.2	07/10/09 SMI"

/*
 * FUNCTION
 *      mlib_ImageBlend_SA_ONE - blend two images with
 *      ONE source blend factor and SA destination blend factor
 *
 * SYNOPSIS
 *
 *      mlib_status mlib_ImageBlend_SA_ONE(mlib_image       *dst,
...
#pragma weak mlib_ImageBlend_SA_ONE = __mlib_ImageBlend_SA_ONE

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageBlend_SA_ONE) mlib_ImageBlend_SA_ONE
    __attribute__((weak, alias("__mlib_ImageBlend_SA_ONE")));
...
mlib_status
__mlib_ImageBlend_SA_ONE(
    mlib_image *dst,
    const mlib_image *src1,
    const mlib_image *src2,
    mlib_s32 cmask)
{
	return (__mlib_ImageBlend_ONE_DA(dst, src2, src1, cmask));
}
