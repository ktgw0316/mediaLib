...
#pragma ident	"@(#)mlib_ImageBlend_DA_OMDC.c	9.2	07/10/09 SMI"

/*
 * FUNCTION
 *      mlib_ImageBlend_DA_OMDC - blend two images with
 *      OMDC source blend factor and DA destination blend factor
 *
 * SYNOPSIS
 *
 *      mlib_status mlib_ImageBlend_DA_OMDC(mlib_image       *dst,
...
#pragma weak mlib_ImageBlend_DA_OMDC = __mlib_ImageBlend_DA_OMDC

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageBlend_DA_OMDC) mlib_ImageBlend_DA_OMDC
    __attribute__((weak, alias("__mlib_ImageBlend_DA_OMDC")));
...
__mlib_ImageBlend_DA_OMDC(
    ...
    mlib_s32 cmask)
{
	return (__mlib_ImageBlend_OMSC_SA(dst, src2, src1, cmask));
}
