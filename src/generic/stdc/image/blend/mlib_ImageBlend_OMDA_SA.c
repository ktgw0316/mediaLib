...
#pragma ident	"@(#)mlib_ImageBlend_OMDA_SA.c	9.2	07/10/09 SMI"

/*
 * FUNCTION
 *      mlib_ImageBlend_OMDA_SA - blend two images with
 *      SA source blend factor and OMDA destination blend factor
 *
 * SYNOPSIS
 *
 *      mlib_status mlib_ImageBlend_OMDA_SA(mlib_image       *dst,
...
#pragma weak mlib_ImageBlend_OMDA_SA = __mlib_ImageBlend_OMDA_SA

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageBlend_OMDA_SA) mlib_ImageBlend_OMDA_SA
    __attribute__((weak, alias("__mlib_ImageBlend_OMDA_SA")));
...
__mlib_ImageBlend_OMDA_SA(
    ...
    mlib_s32 cmask)
{
	return (__mlib_ImageBlend_DA_OMSA(dst, src2, src1, cmask));
}
