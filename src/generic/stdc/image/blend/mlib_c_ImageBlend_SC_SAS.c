...
#pragma ident	"@(#)mlib_c_ImageBlend_SC_SAS.c	9.2	07/10/09 SMI"
...
#pragma pipeloop(0)
			...
			for (i = 0; i < dst_width; i++) {
				...
				pdst[4 * i + 0] =
				    FLOAT2INT_CLAMP((mlib_c_blend_Q8[psrc1[4 *
				    i + 0]] +
				    min) * mlib_c_blend_u8_sat[psrc2[4 * i +
				    0]]) >> 23;
				...
				pdst[4 * i + 3] =
				    FLOAT2INT_CLAMP((mlib_c_blend_Q8[psrc1[4 *
				    i + 3]] +
				    1) * mlib_c_blend_u8_sat[psrc2[4 * i +
				    3]]) >> 23;
			}
