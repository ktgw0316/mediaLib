...
#pragma ident	"@(#)mlib_c_ImageBlend_SA_SAS.c	9.2	07/10/09 SMI"
    ...
    mlib_s32 cmask)
{
	...
	mlib_f32 min, alpha2, src20, src21, src22;
	mlib_f32 src23, src10, src11, src12, src13;
...
#pragma pipeloop(0)
			...
			for (i = 0; i < dst_width; i++) {
				...
				alpha2 = mlib_c_blend_Q8[src_alpha];
				min =
