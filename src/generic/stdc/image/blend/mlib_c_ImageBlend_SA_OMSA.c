...
#pragma ident	"@(#)mlib_c_ImageBlend_SA_OMSA.c	9.2	07/10/09 SMI"
...
#pragma pipeloop(0)
		...
		for (i = 0; i < dst_width; i++) {
			...
			pdst[4 * i + 0] =
			    (mlib_s32)((src10 - src20) * alpha + src20) >> 23;
			pdst[4 * i + 1] =
			    (mlib_s32)((src11 - src21) * alpha + src21) >> 23;
			pdst[4 * i + 2] =
			    (mlib_s32)((src12 - src22) * alpha + src22) >> 23;
			pdst[4 * i + 3] =
			    (mlib_s32)((src13 - src23) * alpha + src23) >> 23;
		}
