...
#pragma ident	"@(#)mlib_ImageBlend_OMSC_DC.c	9.2	07/10/09 SMI"

/*
 * FUNCTION
 *      mlib_ImageBlend_OMSC_DC - blend two images with
 *      DC source blend factor and OMSC destination blend factor
 *
 * SYNOPSIS
 *
 *      mlib_status mlib_ImageBlend_OMSC_DC(mlib_image       *dst,
...
#pragma weak mlib_ImageBlend_OMSC_DC = __mlib_ImageBlend_OMSC_DC

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageBlend_OMSC_DC) mlib_ImageBlend_OMSC_DC
    __attribute__((weak, alias("__mlib_ImageBlend_OMSC_DC")));
