...
#pragma ident	"@(#)mlib_ImageBlend_ONE_ONE.c	9.2	07/10/09 SMI"

/*
 * FUNCTION
 *      mlib_ImageBlend_ONE_ONE - blend two images with
 *      ONE source blend factor and ONE destination blend factor
 *
 * SYNOPSIS
 *
 *      mlib_status mlib_ImageBlend_ONE_ONE(mlib_image       *dst,
...
#pragma weak mlib_ImageBlend_ONE_ONE = __mlib_ImageBlend_ONE_ONE

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageBlend_ONE_ONE) mlib_ImageBlend_ONE_ONE
    __attribute__((weak, alias("__mlib_ImageBlend_ONE_ONE")));
