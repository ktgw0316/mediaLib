...
#pragma ident	"@(#)mlib_c_ImageBlend_OMSC_OMDC.c	9.2	07/10/09 SMI"
...
#pragma pipeloop(0)
		...
		for (i = 0; i < dst_width; i++) {
			...
			fsrc1 = mlib_U82F32[psrc1[i]];
			fsrc2 = mlib_c_blend_Q8[psrc2[i]];

			pdst[i] =
			    (mlib_u8)(fsrc1 * (1 - fsrc2) + fsrc2 * (256 -
			    fsrc1));
		}
