...
#pragma ident	"@(#)mlib_ImageBlend_OMSC_ZERO.c	9.2	07/10/09 SMI"

/*
 * FUNCTION
 *      mlib_ImageBlend_OMSC_ZERO - blend two images with
 *      ZERO source blend factor and OMSC destination blend factor
 *
 * SYNOPSIS
 *
 *      mlib_status mlib_ImageBlend_OMSC_ZERO(mlib_image       *dst,
...
#pragma weak mlib_ImageBlend_OMSC_ZERO = __mlib_ImageBlend_OMSC_ZERO

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageBlend_OMSC_ZERO) mlib_ImageBlend_OMSC_ZERO
    __attribute__((weak, alias("__mlib_ImageBlend_OMSC_ZERO")));
...
__mlib_ImageBlend_OMSC_ZERO(
    ...
    mlib_s32 cmask)
{
	return (__mlib_ImageBlend_ZERO_OMDC(dst, src2, src1, cmask));
}
