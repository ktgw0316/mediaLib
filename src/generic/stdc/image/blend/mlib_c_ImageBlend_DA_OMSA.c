...
#pragma ident	"@(#)mlib_c_ImageBlend_DA_OMSA.c	9.3	07/10/09 SMI"
...
#pragma pipeloop(0)
		...
		for (i = 0; i < dst_width; i++) {
			...
			pdst[4 * i + 0] =
			    (mlib_s32)(src10 * alpha1 + src20 * alpha2) >> 23;
			pdst[4 * i + 1] =
			    (mlib_s32)(src11 * alpha1 + src21 * alpha2) >> 23;
			pdst[4 * i + 2] =
			    (mlib_s32)(src12 * alpha1 + src22 * alpha2) >> 23;
			pdst[4 * i + 3] =
			    (mlib_s32)(src13 * alpha1 + src23 * alpha2) >> 23;
