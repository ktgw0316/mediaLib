...
#pragma ident	"@(#)mlib_ImageBlend_OMDA_OMDA.c	9.2	07/10/09 SMI"

/*
 * FUNCTION
 *      mlib_ImageBlend_OMDA_OMDA - blend two images with
 *      OMDA source blend factor and OMDA destination blend factor
 *
 * SYNOPSIS
 *
 *      mlib_status mlib_ImageBlend_OMDA_OMDA(mlib_image       *dst,
...
#pragma weak mlib_ImageBlend_OMDA_OMDA = __mlib_ImageBlend_OMDA_OMDA

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageBlend_OMDA_OMDA) mlib_ImageBlend_OMDA_OMDA
    __attribute__((weak, alias("__mlib_ImageBlend_OMDA_OMDA")));
...
__mlib_ImageBlend_OMDA_OMDA(
    ...
    mlib_s32 cmask)
{
	return (__mlib_ImageBlend_OMSA_OMSA(dst, src2, src1, cmask));
}
