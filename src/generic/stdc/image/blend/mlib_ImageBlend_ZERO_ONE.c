...
#pragma ident	"@(#)mlib_ImageBlend_ZERO_ONE.c	9.2	07/10/09 SMI"

/*
 * FUNCTION
 *      mlib_ImageBlend_ZERO_ONE - blend two images with
 *      ONE source blend factor and ZERO destination blend factor
 *
 * SYNOPSIS
 *
 *      mlib_status mlib_ImageBlend_ZERO_ONE(mlib_image       *dst,
...
#pragma weak mlib_ImageBlend_ZERO_ONE = __mlib_ImageBlend_ZERO_ONE

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageBlend_ZERO_ONE) mlib_ImageBlend_ZERO_ONE
    __attribute__((weak, alias("__mlib_ImageBlend_ZERO_ONE")));
