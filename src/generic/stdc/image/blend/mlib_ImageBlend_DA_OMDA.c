...
#pragma ident	"@(#)mlib_ImageBlend_DA_OMDA.c	9.2	07/10/09 SMI"

/*
 * FUNCTION
 *      mlib_ImageBlend_DA_OMDA - blend two images with
 *      OMDA source blend factor and DA destination blend factor
 *
 * SYNOPSIS
 *
 *      mlib_status mlib_ImageBlend_DA_OMDA(mlib_image       *dst,
...
#pragma weak mlib_ImageBlend_DA_OMDA = __mlib_ImageBlend_DA_OMDA

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageBlend_DA_OMDA) mlib_ImageBlend_DA_OMDA
    __attribute__((weak, alias("__mlib_ImageBlend_DA_OMDA")));
...
__mlib_ImageBlend_DA_OMDA(
    ...
    mlib_s32 cmask)
{
	return (__mlib_ImageBlend_OMSA_SA(dst, src2, src1, cmask));
}
