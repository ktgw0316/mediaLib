...
#pragma ident	"@(#)mlib_ImageBlend_OMDA_DA.c	9.2	07/10/09 SMI"

/*
 * FUNCTION
 *      mlib_ImageBlend_OMDA_DA - blend two images with
 *      DA source blend factor and OMDA destination blend factor
 *
 * SYNOPSIS
 *
 *      mlib_status mlib_ImageBlend_OMDA_DA(mlib_image       *dst,
...
#pragma weak mlib_ImageBlend_OMDA_DA = __mlib_ImageBlend_OMDA_DA

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageBlend_OMDA_DA) mlib_ImageBlend_OMDA_DA
    __attribute__((weak, alias("__mlib_ImageBlend_OMDA_DA")));
...
mlib_status
__mlib_ImageBlend_OMDA_DA(
    mlib_image *dst,
    const mlib_image *src1,
    const mlib_image *src2,
    mlib_s32 cmask)
{
	return (__mlib_ImageBlend_SA_OMSA(dst, src2, src1, cmask));
}
