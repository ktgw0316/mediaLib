...
#pragma ident	"@(#)mlib_ImageBlend_ZERO_ZERO.c	9.2	07/10/09 SMI"

/*
 * FUNCTION
 *      mlib_ImageBlend_ZERO_ZERO - blend two images with
 *      ZERO source blend factor and ZERO destination blend factor
 *
 * SYNOPSIS
 *
 *      mlib_status mlib_ImageBlend_ZERO_ZERO(mlib_image       *dst,
...
#pragma weak mlib_ImageBlend_ZERO_ZERO = __mlib_ImageBlend_ZERO_ZERO

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageBlend_ZERO_ZERO) mlib_ImageBlend_ZERO_ZERO
    __attribute__((weak, alias("__mlib_ImageBlend_ZERO_ZERO")));
