...
#pragma ident	"@(#)mlib_ImageMedianFilter7x7_Fp.c	9.2	07/10/09 SMI"

/*
 * FUNCTION
 *      mlib_ImageMedianFilter7x7_Fp  - median filtering with 7x7 mask
 *
 * SYNOPSIS
...
#pragma weak mlib_ImageMedianFilter7x7_Fp = __mlib_ImageMedianFilter7x7_Fp

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageMedianFilter7x7_Fp) mlib_ImageMedianFilter7x7_Fp
    __attribute__((weak, alias("__mlib_ImageMedianFilter7x7_Fp")));
...
mlib_status
__mlib_ImageMedianFilter7x7_Fp(
    mlib_image *dst,
    const mlib_image *src,
    mlib_median_mask mmask,
    mlib_s32 cmask,
