...
#pragma ident	"@(#)mlib_ImageMinFilter3x3_Fp.c	9.3	07/10/09 SMI"

/*
 * FUNCTION
 *      mlib_ImageMinFilter3x3_Fp
 *              Does a 3x3 min filter. Edge policy = no write.
 *
 * SYNOPSIS
...
#pragma weak mlib_ImageMinFilter3x3_Fp = __mlib_ImageMinFilter3x3_Fp

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageMinFilter3x3_Fp) mlib_ImageMinFilter3x3_Fp
    __attribute__((weak, alias("__mlib_ImageMinFilter3x3_Fp")));
    ...
    const mlib_image *src)
{
	...
	switch (type) {
	case MLIB_FLOAT:
		return (mlib_ImageMinFilter3x3_F32(da, sa, dlb, slb, wid, hgt));

	case MLIB_DOUBLE:
		return (mlib_ImageMinFilter3x3_D64(da, sa, dlb, slb, wid, hgt));
