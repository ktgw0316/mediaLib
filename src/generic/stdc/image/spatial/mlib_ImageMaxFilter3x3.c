...
#pragma ident	"@(#)mlib_ImageMaxFilter3x3.c	9.2	07/10/09 SMI"

/*
 * FUNCTION
 *      mlib_ImageMaxFilter3x3
 *              Does a 3x3 max filter. Edge policy = no write.
 *
 * SYNOPSIS
 *      mlib_status mlib_ImageMaxFilter3x3(mlib_image       *dst,
...
#pragma weak mlib_ImageMaxFilter3x3 = __mlib_ImageMaxFilter3x3

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageMaxFilter3x3) mlib_ImageMaxFilter3x3
    __attribute__((weak, alias("__mlib_ImageMaxFilter3x3")));
    ...
    const mlib_image *src)
{
	...
	switch (type) {
	case MLIB_BIT:
		return mlib_ImageMaxFilter3x3_BIT(da, sa, dlb, slb, wid, hgt,
		    mlib_ImageGetBitOffset(dst_i),
		    mlib_ImageGetBitOffset(src_i));

	case MLIB_BYTE:
		return (mlib_ImageMaxFilter3x3_U8(da, sa, dlb, slb, wid, hgt));

	case MLIB_SHORT:
		return (mlib_ImageMaxFilter3x3_S16(da, sa, dlb, slb, wid, hgt));

	case MLIB_USHORT:
		return (mlib_ImageMaxFilter3x3_U16(da, sa, dlb, slb, wid, hgt));

	case MLIB_INT:
		return (mlib_ImageMaxFilter3x3_S32(da, sa, dlb, slb, wid, hgt));
