...
#pragma ident	"@(#)mlib_ImageMaxFilter5x5.c	9.2	07/10/09 SMI"

/*
 * FUNCTION
 *      mlib_ImageMaxFilter5x5
 *              Does a 5x5 max filter. Edge policy = no write.
 *
 * SYNOPSIS
 *      mlib_status mlib_ImageMaxFilter5x5(mlib_image       *dst,
...
#pragma weak mlib_ImageMaxFilter5x5 = __mlib_ImageMaxFilter5x5

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageMaxFilter5x5) mlib_ImageMaxFilter5x5
    __attribute__((weak, alias("__mlib_ImageMaxFilter5x5")));
    ...
    const mlib_image *src)
{
	...
	switch (type) {
	case MLIB_BYTE:
		return (mlib_ImageMaxFilter5x5_U8(da, sa, dlb, slb, wid, hgt));

	case MLIB_SHORT:
		return (mlib_ImageMaxFilter5x5_S16(da, sa, dlb, slb, wid, hgt));

	case MLIB_USHORT:
		return (mlib_ImageMaxFilter5x5_U16(da, sa, dlb, slb, wid, hgt));

	case MLIB_INT:
		return (mlib_ImageMaxFilter5x5_S32(da, sa, dlb, slb, wid, hgt));
