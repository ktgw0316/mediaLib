...
#pragma ident	"@(#)mlib_ImageDilate8.c	9.2	07/10/09 SMI"
 ...
 *
 * SYNOPSIS
 *      mlib_status mlib_ImageDilate8(mlib_image       *dst,
...
#pragma weak mlib_ImageDilate8 = __mlib_ImageDilate8

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageDilate8) mlib_ImageDilate8
    __attribute__((weak, alias("__mlib_ImageDilate8")));
