...
#pragma ident	"@(#)mlib_ImageErode8_Fp.c	9.2	07/10/09 SMI"
 ...
 *
 * SYNOPSIS
 *      mlib_status mlib_ImageErode8_Fp(mlib_image       *dst,
...
#pragma weak mlib_ImageErode8_Fp = __mlib_ImageErode8_Fp

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageErode8_Fp) mlib_ImageErode8_Fp
    __attribute__((weak, alias("__mlib_ImageErode8_Fp")));
