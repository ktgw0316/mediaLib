...
#pragma ident	"@(#)mlib_ImageMinFilter7x7.c	9.2	07/10/09 SMI"
 ...
 *
 * SYNOPSIS
 *      mlib_status mlib_ImageMinFilter7x7(mlib_image       *dst,
...
#pragma weak mlib_ImageMinFilter7x7 = __mlib_ImageMinFilter7x7

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageMinFilter7x7) mlib_ImageMinFilter7x7
    __attribute__((weak, alias("__mlib_ImageMinFilter7x7")));
    ...
    const mlib_image *src)
{
	...
	switch (type) {
	case MLIB_BYTE:
		return (mlib_ImageMinFilter7x7_U8(da, sa, dlb, slb, wid, hgt));

	case MLIB_SHORT:
		return (mlib_ImageMinFilter7x7_S16(da, sa, dlb, slb, wid, hgt));

	case MLIB_USHORT:
		return (mlib_ImageMinFilter7x7_U16(da, sa, dlb, slb, wid, hgt));

	case MLIB_INT:
		return (mlib_ImageMinFilter7x7_S32(da, sa, dlb, slb, wid, hgt));
