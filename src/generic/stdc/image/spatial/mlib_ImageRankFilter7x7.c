...
#pragma ident	"@(#)mlib_ImageRankFilter7x7.c	9.2	07/10/09 SMI"

/*
 * FUNCTION
 *      mlib_ImageRankFilter7x7 - performs rank filtering on an image.
 *
 * SYNOPSIS
 *      mlib_status mlib_ImageRankFilter7x7(mlib_image       *dst,
...
#pragma weak mlib_ImageRankFilter7x7 = __mlib_ImageRankFilter7x7

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageRankFilter7x7) mlib_ImageRankFilter7x7
    __attribute__((weak, alias("__mlib_ImageRankFilter7x7")));
...
mlib_status
__mlib_ImageRankFilter7x7(
    mlib_image *dst,
    const mlib_image *src,
    mlib_s32 rank)
{
	if (rank == 0)
		return (__mlib_ImageMinFilter7x7(dst, src));

	if (rank == 48)
		return (__mlib_ImageMaxFilter7x7(dst, src));

	return (__mlib_ImageRankFilterMxN(dst, src, 7, 7, rank));
}
