...
#ifndef _MLIB_C_IMAGEMAXMINFILTER3X3_H
#define	_MLIB_C_IMAGEMAXMINFILTER3X3_H

#pragma ident	"@(#)mlib_c_ImageMaxMinFilter3x3.h	9.2	07/10/09 SMI"
...
#if ! defined(BUFF_SIZE)

#define	BUFF_SIZE	512

#endif		   /* ! defined(BUFF_SIZE) */
...
#define	FUNC_NAME	mlib_ImageMaxFilter3x3_U8

#elif FTYPE == FTYPE_S16	/* FTYPE == FTYPE_U8 */

#define	FUNC_NAME	mlib_ImageMaxFilter3x3_S16

#elif FTYPE == FTYPE_U16	/* FTYPE == FTYPE_U8 */

#define	FUNC_NAME	mlib_ImageMaxFilter3x3_U16
...
#define	FUNC_NAME	mlib_ImageMinFilter3x3_U8

#elif FTYPE == FTYPE_S16	/* FTYPE == FTYPE_U8 */

#define	FUNC_NAME	mlib_ImageMinFilter3x3_S16

#elif FTYPE == FTYPE_U16	/* FTYPE == FTYPE_U8 */

#define	FUNC_NAME	mlib_ImageMinFilter3x3_U16
...
#endif /* _MLIB_C_IMAGEMAXMINFILTER3X3_H */
