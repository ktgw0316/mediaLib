...
#pragma ident	"@(#)mlib_ImageMinFilter3x3.c	9.2	07/10/09 SMI"

/*
 * FUNCTION
 *      mlib_ImageMinFilter3x3
 *              Does a 3x3 min filter. Edge policy = no write.
 *
 * SYNOPSIS
 *      mlib_status mlib_ImageMinFilter3x3(mlib_image       *dst,
...
#pragma weak mlib_ImageMinFilter3x3 = __mlib_ImageMinFilter3x3

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageMinFilter3x3) mlib_ImageMinFilter3x3
    __attribute__((weak, alias("__mlib_ImageMinFilter3x3")));
