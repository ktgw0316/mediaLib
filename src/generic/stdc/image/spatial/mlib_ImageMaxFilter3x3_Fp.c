...
#pragma ident	"@(#)mlib_ImageMaxFilter3x3_Fp.c	9.3	07/10/09 SMI"

/*
 * FUNCTION
 *      mlib_ImageMaxFilter3x3_Fp
 *              Does a 3x3 max filter. Edge policy = no write.
 *
 * SYNOPSIS
 *      mlib_status mlib_ImageMaxFilter3x3_Fp(mlib_image       *dst,
...
#pragma weak mlib_ImageMaxFilter3x3_Fp = __mlib_ImageMaxFilter3x3_Fp

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageMaxFilter3x3_Fp) mlib_ImageMaxFilter3x3_Fp
    __attribute__((weak, alias("__mlib_ImageMaxFilter3x3_Fp")));
