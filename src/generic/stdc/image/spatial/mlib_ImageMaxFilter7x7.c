...
#pragma ident	"@(#)mlib_ImageMaxFilter7x7.c	9.2	07/10/09 SMI"

/*
 * FUNCTION
 *      mlib_ImageMaxFilter7x7
 *              Does a 7x7 max filter. Edge policy = no write.
 *
 * SYNOPSIS
 *      mlib_status mlib_ImageMaxFilter7x7(mlib_image       *dst,
...
#pragma weak mlib_ImageMaxFilter7x7 = __mlib_ImageMaxFilter7x7

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageMaxFilter7x7) mlib_ImageMaxFilter7x7
    __attribute__((weak, alias("__mlib_ImageMaxFilter7x7")));
    ...
    const mlib_image *src)
{
	...
	switch (type) {
	case MLIB_BYTE:
		return (mlib_ImageMaxFilter7x7_U8(da, sa, dlb, slb, wid, hgt));

	case MLIB_SHORT:
		return (mlib_ImageMaxFilter7x7_S16(da, sa, dlb, slb, wid, hgt));

	case MLIB_USHORT:
		return (mlib_ImageMaxFilter7x7_U16(da, sa, dlb, slb, wid, hgt));

	case MLIB_INT:
		return (mlib_ImageMaxFilter7x7_S32(da, sa, dlb, slb, wid, hgt));
