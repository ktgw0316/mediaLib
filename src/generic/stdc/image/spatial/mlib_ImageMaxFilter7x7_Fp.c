...
#pragma ident	"@(#)mlib_ImageMaxFilter7x7_Fp.c	9.3	07/10/09 SMI"

/*
 * FUNCTION
 *      mlib_ImageMaxFilter7x7_Fp
...
#pragma weak mlib_ImageMaxFilter7x7_Fp = __mlib_ImageMaxFilter7x7_Fp

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageMaxFilter7x7_Fp) mlib_ImageMaxFilter7x7_Fp
    __attribute__((weak, alias("__mlib_ImageMaxFilter7x7_Fp")));
    ...
    const mlib_image *src)
{
	...
	switch (type) {
	case MLIB_FLOAT:
		return (mlib_ImageMaxFilter7x7_F32(da, sa, dlb, slb, wid, hgt));

	case MLIB_DOUBLE:
		return (mlib_ImageMaxFilter7x7_D64(da, sa, dlb, slb, wid, hgt));
