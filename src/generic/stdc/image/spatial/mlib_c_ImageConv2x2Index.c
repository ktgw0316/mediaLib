...
#pragma ident	"@(#)mlib_c_ImageConv2x2Index.c	9.2	07/10/09 SMI"
    ...
    const void *colormap)
{
	...
	case MLIB_BYTE:
		...
		case MLIB_BYTE:
			...
			case MLIB_EDGE_DST_FILL_ZERO:
				stat =
				    mlib_conv2x2Index_8_8nw(src, dst, kernel,
				    scale, colormap);
			...
			case MLIB_EDGE_SRC_EXTEND:
				stat =
				    mlib_conv2x2Index_8_8ext(src, dst, kernel,
				    scale, colormap);
				break;
	...
	case MLIB_SHORT:	/* convert wid from pixels to bytes */
		...
		case MLIB_BYTE:
			...
			case MLIB_EDGE_DST_FILL_ZERO:
				stat =
				    mlib_conv2x2Index_8_16nw(src, dst, kernel,
				    scale, colormap);
			...
			case MLIB_EDGE_SRC_EXTEND:
				stat =
				    mlib_conv2x2Index_8_16ext(src, dst, kernel,
				    scale, colormap);
				break;
			case MLIB_EDGE_DST_NO_WRITE:
			default:
