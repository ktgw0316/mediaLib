...
#pragma ident	"@(#)mlib_ImageMedianFilter3x3_Fp.c	9.2	07/10/09 SMI"

/*
 * FUNCTION
 *      mlib_ImageMedianFilter3x3_Fp    - median filtering with 3x3 mask
 *
 * SYNOPSIS
 *      mlib_status mlib_ImageMedianFilter3x3_Fp(mlib_image       *dst,
...
#pragma weak mlib_ImageMedianFilter3x3_Fp = __mlib_ImageMedianFilter3x3_Fp

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageMedianFilter3x3_Fp) mlib_ImageMedianFilter3x3_Fp
    __attribute__((weak, alias("__mlib_ImageMedianFilter3x3_Fp")));
...
mlib_status
__mlib_ImageMedianFilter3x3_Fp(
    mlib_image *dst,
    const mlib_image *src,
    mlib_median_mask mmask,
    mlib_s32 cmask,
