...
#pragma ident	"@(#)mlib_ImageMinFilter5x5_Fp.c	9.3	07/10/09 SMI"
 ...
 *
 * SYNOPSIS
 *      mlib_status mlib_ImageMinFilter5x5_Fp(mlib_image       *dst,
...
#pragma weak mlib_ImageMinFilter5x5_Fp = __mlib_ImageMinFilter5x5_Fp

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageMinFilter5x5_Fp) mlib_ImageMinFilter5x5_Fp
    __attribute__((weak, alias("__mlib_ImageMinFilter5x5_Fp")));
    ...
    const mlib_image *src)
{
	...
	switch (type) {
	case MLIB_FLOAT:
		return (mlib_ImageMinFilter5x5_F32(da, sa, dlb, slb, wid, hgt));

	case MLIB_DOUBLE:
		return (mlib_ImageMinFilter5x5_D64(da, sa, dlb, slb, wid, hgt));
