...
#pragma ident	"@(#)mlib_ImageErode4.c	9.2	07/10/09 SMI"
 ...
 *
 * SYNOPSIS
 *      mlib_status mlib_ImageErode4(mlib_image       *dst,
...
#pragma weak mlib_ImageErode4 = __mlib_ImageErode4

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageErode4) mlib_ImageErode4
    __attribute__((weak, alias("__mlib_ImageErode4")));
    ...
    const mlib_image *src)
{
	...
	switch (type) {
	case MLIB_BIT:
		return mlib_ImageErode4_BIT(da, sa, dlb, slb, wid, hgt,
		    mlib_ImageGetBitOffset(dst_i),
		    mlib_ImageGetBitOffset(src_i));

	case MLIB_BYTE:
		return (mlib_ImageErode4_U8(da, sa, dlb, slb, wid, hgt));

	case MLIB_SHORT:
		return (mlib_ImageErode4_S16(da, sa, dlb, slb, wid, hgt));

	case MLIB_USHORT:
		return (mlib_ImageErode4_U16(da, sa, dlb, slb, wid, hgt));

	case MLIB_INT:
		return (mlib_ImageErode4_S32(da, sa, dlb, slb, wid, hgt));
