...
#pragma ident	"@(#)mlib_ImageRotate_Fp.c	9.2	07/10/09 SMI"

/*
 * FUNCTION
 *      mlib_ImageRotate_Fp - image rotation with edge condition
 *
 * SYNOPSIS
 *      mlib_status mlib_ImageRotate_Fp(mlib_image       *dst,
...
#pragma weak mlib_ImageRotate_Fp = __mlib_ImageRotate_Fp

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageRotate_Fp) mlib_ImageRotate_Fp
    __attribute__((weak, alias("__mlib_ImageRotate_Fp")));
