...
#ifndef _MLIB_IMAGEFILTEREDSUBSAMPLEFUNC_H
#define	_MLIB_IMAGEFILTEREDSUBSAMPLEFUNC_H

#pragma ident	"@(#)mlib_ImageFilteredSubsampleFunc.h	9.2	07/10/09 SMI"
...
#endif /* _MLIB_IMAGEFILTEREDSUBSAMPLEFUNC_H */
