...
#pragma ident	"@(#)mlib_ImageZoomTransTable_F32ext.c	9.2	07/10/09 SMI"
...
#define	FUNC_NAME	mlib_ImageZoomTranslateTable_F32ext

#include <mlib_ImageZoomTranslateTable_f.h>
