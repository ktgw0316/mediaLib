...
#pragma ident	"@(#)mlib_c_ImageFilteredSubsample.c	9.2	07/10/09 SMI"
    ...
    mlib_edge edge)
{
	...
	if (kh > 2 * scaleY || (kh == 2 * scaleY && scaleY > 1)) {
		switch (type) {
		case MLIB_BYTE:
			return mlib_ImageFilteredSubsample_8nw_2(dst, src,
			    scaleX, scaleY, transX, transY, hKernel, vKernel,
			    hSize, vSize, hParity, vParity, edge);
		case MLIB_SHORT:
			return mlib_ImageFilteredSubsample_16nw_2(dst, src,
			    scaleX, scaleY, transX, transY, hKernel, vKernel,
			    hSize, vSize, hParity, vParity, edge);
		case MLIB_USHORT:
			return mlib_ImageFilteredSubsample_u16nw_2(dst, src,
			    scaleX, scaleY, transX, transY, hKernel, vKernel,
			    hSize, vSize, hParity, vParity, edge);
		case MLIB_INT:
			return mlib_ImageFilteredSubsample_32nw_2(dst, src,
			    scaleX, scaleY, transX, transY, hKernel, vKernel,
			    hSize, vSize, hParity, vParity, edge);
		default:
			return (MLIB_FAILURE);
		...
		switch (type) {
		case MLIB_BYTE:
			return mlib_ImageFilteredSubsample_8nw_1(dst, src,
			    scaleX, scaleY, transX, transY, hKernel, vKernel,
			    hSize, vSize, hParity, vParity, edge);
		case MLIB_SHORT:
			return mlib_ImageFilteredSubsample_16nw_1(dst, src,
			    scaleX, scaleY, transX, transY, hKernel, vKernel,
			    hSize, vSize, hParity, vParity, edge);
		case MLIB_USHORT:
			return mlib_ImageFilteredSubsample_u16nw_1(dst, src,
			    scaleX, scaleY, transX, transY, hKernel, vKernel,
			    hSize, vSize, hParity, vParity, edge);
		case MLIB_INT:
			return mlib_ImageFilteredSubsample_32nw_1(dst, src,
			    scaleX, scaleY, transX, transY, hKernel, vKernel,
			    hSize, vSize, hParity, vParity, edge);
		default:
			return (MLIB_FAILURE);
