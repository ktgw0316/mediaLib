...
#pragma ident	"@(#)mlib_c_ImageZoomIn2X.c	9.2	07/10/09 SMI"
...
#define	MLIB_ZOOMIN2XCALLEDGE(MLIB_TYPE)                              \
	MLIB_ZOOMIN2XCALLPARAM(MLIB_TYPE),                            \
	(MLIB_TYPE *)pdst_near, (MLIB_TYPE *)psrc_near,               \
	src_width_near, src_height_near,                              \
	src_w_beg_near, src_h_beg_near

/* *********************************************************** */

#define	MLIB_ZOOMIN2XCALLEDGE_BC(MLIB_TYPE)                           \
	MLIB_ZOOMIN2XCALLEDGE(MLIB_TYPE),                             \
	(MLIB_TYPE *)psrc_beg, src_width_beg, src_height_beg
...
/* handle MLIB_BYTE data type of image */
		case MLIB_BYTE:
			...
			case MLIB_BILINEAR:
				switch (flag) {
				case 0:
					mlib_c_ImageZoomIn2X_U8_BL_FL0
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u8));
					break;
				case 1:
					mlib_c_ImageZoomIn2X_U8_BL_FL1
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u8));
					break;
				case 2:
					mlib_c_ImageZoomIn2X_U8_BL_FL2
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u8));
					break;
				case 3:
					mlib_c_ImageZoomIn2X_U8_BL_FL3
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u8));
					break;
				}
			...
			case MLIB_BICUBIC:
				switch (flag) {
				case 0:
					mlib_c_ImageZoomIn2X_U8_BC_FL0
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u8));
					break;
				case 1:
					mlib_c_ImageZoomIn2X_U8_BC_FL1
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u8));
					break;
				case 2:
					mlib_c_ImageZoomIn2X_U8_BC_FL2
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u8));
					break;
				case 3:
					mlib_c_ImageZoomIn2X_U8_BC_FL3
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u8));
					break;
				}
			...
			case MLIB_BICUBIC2:
				switch (flag) {
				case 0:
					mlib_c_ImageZoomIn2X_U8_BC2_FL0
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u8));
					break;
				case 1:
					mlib_c_ImageZoomIn2X_U8_BC2_FL1
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u8));
					break;
				case 2:
					mlib_c_ImageZoomIn2X_U8_BC2_FL2
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u8));
					break;
				case 3:
					mlib_c_ImageZoomIn2X_U8_BC2_FL3
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u8));
					break;
				}
...
/* handle MLIB_SHORT data type of image */
		case MLIB_SHORT:
			...
			case MLIB_BILINEAR:
				switch (flag) {
				case 0:
					mlib_c_ImageZoomIn2X_S16_BL_FL0
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_s16));
					break;
				case 1:
					mlib_c_ImageZoomIn2X_S16_BL_FL1
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_s16));
					break;
				case 2:
					mlib_c_ImageZoomIn2X_S16_BL_FL2
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_s16));
					break;
				case 3:
					mlib_c_ImageZoomIn2X_S16_BL_FL3
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_s16));
					break;
				}
			...
			case MLIB_BICUBIC:
				switch (flag) {
				case 0:
					mlib_c_ImageZoomIn2X_S16_BC_FL0
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_s16));
					break;
				case 1:
					mlib_c_ImageZoomIn2X_S16_BC_FL1
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_s16));
					break;
				case 2:
					mlib_c_ImageZoomIn2X_S16_BC_FL2
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_s16));
					break;
				case 3:
					mlib_c_ImageZoomIn2X_S16_BC_FL3
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_s16));
					break;
				}
			...
			case MLIB_BICUBIC2:
				switch (flag) {
				case 0:
					mlib_c_ImageZoomIn2X_S16_BC2_FL0
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_s16));
					break;
				case 1:
					mlib_c_ImageZoomIn2X_S16_BC2_FL1
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_s16));
					break;
				case 2:
					mlib_c_ImageZoomIn2X_S16_BC2_FL2
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_s16));
					break;
				case 3:
					mlib_c_ImageZoomIn2X_S16_BC2_FL3
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_s16));
					break;
				}
...
/* handle MLIB_USHORT data type of image */
		case MLIB_USHORT:
			...
			case MLIB_BILINEAR:
				switch (flag) {
				case 0:
					mlib_c_ImageZoomIn2X_U16_BL_FL0
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u16));
					break;
				case 1:
					mlib_c_ImageZoomIn2X_U16_BL_FL1
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u16));
					break;
				case 2:
					mlib_c_ImageZoomIn2X_U16_BL_FL2
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u16));
					break;
				case 3:
					mlib_c_ImageZoomIn2X_U16_BL_FL3
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u16));
					break;
				}
			...
			case MLIB_BICUBIC:
				switch (flag) {
				case 0:
					mlib_c_ImageZoomIn2X_U16_BC_FL0
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u16));
					break;
				case 1:
					mlib_c_ImageZoomIn2X_U16_BC_FL1
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u16));
					break;
				case 2:
					mlib_c_ImageZoomIn2X_U16_BC_FL2
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u16));
					break;
				case 3:
					mlib_c_ImageZoomIn2X_U16_BC_FL3
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u16));
					break;
				}
			...
			case MLIB_BICUBIC2:
				switch (flag) {
				case 0:
					mlib_c_ImageZoomIn2X_U16_BC2_FL0
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u16));
					break;
				case 1:
					mlib_c_ImageZoomIn2X_U16_BC2_FL1
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u16));
					break;
				case 2:
					mlib_c_ImageZoomIn2X_U16_BC2_FL2
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u16));
					break;
				case 3:
					mlib_c_ImageZoomIn2X_U16_BC2_FL3
					    (MLIB_ZOOMIN2XCALLPARAM(mlib_u16));
					break;
				}
	...
	if ((filter != MLIB_NEAREST) && (edge != MLIB_EDGE_DST_NO_WRITE) &&
		...
		case MLIB_BYTE:
			...
			case MLIB_EDGE_DST_FILL_ZERO:
				mlib_ImageZoomIn2X_U8_CE
				    (MLIB_ZOOMIN2XCALLEDGE(mlib_u8));
				break;
			case MLIB_EDGE_OP_NEAREST:
				mlib_ImageZoomIn2X_U8_ON
				    (MLIB_ZOOMIN2XCALLEDGE(mlib_u8));
				break;
		...
		case MLIB_SHORT:
			switch (edge) {
			case MLIB_EDGE_DST_FILL_ZERO:
				mlib_ImageZoomIn2X_S16_CE
				    (MLIB_ZOOMIN2XCALLEDGE(mlib_s16));
				break;
			case MLIB_EDGE_OP_NEAREST:
				mlib_ImageZoomIn2X_S16_ON
				    (MLIB_ZOOMIN2XCALLEDGE(mlib_s16));
				break;
			case MLIB_EDGE_SRC_EXTEND:
				switch (filter) {
