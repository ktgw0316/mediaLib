...
#pragma ident	"@(#)mlib_ImageAffineTable_32ext.c	9.3	07/10/09 SMI"
...
#define	LINE_FUNC(KERN)                                          \
	void                                                     \
	mlib_ImageAffineTableLine_32ext_##KERN(FP_TYPE * buff,   \
...
#define	LINE_FUNC(KERN)                                             \
	void                                                        \
	mlib_ImageAffineTableLine_32nw_##KERN(FP_TYPE * buff,       \
	    FILTER_TYPE * filterX, FILTER_TYPE * filterY,           \
