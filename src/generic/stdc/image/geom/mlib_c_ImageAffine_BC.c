...
#pragma ident	"@(#)mlib_c_ImageAffine_BC.c	9.2	07/10/09 SMI"
...
#pragma pipeloop(0)
		...
		for (; dstPixelPtr <= (dstLineEnd - 1); dstPixelPtr++) {
			...
			c1 = (mlib_U82D64[srcPixelPtr[0]] * xf0 +
				mlib_U82D64[srcPixelPtr[1]] * xf1 +
				mlib_U82D64[srcPixelPtr[2]] * xf2 +
				mlib_U82D64[srcPixelPtr[3]] * xf3);
			srcPixelPtr =
				(DTYPE *) ((mlib_addr)srcPixelPtr + srcYStride);
			c2 = (mlib_U82D64[srcPixelPtr[0]] * xf0 +
				mlib_U82D64[srcPixelPtr[1]] * xf1 +
				mlib_U82D64[srcPixelPtr[2]] * xf2 +
				mlib_U82D64[srcPixelPtr[3]] * xf3);
			srcPixelPtr =
				(DTYPE *) ((mlib_addr)srcPixelPtr + srcYStride);
			c3 = (mlib_U82D64[srcPixelPtr[0]] * xf0 +
				mlib_U82D64[srcPixelPtr[1]] * xf1 +
				mlib_U82D64[srcPixelPtr[2]] * xf2 +
				mlib_U82D64[srcPixelPtr[3]] * xf3);
...
#pragma pipeloop(0)
			...
			for (; dPtr <= (dstLineEnd - 1); dPtr += 2) {
				...
				srcPixelPtr =
					...
					srcYStride);
				c1 = (mlib_U82D64[srcPixelPtr[0]] * xf0 +
					mlib_U82D64[srcPixelPtr[2]] * xf1 +
					mlib_U82D64[srcPixelPtr[4]] * xf2 +
					mlib_U82D64[srcPixelPtr[6]] * xf3);
				srcPixelPtr =
					(DTYPE *) ((mlib_addr)srcPixelPtr +
					srcYStride);
				c2 = (mlib_U82D64[srcPixelPtr[0]] * xf0 +
...
#pragma pipeloop(0)
			...
			for (; dPtr <= (dstLineEnd - 1); dPtr += 3) {
				...
				srcPixelPtr =
					...
					srcYStride);
				c1 = (mlib_U82D64[srcPixelPtr[0]] * xf0 +
					mlib_U82D64[srcPixelPtr[3]] * xf1 +
					mlib_U82D64[srcPixelPtr[6]] * xf2 +
					mlib_U82D64[srcPixelPtr[9]] * xf3);
				srcPixelPtr =
					(DTYPE *) ((mlib_addr)srcPixelPtr +
					srcYStride);
				c2 = (mlib_U82D64[srcPixelPtr[0]] * xf0 +
...
#pragma pipeloop(0)
			...
			for (; dPtr <= (dstLineEnd - 1); dPtr += 4) {
				...
				srcPixelPtr =
					...
					srcYStride);
				c1 = (mlib_U82D64[srcPixelPtr[0]] * xf0 +
					mlib_U82D64[srcPixelPtr[4]] * xf1 +
					mlib_U82D64[srcPixelPtr[8]] * xf2 +
					mlib_U82D64[srcPixelPtr[12]] * xf3);
				srcPixelPtr =
					(DTYPE *) ((mlib_addr)srcPixelPtr +
					srcYStride);
				c2 = (mlib_U82D64[srcPixelPtr[0]] * xf0 +
