...
#pragma ident	"@(#)mlib_ImageExtremaLocations_Fp.c	9.2	07/10/09 SMI"

/*
 * FUNCTION
 *      mlib_ImageExtremaLocations_Fp  - finds the image-wise minimum and
 *                                       maximum pixel values for each channel,
 *
 * SYNOPSIS
 *      mlib_status
 *      mlib_ImageExtremaLocations_Fp(mlib_d64         *min,
 *                                    mlib_d64         *max,
 ...
 *      For mlib_ImageExtremaLocations_Fp, the image can be of MLIB_FLOAT or
...
#pragma weak mlib_ImageExtremaLocations_Fp = __mlib_ImageExtremaLocations_Fp

#elif defined(__GNUC__)	/* defined(__SUNPRO_C) */
__typeof__(__mlib_ImageExtremaLocations_Fp) mlib_ImageExtremaLocations_Fp
    __attribute__((weak, alias("__mlib_ImageExtremaLocations_Fp")));
...
#define	FUNC_IMAGE_EXTREMALOCATIONS(STYPE)                                \
	mlib_status                                                       \
	mlib_ImageExtremaLocations_##STYPE(mlib_d64 *min,                 \
	    mlib_d64 *max, const mlib_image *img, mlib_s32 xStart,        \
	...
	{                                                                 \
		...
		mlib_##STYPE tmax = (mlib_##STYPE) max[c];                \
		mlib_##STYPE tmin = (mlib_##STYPE) min[c];                \
...
FUNC_IMAGE_EXTREMALOCATIONS(f32)
    FUNC_IMAGE_EXTREMALOCATIONS(d64)
