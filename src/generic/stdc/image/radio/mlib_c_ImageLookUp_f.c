...
#pragma ident	"@(#)mlib_c_ImageLookUp_f.c	9.2	07/10/09 SMI"
...
#define	STORE_MASK_LSB(res, left, right)                        \
	res >>= shift;						\
...
#define	STORE_MASK(res, left, right)                            \
...
#pragma pipeloop(0)
				...
				for (i = 0; i < size - 7;
				    i += 4, da++, sa += 2) {
					READ_U8_U8_ALIGN(tab0, tab1, tab0,
					    tab1);
					t = (t0 << 24) + (t1 << 16) +
					    (t2 << 8) + t3;
					s0 = sa[0];
...
#pragma pipeloop(0)
				...
				for (i = 0; i < size - 7;
				    i += 4, da++, sa += 2) {
					READ_U8_U8_ALIGN(tab0, tab1, tab2,
					    tab0);
					t = (t0 << 24) + (t1 << 16) +
					    (t2 << 8) + t3;
					tab = tab0;
...
#pragma pipeloop(0)
				...
				for (i = 0; i < size - 10;
				    i += 4, da += 2, sa++) {
					READ_U8_S16_NOTALIGN(tab, tab, tab,
					    tab);
					s0 = s1;
					res1 = (t0 << 16) + t1;
					res2 = (t2 << 16) + t3;
...
#pragma pipeloop(0)
				...
				for (i = 0; i < size - 7;
				    i += 4, da += 2, sa++) {
					READ_U8_S16_ALIGN(tab0, tab1, tab0,
					    tab1);
					res1 = (t0 << 16) + t1;
					res2 = (t2 << 16) + t3;
					s0 = sa[0];
...
#pragma pipeloop(0)
				...
				for (i = 0; i < size - 10;
				    i += 4, da += 2, sa++) {
					READ_U8_S16_NOTALIGN(tab1, tab0, tab1,
					    tab0);
					s0 = s1;
					res1 = (t0 << 16) + t1;
					res2 = (t2 << 16) + t3;
...
#pragma pipeloop(0)
				...
				for (i = 0; i < size - 7;
				    i += 4, da += 2, sa++) {
					READ_U8_S16_ALIGN(tab0, tab1, tab2,
					    tab0);
					res1 = (t0 << 16) + t1;
					res2 = (t2 << 16) + t3;
					tab = tab0;
...
#pragma pipeloop(0)
				...
				for (i = 0; i < size - 10;
				    i += 4, da += 2, sa++) {
					READ_U8_S16_NOTALIGN(tab1, tab2, tab0,
					    tab1);
					s0 = s1;
					res1 = (t0 << 16) + t1;
					res2 = (t2 << 16) + t3;
...
#pragma pipeloop(0)
				...
				for (i = 0; i < size - 10;
				    i += 4, da += 2, sa++) {
					READ_U8_S16_NOTALIGN(tab1, tab2, tab3,
					    tab0);
					s0 = s1;
					res1 = (t0 << 16) + t1;
					res2 = (t2 << 16) + t3;
...
#pragma pipeloop(0)
				...
				da[1] = res2;
#ifdef _LITTLE_ENDIAN
				STORE_MASK_LSB(t2, 8, (11 - off))
#else /* _LITTLE_ENDIAN */
				STORE_MASK(t2, 8, (11 - off))
#endif /* _LITTLE_ENDIAN */
				    da += 2;
				dp = (mlib_u8 *)da + (4 - off);
...
#pragma pipeloop(0)
				...
				da[0] = res;
#ifdef _LITTLE_ENDIAN
				STORE_MASK_LSB(res2, 4, (7 - off))
#else /* _LITTLE_ENDIAN */
				STORE_MASK(res2, 4, (7 - off))
#endif /* _LITTLE_ENDIAN */
			}
		}
	}
...
#ifdef _LITTLE_ENDIAN
				t0 = *(mlib_u32 *)((mlib_u8 *)tab0 +
				    ((s0 << 2) & 0x3FC));
				t1 = *(mlib_u32 *)((mlib_u8 *)tab1 +
				    ((s0 << 2) & 0x3FC));
				t2 = *(mlib_u32 *)((mlib_u8 *)tab0 +
				    ((s0 >> 6) & 0x3FC));
				t3 = *(mlib_u32 *)((mlib_u8 *)tab1 +
				    ((s0 >> 6) & 0x3FC));
#else /* _LITTLE_ENDIAN */
				t0 = *(mlib_u32 *)((mlib_u8 *)tab0 +
				    ((s0 >> 22) & 0x3FC));
...
#pragma pipeloop(0)
			...
			for (i = 0; i < size - 7; i += 4, dp += 12, sa++) {
				...
				t1 = *(mlib_u32 *)((mlib_u8 *)tab1 +
				    ((s0 << 2) & 0x3FC));
				t2 = *(mlib_u32 *)((mlib_u8 *)tab2 +
				    ((s0 << 2) & 0x3FC));
				t3 = *(mlib_u32 *)((mlib_u8 *)tab0 +
				    ((s0 >> 6) & 0x3FC));
				t4 = *(mlib_u32 *)((mlib_u8 *)tab1 +
				    ((s0 >> 6) & 0x3FC));
				t5 = *(mlib_u32 *)((mlib_u8 *)tab2 +
				    ((s0 >> 6) & 0x3FC));
#else /* _LITTLE_ENDIAN */
				t0 = *(mlib_u32 *)((mlib_u8 *)tab0 +
				    ((s0 >> 22) & 0x3FC));
