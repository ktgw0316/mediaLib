...
#pragma ident	"@(#)mlib_ImageLookUp_64.c	9.2	07/10/09 SMI"
...
#ifdef _LITTLE_ENDIAN
				t0 = *(mlib_d64 *)((mlib_u8 *)tab0 +
				    ((s0 << 3) & 0x7F8));
				t1 = *(mlib_d64 *)((mlib_u8 *)tab1 +
				    ((s0 << 3) & 0x7F8));
				t2 = *(mlib_d64 *)((mlib_u8 *)tab0 +
				    ((s0 >> 5) & 0x7F8));
				t3 = *(mlib_d64 *)((mlib_u8 *)tab1 +
				    ((s0 >> 5) & 0x7F8));
#else /* _LITTLE_ENDIAN */
				t0 = *(mlib_d64 *)((mlib_u8 *)tab0 +
				    ((s0 >> 21) & 0x7F8));
...
#pragma pipeloop(0)
			...
			for (i = 0; i < size - 7; i += 4, dp += 12, sa++) {
				...
				t1 = *(mlib_d64 *)((mlib_u8 *)tab1 +
				    ((s0 << 3) & 0x7F8));
				t2 = *(mlib_d64 *)((mlib_u8 *)tab2 +
				    ((s0 << 3) & 0x7F8));
				t3 = *(mlib_d64 *)((mlib_u8 *)tab0 +
				    ((s0 >> 5) & 0x7F8));
				t4 = *(mlib_d64 *)((mlib_u8 *)tab1 +
				    ((s0 >> 5) & 0x7F8));
				t5 = *(mlib_d64 *)((mlib_u8 *)tab2 +
				    ((s0 >> 5) & 0x7F8));
#else /* _LITTLE_ENDIAN */
				t0 = *(mlib_d64 *)((mlib_u8 *)tab0 +
				    ((s0 >> 21) & 0x7F8));
