...
#pragma ident	"@(#)mlib_ImageNotXor_Bit.c	9.2	07/10/09 SMI"

/*
 * FUNCTION
 *      mlib_ImageNotXor_Bit     - notxor two bit type images  (C version)
 *
 * SYNOPSIS
...
#define	LOGIC_BITS                                                      \
	mlib_status                                                     \
	mlib_ImageNotXor_Bit(mlib_image *dst, const mlib_image *src1,   \
	    const mlib_image *src2)
