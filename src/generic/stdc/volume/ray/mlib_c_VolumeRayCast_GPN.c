...
#pragma ident	"@(#)mlib_c_VolumeRayCast_GPN.c	9.3	07/10/09 SMI"
...
static mlib_status
mlib_c_VolumeRayCast_General_Parallel_Nearest_S16_S16_OneRegion(
	mlib_rays *rays,
	mlib_s32 nrays,
	mlib_s32 minsteps,
	mlib_s32 maxsteps,
...
static mlib_status
mlib_c_VolumeRayCast_General_Parallel_Nearest_S16_S16_MultiRegion(
	mlib_rays *rays,
	mlib_s32 nrays,
	mlib_s32 maxsteps,
	const mlib_genvolume *vol);
...
static mlib_status
mlib_c_VolumeRayCast_General_Parallel_Nearest_U8_U8_OneRegion(
	mlib_rays *rays,
	mlib_s32 nrays,
	mlib_s32 minsteps,
	mlib_s32 maxsteps,
...
static mlib_status
mlib_c_VolumeRayCast_General_Parallel_Nearest_U8_U8_MultiRegion(
	mlib_rays *rays,
	mlib_s32 nrays,
	mlib_s32 maxsteps,
	const mlib_genvolume *vol);
...
/*
 * coordinate differences vs the voxel in home ray,
 * for current step
 */
...
#define	FUN_NAME(REG) \
	mlib_c_VolumeRayCast_General_Parallel_Nearest_S16_S16_##REG
