...
#pragma ident	"@(#)mlib_MatrixMulShift.c	9.3	07/10/08 SMI"
...
#pragma weak mlib_MatrixMulShift_S16_S16_Sat = \
	__mlib_MatrixMulShift_S16_S16_Sat

#elif defined(__GNUC__)

__typeof__(__mlib_MatrixMulShift_S16_S16_Sat) mlib_MatrixMulShift_S16_S16_Sat
	__attribute__((weak, alias("__mlib_MatrixMulShift_S16_S16_Sat")));
...
MATRIX_MUL_SHIFT(S16, S16, Sat, mlib_d64)
