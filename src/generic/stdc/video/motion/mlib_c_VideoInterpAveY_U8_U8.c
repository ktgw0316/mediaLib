...
#pragma ident	"@(#)mlib_c_VideoInterpAveY_U8_U8.c	9.2	07/10/09 SMI"
...
#define	MLIB_C_VIDEOINTERPAVG(width, height)                              \
	...
	for (y = 0; y < height; y++) {                                    \
		...
		mlib_u32 d0 = *(mlib_u32 *)dd;                            \
	                                                                  \
		dd[0] = (mlib_u32)(((d0 & 0xff) << 1) + sd[0] + (sd +     \
			frame_stride)[0] + 3) >> 2;                       \
		dd[1] = (mlib_u32)(((d0 >> 7) & 0x1fe) + sd[1] + (sd +    \
			frame_stride)[1] + 3) >> 2;                       \
		dd[2] = (mlib_u32)(((d0 >> 15) & 0x1fe) + sd[2] + (sd +   \
			frame_stride)[2] + 3) >> 2;                       \
		dd[3] = (mlib_u32)(((d0 >> 23) & 0x1fe) + sd[3] + (sd +   \
			frame_stride)[3] + 3) >> 2;                       \
		sd += 4;                                                  \
		dd += 4;                                                  \
	    }                                                             \
...
#define	MLIB_C_VIDEOINTERPAVG(width, height)                              \
	...
	for (y = 0; y < height; y++) {                                    \
		...
		mlib_u32 d0 = *(mlib_u32 *)dd;                            \
	                                                                  \
		dd[0] = (mlib_u32)(((d0 >> 23) & 0x1fe) + sd[0] + (sd +   \
			frame_stride)[0] + 3) >> 2;                       \
		dd[1] = (mlib_u32)(((d0 >> 15) & 0x1fe) + sd[1] + (sd +   \
			frame_stride)[1] + 3) >> 2;                       \
		dd[2] = (mlib_u32)(((d0 >> 7) & 0x1fe) + sd[2] + (sd +    \
			frame_stride)[2] + 3) >> 2;                       \
		dd[3] = (mlib_u32)(((d0 & 0xff) << 1) + sd[3] + (sd +     \
			frame_stride)[3] + 3) >> 2;                       \
		sd += 4;                                                  \
		dd += 4;                                                  \
	    }                                                             \
