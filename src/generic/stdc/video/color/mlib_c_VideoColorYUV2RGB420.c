...
#pragma ident	"@(#)mlib_c_VideoColorYUV2RGB420.c	9.2	07/10/09 SMI"
...
#pragma pipeloop(0)
			...
			for (i = 0; i < (width >> 1); i++) {
				...
				TCLAMP_U8(sf02 + sfr, da2[0]);
				TCLAMP_U8(sf02 + sfg, da2[1]);
				SCLAMP_U8(sf02 + sfb, da2[2]);
				TCLAMP_U8(sf04 + sfr, da2[3]);
				SCLAMP_U8(sf04 + sfg, da2[4]);
			...
			dl1 = da1 = ((mlib_u8 *)dl1 + 2 * rgb_stride);
			dl2 = da2 = ((mlib_u8 *)dl2 + 2 * rgb_stride);
		}
	}
