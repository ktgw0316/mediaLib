...
#pragma ident	"@(#)mlib_c_VideoColorYUV2ABGR411.c	9.2	07/10/09 SMI"
...
#pragma pipeloop(0)
			...
			for (i = 0; i < (width >> 2); i++) {
				...
				TCLAMP_U8(sf02 + sfb, da1[9]);
				TCLAMP_U8(sf02 + sfg, da1[10]);
				SCLAMP_U8(sf02 + sfr, da1[11]);
				TCLAMP_U8(sf04 + sfb, da1[13]);
				SCLAMP_U8(sf04 + sfg, da1[14]);
				TCLAMP_U8(sf04 + sfr, da1[15]);
			...
			dl1 = da1 = ((mlib_u8 *)dl1 + abgr_stride);
		}
