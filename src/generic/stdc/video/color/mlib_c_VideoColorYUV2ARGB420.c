...
#pragma ident	"@(#)mlib_c_VideoColorYUV2ARGB420.c	9.2	07/10/09 SMI"
...
#pragma pipeloop(0)
			...
			for (i = 0; i < (width >> 1); i++) {
				...
				TCLAMP_U8(sf02 + sfr, da2[1]);
				TCLAMP_U8(sf02 + sfg, da2[2]);
				SCLAMP_U8(sf02 + sfb, da2[3]);
				TCLAMP_U8(sf04 + sfr, da2[5]);
				SCLAMP_U8(sf04 + sfg, da2[6]);
				TCLAMP_U8(sf04 + sfb, da2[7]);
			...
			dl1 = da1 = ((mlib_u8 *)dl1 + 2 * argb_stride);
			dl2 = da2 = ((mlib_u8 *)dl2 + 2 * argb_stride);
		}
	}
