...
#pragma ident	"@(#)mlib_i_VideoInterpAveX_U8_U8.c	9.2	07/11/05 SMI"
...
#define	MLIB_C_VIDEOINTERPAVG(width, height)                               \
	...
	for (y = 0; y < height; y++) {                                     \
	    ...
	    for (x = 0; x < (width >> 2); x++) {                           \
		d0 = *(mlib_u32 *)dd;                                      \
		a0 = (mlib_u32)(((d0 & 0xff) << 1) + sd[0] + (sd[1] +   \
			3)) >> 2;                                          \
		a1 = (mlib_u32)(((d0 >> 7) & 0x1fe) + sd[2] +           \
			(sd[1] + 3)) >> 2;                                 \
		a2 = (mlib_u32)(((d0 >> 15) & 0x1fe) + sd[2] +          \
			(sd[3] + 3)) >> 2;                                 \
		a3 = (mlib_u32)(((d0 >> 23) & 0x1fe) + sd[4] +          \
			(sd[3] + 3)) >> 2;                                 \
...
#define	MLIB_C_VIDEOINTERPAVG(width, height)                               \
	...
	for (y = 0; y < height; y++) {                                     \
	    ...
	    for (x = 0; x < (width >> 2); x++) {                           \
		d0 = *(mlib_u32 *)dd;                                      \
		a0 = (mlib_u32)(((d0 >> 23) & 0x1fe) + sd[0] +          \
			(sd[1] + 3)) >> 2;                                 \
		a1 = (mlib_u32)(((d0 >> 15) & 0x1fe) + sd[2] +          \
			(sd[1] + 3)) >> 2;                                 \
		a2 = (mlib_u32)(((d0 >> 7) & 0x1fe) + sd[2] +           \
			(sd[3] + 3)) >> 2;                                 \
		a3 = (mlib_u32)(((d0 & 0xff) << 1) + sd[4] + (sd[3] +   \
			3)) >> 2;                                          \
