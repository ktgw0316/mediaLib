...
#pragma ident   "@(#)mlib_ImageConv_8nw.c	9.2    07/11/05 SMI"
...
#endif /* __SUNPRO_C */
		for (i = 0; i < wid + (KSIZE - 1); i++) {
			buffs[0][i] = (mlib_s32) sl[i * chan1];
			buffs[1][i] = (mlib_s32) sl1[i * chan1];
			buffs[2][i] = (mlib_s32) sl2[i * chan1];
			buffs[3][i] = (mlib_s32) sl3[i * chan1];
			buffs[4][i] = (mlib_s32) sl4[i * chan1];
			buffs[5][i] = (mlib_s32) sl5[i * chan1];
			buffs[6][i] = (mlib_s32) sl6[i * chan1];
		}
