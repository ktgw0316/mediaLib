...
#pragma ident   "@(#)mlib_i_ImageSConv_8nw.c	9.2    07/11/05 SMI"
...
/* for SPARC, using integer-point multiplies is faster in U8 and S16 cases */
...
CONV_FUNC(7x7)
{
	...
	mlib_s32 buff[KSIZE * BUFF_LINE];
	mlib_s32 *pbuff = buff, *buff4, *buffT;
	mlib_s32 *buff0, *buff1, *buff2, *buff3, *buff5, *buff6;
