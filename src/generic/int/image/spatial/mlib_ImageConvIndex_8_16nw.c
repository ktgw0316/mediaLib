...
#pragma ident   "@(#)mlib_ImageConvIndex_8_16nw.c	9.2    07/11/05 SMI"
...
#define	CONV_FUNC(KERN)                                         \
	mlib_conv##KERN##Index_16_8nw(const mlib_image *src,     \
...
#define	GET_ColorTrueFunc()                                     \
	(nchan ==                                               \
	    3) ? mlib_ImageColorTrue2IndexLine_S16_U8_3 :        \
