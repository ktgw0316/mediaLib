...
#pragma ident	"@(#)mlib_ImageAffineTable_8ext.c	9.3	07/11/05 SMI"
...
#define	LINE_FUNC(KERN)                                         \
	void                                                    \
	mlib_ImageAffineTableLine_8ext_##KERN(FP_TYPE * buff,   \
...
#define	LINE_FUNC(KERN)                                                 \
	void                                                            \
	mlib_ImageAffineTableLine_8nw_##KERN(FP_TYPE * buff,            \
		FILTER_TYPE * filterX, FILTER_TYPE * filterY,           \
