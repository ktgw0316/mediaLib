...
#pragma ident	"@(#)mlib_ImageAffine_NN.c	9.2	07/11/05"
...
/* do not perform the copying by mlib_s64 data type if _NO_LONGLONG defined */
#ifdef	_NO_LONGLONG
...
#pragma pipeloop(0)
		...
		for (i = 0; i <= (size - 2); i += 2) {
			...
			sp0 = (mlib_s32 *)S_PTR(Y);
			sp1 = (mlib_s32 *)S_PTR(Y + dY);
