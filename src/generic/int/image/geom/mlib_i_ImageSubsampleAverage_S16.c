...
#pragma ident	"@(#)mlib_i_ImageSubsampleAverage_S16.c	9.3	07/11/05"
...
#define	FUNC(SUFF)	mlib_ImageSubsampleAverage_S16_##SUFF
...
#define	_NOT_IN_IMAGESUBSAMPLEAVERAGE_U8
#include <mlib_i_ImageSubsampleAverage.h>

/* *********************************************************** */

#undef	FUNC
#define	FUNC(SUFF)	mlib_ImageSubsampleAverage_S16_##SUFF##_int
...
#define	SAVE_MUL(src)                                           \
	ss = *buff + src;                                       \
	(*dl++) = (DTYPE) ((ss * d_mul_int)>>MUL_SHIFT);        \
	(*buff++) = rnd_ini
