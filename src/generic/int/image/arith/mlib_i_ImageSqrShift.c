...
#pragma ident   "@(#)mlib_i_ImageSqrShift.c	9.2	07/11/05 SMI"
    ...
    mlib_s32 shift)
{
	...
	if (dtype == MLIB_BYTE) {
		...
		return (mlib_i_ImageSqrShift_U8(dst, src, shift));
	} else {
		...
		if (dtype == MLIB_SHORT) {
			...
			mlib_i_ImageSqrShift_S16((mlib_s16 *)sa, (slb >> 1),
			    (mlib_s16 *)da, (dlb >> 1), xsize, ysize, shift);
			return (MLIB_SUCCESS);
		} else if (dtype == MLIB_USHORT) {

			mlib_i_ImageSqrShift_U16((mlib_u16 *)sa, (slb >> 1),
			    (mlib_u16 *)da, (dlb >> 1), xsize, ysize, shift);
			return (MLIB_SUCCESS);
		} else if (dtype == MLIB_INT) {
			if (shift < 0 || shift > 62) {
				mlib_c_ImageSqrShift_S32((mlib_s32 *)sa,
					(slb >> 2), (mlib_s32 *)da,
					(dlb >> 2), xsize, ysize, shift);
			return (MLIB_SUCCESS);
			} else {
				mlib_i_ImageSqrShift_S32((mlib_s32 *)sa,
					(slb >> 2), (mlib_s32 *)da,
					(dlb >> 2), xsize, ysize, shift);
			return (MLIB_SUCCESS);
			}
