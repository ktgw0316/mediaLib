...
#pragma ident	"@(#)mlib_i_ImageColorErrDiffMxN_Bit.c	9.3	07/11/05 SMI"
...
#define	FUNC_DM_ARG                                                      \
	mlib_u8 *dl, mlib_s64 *buffd, mlib_s64 *perror, mlib_s32 *pkern, \
	mlib_s64 dscale, const void *colormap, mlib_u8 *lut_table,       \
	mlib_s32 sw, mlib_s32 dm, mlib_s32 bitoff
...
#define	D64_T0_U8(src, dst)                                          \
	sat = (mlib_s32)(src / dscale);                              \
	dst = (mlib_u8)(sat | ((255 - sat) >> 31)) & ~(sat >> 31)

/* *********************************************************** */

#define	GET_COLOR_ERROR(ae)	ae = col0 - (mlib_s64)lut_table[col_ind]
