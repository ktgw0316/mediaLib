...
#pragma ident	"@(#)mlib_ImageThresh5_Fp.c	9.2	07/11/05 SMI"
...
#define	INIT_THRESH_F32(n)                                  \
	...
	gtemp = gmid[n];                                        \
	mlib_s32 gmid##n = *((mlib_s32 *) &gtemp)
...
#define	INIT_THRESH_F32(n)                                  \
	...
	mlib_s32 tlow##n = *((mlib_s32 *) &gtemp);              \
	(volatile)gtemp = gmid[n];                              \
	mlib_s32 gmid##n = *((mlib_s32 *) &gtemp)
#endif

/* *********************************************************** */

#define	DO_THRESH_F32(src, th, tl, gm)                      \
	((tl & 0x80000000) && (src & 0x80000000)) ?             \
		((tl < src) ? src : ((th & 0x80000000) ?            \
		((src < th) ? src : gm) : ((src <= th) ? gm : src)))\
		: ((tl > src) || (src > th)) ? src : gm
/* *********************************************************** */
...
#define	INIT_THRESH_D64(n)                                  \
	...
	gtemp = gmid[n];                                        \
	mlib_s64 gmid##n = *((mlib_s64 *) &gtemp)
...
#define	DO_THRESH_D64(src, th, tl, gm)                         \
	((tl & 0x8000000000000000) && (src & 0x8000000000000000)) ?\
		((tl < src) ? src : ((th & 0x8000000000000000) ?       \
		((src < th) ? src : gm) : ((src <= th) ? gm : src)))   \
		: ((tl > src) || (src > th)) ? src : gm
/* *********************************************************** */
