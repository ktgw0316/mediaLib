...
#pragma ident	"@(#)mlib_VectorMulShift32.c	9.3	07/11/05 SMI"
...
/*  Note: performance mistake here is 1  */
{
	...
	for (i = 0; i < n; i++) {
		...
		if (px[index1] == 0x80000000 && px[index2] == 0x80000000 &&
			py[index1] == 0x80000000 && py[index2] == 0x80000000) {
			pz[index1] = 0;
