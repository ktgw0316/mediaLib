...
#pragma ident	"@(#)mlib_i_SignalFFT_3.c	9.4	07/11/05 SMI"
 ...
 *      mlib_SignalFFT_3_S16C_S16_Mod    - FFT of 16bit
 ...
 *                                         into 2 arrays as
 *                                         real and imag parts of complex
 *      mlib_SignalIFFT_3_S16_S16C_Mod   - inverse FFT of 16bit
 *                                         format complex array
    ...
    mlib_s32 order)
{
	...
	return mlib_c_fftDispatcher_3(dstc, NULL, (void *)srcc, NULL, order,
	    eSrcCmplx | eDstCmplx);
#else
	return mlib_c_fftDispatcher_3_i(dstc, NULL, (void *)srcc, NULL, order,
	    eSrcCmplx | eDstCmplx);
#endif
}
...
#else
	return mlib_c_fftDispatcher_3_i(dstr, dsti, (void *)srcr, (void *)srci,
	    order, eSrcReIm | eDstReIm);
#endif
}
...
#else
	return mlib_c_fftDispatcher_3_i(dstr, NULL, (void *)srcc, NULL, order,
	    eSrcCmplx | eDstRe | eInversFFT);
#endif
}
