...
#pragma ident	"@(#)mlib_i_SignalFFT_1.c	9.5	07/11/05 SMI"
 ...
 *      mlib_SignalFFT_1_S16C_S16_Mod    - FFT of 16-bit format
 *                                         1 array as real part
 *                                         of( real-valued ) complex
 *                                         into complex array
 *      mlib_SignalIFFT_1_S16C_S16C      - inverse FFT of 16-bit
 *                                         format complex array
 *                                         into complex array
 *      mlib_SignalIFFT_1_S16_S16        - inverse FFT of 16-bit
 *                                         format 2 arrays as real
 *                                         and imag parts of complex
 *                                         into 2 arrays as
 *                                         real and imag parts of complex
 *      mlib_SignalIFFT_1_S16_S16C       - inverse FFT of 16-bit
 *                                         format complex array
 *                                         into 1 array as real part
 *                                         of( real-valued ) complex
 *                                         NOTE: this is a semantic pair
 *                                           to mlib_SignalFFT_1_S16C_S16_Mod
 *      mlib_SignalFFT_1_S16C_Mod        - FFT of 16-bit
 *                                         format complex array into
 *                                         complex array
 *                                         (input and output arrays
 *                                         are the same)
 *      mlib_SignalFFT_1_S16_Mod         - FFT of 16-bit
 ...
 *                                         are the same)
 *      mlib_SignalIFFT_1_S16C           - inverse FFT of 16-bit
 *                                         format complex array
 *                                         into complex array
 *                                         (input and output arrays
 *                                         are the same)
 *      mlib_SignalIFFT_1_S16            - inverse FFT of 16-bit
 *                                         format 2 arrays as real
 *                                         and imag parts of complex
 *                                         into 2 arrays as
 *                                         real and imag parts of complex
...
#ifdef _NO_LONGLONG
	return mlib_c_fftDispatcher_1(dstc, NULL, (void *)srcc, NULL, order,
	    eSrcCmplx | eDstCmplx);
#else
	return mlib_c_fftDispatcher_1_i(dstc, NULL, (void *)srcc, NULL, order,
	    eSrcCmplx | eDstCmplx);
#endif
}
...
#ifdef _NO_LONGLONG
	return mlib_c_fftDispatcher_1(dstr, dsti, (void *)srcr, (void *)srci,
	    order, eSrcReIm | eDstReIm);
#else
	return mlib_c_fftDispatcher_1_i(dstr, dsti, (void *)srcr, (void *)srci,
	    order, eSrcReIm | eDstReIm);
#endif
}
    ...
    mlib_s32 order)
{
	...
	SERVE_BAD_POINTER(dstr);
#ifdef _NO_LONGLONG
	return mlib_c_fftDispatcher_1(dstr, NULL, (void *)srcc, NULL, order,
	    eSrcCmplx | eDstRe | eInversFFT);
#else
	return mlib_c_fftDispatcher_1_i(dstr, NULL, (void *)srcc, NULL, order,
	    eSrcCmplx | eDstRe | eInversFFT);
#endif
}
