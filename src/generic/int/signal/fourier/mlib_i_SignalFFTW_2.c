...
#pragma ident	"@(#)mlib_i_SignalFFTW_2.c	9.4	07/11/05 SMI"
...
#else
	return mlib_c_fftDispatcherW_2_i(dstc, NULL, (void *)srcc, NULL,
	    (void *)window, order, eSrcCmplx | eDstCmplx);
#endif
}
...
#else
	return mlib_c_fftDispatcherW_2_i(dstr, dsti, (void *)srcr, (void *)srci,
	    (void *)window, order, eSrcReIm | eDstReIm);
#endif
}
...
#else
	return mlib_c_fftDispatcherW_2_i(dstr, NULL, (void *)srcc, NULL,
	    (void *)window, order, eSrcCmplx | eDstRe | eInversFFT);
#endif
}
