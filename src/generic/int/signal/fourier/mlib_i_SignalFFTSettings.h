...
#ifndef _MLIB_I_SIGNALFFTSETTINGS_H
#define	_MLIB_I_SIGNALFFTSETTINGS_H

#pragma ident	"@(#)mlib_i_SignalFFTSettings.h	9.2	07/11/05 SMI"

#ifdef MLIB_VIS
#if MLIB_VIS >= 0x200
#error this include file can not be used with VIS >= 2.0
