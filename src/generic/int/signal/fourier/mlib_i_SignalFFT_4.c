...
#pragma ident	"@(#)mlib_i_SignalFFT_4.c	9.5	07/11/05 SMI"
...
#else
	return mlib_c_fftDispatcher_4_i(dstc, NULL, (void *)srcc, NULL, order,
	    scale, eSrcCmplx | eDstCmplx);
#endif
}
...
#else
	return mlib_c_fftDispatcher_4_i(dstr, dsti, (void *)srcr, (void *)srci,
	    order, scale, eSrcReIm | eDstReIm);
#endif
}
    ...
    mlib_s32 *scale)
{
	...
	return mlib_c_fftDispatcherW_4_S16C_S16_i(dstc, NULL, (void *)srcr,
	    NULL, NULL, order, scale, eSrcRe | eDstCmplx);
#endif
}
...
#else
	return mlib_c_fftDispatcher_4_i(dstr, NULL, (void *)srcc, NULL, order,
	    scale, eSrcCmplx | eDstRe | eInversFFT);
#endif
}
