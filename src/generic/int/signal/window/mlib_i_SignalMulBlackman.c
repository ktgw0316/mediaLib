...
#pragma ident	"@(#)mlib_i_SignalMulBlackman.c	9.2	07/11/05 SMI"
    ...
    mlib_s32 i1)
{
	...
	const mlib_s16 * BLACKMAN =
		mlib_i_Blackman_S16 + (n >> 1) - 1;

	if ((n <= 1024) && ((n & (n - 1)) == 0) &&
		*(mlib_s32 *)(&alpha) == ALPHA_G) {
		MLIB_MULWIN2P_S16(BLACKMAN);
		return (MLIB_SUCCESS);
	}
...
__mlib_SignalMulBlackman_S16_S16(
    ...
    mlib_s32 n)
{
	return mlib_SignalMulBlackman_S16_S16_i(dst, src, alpha, n,
		0, n >> 2);
}
...
__mlib_SignalMulBlackman_S16(
    ...
    mlib_s32 n)
{
	return mlib_SignalMulBlackman_S16_S16_i(data, data, alpha, n,
		0, n >> 2);
}
...
__mlib_SignalMulBlackman_S16S_S16S(
    ...
    mlib_s32 n)
{
	return mlib_SignalMulBlackman_S16S_S16S_i(dst, src, alpha, n,
		0, n >> 2);
}
...
__mlib_SignalMulBlackman_S16S(
    ...
    mlib_s32 n)
{
	return mlib_SignalMulBlackman_S16S_S16S_i(data, data, alpha, n,
		0, n >> 2);
}
