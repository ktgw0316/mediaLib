...
#pragma ident	"@(#)mlib_i_SignalMulHamming.c	9.2	07/11/05 SMI"
    ...
    mlib_s32 i1)
{
	...
	const mlib_s16 * HAMMING =
		mlib_i_Hamming_S16 + (n >> 1) - 1;

	if ((n <= 1024) && ((n & (n - 1)) == 0)) {
		MLIB_MULWIN2P_S16(HAMMING);
		return (MLIB_SUCCESS);
	}
...
__mlib_SignalMulHamming_S16_S16(
    ...
    mlib_s32 n)
{
	return mlib_SignalMulHamming_S16_S16_i(dst, src, n,
		0, n >> 2);
}
...
__mlib_SignalMulHamming_S16(
    ...
    mlib_s32 n)
{
	return mlib_SignalMulHamming_S16_S16_i(data, data, n,
		0, n >> 2);
}
    ...
    mlib_s32 i1)
{
	...
	const mlib_s16 * HAMMING = mlib_i_Hamming_S16 + (n >> 1) - 1;

	if ((n <= 1024) && ((n & (n - 1)) == 0)) {
		MLIB_MULWIN2P_S16S(HAMMING);
		return (MLIB_SUCCESS);
	}
...
__mlib_SignalMulHamming_S16S_S16S(
    ...
    mlib_s32 n)
{
	return mlib_SignalMulHamming_S16S_S16S_i(dst, src, n,
		0, n >> 2);
}
...
__mlib_SignalMulHamming_S16S(
    ...
    mlib_s32 n)
{
	return mlib_SignalMulHamming_S16S_S16S_i(data, data, n,
		0, n >> 2);
}
